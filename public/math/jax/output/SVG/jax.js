...
(function (j, e, g, a) {
  ...
  a.Augment({
    ...
    Startup: function () {
      ...
      l.GLYPH.defs = this.addElement(this.addElement(this.hiddenDiv.parentNode, 'svg'), 'defs', {
    ...
    InitializeSVG: function () {
      ...
      this.defaultWidth = Math.max(0, n.lastChild.offsetLeft - n.firstChild.offsetLeft - 2);
    ...
    preTranslate: function (s) {
      ...
      for (D = 0; D < z; D++) {
        ...
        if (
          w &&
          String(w.className).match(/^MathJax(_SVG)?(_Display)?( MathJax(_SVG)?_Process(ing|ed))?$/)
        ) {
        ...
        p.SVG = { display: p.root.Get('display') === 'block', preview: (p.SVG || {}).preview };
        C = u = g.Element('span', {
    ...
    length2em: function (s, o, q) {
      ...
      var p = s.match(/^\s*([-+]?(?:\.\d+|\d+(?:\.\d*)?))?(pt|em|ex|mu|px|pc|in|mm|cm|%)?/);
    ...
    HandleVariant: function (u, t, D) {
        ...
        if (B) {
          ...
          if (this.FONTDATA.DELIMITERS[q]) {
            ...
            if (q <= 65535) {
              ...
              z = q - 65536;
              B = String.fromCharCode((z >> 10) + 55296) + String.fromCharCode((z & 1023) + 56320);
            }
      ...
      if (x.element.childNodes.length === 1 && !x.element.firstChild.getAttribute('x')) {
    ...
    createDelimiter: function (n, p, s, q) {
      ...
      for (var t = 0, r = o.HW.length; t < r; t++) {
        if (o.HW[t][0] * s >= p - 10 - a.config.blacker || (t == r - 1 && !o.stretch)) {
          if (o.HW[t][2]) {
            s *= o.HW[t][2];
          }
          if (o.HW[t][3]) {
          ...
          return this.createChar(s, [n, o.HW[t][1]], q).With({ stretched: true });
        }
      }
      if (o.stretch) {
    ...
    extendDelimiterV: function (u, C, o, q, p) {
      ...
      if (C > t) {
        ...
        while (r-- > 0) {
          var v = a.Element('g', {
            transform: 'translate(' + n.y + ',' + (z - D * n.h + 50 + n.y) + ') scale(1,' + D + ')',
          });
    ...
    extendDelimiterH: function (v, q, o, t, p) {
      ...
      if (q > D) {
        ...
        while (u-- > 0) {
          var y = a.Element('g', {
            transform:
              'translate(' + (B - n / 2 - F * A.l + A.x) + ',' + A.y + ') scale(' + F + ',1)',
          });
  ...
  var l = (a.BBOX = MathJax.Object.Subclass({
        ...
        if (Math.abs(q.x) < 1 && Math.abs(q.y) < 1) {
          ...
          if (s === 'g') {
            ...
            if (s === 'line' || s === 'polygon' || s === 'path' || s === 'a') {
              ...
              p = 'translate(' + Math.floor(q.x) + ',' + Math.floor(q.y) + ')' + p;
        ...
        if (q.remove) {
          ...
          while (q.element.firstChild) {
            if (u && this.element.firstChild) {
              this.element.insertBefore(q.element.firstChild, this.element.firstChild);
            } else {
    ...
    Align: function (r, s, q, p, o) {
      q = { left: q, center: (this.w - r.w) / 2, right: this.w - r.w - q }[s] || 0;
      var n = this.w;
      this.Add(r, q + (o || 0), p);
      this.w = n;
    },
    ...
    Stretch: function () {
      for (var q = 0, n = this.svg.length; q < n; q++) {
        var o = this.svg[q],
          p = o.mml;
        if (p) {
          if (p.forceStretch || p.SVGdata.h !== this.sh || p.SVGdata.d !== this.sd) {
  ...
  l.FRAME = l.Subclass({
    ...
    Init: function (q, u, n, p, s, o, r) {
      ...
      r.transform = 'translate(' + Math.floor(p / 2) + ',' + Math.floor(-u + p / 2) + ')';
      if (s === 'dashed') {
        r['stroke-dasharray'] = [Math.floor(6 * a.em), Math.floor(6 * a.em)].join(' ');
      }
  ...
  l.TEXT = l.Subclass({
    ...
    Init: function (q, p, n) {
      ...
      q *= 1000 / a.em;
      this.element.setAttribute('transform', 'scale(' + a.Fixed(q) + ') matrix(1 0 0 -1 0 0)');
  ...
  e.Register.StartupHook('mml Jax Ready', function () {
    ...
    i.mbase.Augment(
      {
        ...
        SVGaddAttributes: function (o) {
          if (this.attrNames) {
            ...
            for (var p = 0, n = u.length; p < n; p++) {
              ...
              if (
                t[s] == false ||
                (!q[s] && !t[s] && r[s] == null && typeof o.element[s] === 'undefined')
              ) {
        ...
        SVGhandleSpace: function (q) {
          if (this.hasMMLspacing()) {
            ...
            if (p.scriptlevel <= 0 || this.hasValue('lspace') || this.hasValue('rspace')) {
        ...
        SVGhandleColor: function (r) {
          ...
          if (A.background !== i.COLOR.TRANSPARENT) {
            ...
            r.Add(l.RECT(r.h, r.d, r.w, { fill: A.background, stroke: 'none' }), 0, 0, false, true);
          }
          if (v) {
            var z = 5;
            var p = {
            ...
            for (n in p) {
              if (p.hasOwnProperty(n)) {
                if (v[n]) {
                  var u = p[n],
                    q = l[u[0] + 'LINE'];
                  r.Add(q(u[1], v[n], v[n + 'Style'], v[n + 'Color']), u[2], u[3]);
                }
              }
            }
          }
        ...
        SVGgetVariant: function () {
          var n = this.getValues('mathvariant', 'fontfamily', 'fontweight', 'fontstyle');
          var o = n.mathvariant;
          if (this.variantForm) {
        ...
        SVGnotEmpty: function (n) {
          while (n) {
            if ((n.type !== 'mrow' && n.type !== 'texatom') || n.data.length > 1) {
              return true;
            }
            n = n.data[0];
          }
    ...
    i.mo.Augment({
      ...
      SVGcanStretch: function (r) {
        ...
        if (o && o.isa(i.munderover) && a.isChar(this.CoreText(o.data[o.base]))) {
          var q = o.data[o.over],
            n = o.data[o.under];
        ...
        this.forceStretch = p && (this.Get('minsize', true) || this.Get('maxsize', true));
        return p;
      },
      SVGstretchV: function (s, t) {
        ...
        if (q != o.minsize) {
          q = [Math.max((q * a.TeX.delimiterfactor) / 1000, q - a.TeX.delimitershortfall), q];
        }
      ...
      SVGstretchH: function (o) {
        var q = this.svg || this.toSVG(),
          n = this.SVGgetMu(q);
        var p = this.getValues('maxsize', 'minsize', 'mathvariant', 'fontweight');
        if (
        ...
        q = a.createDelimiter(this.data.join('').charCodeAt(0), o, q.scale, p.mathvariant);
    ...
    i.mphantom.Augment({
      toSVG: function (n, p) {
        ...
        if (this.data[0] != null) {
          ...
          o.D = o.d;
          o.H = o.h;
          o.r = Math.max(0, Math.min(o.w, o.r));
          o.l = Math.max(0, Math.min(o.w, o.l));
        }
        this.SVGhandleColor(o);
        this.SVGsaveData(o);
      ...
      toSVG: function (q, n) {
        ...
        if (this.data[0] != null) {
          ...
          var r = this.SVGdataStretched(0, q, n),
            A = this.SVGgetMu(t);
          var z = this.getValues('height', 'depth', 'width', 'lspace', 'voffset'),
            p = 0,
            o = 0;
          if (z.lspace) {
    ...
    i.mrow.Augment({
      ...
      SVGlineBreaks: function (n) {
        ...
        return (a.config.linebreaks.automatic && n.w > a.linebreakWidth) || this.hasNewline();
      },
    ...
    i.mstyle.Augment({
      toSVG: function (n, q) {
        ...
        if (this.data[0] != null) {
          this.SVGhandleSpace(o);
          var p = o.Add(this.data[0].toSVG(n, q));
          o.Clean();
          if (p.ic) {
            o.ic = p.ic;
          }
    ...
    i.munderover.Augment({
      toSVG: function (G, E) {
        ...
        if (!n.displaystyle && p != null && (p.movablelimits || p.CoreMO().Get('movablelimits'))) {
        ...
        for (K = 0, H = this.data.length; K < H; K++) {
          if (this.data[K] != null) {
            if (K == this.base) {
              ...
              L[K] = (E != null || G == null) && this.data[K].SVGcanStretch('Horizontal');
        ...
        var u,
          ...
          I,
          M = 0;
        p = q[this.base] || { w: 0, h: 0, d: 0, H: 0, D: 0, l: 0, r: 0, y: 0, scale: O };
        if (p.ic) {
          M = 1.3 * p.ic + 0.05;
        }
        for (K = 0, H = this.data.length; K < H; K++) {
    ...
    i.msubsup.Augment({
      toSVG: function (M, G) {
        ...
        var w = (this.data[this.sup] || this.data[this.sub] || this).SVGgetScale();
        ...
        N.subscriptshift = N.subscriptshift === '' ? 0 : a.length2em(N.subscriptshift, K);
        N.superscriptshift = N.superscriptshift === '' ? 0 : a.length2em(N.superscriptshift, K);
        var A = y.w + y.x;
        if (!n) {
          if (z) {
            B = Math.max(B, a.TeX.sub1 * Q, z.h - (4 / 5) * O, N.subscriptshift);
            I.Add(z, A, -B);
          ...
          if (!z) {
            ...
            L = a.TeX[o.displaystyle ? 'sup1' : o.texprimestyle ? 'sup3' : 'sup2'];
      ...
      toSVG: function (B, p) {
        ...
        if (this.data[0]) {
          ...
          x.element.setAttribute(
            'viewBox',
            a.Fixed(-u, 1) + ' ' + a.Fixed(-E, 1) + ' ' + a.Fixed(z, 1) + ' ' + a.Fixed(E + n, 1),
          );
          if (x.H > x.h) {
          ...
          if (Math.abs(z - a.cwidth) < 10) {
            q.maxWidth = a.Fixed(((a.cwidth * a.em) / 1000) * a.config.scale) + 'px';
          }
          ...
          x.element = null;
          if (!this.isMultiline && this.Get('display') === 'block' && !x.hasIndent) {
            ...
            if (s) {
              e.Insert(
                q,
                {
                  ...
                  right: { marginRight: a.Ex(-s), marginLeft: a.Ex(Math.max(0, s - z)) },
