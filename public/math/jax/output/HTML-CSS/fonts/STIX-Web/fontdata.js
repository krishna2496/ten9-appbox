...
(function (aj, l, am) {
  ...
  aj.Augment({
    FONTDATA: {
      ...
      VARIANT: {
        ...
        'bold-script': { fonts: [a], offsetA: 120016, bold: true, italic: true },
        'sans-serif': {
          fonts: [d],
          offsetA: 120224,
          offsetN: 120802,
        ...
        '-tex-mathit': { fonts: [P, T, O, c, an, D, z, n, ad, ai, ae], italic: true, noIC: true },
        '-largeOp': { fonts: [ae, E] },
        '-smallOp': {},
      },
      RANGES: [
      ...
      DELIMITERS: {
        ...
        8431: L,
        8512: y,
        8592: { dir: s, HW: [[0.786, E]], stretch: { left: [8592, E], rep: ag } },
        8593: { dir: f, HW: [[0.818, E]], stretch: { ext: [9168, E], top: [8593, E] } },
        8594: { dir: s, HW: [[0.786, E]], stretch: { rep: ag, right: [8594, E] } },
        8595: { dir: f, HW: [[0.818, E]], stretch: { bot: [8595, E], ext: [9168, E] } },
        8596: { dir: s, HW: [[0.85, E]], stretch: { left: [8592, E], rep: ag, right: [8594, E] } },
        8597: {
          dir: f,
          HW: [[0.954, E]],
  ...
  MathJax.Hub.Register.LoadHook(aj.fontDir + '/Main/Regular/Main.js', function () {
  ...
  MathJax.Hub.Register.LoadHook(aj.fontDir + '/Size5/Regular/Main.js', function () {
    var H;
