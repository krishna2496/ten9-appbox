...
MathJax.Hub.Register.StartupHook('HTML-CSS Jax Ready', function () {
  ...
  a.mbase.Augment({
    ...
    HTMLmultiline: function (o) {
      ...
      var m = (p.type === 'math' && p.Get('display') === 'block') || p.type === 'mtd';
      p.isMultiline = true;
      ...
      this.HTMLgetScale();
      var g = { n: 0, Y: 0, scale: this.scale || 1, isTop: m, values: {}, VALUES: q },
        l = this.HTMLgetAlign(g, {}),
        i = this.HTMLgetShift(g, {}, l),
        h = [],
        j = { index: [], penalty: e.nobreak, w: 0, W: i, shift: i, scanW: i, nest: 0 },
        k = false;
      while (
      ...
      if (p.type === 'math') {
        n.style.width = o.bbox.width = '100%';
      }
    ...
    HTMLmoveLine: function (p, g, m, o, h) {
      ...
      if (l === k && p.length > 1) {
        this.data[l].HTMLmoveSlice(p.slice(1), g.slice(1), m, o, h, 'paddingLeft');
      } else {
        var n = o.last;
        o.last = false;
        while (l < k) {
          if (this.data[l]) {
            if (p.length <= 1) {
              ...
              this.data[l].HTMLmoveSlice(p.slice(1), [], m, o, h, 'paddingLeft');
            }
          }
          l++;
          o.first = false;
    ...
    HTMLmoveSpan: function (g, k, i) {
      if (
        ...
        var h = document.getElementById('MathJax-Color-' + this.spanID + b.idPostfix);
        if (h) {
          g.appendChild(h);
        }
  ...
  a.mfenced.Augment({
    ...
    HTMLmoveLine: function (h, m, p, g, r) {
      ...
      if (o === n && h.length > 1) {
        this.data[this.dataI[o]].HTMLmoveSlice(h.slice(1), m.slice(1), p, g, r, 'paddingLeft');
      } else {
        var q = g.last;
        g.last = false;
        var l = this.dataI[o];
        while (o < n) {
          if (this.data[l]) {
            if (h.length <= 1) {
              ...
              this.data[l].HTMLmoveSlice(h.slice(1), [], p, g, r, 'paddingLeft');
            }
          }
          o++;
          l = this.dataI[o];
  ...
  a.msubsup.Augment({
    ...
    HTMLmoveLine: function (h, j, m, g, n) {
      if (this.data[this.base]) {
        if (h.length > 1) {
          this.data[this.base].HTMLmoveSlice(h.slice(1), j.slice(1), m, g, n, 'paddingLeft');
        } else {
          if (j.length <= 1) {
            this.data[this.base].HTMLmoveSpan(m, g, n);
          } else {
            this.data[this.base].HTMLmoveSlice([], j.slice(1), m, g, n, 'paddingRight');
          }
        }
      }
      if (j.length === 0) {
        var o = this.data[this.sup] || this.data[this.sub];
        if (o && this.HTMLnotEmpty(o)) {
          var k = o.HTMLspanElement().parentNode;
          if (o.href) {
            k = k.parentNode;
          }
          var l = k.parentNode;
          if (this.data[this.base]) {
            var i = this.data[this.base].HTMLspanElement().bbox.ic;
            if (i) {
              l.style.marginLeft = b.Em(-i);
            }
            l.removeChild(l.firstChild);
          }
          for (k = l.firstChild; k; k = k.nextSibling) {
            k.style.left = b.Em(b.unEm(k.style.left) - this.HTMLbaseW);
          }
          l.bbox.w -= this.HTMLbaseW;
          l.style.width = b.Em(l.bbox.w);
  ...
  a.mmultiscripts.Augment({
    ...
    HTMLmoveLine: function (i, j, p, h, q) {
      ...
      if (this.data[this.base]) {
        if (i.length > 1) {
          this.data[this.base].HTMLmoveSlice(i.slice(1), j.slice(1), p, h, q, 'paddingLeft');
        } else {
          if (j.length <= 1) {
            this.data[this.base].HTMLmoveSpan(p, h, q);
          } else {
            this.data[this.base].HTMLmoveSlice([], j.slice(1), p, h, q, 'paddingRight');
          }
        }
      }
      if (j.length === 0) {
  ...
  a.mo.Augment({
    HTMLbetterBreak: function (i, g) {
      ...
      if (
        (q.linebreakstyle === a.LINEBREAKSTYLE.AFTER && q.texClass === a.TEXCLASS.OPEN) ||
  ...
  a.mspace.Augment({
    HTMLbetterBreak: function (h, g) {
      ...
      var p = e[l] || 0;
      if (l === a.LINEBREAK.AUTO && n >= e.spacelimit && !this.mathbackground && !this.background) {
  ...
  a.maction.Augment({
    ...
    HTMLmoveSlice: function (h, j, m, g, o, k) {
      var p = document.getElementById('MathJax-HitBox-' + this.spanID + b.idPostfix);
      if (p) {
        p.parentNode.removeChild(p);
      }
