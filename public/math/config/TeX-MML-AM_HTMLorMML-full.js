...
MathJax.Extension.mml2jax = {
  ...
  InitBrowser: function () {
    ...
    var a = b.outerHTML || '';
    this.AttributeBug =
      a !== '' && !(a.match(/id="&lt;"/) && a.match(/class="mathjax"/) && a.match(/<\/math>/));
...
(function (d, h, l, g, m, b, j) {
    ...
    Mouseover: function (s, r) {
      if (k.discoverable || k.zoom === 'Hover') {
        ...
        if (
          u &&
          t &&
          (d.isMathJaxNode(u) !== d.isMathJaxNode(t) || d.getJaxFor(u) !== d.getJaxFor(t))
        ) {
  ...
  c.topImg = c.msieAlignBug
    ? h.Element('img', { style: { width: 0, height: 0, position: 'relative' }, src: 'about:blank' })
  ...
  var e = function () {
    ...
    q['box-shadow'] = q['-webkit-box-shadow'] = q['-moz-box-shadow'] = q['-khtml-box-shadow'] =
...
(function (a) {
  ...
  a.mi = a.mbase.Subclass({
    ...
    autoDefault: function (f) {
      if (f === 'mathvariant') {
        ...
        return e.length === 1 ||
          (e.length === 2 && e.charCodeAt(0) >= 55296 && e.charCodeAt(0) < 56320)
          ? a.VARIANT.ITALIC
          : a.VARIANT.NORMAL;
      }
      return '';
  ...
  a.mo = a.mbase.Subclass({
    ...
    CoreText: function (e) {
      ...
      while (
        (((e.isa(a.mrow) || e.isa(a.TeXAtom) || e.isa(a.mstyle) || e.isa(a.mphantom)) &&
          e.data.length === 1) ||
          e.isa(a.munderover)) &&
        e.data[0]
      ) {
...
MathJax.Hub.Register.LoadHook('[MathJax]/jax/element/mml/jax.js', function () {
  ...
  a.mbase.Augment({
    ...
    toMathMLclass: function (d) {
      ...
      if (this.isa(a.TeXAtom) && b.texHints) {
        var e = ['ORD', 'OP', 'BIN', 'REL', 'OPEN', 'CLOSE', 'PUNCT', 'INNER', 'VCENTER'][
          this.texClass
        ];
        if (e) {
  ...
  a.math.Augment({
    toMathML: function (d, e) {
      ...
      if (g) {
        ...
        j.push(
          d + '    <annotation encoding="' + this.toMathMLquote(g) + '">' + l + '</annotation>',
        );
        j.push(d + '  </semantics>');
      }
      return d + '<' + p + k + '>\n' + j.join('\n') + '\n' + d + '</' + p + '>';
  ...
  a.entity.Augment({
    toMathML: function (d) {
      return (
        (d || '') + '&' + this.toMathMLquote(this.data[0]) + ';<!-- ' + this.toString() + ' -->'
      );
    },
  });
  a.xml.Augment({
...
(function (d, c, j) {
  ...
  var a = MathJax.Object.Subclass({
    ...
    Phantom: function (o, m, p) {
      var n = this.ParseArg(o);
      if (m || p) {
        n = i.mpadded(n);
        if (p) {
          n.height = n.depth = 0;
      ...
      this.Push(i.TeXAtom(i.mphantom(n)));
    },
    Smash: function (o) {
    ...
    rule: function (p) {
      ...
      var o = i
        .mspace()
        .With({ width: m, height: q, mathbackground: this.stack.env.color || 'black' });
      if (n) {
          ...
          .mstyle(
            i
              .TeXAtom(
                i
                  .mo(o)
                  .With({ minsize: n, maxsize: n, fence: true, stretchy: true, symmetric: true }),
              )
              .With({ texClass: p }),
          )
          .With({ scriptlevel: 0 }),
    ...
    FBox: function (m) {
      this.Push(
        i.menclose.apply(i, this.InternalMath(this.GetArgument(m))).With({ notation: 'box' }),
      );
    },
    Not: function (m) {
      this.Push(b.not());
    ...
    CrLaTeX: function (o, m) {
      var r;
      if (!m && this.string.charAt(this.i) === '[') {
        r = this.GetBrackets(o, '').replace(/ /g, '').replace(/,/, '.');
        if (r && !this.matchDimen(r)) {
          d.Error(['BracketMustBeDimension', 'Bracket argument to %1 must be a dimension', o]);
        }
      }
      this.Push(b.cell().With({ isCR: true, name: o, linebreak: true }));
      var q = this.stack.Top();
      if (q.isa(b.array)) {
        if (r && q.arraydef.rowspacing) {
          var p = q.arraydef.rowspacing.split(/ /);
          if (!q.rowspacing) {
            q.rowspacing = this.dimen2em(p[0]);
          }
          while (p.length < q.table.length) {
            p.push(this.Em(q.rowspacing));
          }
          p[q.table.length - 1] = this.Em(Math.max(0, q.rowspacing + this.dimen2em(r)));
          q.arraydef.rowspacing = p.join(' ');
        }
      } else {
        if (r) {
          this.Push(i.mspace().With({ depth: r }));
        }
    ...
    Array: function (n, p, u, s, t, o, m, q) {
      ...
      var r = b
        .array()
        .With({ arraydef: { columnalign: s, columnspacing: t || '1em', rowspacing: o || '4pt' } });
      if (v.match(/[|:]/)) {
        if (v.charAt(0).match(/[|:]/)) {
          r.frame.push('left');
  ...
  d.Augment({
    ...
    fenced: function (o, n, p) {
      ...
      m.Append(
        i.mo(o).With({ fence: true, stretchy: true, symmetric: true, texClass: i.TEXCLASS.OPEN }),
      );
      ...
      m.Append(
        i.mo(p).With({ fence: true, stretchy: true, symmetric: true, texClass: i.TEXCLASS.CLOSE }),
      );
      return m;
    },
    ...
    fixInitialMO: function (l) {
      for (var k = 0, j = l.length; k < j; k++) {
        if (
          l[k] &&
          l[k].type !== 'mspace' &&
          (l[k].type !== 'texatom' || (l[k].data[0] && l[k].data[0].data.length))
        ) {
          if (
            l[k].isEmbellished() ||
            (l[k].type === 'texatom' && l[k].texClass === b.TEXCLASS.REL)
          ) {
            l.unshift(b.mi());
          }
          break;
...
MathJax.Extension['TeX/AMSsymbols'] = { version: '2.7.9' };
MathJax.Hub.Register.StartupHook('TeX Jax Ready', function () {
  var a = MathJax.ElementJax.mml,
  ...
  c.Parse = MathJax.Object.Subclass(
    {
                ...
                if (h[g].substr(0, 11) !== 'MJX-TeXAtom') {
                  ...
                  if (
                    ...
                    if (!MathJax.Extension['TeX/boldsymbol']) {
                      MathJax.Hub.RestartAfter(
                        MathJax.Ajax.Require('[MathJax]/extensions/TeX/boldsymbol.js'),
                      );
                    }
                  }
                }
          ...
          if (k != null) {
            ...
            if (n === 'true' || n === 'false') {
              if (
                ...
                g.type === 'math' ||
                g.type === 'mstyle' ||
                (l[f] === a.AUTO && (g.defaultDef == null || typeof g.defaultDef[f] === 'boolean'))
              ) {
                k = n === 'true';
              }
            }
      ...
      preProcessMath: function (f) {
        ...
        if (e && e[2].match(/ (?!xmlns=)[a-z]+=\"http:/i)) {
          f =
            e[1].replace(/ (?!xmlns=)([a-z]+=(['"])http:.*?\2)/gi, ' xmlns:$1 $1') +
            f.substr(e[0].length);
        }
...
(function (aa) {
  ...
  var z = [
    ...
    { input: 'overarc', tag: 'mover', output: '\u23DC', tex: 'overparen', ttype: A, acc: true },
              ...
              if (typeof ad.acc == 'boolean' && ad.acc) {
                ...
                if (
                  ...
                  ((al[0].nodeName == 'mrow' &&
                    ...
                    (al[0].firstChild.nodeValue !== null && al[0].firstChild.nodeValue.length == 1))
                ) {
  ...
  function t(ah) {
    ...
    if (af.ttype == i && af.input != '/') {
      ...
      if (typeof ai.func != 'undefined' && ai.func) {
        ag = j(ah);
        if (ag.ttype != i && ag.ttype != h && (ai.input.length > 1 || ag.ttype == b)) {
          ab = t(ah);
          ae = O('mrow', ae);
          ae.appendChild(ab[0]);
          ah = ab[1];
  ...
  l.Augment({
    ...
    isFullWidth: function (r) {
      ...
      var q =
        ...
        (String(r.getAttribute('style')).match(/(?:^| )width: *([^; ]*)/) || [])[1];
      if (q) {
        return !!q.match(/%/);
      }
    ...
    f.mbase.Augment({
      ...
      NativeMMLclass: function (o) {
        ...
        if (this.isa(f.TeXAtom)) {
          var p = ['ORD', 'OP', 'BIN', 'REL', 'OPEN', 'CLOSE', 'PUNCT', 'INNER', 'VCENTER'][
            this.texClass
          ];
          if (p) {
          ...
          if (l.tableLabelBug) {
            ...
            if (this.parent.nMMLhasLabels && p.firstChild) {
              if (o || u !== 'r') {
                j('Left', p.firstChild);
                if (s !== 'l') {
                  p.insertBefore(this.NativeMMLelement('mtd'), p.firstChild).setAttribute(
                    'style',
                    'padding:0',
                  );
                }
          ...
          if (l.tableLabelBug && this.data[0]) {
            ...
            if (p || z !== 'r') {
              ...
              if (x !== 'l') {
                ...
                o -= B;
                t.insertBefore(this.NativeMMLelement('mtd'), t.firstChild).setAttribute(
                  'style',
                  'padding:0;width:' + B + '%',
                );
              }
  ...
  d.Augment({
    config: {
      styles: {
        ...
        '.MathJax_test.mjx-test-display': { display: (g ? 'block' : 'table') + '!important' },
    ...
    getW: function (q) {
      ...
      if (
        (q.bbox && o >= 0 && !this.initialSkipBug && !this.msieItalicWidthBug) ||
        this.negativeBBoxes ||
        !q.firstChild
      ) {
        n = q.offsetWidth;
    ...
    createFrame: function (v, s, u, x, z, n) {
      ...
      var p = this.addElement(v, 'span', {
        style: { border: o, display: 'inline-block', overflow: 'hidden', width: q, height: y },
      ...
      if (F) {
        ...
        if (!this.msieClipRectBug && !F.noclip && !q) {
          ...
          var G = A - C - E,
            ...
            m = F.rw + 1000;
          w.style.clip =
            'rect(' + this.Em(G) + ' ' + this.Em(m) + ' ' + this.Em(s) + ' ' + this.Em(p) + ')';
        }
      }
    ...
    alignBox: function (t, p, s, x, w) {
      ...
      b.Insert(
        t.style,
        { right: { left: '', right: this.Em(m - x) }, center: { left: o, marginLeft: q } }[p],
      );
    },
    ...
    loadWebFontError: function (n, m) {
      ...
      if (this.config.imageFont && this.config.imageFont === this.fontInUse) {
        ...
        b.Startup.signal.Post('HTML-CSS Jax - using image fonts');
        e(
          ['WebFontNotAvailable', 'Web-Fonts not available -- using image fonts instead'],
          null,
          3000,
        );
    ...
    b.Browser.Select({
      ...
      Safari: function (r) {
        ...
        var s =
          o &&
          r.isMobile &&
          ((navigator.platform.match(/iPad|iPod|iPhone/) && !r.versionAtLeast('5.0')) ||
  ...
  var d = (MathJax.Extension.AssistiveMML = {
    ...
    HandleMML: function (n) {
      var h = n.jax.length,
        ...
        k;
      var g = MathJax.ElementJax.mml;
      g.copyAttributes.id = 1;
      while (n.i < h) {
        i = n.jax[n.i];
        o = document.getElementById(i.inputID + '-Frame');
        if (
          i.outputJax !== 'NativeMML' &&
          i.outputJax !== 'PlainSource' &&
          o &&
          !o.getAttribute('data-mathml')
        ) {
          try {
            j = i.root
              .toMathML('')
            ...
            g.copyAttributes.id = true;
            if (!l.restart) {
              throw l;
            }
            return MathJax.Callback.After(['HandleMML', this, n], l.restart);
          }
          o.setAttribute('data-mathml', j);
          k = f.addElement(o, 'span', {
            isMathJax: true,
            unselectable: 'on',
            className:
              'MJX_Assistive_MathML' +
              (i.root.Get('display') === 'block' ? ' MJX_Assistive_MathML_Block' : ''),
          });
          try {
            k.innerHTML = j;
          } catch (l) {}
          ...
          o.firstChild.setAttribute('aria-hidden', 'true');
...
!(function (i, e) {
  ...
  var l = (e['accessibility-menu'] = {
      ...
      AddMenu: function () {
        for (var e, t = Array(this.modules.length), n = 0; (e = this.modules[n]); n++)
          t[n] = e.placeHolder;
        var i,
          a,
          o = u.FindId('Accessibility');
        o
          ? (t.unshift(s.RULE()), o.submenu.items.push.apply(o.submenu.items, t))
          : ((i = (u.FindId('Settings', 'Renderer') || {}).submenu) &&
              (t.unshift(s.RULE()), t.unshift(i.items.pop()), t.unshift(i.items.pop())),
            t.unshift('Accessibility'),
            (o = s.SUBMENU.apply(s.SUBMENU, t)),
            (a = u.IndexOfId('Locale')) ? u.items.splice(a, 0, o) : u.items.push(s.RULE(), o));
      },
      Register: function (e) {
    ...
    r = (MathJax.Extension.ModuleLoader = MathJax.Object.Subclass({
      ...
      CreateMenu: function () {
        ...
        this.submenu
          ? (this.placeHolder = s.SUBMENU(
              this.name,
              s.CHECKBOX(['Activate', 'Activate'], l.MakeOption(this.option), {
                action: e,
              }),
              s.RULE(),
              s.COMMAND(['OptionsWhenActive', '(Options when Active)'], null, {
                disabled: !0,
              }),
            ))
  ...
  l.Register(r('collapsible', 'Collapsible Math', '[a11y]/collapsible.js', 'collapsible')),
    ...
    l.Register(r('explorer', 'Explorer', '[a11y]/explorer.js', 'explorer', !0)),
    l.AddDefaults(),
    i.Register.StartupHook(
      'End Extensions',
      function () {
        i.Register.StartupHook(
          'MathMenu Ready',
