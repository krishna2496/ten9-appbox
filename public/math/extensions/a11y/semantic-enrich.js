(MathJax.Extension['semantic-enrich'] = {
  ...
  Filter: function (t, a, e) {
    if ((delete t.enriched, !this.config.disabled))
      try {
        this.running = !0;
        var n = sre.Enrich.semanticMathmlSync(t.root.toMathML());
        (t.root = MathJax.InputJax.MathML.Parse.prototype.MakeMML(n)),
          (t.root.inputID = e.id),
          (t.enriched = !0),
          (this.running = !1);
      } catch (t) {
  ...
  (function () {
    ...
    t.a11y || (t.a11y = HUB.config.root + '/extensions/a11y'),
      t.SRE || (t.SRE = MathJax.Ajax.fileURL(t.a11y)),
  ...
  MathJax.Callback.Queue(
    ...
    MathJax.Hub.Register.StartupHook('Sre Ready', function () {
      var l = MathJax.ElementJax.mml,
        c = MathJax.Extension['semantic-enrich'];
      l.mbase.Augment({
        toMathMLattributes: function () {
          var t = 'mstyle' === this.type ? l.math.prototype.defaults : this.defaults,
            a = this.attrNames || l.copyAttributeNames,
            e = l.skipAttributes,
            n = l.copyAttributes,
            s = (c.running && c.mstyleLookup[this.type]) || [],
            i = [],
            h = this.attr || {};
          if (
            ('math' !== this.type ||
              (this.attr && 'xmlns' in this.attr) ||
              i.push('xmlns="http://www.w3.org/1998/Math/MathML"'),
            !this.attrNames)
          )
            for (var r in t)
              e[r] ||
                ...
                (null != this[r] &&
                  ...
                  this.toMathMLaddAttr(i, r, this[r]));
          for (var o = 0, u = a.length; o < u; o++)
            (1 === n[a[o]] && !t.hasOwnProperty(a[o])) ||
              ((value = h[a[o]]),
              null == value && (value = this[a[o]]),
              null != value && this.toMathMLaddAttr(i, a[o], value));
          for (o = 0, u = s.length; o < u; o++)
            (r = s[o]),
              t.hasOwnProperty(r) &&
                !i['_' + r] &&
                ((value = this.Get(r, 1)), null != value && this.toMathMLaddAttr(i, r, value));
      ...
      l.mo.Augment({
        setTeXclass: function (t) {
          ...
          return this.useMMLspacing
            ...
            ? ((this.texClass = this.prevClass = l.TEXCLASS.NONE), t)
