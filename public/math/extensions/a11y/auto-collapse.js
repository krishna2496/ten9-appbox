!(function (c) {
  ...
  var l = (MathJax.Extension['auto-collapse'] = {
    ...
    Startup: function () {
      ...
      t && t.Dependent(this),
        c.postInputHooks.Add(['Filter', l], 150),
        c.Queue(function () {
          return l.CollapseWideMath();
        }),
        window.addEventListener
          ? window.addEventListener('resize', l.resizeHandler, !1)
          : window.attachEvent
          ? window.attachEvent('onresize', l.resizeHandler)
          : (window.onresize = l.resizeHandler);
    },
    Filter: function (t, e, n) {
      t.enriched &&
        !this.config.disabled &&
        ('block' === t.root.Get('display') || n.parentNode.childNodes.length <= 3) &&
        (t.root.SRE = {
    ...
    getActions: function (t, e, n) {
      if (!t.isToken && t.data) {
        ...
        for (var o, i = 0, a = t.data.length; i < a; i++) {
          t.data[i] &&
            ((o = t.data[i]).collapsible
              ? (n[e] || (n[e] = []), n[e].push(o), this.getActions(o.data[1], e, n))
              : this.getActions(o, e, n));
        }
      }
    },
    sortActions: function (t) {
      for (var e = [], n = 0, o = t.length; n < o; n++)
        t[n] && (e = e.concat(t[n].sort(this.sortActionsBy)));
      return e;
    },
    ...
    collapseActions: function (t, e) {
      for (var n = t.width, o = n, i = 1e6, a = t.action.length - 1; 0 <= a; a--) {
        var s = t.action[a],
          r = s.selection;
        n > t.cwidth ? ((s.selection = 1), (o = s.SREwidth), (i = n)) : (s.selection = 2),
          (n = s.SREwidth),
          t.DOMupdate
            ? document.getElementById(s.id).setAttribute('selection', s.selection)
            : s.selection !== r && (e.changed = !0);
      }
      (t.m = o), (t.M = i);
    },
    ...
    GetContainerWidths: function (t) {
      for (
        ...
        (o = (n = i[r]).root),
          ...
          SRE &&
            SRE.action.length &&
            (null == SRE.width && (n.sreGetMetrics(), (SRE.m = SRE.width), (SRE.M = 1e6)),
            ((e = n.SourceElement()).previousSibling.style.display = 'none'),
            e.parentNode.insertBefore(a.cloneNode(!1), e),
            s.push([n, e]));
      for (r = 0, l = s.length; r < l; r++)
        (n = s[r][0]),
          (e = s[r][1]).previousSibling.offsetWidth &&
            (n.root.SRE.cwidth = e.previousSibling.offsetWidth * n.root.SRE.em);
      for (r = 0, l = s.length; r < l; r++)
        (n = s[r][0]),
          (e = s[r][1]).parentNode.removeChild(e.previousSibling),
    ...
    resizeHandler: function (t) {
      l.config.disabled ||
        (l.running
          ? (l.retry = !0)
          : (l.timer && clearTimeout(l.timer), (l.timer = setTimeout(l.resizeAction, 100))));
    },
    ...
    resizeCheck: function () {
      (l.running = !1),
        (c.processSectionDelay = l.saved_delay),
        l.retry && ((l.retry = !1), setTimeout(l.resizeHandler, 0));
    },
  });
  c.Register.StartupHook(
    'End Extensions',
    function () {
      null == s.autocollapse
        ? (s.autocollapse = !l.config.disabled)
        : (l.config.disabled = !s.autocollapse),
        c.Register.StartupHook(
          'MathMenu Ready',
          function () {
            ...
            var t,
              e = MathJax.Menu.ITEM,
              n = MathJax.Menu.menu,
              o = e.CHECKBOX(['AutoCollapse', 'Auto Collapse'], 'autocollapse', {
                action: function (t) {
            ...
            i
              ? null !== (t = i.IndexOfId('AutoCollapse'))
                ? (i.items[t] = o)
                : ((t = i.IndexOfId('CollapsibleMath')), i.items.splice(t + 1, 0, o))
              : ((t = n.IndexOfId('CollapsibleMath')), n.items.splice(t + 1, 0, o));
            function a() {
              l[s.autocollapse ? 'Enable' : 'Disable']();
            }
            MathJax.Extension.collapse
              ? a()
              : MathJax.Hub.Register.StartupHook('Auto Collapse Ready', a);
          },
          25,
        );
    },
  ...
  MathJax.Hub.Register.StartupHook('HTML-CSS Jax Ready', function () {
    MathJax.OutputJax['HTML-CSS'].Augment({
      sreGetMetrics: function (t, e) {
        (e.width = t.root.data[0].HTMLspanElement().parentNode.bbox.w),
          (e.em = 1 / t.HTMLCSS.em / t.HTMLCSS.scale);
      },
      sreGetRootWidth: function (t, e) {
  ...
  MathJax.Hub.Register.StartupHook('SVG Jax Ready', function () {
    MathJax.OutputJax.SVG.Augment({
      getMetrics: function (t) {
        (this.em = MathJax.ElementJax.mml.mbase.prototype.em = t.SVG.em),
          (this.ex = t.SVG.ex),
          (this.linebreakWidth = t.SVG.lineWidth),
  ...
  MathJax.Hub.Register.StartupHook('CommonHTML Jax Ready', function () {
    MathJax.OutputJax.CommonHTML.Augment({
      ...
      sreGetRootWidth: function (t, e) {
        return (
          (e.span = document.getElementById(t.inputID + '-Frame').firstChild),
          (e.tmp = document.createElement('span')),
          (e.tmp.className = e.span.className),
          t.root.CHTML.w / t.CHTML.scale
        );
      },
      sreGetActionWidth: function (t, e, n) {
        e.span.parentNode.replaceChild(e.tmp, e.span),
          (MathJax.OutputJax.CommonHTML.CHTMLnode = e.tmp);
        try {
  ...
  MathJax.Hub.Register.StartupHook('NativeMML Jax Ready', function () {
    MathJax.OutputJax.NativeMML.Augment({
      ...
      sreGetRootWidth: function (t, e) {
        return (
          (e.span = document.getElementById(t.inputID + '-Frame').firstChild), e.span.offsetWidth
        );
      },
      sreGetActionWidth: function (t, e, n) {
