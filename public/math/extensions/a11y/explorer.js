MathJax.Hub.Register.StartupHook('Sre Ready', function () {
  var o,
    r,
    s = MathJax.Hub.config.menuSettings,
    l = {};
  ...
  var h = (MathJax.Extension.explorer = {
      ...
      addDefaults: function () {
        for (
          var e, t = MathJax.Hub.CombineConfig('explorer', h.defaults), a = Object.keys(t), i = 0;
          (e = a[i]);
          i++
        )
          void 0 === s[h.prefix + e] && h.addMenuOption(e, t[e]);
      ...
      Enable: function (e, t) {
        (s.explorer = !0),
          t && (l.explorer = !0),
          MathJax.Extension.collapsible.Enable(!1, t),
      ...
      Disable: function (e, t) {
        (s.explorer = !1),
          t && (l.explorer = !1),
          this.DisableMenus(!0),
          this.hook && (MathJax.Hub.UnRegister.MessageHook(this.hook), (this.hook = null));
      ...
      DisableMenus: function (e) {
        if (MathJax.Menu) {
          ...
          if (t) {
            ...
            e ||
              !t.FindId('SpeechOutput') ||
              s[h.prefix + 'speech'] ||
              (t.FindId('Subtitles').disabled = !0);
          }
        }
      },
    ...
    n = MathJax.Object.Subclass(
      {
        ...
        Show: function (e, t) {
          ...
          var a = e.getBoundingClientRect(),
            i = a.bottom + 10 + window.pageYOffset,
            n = a.left + window.pageXOffset;
          (this.div.style.top = i + 'px'), (this.div.style.left = n + 'px');
          var o = t.colorString();
          (this.inner.style.backgroundColor = o.background),
            (this.inner.style.color = o.foreground);
        },
        Hide: function (e) {
      ...
      {
        ANNOUNCE:
          'Navigatable Math in page. Explore with enter or shift space and arrow keys. Expand or collapse elements hitting enter.',
        announced: !1,
        added: !1,
        styles: {
          '.MJX_LiveRegion': {
        ...
        Announce: function () {
          ...
          h.getOption('speech') &&
            ((n.announced = !0),
            MathJax.Ajax.Styles(n.styles),
            (e = n.Create('polite')),
            document.body.appendChild(e),
            n.Update(e, n.ANNOUNCE),
            setTimeout(function () {
  ...
  var e = MathJax.Ajax.fileURL(MathJax.Ajax.config.path.a11y),
    u = (MathJax.Extension.explorer.Explorer = {
      liveRegion: n(),
      walker: null,
      highlighter: null,
      hoverer: null,
      ...
      earconFile:
        e +
        '/invalid_keypress' +
        (-1 !== ['Firefox', 'Chrome', 'Opera'].indexOf(MathJax.Hub.Browser.name) ? '.ogg' : '.mp3'),
      expanded: !1,
      ...
      Register: function (e) {
        ...
        !h.hook ||
          ((t = document.getElementById(e[1])) &&
            ...
            a.enriched &&
            (u.StateChange(t.id, a), u.liveRegion.Add(), u.AddEvent(t)));
      },
      StateChange: function (e, t) {
        u.GetHighlighter(0.2);
        var a = u.jaxCache[e];
      ...
      AddHook: function (i) {
        u.RemoveHook(),
          (u.hook = MathJax.Hub.Register.MessageHook('End Math', function (e) {
            var t = e[1].id + '-Frame',
      ...
      AddEvent: function (e) {
        var t,
          ...
          i = e.previousSibling;
        i &&
          ((t = i.id !== a ? i.firstElementChild : i),
          u.AddAria(t),
          u.AddMouseEvents(t),
          'MathJax_MathML' === t.className && (t = t.firstElementChild),
          t &&
            ((t.onkeydown = u.Keydown),
            u.Flame(t),
            t.addEventListener(u.focusinEvent, function (e) {
              h.hook && (n.announced || n.Announce());
            }),
            t.addEventListener(u.focusoutEvent, function (e) {
              h.hook &&
                (u.ignoreFocusOut && ((u.ignoreFocusOut = !1), 'enter' === u.walker.moved)
                  ? e.target.focus()
                  : u.walker && u.DeactivateWalker());
            }),
            h.getOption('speech') && u.AddSpeech(t)));
      },
      AddSpeech: function (e) {
        var t = e.id,
          a = MathJax.Hub.getJaxFor(t).root.toMathML();
        if ((e.getAttribute('haslabel') || u.AddMathLabel(a, t), !e.getAttribute('hasspeech')))
          switch (MathJax.Hub.config.explorer.generation) {
            ...
            case 'mixed':
              e.querySelectorAll('[data-semantic-complexity]').length >= h.eagerComplexity &&
                u.AddSpeechEager(a, t);
          }
      },
      AddSpeechLazy: function (e) {
        var t = new sre.TreeSpeechGenerator();
        t.setRebuilt(u.walker.getRebuilt()),
          t.getSpeech(u.walker.rootNode, u.walker.getXml()),
      ...
      MakeSpeechTask: function (i, n, o, r, e) {
        ...
        setTimeout(function () {
          var e = new o(),
            ...
            a = new sre.DummyWalker(t, e, u.highlighter, i).speech();
      ...
      Keydown: function (e) {
        ...
        if (u.walker && u.walker.isActive()) {
          (t = t === r.RETURN ? r.DASH : t),
            void 0 !== u.walker.modifier && (u.walker.modifier = e.shiftKey);
          var a = u.walker.move(t);
          if (null === a) return;
          if (a) {
            if ('expand' === u.walker.moved) {
              if (((u.expanded = u.walker.node.id), MathJax.Hub.Browser.isEdge))
                return (u.ignoreFocusOut = !0), void u.DeactivateWalker();
              if (MathJax.Hub.Browser.isFirefox || MathJax.Hub.Browser.isMSIE)
                return void u.DeactivateWalker();
            }
          ...
          var i = e.target;
          if (t === r.SPACE && !e.shiftKey)
            return MathJax.Extension.MathEvents.Event.ContextMenu(e, i), void o(e);
      ...
      MouseOver: function (e) {
        var t;
        'none' !== h.getOption('highlight') &&
          ('hover' === h.getOption('highlight') &&
            ((t = e.currentTarget),
            u.GetHighlighter(0.1),
            u.highlighter.highlight([t]),
            (u.hoverer = !0)),
          o(e));
      },
      MouseOut: function (e) {
      ...
      Flame: function (e) {
        if ('flame' === h.getOption('highlight'))
          return u.GetHighlighter(0.05), u.highlighter.highlightAll(e), void (u.flamer = !0);
      },
      UnFlame: function () {
      ...
      FlameEnriched: function () {
        ...
        for (var e, t = 0, a = MathJax.Hub.getAllJax(); (e = a[t]); t++)
          u.Flame(e.SourceElement().previousSibling);
      },
      Walkers: {
      ...
      ActivateWalker: function (e, t) {
        var a = h.getOption('speech'),
          i = h.getOption('walker')
            ? u.Walkers[MathJax.Hub.config.explorer.walker]
            : u.Walkers.none,
          n = a ? new sre.DirectSpeechGenerator() : new sre.DummySpeechGenerator(),
          o = sre.System.getInstance().engineSetup();
        n.setOptions({
          locale: o.locale,
          domain: o.domain,
          style: o.style,
          ...
          u.GetHighlighter(0.2),
          (u.walker = new i(e, n, u.highlighter, t.root.toMathML())),
          a && !e.getAttribute('hasspeech') && u.AddSpeechLazy(e),
          u.walker.activate(),
          a &&
            (h.getOption('subtitle') && u.liveRegion.Show(e, u.highlighter),
            u.liveRegion.Update(u.walker.speech())),
          u.Highlight(),
          u.ignoreFocusOut &&
            setTimeout(function () {
              u.ignoreFocusOut = !1;
      ...
      DeactivateWalker: function () {
        var e = sre.System.getInstance().engineSetup(),
          t = 'clearspeak' === e.domain ? 'default' : e.style;
        h.setOption('ruleset', e.domain + '-' + t),
          u.liveRegion.Clear(),
          u.liveRegion.Hide(),
          u.Unhighlight(),
          (u.currentHighlight = null),
          u.walker.deactivate(),
          (u.walker = null);
      },
      Highlight: function () {
        ...
        MathJax.Hub.Register.StartupHook(
          ...
          function () {
            ...
            var e,
              ...
              o = t.SUBMENU(
                ['Explorer', 'Explorer'],
                t.CHECKBOX(['Active', 'Active'], 'explorer', {
                  action: function (e) {
                    h[s.explorer ? 'Enable' : 'Disable'](!0, !0), MathJax.Menu.saveCookie();
                  },
                }),
                t.RULE(),
                t.CHECKBOX(['Walker', 'Walker'], 'Assistive-walker'),
                t.SUBMENU(
                  ['Highlight', 'Highlight'],
                  t.RADIO(['none', 'None'], 'Assistive-highlight', i),
                  t.RADIO(['hover', 'Hover'], 'Assistive-highlight', i),
                  t.RADIO(['flame', 'Flame'], 'Assistive-highlight', i),
                ),
                t.SUBMENU(
                  ['Background', 'Background'],
                  t.RADIO(['blue', 'Blue'], 'Assistive-background', i),
                  t.RADIO(['red', 'Red'], 'Assistive-background', i),
                  t.RADIO(['green', 'Green'], 'Assistive-background', i),
                  t.RADIO(['yellow', 'Yellow'], 'Assistive-background', i),
                  t.RADIO(['cyan', 'Cyan'], 'Assistive-background', i),
                  t.RADIO(['magenta', 'Magenta'], 'Assistive-background', i),
                  t.RADIO(['white', 'White'], 'Assistive-background', i),
                  t.RADIO(['black', 'Black'], 'Assistive-background', i),
                ),
                t.SUBMENU(
                  ['Foreground', 'Foreground'],
                  t.RADIO(['black', 'Black'], 'Assistive-foreground', i),
                  t.RADIO(['white', 'White'], 'Assistive-foreground', i),
                  t.RADIO(['magenta', 'Magenta'], 'Assistive-foreground', i),
                  t.RADIO(['cyan', 'Cyan'], 'Assistive-foreground', i),
                  t.RADIO(['yellow', 'Yellow'], 'Assistive-foreground', i),
                  t.RADIO(['green', 'Green'], 'Assistive-foreground', i),
                  t.RADIO(['red', 'Red'], 'Assistive-foreground', i),
                  t.RADIO(['blue', 'Blue'], 'Assistive-foreground', i),
                ),
                t.RULE(),
                t.CHECKBOX(['SpeechOutput', 'Speech Output'], 'Assistive-speech', {
                ...
                t.SUBMENU(
                  ...
                  t.RADIO(['mathspeak-default', 'Verbose'], 'Assistive-ruleset', n),
                  t.RADIO(['mathspeak-brief', 'Brief'], 'Assistive-ruleset', n),
                  t.RADIO(['mathspeak-sbrief', 'Superbrief'], 'Assistive-ruleset', n),
                ),
                t.RADIO(['clearspeak-default', 'Clearspeak Rules'], 'Assistive-ruleset', n),
                t.SUBMENU(
                  ['Chromevox', 'ChromeVox Rules'],
                  t.RADIO(['chromevox-default', 'Verbose'], 'Assistive-ruleset', n),
                  t.RADIO(['chromevox-alternative', 'Alternative'], 'Assistive-ruleset', n),
                ),
              ),
              r = (a.FindId('Accessibility') || {}).submenu;
            r
              ? null !== (e = r.IndexOfId('Explorer'))
                ? (r.items[e] = o)
                : ((e = r.IndexOfId('CollapsibleMath')), r.items.splice(e + 1, 0, o))
              : ((e = a.IndexOfId('CollapsibleMath')), a.items.splice(e + 1, 0, o)),
  ...
  MathJax.Hub.Register.StartupHook('SVG Jax Ready', function () {
    ...
    var t,
      e = MathJax.OutputJax.SVG;
    parseFloat(e.version) < 2.7 &&
      ((t = e.getJaxFromMath),
      e.Augment({
        getJaxFromMath: function (e) {
          return (
            e.parentNode.className.match(/MathJax_SVG_Display/) && (e = e.parentNode),
            t.call(this, e)
          );
        },
      }));
