...
if (typeof mxVertexHandler != 'undefined') {
  (function () {
     ...
     *
     */
    Graph.prototype.importGraphModel = function (node, dx=null, dy=null, crop=false, dontImportIntoDefaultLayer=false) {
      dx = dx != null ? dx : 0;
      dy = dy != null ? dy : 0;
      ...
      if (layers != null) {
        ...
        try {
          ...
          if (!dontImportIntoDefaultLayer && layers.length == 1 && !this.isCellLocked(this.getDefaultParent())) {
