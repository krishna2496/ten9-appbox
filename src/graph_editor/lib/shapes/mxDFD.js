...
mxShapeDFDStart.prototype.getConstraints = function (style, w, h) {
  ...
  constr.push(new mxConnectionConstraint(new mxPoint(0.5, 0.5), false, null, 0, r));
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, r * 0.293, h * 0.5 - r * 0.707),
  );
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - r * 0.293, h * 0.5 - r * 0.707),
  );
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - r * 0.293, h * 0.5 + r * 0.707),
  );
...
mxCellRenderer.registerShape(
  mxShapeDFDDataStoreID.prototype.cst.DATA_STORE_ID,
...
mxCellRenderer.registerShape(
  mxShapeDFDExternalEntity.prototype.cst.EXTERNAL_ENTITY,
  mxShapeDFDExternalEntity,
);
...
mxShapeDFDExternalEntity.prototype.getConstraints = function (style, w, h) {
  ...
  constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, size, h));
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, (w - size) * 0.25 + size, h),
  );
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, (w - size) * 0.5 + size, h),
  );
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, (w - size) * 0.75 + size, h),
  );
  ...
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, size + (h - size) * 0.25),
  );
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, size + (h - size) * 0.5),
  );
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, size + (h - size) * 0.75),
  );
