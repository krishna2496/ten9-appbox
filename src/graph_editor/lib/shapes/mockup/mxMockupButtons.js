...
mxShapeMockupMultiButton.prototype.paintVertexShape = function (c, x, y, w, h) {
  var mainText = mxUtils.getValue(
    this.style,
    mxShapeMockupMultiButton.prototype.cst.MAIN_TEXT,
    'Main Text',
  );
  var subText = mxUtils.getValue(
    this.style,
    mxShapeMockupMultiButton.prototype.cst.SUB_TEXT,
    'Sub Text',
  );
  var fontColor = mxUtils.getValue(
    this.style,
    mxShapeMockupMultiButton.prototype.cst.TEXT_COLOR,
    '#666666',
  );
  var fontSize = mxUtils.getValue(
    this.style,
...
mxShapeMockupMultiButton.prototype.background = function (c, x, y, w, h) {
  var buttonStyle = mxUtils
    .getValue(
      this.style,
      mxShapeMockupMultiButton.prototype.cst.BUTTON_STYLE,
...
mxCellRenderer.registerShape(
  mxShapeMockupMultiButton.prototype.cst.SHAPE_MULTILINE_BUTTON,
...
mxShapeMockupButton.prototype.paintVertexShape = function (c, x, y, w, h) {
  var mainText = mxUtils.getValue(
    this.style,
    mxShapeMockupButton.prototype.cst.MAIN_TEXT,
    'Main Text',
  );
  var fontColor = mxUtils
    .getValue(this.style, mxShapeMockupButton.prototype.cst.TEXT_COLOR, '#666666')
    .toString();
  var fontSize = mxUtils
    .getValue(this.style, mxShapeMockupButton.prototype.cst.TEXT_SIZE, '17')
    .toString();
  c.translate(x, y);
  this.background(c, x, y, w, h);
  c.setShadow(false);
...
mxShapeMockupButton.prototype.background = function (c, x, y, w, h) {
  var buttonStyle = mxUtils
    .getValue(
      this.style,
      mxShapeMockupButton.prototype.cst.BUTTON_STYLE,
...
mxShapeMockupHorButtonBar.prototype.paintVertexShape = function (c, x, y, w, h) {
  var textStrings = mxUtils
    .getValue(
      this.style,
      mxShapeMockupHorButtonBar.prototype.cst.MAIN_TEXT,
  ...
  var fontColor = mxUtils.getValue(
    this.style,
    mxShapeMockupHorButtonBar.prototype.cst.TEXT_COLOR,
    '#666666',
  );
  var selectedFontColor = mxUtils.getValue(
    this.style,
    mxShapeMockupHorButtonBar.prototype.cst.TEXT_COLOR2,
    '#ffffff',
  );
  var fontSize = mxUtils
    .getValue(this.style, mxShapeMockupHorButtonBar.prototype.cst.TEXT_SIZE, '17')
    .toString();
  var frameColor = mxUtils.getValue(this.style, mxConstants.STYLE_STROKECOLOR, '#666666');
  var separatorColor = mxUtils.getValue(
    this.style,
    mxShapeMockupHorButtonBar.prototype.cst.STROKE_COLOR2,
    '#c4c4c4',
  );
  var bgColor = mxUtils.getValue(this.style, mxConstants.STYLE_FILLCOLOR, '#ffffff');
  var selectedFillColor = mxUtils.getValue(
    this.style,
    mxShapeMockupHorButtonBar.prototype.cst.FILL_COLOR2,
    '#008cff',
  );
...
mxShapeMockupHorButtonBar.prototype.background = function (
  c,
  w,
  h,
  rSize,
...
mxShapeMockupHorButtonBar.prototype.buttonText = function (
  c,
  w,
  h,
  textString,
...
mxCellRenderer.registerShape(
  mxShapeMockupHorButtonBar.prototype.cst.SHAPE_HOR_BUTTON_BAR,
...
mxShapeMockupVerButtonBar.prototype.paintVertexShape = function (c, x, y, w, h) {
  var textStrings = mxUtils
    .getValue(
      this.style,
      mxShapeMockupVerButtonBar.prototype.cst.MAIN_TEXT,
      '+Button 1, Button 2, Button 3',
    )
    .toString()
    .split(',');
  var fontColor = mxUtils.getValue(
    this.style,
    mxShapeMockupVerButtonBar.prototype.cst.TEXT_COLOR,
    '#666666',
  );
  var selectedFontColor = mxUtils.getValue(
    this.style,
    mxShapeMockupVerButtonBar.prototype.cst.TEXT_COLOR2,
    '#ffffff',
  );
  var fontSize = mxUtils
    .getValue(this.style, mxShapeMockupVerButtonBar.prototype.cst.TEXT_SIZE, '17')
    .toString();
  var frameColor = mxUtils.getValue(this.style, mxConstants.STYLE_STROKECOLOR, '#666666');
  var separatorColor = mxUtils.getValue(
    this.style,
    mxShapeMockupVerButtonBar.prototype.cst.STROKE_COLOR2,
    '#c4c4c4',
  );
  var bgColor = mxUtils.getValue(this.style, mxConstants.STYLE_FILLCOLOR, '#ffffff');
  var selectedFillColor = mxUtils.getValue(
    this.style,
    mxShapeMockupVerButtonBar.prototype.cst.FILL_COLOR2,
    '#008cff',
  );
  var buttonNum = textStrings.length;
...
mxShapeMockupVerButtonBar.prototype.background = function (
  c,
  w,
  h,
  rSize,
...
mxCellRenderer.registerShape(
  mxShapeMockupVerButtonBar.prototype.cst.SHAPE_VER_BUTTON_BAR,
...
mxShapeMockupOnOffButton.prototype.foreground = function (c, x, y, w, h) {
  var state = mxUtils.getValue(
    this.style,
    mxShapeMockupOnOffButton.prototype.cst.BUTTON_STATE,
    mxShapeMockupOnOffButton.prototype.cst.STATE_ON,
  );
  var fillColor2 = mxUtils.getValue(
    this.style,
    mxShapeMockupOnOffButton.prototype.cst.FILL_COLOR2,
    '#008cff',
  );
  var textColor = mxUtils
    .getValue(this.style, mxShapeMockupOnOffButton.prototype.cst.TEXT_COLOR, '#ffffff,#999999')
    .toString()
    .split(',');
  var mainText = mxUtils
    .getValue(this.style, mxShapeMockupOnOffButton.prototype.cst.MAIN_TEXT, 'ON,OFF')
    .toString()
    .split(',');
  var textSize = mxUtils.getValue(
    this.style,
    mxShapeMockupOnOffButton.prototype.cst.TEXT_SIZE,
    '17',
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupOnOffButton.prototype.cst.SHAPE_ON_OFF_BUTTON,
  mxShapeMockupOnOffButton,
);
...
mxShapeMockupTopButton.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var rSize = parseInt(
    mxUtils.getValue(this.style, mxShapeMockupTopButton.prototype.cst.R_SIZE, '10'),
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupTopButton.prototype.cst.TOP_BUTTON,
  mxShapeMockupTopButton,
);
...
mxShapeMockupBottomButton.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var rSize = parseInt(
    mxUtils.getValue(this.style, mxShapeMockupBottomButton.prototype.cst.R_SIZE, '10'),
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupBottomButton.prototype.cst.BOTTOM_BUTTON,
  mxShapeMockupBottomButton,
);
...
mxShapeMockupRightButton.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var rSize = parseInt(
    mxUtils.getValue(this.style, mxShapeMockupRightButton.prototype.cst.R_SIZE, '10'),
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupRightButton.prototype.cst.RIGHT_BUTTON,
...
mxShapeMockupLeftButton.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var rSize = parseInt(
    mxUtils.getValue(this.style, mxShapeMockupLeftButton.prototype.cst.R_SIZE, '10'),
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupLeftButton.prototype.cst.LEFT_BUTTON,
  mxShapeMockupLeftButton,
);
