...
mxShapeMockupBarChart.prototype.bars = function (c, x, y, w, h) {
  var barStroke = mxUtils.getValue(
    this.style,
    mxShapeMockupBarChart.prototype.cst.STROKE_COLOR2,
    'none',
  );
  var coordStroke = mxUtils.getValue(
    this.style,
    mxShapeMockupBarChart.prototype.cst.STROKE_COLOR3,
    '#666666',
  );
  var barFill1 = mxUtils.getValue(
    this.style,
    mxShapeMockupBarChart.prototype.cst.FILL_COLOR2,
    '#008cff',
  );
  var barFill2 = mxUtils.getValue(
    this.style,
    mxShapeMockupBarChart.prototype.cst.FILL_COLOR3,
    '#dddddd',
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupBarChart.prototype.cst.SHAPE_BAR_CHART,
  mxShapeMockupBarChart,
);
...
mxShapeMockupColumnChart.prototype.bars = function (c, x, y, w, h) {
  var barStroke = mxUtils.getValue(
    this.style,
    mxShapeMockupColumnChart.prototype.cst.STROKE_COLOR2,
    'none',
  );
  var coordStroke = mxUtils.getValue(
    this.style,
    mxShapeMockupColumnChart.prototype.cst.STROKE_COLOR3,
    '#666666',
  );
  var barFill1 = mxUtils.getValue(
    this.style,
    mxShapeMockupColumnChart.prototype.cst.FILL_COLOR2,
    '#008cff',
  );
  var barFill2 = mxUtils.getValue(
    this.style,
    mxShapeMockupColumnChart.prototype.cst.FILL_COLOR3,
    '#dddddd',
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupColumnChart.prototype.cst.SHAPE_COLUMN_CHART,
...
mxShapeMockupLineChart.prototype.bars = function (c, x, y, w, h) {
  var coordStroke = mxUtils.getValue(
    this.style,
    mxShapeMockupLineChart.prototype.cst.STROKE_COLOR2,
    '#666666',
  );
  var line1Stroke = mxUtils.getValue(
    this.style,
    mxShapeMockupLineChart.prototype.cst.STROKE_COLOR3,
    '#008cff',
  );
  var line2Stroke = mxUtils.getValue(
    this.style,
    mxShapeMockupLineChart.prototype.cst.STROKE_COLOR4,
    '#dddddd',
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupLineChart.prototype.cst.SHAPE_LINE_CHART,
  mxShapeMockupLineChart,
);
...
mxShapeMockupPieChart.prototype.foreground = function (c, x, y, w, h) {
  var parts = mxUtils
    .getValue(this.style, mxShapeMockupPieChart.prototype.cst.PARTS, '10,20,30')
    .toString()
    .split(',');
  var partNum = parts.length;
  var partColors = mxUtils
    .getValue(
      this.style,
      mxShapeMockupPieChart.prototype.cst.PART_COLORS,
...
mxCellRenderer.registerShape(
  mxShapeMockupPieChart.prototype.cst.SHAPE_PIE_CHART,
...
mxShapeMockupIconGrid.prototype.paintVertexShape = function (c, x, y, w, h) {
  c.translate(x, y);
  var gridSize = mxUtils
    .getValue(this.style, mxShapeMockupIconGrid.prototype.cst.GRID_SIZE, '3,3')
    .toString()
    .split(',');
...
mxCellRenderer.registerShape(
  mxShapeMockupIconGrid.prototype.cst.SHAPE_ICON_GRID,
  mxShapeMockupIconGrid,
);
...
mxShapeMockupBubbleChart.prototype.bars = function (c, x, y, w, h) {
  var barStroke = mxUtils.getValue(
    this.style,
    mxShapeMockupBubbleChart.prototype.cst.STROKE_COLOR2,
    'none',
  );
  var coordStroke = mxUtils.getValue(
    this.style,
    mxShapeMockupBubbleChart.prototype.cst.STROKE_COLOR3,
    '#666666',
  );
  var barFill1 = mxUtils.getValue(
    this.style,
    mxShapeMockupBubbleChart.prototype.cst.FILL_COLOR2,
    '#008cff',
  );
  var barFill2 = mxUtils.getValue(
    this.style,
    mxShapeMockupBubbleChart.prototype.cst.FILL_COLOR3,
    '#dddddd',
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupBubbleChart.prototype.cst.SHAPE_BUBBLE_CHART,
  mxShapeMockupBubbleChart,
);
...
mxShapeMockupGauge.prototype.foreground = function (c, w, h) {
  ...
  var scaleColors = mxUtils
    .getValue(this.style, mxShapeMockupGauge.prototype.cst.SCALE_COLORS, '#888888,#aaaaaa,#444444')
    .toString()
    .split(',');
  var gaugeLabels = mxUtils
    .getValue(this.style, mxShapeMockupGauge.prototype.cst.GAUGE_LABELS, 'CPU[%],0,100')
    .toString()
    .split(',');
  var needleColor = mxUtils.getValue(
    this.style,
    mxShapeMockupGauge.prototype.cst.NEEDLE_COLOR,
    '#008cff',
  );
  var fillColor = mxUtils.getValue(this.style, mxConstants.STYLE_FILLCOLOR, '#ffffff');
  var textColor = mxUtils.getValue(
    this.style,
    mxShapeMockupGauge.prototype.cst.TEXT_COLOR,
    '#666666',
  );
...
Graph.handleFactory[mxShapeMockupGauge.prototype.cst.SHAPE_GAUGE] = function (state) {
  var handles = [
    Graph.createHandle(
      ...
      ['gaugePos'],
      function (bounds) {
        var gaugePos = Math.max(
          0,
          Math.min(100, parseFloat(mxUtils.getValue(this.state.style, 'gaugePos', this.gaugePos))),
        );

        return new mxPoint(
          bounds.x + bounds.width * 0.2 + (gaugePos * 0.6 * bounds.width) / 100,
          bounds.y + bounds.height * 0.8,
        );
      },
      function (bounds, pt) {
        this.state.style['gaugePos'] =
...
mxShapeMockupPlotChart.prototype.foreground = function (c, x, y, w, h) {
  var shapeStroke = mxUtils.getValue(
    this.style,
    mxShapeMockupPlotChart.prototype.cst.STROKE_COLOR2,
    '#dddddd',
  );
  var coordStroke = mxUtils.getValue(
    this.style,
    mxShapeMockupPlotChart.prototype.cst.STROKE_COLOR3,
    '#666666',
  );
  var shapesColors = mxUtils
    .getValue(
      this.style,
      mxShapeMockupPlotChart.prototype.cst.SHAPES_COLORS,
      '#00aaff,#0044ff,#008cff',
    )
    .toString()
    .split(',');
...
mxCellRenderer.registerShape(
  mxShapeMockupPlotChart.prototype.cst.SHAPE_PLOT_CHART,
...
mxShapeMockupGanttChart.prototype.foreground = function (c, x, y, w, h) {
  var shapesColors = mxUtils
    .getValue(this.style, mxShapeMockupGanttChart.prototype.cst.SHAPES_COLORS, '#888888,#bbbbbb')
    .toString()
    .split(',');
  var textColor = mxUtils.getValue(
    this.style,
    mxShapeMockupGanttChart.prototype.cst.TEXT_COLOR,
    '#666666',
  );
  var textSize = mxUtils.getValue(
    this.style,
    mxShapeMockupGanttChart.prototype.cst.TEXT_SIZE,
    '#12',
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupGanttChart.prototype.cst.SHAPE_GANTT_CHART,
  mxShapeMockupGanttChart,
);
...
mxCellRenderer.registerShape(
  mxShapeMockupSimpleIcon.prototype.cst.SIMPLE_ICON,
  mxShapeMockupSimpleIcon,
);
...
mxCellRenderer.registerShape(
  mxShapeMockupGraphicsAnchor.prototype.cst.ANCHOR,
  mxShapeMockupGraphicsAnchor,
);
...
mxShapeMockupGraphicsRRect.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var rSize = parseInt(
    mxUtils.getValue(this.style, mxShapeMockupGraphicsRRect.prototype.cst.R_SIZE, '10'),
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupGraphicsRRect.prototype.cst.RRECT,
