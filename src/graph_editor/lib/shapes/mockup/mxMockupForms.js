...
const { mxCellRenderer, mxConstants, mxShape, mxUtils } = require('../../jgraph/mxClient.js');
...
mxShapeMockupCheckboxGroup.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var fontColor = mxUtils
    .getValue(this.style, mxShapeMockupCheckboxGroup.prototype.cst.TEXT_COLOR, '#666666,#008cff')
    .toString()
    .split(',');
  var fontSize = mxUtils
    .getValue(this.style, mxShapeMockupCheckboxGroup.prototype.cst.TEXT_SIZE, '17')
    .toString();
  var optionText = mxUtils
    .getValue(this.style, mxShapeMockupCheckboxGroup.prototype.cst.MAIN_TEXT, 'Option 1')
    .toString()
    .split(',');
  ...
  for (var i = 0; i < optionNum; i++) {
    ...
    var currWidth = mxUtils.getSizeForString(currText, fontSize, mxConstants.DEFAULT_FONTFAMILY)
      .width;
...
mxCellRenderer.registerShape(
  mxShapeMockupCheckboxGroup.prototype.cst.SHAPE_CHECKBOX_GROUP,
...
mxShapeMockupRadioGroup.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var fontColor = mxUtils
    .getValue(this.style, mxShapeMockupRadioGroup.prototype.cst.TEXT_COLOR, '#666666,#008cff')
    .toString()
    .split(',');
  var fontSize = mxUtils
    .getValue(this.style, mxShapeMockupRadioGroup.prototype.cst.TEXT_SIZE, '17')
    .toString();
  var optionText = mxUtils
    .getValue(this.style, mxShapeMockupRadioGroup.prototype.cst.MAIN_TEXT, 'Option 1')
    .toString()
    .split(',');
  var optionNum = optionText.length;
  var buttonSize = 15;
  ...
  for (var i = 0; i < optionNum; i++) {
    ...
    if (selected === i) {
      ...
      c.setStrokeColor('#333333');
      c.ellipse(
        iconX + buttonSize * 0.25,
        iconY + buttonSize * 0.25,
        buttonSize * 0.5,
        buttonSize * 0.5,
      );
      c.fillAndStroke();
...
mxCellRenderer.registerShape(
  mxShapeMockupRadioGroup.prototype.cst.SHAPE_RADIO_GROUP,
...
mxShapeMockupColorPicker.prototype.paintVertexShape = function (c, x, y, w, h) {
  var chosenColor = mxUtils.getValue(
    this.style,
    mxShapeMockupColorPicker.prototype.cst.COLOR,
    '#aaddff',
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupColorPicker.prototype.cst.SHAPE_COLOR_PICKER,
  mxShapeMockupColorPicker,
);
...
mxShapeMockupComboBox.prototype.foreground = function (c, x, y, w, h) {
  ...
  var fillColor2 = mxUtils
    .getValue(this.style, mxShapeMockupComboBox.prototype.cst.FILL_COLOR2, '')
    .toString();
...
mxShapeMockupComboBox.prototype.mainText = function (c, x, y, w, h) {
  var mainText = mxUtils.getValue(
    this.style,
    mxShapeMockupComboBox.prototype.cst.MAIN_TEXT,
    'Main Text',
  );
  var fontColor = mxUtils
    .getValue(this.style, mxShapeMockupComboBox.prototype.cst.TEXT_COLOR, '#666666')
    .toString();
  var fontSize = mxUtils
    .getValue(this.style, mxShapeMockupComboBox.prototype.cst.TEXT_SIZE, '17')
    .toString();
...
mxCellRenderer.registerShape(
  mxShapeMockupComboBox.prototype.cst.SHAPE_COMBO_BOX,
  mxShapeMockupComboBox,
);
...
mxShapeMockupSpinner.prototype.customProperties = [
  {
    ...
    enumList: [
      ...
      { val: 'vertical', dispName: 'Vertical' },
      { val: 'horizontal', dispName: 'Horizontal' },
    ],
  },
  {
    name: 'spinStyle',
  ...
  },
  {
    ...
    type: 'enum',
    enumList: [
      { val: 'triangle', dispName: 'Triangle' },
      { val: 'plusMinus', dispName: '+/-' },
      { val: 'arrow', dispName: 'Arrow' },
    ],
  },
];
...
mxShapeMockupSpinner.prototype.paintVertexShape = function (c, x, y, w, h) {
  var spinnerLayout = mxUtils.getValue(
    this.style,
    mxShapeMockupSpinner.prototype.cst.LAYOUT,
    mxShapeMockupSpinner.prototype.cst.LAYOUT_RIGHT,
  );
  c.translate(x, y);
...
mxShapeMockupSpinner.prototype.foreground = function (c, w, h, spinnerLayout) {
  var spinnerStyle = mxUtils.getValue(
    this.style,
    mxShapeMockupSpinner.prototype.cst.SPINNER_STYLE,
    mxShapeMockupSpinner.prototype.cst.SPINNER_NORMAL,
  );
  var adjStyle = mxUtils.getValue(
    this.style,
    mxShapeMockupSpinner.prototype.cst.ADJ_STYLE,
    mxShapeMockupSpinner.prototype.cst.ADJ_TRIANGLE,
  );
...
mxShapeMockupSpinner.prototype.mainText = function (c, w, h, spinnerLayout) {
  var spinnerText = mxUtils
    .getValue(this.style, mxShapeMockupSpinner.prototype.cst.MAIN_TEXT, '100')
    .toString();
  var fontSize = mxUtils.getValue(this.style, mxShapeMockupSpinner.prototype.cst.TEXT_SIZE, '17');
  var fontColor = mxUtils.getValue(
    this.style,
    mxShapeMockupSpinner.prototype.cst.TEXT_COLOR,
    '#666666',
  );
  c.setFontSize(fontSize);
  c.setFontColor(fontColor);
...
mxCellRenderer.registerShape(
  mxShapeMockupSpinner.prototype.cst.SHAPE_SPINNER,
  mxShapeMockupSpinner,
);
...
mxShapeMockupMenuBar.prototype.paintVertexShape = function (c, x, y, w, h) {
  var textStrings = mxUtils
    .getValue(this.style, mxShapeMockupMenuBar.prototype.cst.MAIN_TEXT, '+Menu 1, Menu 2, Menu 3')
    .toString()
    .split(',');
  var fontColor = mxUtils.getValue(
    this.style,
    mxShapeMockupMenuBar.prototype.cst.TEXT_COLOR,
    '#666666',
  );
  var selectedFontColor = mxUtils.getValue(
    this.style,
    mxShapeMockupMenuBar.prototype.cst.TEXT_COLOR2,
    '#ffffff',
  );
  var fontSize = mxUtils
    .getValue(this.style, mxShapeMockupMenuBar.prototype.cst.TEXT_SIZE, '17')
    .toString();
  var frameColor = mxUtils.getValue(this.style, mxConstants.STYLE_STROKECOLOR, '#666666');
  var separatorColor = mxUtils.getValue(
    this.style,
    mxShapeMockupMenuBar.prototype.cst.STROKE_COLOR2,
    '#c4c4c4',
  );
  var bgColor = mxUtils.getValue(this.style, mxConstants.STYLE_FILLCOLOR, '#ffffff');
  var selectedFillColor = mxUtils.getValue(
    this.style,
    mxShapeMockupMenuBar.prototype.cst.FILL_COLOR2,
    '#008cff',
  );
  ...
  for (var i = 0; i < buttonNum; i++) {
    ...
    buttonWidths[i] = mxUtils.getSizeForString(
      buttonText,
      fontSize,
...
mxShapeMockupMenuBar.prototype.background = function (
  c,
  w,
  h,
  rSize,
...
mxShapeMockupMenuBar.prototype.buttonText = function (
  c,
  w,
  h,
  textString,
...
mxCellRenderer.registerShape(
  mxShapeMockupMenuBar.prototype.cst.SHAPE_MENU_BAR,
  mxShapeMockupMenuBar,
);
...
mxShapeMockupHorSlider.prototype.customProperties = [
  {
    ...
    type: 'enum',
    enumList: [
      { val: 'basic', dispName: 'Basic' },
      { val: 'fancy', dispName: 'Fancy' },
    ],
  },
  {
    name: 'handleStyle',
...
mxShapeMockupHorSlider.prototype.paintVertexShape = function (c, x, y, w, h) {
  var sliderStyle = mxUtils.getValue(
    this.style,
    mxShapeMockupHorSlider.prototype.cst.STYLE,
    mxShapeMockupHorSlider.prototype.cst.SLIDER_BASIC,
  );
  var rSize = 5;
...
mxShapeMockupHorSlider.prototype.foreground = function (c, w, h, rSize, sliderStyle) {
  var sliderPos = mxUtils.getValue(
    this.style,
    mxShapeMockupHorSlider.prototype.cst.SLIDER_POS,
    '20',
  );
  var handleStyle = mxUtils.getValue(
    this.style,
    mxShapeMockupHorSlider.prototype.cst.HANDLE_STYLE,
    mxShapeMockupHorSlider.prototype.cst.HANDLE_CIRCLE,
  );
  var fillColor = mxUtils.getValue(this.style, mxConstants.STYLE_FILLCOLOR, '#ffffff');
  var fillColor2 = mxUtils.getValue(
    this.style,
    mxShapeMockupHorSlider.prototype.cst.FILL_COLOR2,
    '#ddeeff',
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupHorSlider.prototype.cst.SHAPE_HOR_SLIDER,
  mxShapeMockupHorSlider,
);
...
Graph.handleFactory[mxShapeMockupHorSlider.prototype.cst.SHAPE_HOR_SLIDER] = function (state) {
  var handles = [
    Graph.createHandle(
      ...
      ['sliderPos'],
      function (bounds) {
        var sliderPos = Math.max(
          0,
          Math.min(
            100,
            parseFloat(mxUtils.getValue(this.state.style, 'sliderPos', this.sliderPos)),
          ),
        );

        return new mxPoint(
          bounds.x + (((bounds.width - 10) * sliderPos) / bounds.width / 100) * bounds.width + 5,
          bounds.y + bounds.height / 2,
        );
      },
      function (bounds, pt) {
        this.state.style['sliderPos'] =
          Math.round(1000 * Math.max(0, Math.min(100, ((pt.x - bounds.x) * 100) / bounds.width))) /
          1000;
      },
    ),
  ];
...
mxShapeMockupListBox.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var frameColor = mxUtils.getValue(this.style, mxConstants.STYLE_STROKECOLOR, '#666666');
  var fontSize = mxUtils
    .getValue(this.style, mxShapeMockupListBox.prototype.cst.TEXT_SIZE, '17')
    .toString();

  var selectedButton = -1;
  var maxShapeWidth = w;
  var subText = mxUtils
    .getValue(this.style, mxShapeMockupListBox.prototype.cst.SUB_TEXT, 'Sub Text')
    .toString()
    .split(',');
  ...
  for (var i = 0; i < subText.length; i++) {
    ...
    var currWidth = mxUtils.getSizeForString(itemText, fontSize, mxConstants.DEFAULT_FONTFAMILY)
      .width;
...
mxShapeMockupListBox.prototype.foreground = function (
  c,
  w,
  h,
  frameColor,
  ...
  var selectedColor = mxUtils.getValue(
    this.style,
    mxShapeMockupListBox.prototype.cst.SELECTED_COLOR,
    '#ddeeff',
  );
  ...
  //buttons
  var windowTitle = mxUtils
    .getValue(this.style, mxShapeMockupListBox.prototype.cst.MAIN_TEXT, 'Window Title')
    .toString();
  var fontColor = mxUtils
    .getValue(this.style, mxShapeMockupListBox.prototype.cst.TEXT_COLOR, '#666666,#008cff')
    .toString()
    .split(',');
...
mxCellRenderer.registerShape(
  mxShapeMockupListBox.prototype.cst.SHAPE_LIST_BOX,
  mxShapeMockupListBox,
);
...
mxShapeMockupPwField.prototype.foreground = function (c, w, h) {
  var mainText = mxUtils.getValue(
    this.style,
    mxShapeMockupPwField.prototype.cst.MAIN_TEXT,
    '******',
  );
  var fontColor = mxUtils.getValue(
    this.style,
    mxShapeMockupPwField.prototype.cst.TEXT_COLOR,
    '#666666',
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupPwField.prototype.cst.SHAPE_PW_FIELD,
  mxShapeMockupPwField,
);
...
mxCellRenderer.registerShape(
  mxShapeMockupSplitter.prototype.cst.SHAPE_SPLITTER,
...
mxShapeMockupWedgeBar.prototype.paintVertexShape = function (c, x, y, w, h) {
  var fontSize = mxUtils
    .getValue(this.style, mxShapeMockupWedgeBar.prototype.cst.TEXT_SIZE, '17')
    .toString();
  var tabNames = mxUtils
    .getValue(this.style, mxShapeMockupWedgeBar.prototype.cst.TAB_NAMES, 'Tab 1,+Tab 2,Tab 3')
    .toString()
    .split(',');
...
mxShapeMockupWedgeBar.prototype.backTabs = function (
  c,
  w,
  h,
  rSize,
  ...
  var tabStyle = mxUtils.getValue(
    this.style,
    mxShapeMockupWedgeBar.prototype.cst.TAB_STYLE,
    mxShapeMockupWedgeBar.prototype.cst.BLOCK,
  );
...
mxShapeMockupWedgeBar.prototype.focusTab = function (
  c,
  w,
  h,
  rSize,
  ...
  var selectedFill = mxUtils.getValue(
    this.style,
    mxShapeMockupWedgeBar.prototype.cst.STYLE_FILLCOLOR2,
    '#008cff',
  );
...
mxShapeMockupWedgeBar.prototype.tabText = function (
  c,
  w,
  h,
  rSize,
  ...
  var fontColor = mxUtils.getValue(
    this.style,
    mxShapeMockupWedgeBar.prototype.cst.TEXT_COLOR,
    '#666666',
  );
  var selFontColor = mxUtils.getValue(
    this.style,
    mxShapeMockupWedgeBar.prototype.cst.SEL_TEXT_COLOR,
    '#ffffff',
  );
  var fontSize = mxUtils
    .getValue(this.style, mxShapeMockupWedgeBar.prototype.cst.TEXT_SIZE, '17')
...
mxCellRenderer.registerShape(
  mxShapeMockupWedgeBar.prototype.cst.SHAPE_WEDGE_BAR,
  mxShapeMockupWedgeBar,
);
...
mxShapeMockupSearchBox.prototype.foreground = function (c, w, h) {
  var mainText = mxUtils.getValue(
    this.style,
    mxShapeMockupSearchBox.prototype.cst.MAIN_TEXT,
    'Search',
  );
  var fontColor = mxUtils.getValue(
    this.style,
    mxShapeMockupSearchBox.prototype.cst.TEXT_COLOR,
    '#666666',
  );
  var strokeColor2 = mxUtils.getValue(
    this.style,
    mxShapeMockupSearchBox.prototype.cst.STROKE_COLOR2,
    '#008cff',
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupSearchBox.prototype.cst.SHAPE_SEARCH_BOX,
  mxShapeMockupSearchBox,
);
...
mxShapeMockupSignIn.prototype.foreground = function (c, w, h) {
  var mainText = mxUtils
    .getValue(
      this.style,
      mxShapeMockupSignIn.prototype.cst.MAIN_TEXT,
  ...
  var fontColor = mxUtils.getValue(
    this.style,
    mxShapeMockupSignIn.prototype.cst.TEXT_COLOR,
    '#666666',
  );
  var fontColor2 = mxUtils.getValue(
    this.style,
    mxShapeMockupSignIn.prototype.cst.TEXT_COLOR2,
    '#ffffff',
  );
  ...
  var strokeColor2 = mxUtils.getValue(
    this.style,
    mxShapeMockupSignIn.prototype.cst.STROKE_COLOR2,
    '#ddeeff',
  );
  var fillColor2 = mxUtils.getValue(
    this.style,
    mxShapeMockupSignIn.prototype.cst.FILL_COLOR2,
    '#66bbff',
  );
  ...
  var forgotW = mxUtils.getSizeForString(mainText[5], fontSize, mxConstants.DEFAULT_FONTFAMILY)
    .width;
  c.text(
    w * 0.05,
    h * 0.7,
...
mxShapeMockupCalendar.prototype.foreground = function (c, w, h) {
  ...
  var strokeColor2 = mxUtils.getValue(
    this.style,
    mxShapeMockupCalendar.prototype.cst.STROKE_COLOR2,
    '#008cff',
  );
  var fillColor2 = mxUtils.getValue(
    this.style,
    mxShapeMockupCalendar.prototype.cst.FILL_COLOR2,
    '#ddeeff',
  );
  ...
  var textColor = mxUtils.getValue(
    this.style,
    mxShapeMockupCalendar.prototype.cst.TEXT_COLOR,
    '#999999',
  );
  var textColor2 = mxUtils.getValue(
    this.style,
    mxShapeMockupCalendar.prototype.cst.TEXT_COLOR2,
    '#ffffff',
  );
  var days = parseInt(
    mxUtils.getValue(this.style, mxShapeMockupCalendar.prototype.cst.DAYS, '30'),
    10,
  );
  var prevDays = parseInt(
    mxUtils.getValue(this.style, mxShapeMockupCalendar.prototype.cst.PREV_DAYS, '31'),
    10,
  );
  //month starts on Monday
  var firstDay = parseInt(
    mxUtils.getValue(this.style, mxShapeMockupCalendar.prototype.cst.FIRST_DAY, '0'),
    10,
  );
  //week starts with Monday
  var startOn = parseInt(
    mxUtils.getValue(this.style, mxShapeMockupCalendar.prototype.cst.START_ON, '6', 10),
  );
  var dayNames = mxUtils
    .getValue(this.style, mxShapeMockupCalendar.prototype.cst.DAY_NAMES, 'Mo,Tu,We,Th,Fr,Sa,Su')
    .toString()
    .split(',');
  var selDay = parseInt(
    mxUtils.getValue(this.style, mxShapeMockupCalendar.prototype.cst.SELECTED_DAY, '24'),
    10,
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupCalendar.prototype.cst.SHAPE_CALENDAR,
  mxShapeMockupCalendar,
);
...
mxShapeMockupEmailForm.prototype.foreground = function (c, w, h, fontSize, tabX, showCC, showBCC) {
  var mainText = mxUtils
    .getValue(
      this.style,
      mxShapeMockupEmailForm.prototype.cst.MAIN_TEXT,
  ...
  var fontColor = mxUtils.getValue(
    this.style,
    mxShapeMockupEmailForm.prototype.cst.TEXT_COLOR,
    '#666666',
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupEmailForm.prototype.cst.SHAPE_EMAIL_FORM,
...
mxShapeMockupFormsRRect.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var rSize = parseInt(
    mxUtils.getValue(this.style, mxShapeMockupFormsRRect.prototype.cst.R_SIZE, '10'),
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupFormsAnchor.prototype.cst.ANCHOR,
  mxShapeMockupFormsAnchor,
);
...
mxCellRenderer.registerShape(
  mxShapeMockupFormsCheckbox.prototype.cst.CHECKBOX,
  mxShapeMockupFormsCheckbox,
);
