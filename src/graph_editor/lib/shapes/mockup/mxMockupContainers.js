...
mxShapeMockupVideoPlayer.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var buttonColor = mxUtils.getValue(
    this.style,
    mxShapeMockupVideoPlayer.prototype.cst.FILL_COLOR2,
    '#c4c4c4',
  );
  var frameColor = mxUtils.getValue(this.style, mxConstants.STYLE_STROKECOLOR, '#666666');
  var filledColor = mxUtils.getValue(
    this.style,
    mxShapeMockupVideoPlayer.prototype.cst.STROKE_COLOR2,
    '#008cff',
  );
  var emptyColor = mxUtils.getValue(
    this.style,
    mxShapeMockupVideoPlayer.prototype.cst.STROKE_COLOR3,
    '#c4c4c4',
  );
  var barHeight = mxUtils.getValue(
    this.style,
    mxShapeMockupVideoPlayer.prototype.cst.BAR_HEIGHT,
    '30',
  );
...
mxShapeMockupVideoPlayer.prototype.otherShapes = function (
  ...
  c.arcTo(
    ...
    0,
    1,
    speakerX + barHeight * 0.4,
    speakerY + barHeight * 0.65,
  );
  ...
  c.arcTo(
    ...
    0,
    1,
    speakerX + barHeight * 0.425,
    speakerY + barHeight * 0.75,
  );
  c.stroke();
  ...
  var textColor = mxUtils.getValue(
    this.style,
    mxShapeMockupVideoPlayer.prototype.cst.TEXT_COLOR,
    '#666666',
  );
  c.begin();
...
mxCellRenderer.registerShape(
  mxShapeMockupVideoPlayer.prototype.cst.SHAPE_VIDEO_PLAYER,
  mxShapeMockupVideoPlayer,
);
  ...
  var handles = [
    Graph.createHandle(
      ...
      function (bounds) {
        var barPos = Math.max(
          0,
          Math.min(100, parseFloat(mxUtils.getValue(this.state.style, 'barPos', this.barPos))),
        );

        var barH = parseFloat(mxUtils.getValue(this.state.style, 'barHeight', this.barHeight));

        return new mxPoint(
          bounds.x + (((bounds.width - 16) * barPos) / bounds.width / 100) * bounds.width + 8,
          bounds.y + bounds.height - barH - 20,
        );
      },
      function (bounds, pt) {
        this.state.style['barPos'] =
  ...
  var handle2 = Graph.createHandle(
    ...
    function (bounds) {
      var barHeight = Math.max(
        ...
        Math.min(
          bounds.height,
          parseFloat(mxUtils.getValue(this.state.style, 'barHeight', this.barHeight)),
        ),
      );
    ...
    function (bounds, pt) {
      this.state.style['barHeight'] =
        Math.round(1000 * Math.max(0, Math.min(bounds.height, bounds.y + bounds.height - pt.y))) /
        1000;
    },
  );
...
mxShapeMockupAccordion.prototype.paintVertexShape = function (c, x, y, w, h) {
  var textStrings = mxUtils
    .getValue(
      this.style,
      mxShapeMockupAccordion.prototype.cst.MAIN_TEXT,
  ...
  var fontColor = mxUtils.getValue(
    this.style,
    mxShapeMockupAccordion.prototype.cst.TEXT_COLOR,
    '#666666',
  );
  var selectedFontColor = mxUtils.getValue(
    this.style,
    mxShapeMockupAccordion.prototype.cst.TEXT_COLOR2,
    '#ffffff',
  );
  var fontSize = mxUtils
    .getValue(this.style, mxShapeMockupAccordion.prototype.cst.TEXT_SIZE, '17')
    .toString();
  var frameColor = mxUtils.getValue(this.style, mxConstants.STYLE_STROKECOLOR, '#666666');
  var separatorColor = mxUtils.getValue(
    this.style,
    mxShapeMockupAccordion.prototype.cst.STROKE_COLOR2,
    '#c4c4c4',
  );
  var bgColor = mxUtils.getValue(this.style, mxConstants.STYLE_FILLCOLOR, '#ffffff');
  var selectedFillColor = mxUtils.getValue(
    this.style,
    mxShapeMockupAccordion.prototype.cst.FILL_COLOR2,
    '#008cff',
  );
  ...
  for (var i = 0; i < buttonNum; i++) {
    ...
    var currWidth = mxUtils.getSizeForString(buttonText, fontSize, mxConstants.DEFAULT_FONTFAMILY)
      .width;
...
mxShapeMockupAccordion.prototype.background = function (
  c,
  w,
  h,
  rSize,
...
mxCellRenderer.registerShape(
  mxShapeMockupAccordion.prototype.cst.SHAPE_ACCORDION,
...
mxShapeMockupBrowserWindow.prototype.paintVertexShape = function (c, x, y, w, h) {
  var bgColor = mxUtils.getValue(this.style, mxConstants.STYLE_FILLCOLOR, '#ffffff');
  var frameColor = mxUtils.getValue(this.style, mxConstants.STYLE_STROKECOLOR, '#666666');
  var closeColor = mxUtils.getValue(
    this.style,
    mxShapeMockupBrowserWindow.prototype.cst.STROKE_COLOR2,
    '#008cff',
  );
  var insideColor = mxUtils.getValue(
    this.style,
    mxShapeMockupBrowserWindow.prototype.cst.STROKE_COLOR3,
    '#c4c4c4',
  );
  w = Math.max(w, 260);
  h = Math.max(h, 110);
...
mxShapeMockupBrowserWindow.prototype.otherShapes = function (
  c,
  x,
  y,
  w,
  ...
  var mainText = mxUtils
    .getValue(
      this.style,
      mxShapeMockupBrowserWindow.prototype.cst.MAIN_TEXT,
      'http://www.draw.io,Page 1',
    )
    .toString()
    .split(',');
  ...
  var textColor = mxUtils.getValue(
    this.style,
    mxShapeMockupBrowserWindow.prototype.cst.TEXT_COLOR,
    '#666666',
  );
  c.setFontColor(textColor);
  c.setFontSize(17);
...
mxCellRenderer.registerShape(
  mxShapeMockupBrowserWindow.prototype.cst.SHAPE_BROWSER_WINDOW,
...
mxShapeMockupUserMale.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var insideColor = mxUtils.getValue(
    this.style,
    mxShapeMockupUserMale.prototype.cst.STROKE_COLOR2,
    '#008cff',
  );
  c.translate(x, y);
  this.background(c, x, y, w, h, bgColor, frameColor);
...
mxCellRenderer.registerShape(
  mxShapeMockupUserMale.prototype.cst.SHAPE_MALE_USER,
  mxShapeMockupUserMale,
);
...
mxShapeMockupUserFemale.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var insideColor = mxUtils.getValue(
    this.style,
    mxShapeMockupUserFemale.prototype.cst.STROKE_COLOR2,
    '#008cff',
  );
  c.translate(x, y);
  this.background(c, x, y, w, h, bgColor, frameColor);
...
mxCellRenderer.registerShape(
  mxShapeMockupUserFemale.prototype.cst.SHAPE_FEMALE_USER,
  mxShapeMockupUserFemale,
);
...
mxShapeMockupGroup.prototype.paintVertexShape = function (c, x, y, w, h) {
  var groupString = mxUtils
    .getValue(this.style, mxShapeMockupGroup.prototype.cst.MAIN_TEXT, 'Group')
    .toString();
  var fontSize = mxUtils.getValue(this.style, mxShapeMockupGroup.prototype.cst.TEXT_SIZE, '17');

  var textWidth = mxUtils.getSizeForString(groupString, fontSize, mxConstants.DEFAULT_FONTFAMILY)
    .width;
...
mxShapeMockupGroup.prototype.foreground = function (c, w, h, textWidth, fontSize) {
  var fillColor = mxUtils.getValue(
    this.style,
    mxShapeMockupGroup.prototype.cst.FILL_COLOR2,
    '#000000',
  );
...
mxShapeMockupGroup.prototype.buttonText = function (c, w, h, textString, fontSize) {
  var fontColor = mxUtils.getValue(
    this.style,
    mxShapeMockupGroup.prototype.cst.TEXT_COLOR,
    '#ffffff',
  );
...
mxShapeMockupWindow.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var closeColor = mxUtils.getValue(
    this.style,
    mxShapeMockupWindow.prototype.cst.STROKE_COLOR2,
    '#008cff',
  );
  var insideColor = mxUtils.getValue(
    this.style,
    mxShapeMockupWindow.prototype.cst.STROKE_COLOR3,
    '#c4c4c4',
  );
  c.translate(x, y);
...
mxShapeMockupWindow.prototype.otherShapes = function (
  ...
  //text
  var windowTitle = mxUtils.getValue(
    this.style,
    mxShapeMockupWindow.prototype.cst.MAIN_TEXT,
    'Window Title',
  );
  var fontColor = mxUtils.getValue(
    this.style,
    mxShapeMockupWindow.prototype.cst.TEXT_COLOR,
    '#666666',
  );
  var fontSize = mxUtils
    .getValue(this.style, mxShapeMockupWindow.prototype.cst.TEXT_SIZE, '17')
    .toString();
...
mxShapeMockupHorTabBar.prototype.paintVertexShape = function (c, x, y, w, h) {
  var fontSize = mxUtils
    .getValue(this.style, mxShapeMockupHorTabBar.prototype.cst.TEXT_SIZE, '17')
    .toString();
  var tabNames = mxUtils
    .getValue(this.style, mxShapeMockupHorTabBar.prototype.cst.TAB_NAMES, 'Tab 1,+Tab 2,Tab 3')
    .toString()
    .split(',');
...
mxShapeMockupHorTabBar.prototype.backTabs = function (
  c,
  w,
  h,
  rSize,
  ...
  var tabStyle = mxUtils.getValue(
    this.style,
    mxShapeMockupHorTabBar.prototype.cst.TAB_STYLE,
    mxShapeMockupHorTabBar.prototype.cst.BLOCK,
  );
...
mxShapeMockupHorTabBar.prototype.focusTab = function (
  c,
  w,
  h,
  rSize,
  ...
  var selectedFill = mxUtils.getValue(
    this.style,
    mxShapeMockupHorTabBar.prototype.cst.STYLE_FILLCOLOR2,
    '#008cff',
  );
...
mxShapeMockupHorTabBar.prototype.tabText = function (
  c,
  w,
  h,
  rSize,
  ...
  var fontColor = mxUtils.getValue(
    this.style,
    mxShapeMockupHorTabBar.prototype.cst.TEXT_COLOR,
    '#666666',
  );
  var selFontColor = mxUtils.getValue(
    this.style,
    mxShapeMockupHorTabBar.prototype.cst.SEL_TEXT_COLOR,
    '#ffffff',
  );
  var fontSize = mxUtils
    .getValue(this.style, mxShapeMockupHorTabBar.prototype.cst.TEXT_SIZE, '17')
...
mxCellRenderer.registerShape(
  mxShapeMockupHorTabBar.prototype.cst.SHAPE_HOR_TAB_BAR,
  mxShapeMockupHorTabBar,
);
...
mxShapeMockupVerTabBar.prototype.paintVertexShape = function (c, x, y, w, h) {
  var fontSize = mxUtils
    .getValue(this.style, mxShapeMockupVerTabBar.prototype.cst.TEXT_SIZE, '17')
    .toString();
  var tabNames = mxUtils
    .getValue(this.style, mxShapeMockupVerTabBar.prototype.cst.TAB_NAMES, 'Tab 1,+Tab 2,Tab 3')
    .toString()
    .split(',');
...
mxShapeMockupVerTabBar.prototype.backTabs = function (
  c,
  w,
  h,
  rSize,
  ...
  var tabStyle = mxUtils.getValue(
    this.style,
    mxShapeMockupVerTabBar.prototype.cst.TAB_STYLE,
    mxShapeMockupVerTabBar.prototype.cst.BLOCK,
  );
...
mxShapeMockupVerTabBar.prototype.focusTab = function (
  c,
  w,
  h,
  rSize,
  ...
  var selectedFill = mxUtils.getValue(
    this.style,
    mxShapeMockupVerTabBar.prototype.cst.STYLE_FILLCOLOR2,
    '#008cff',
  );
...
mxShapeMockupVerTabBar.prototype.tabText = function (
  c,
  w,
  h,
  rSize,
  ...
  var fontColor = mxUtils.getValue(
    this.style,
    mxShapeMockupVerTabBar.prototype.cst.TEXT_COLOR,
    '#666666',
  );
  var selFontColor = mxUtils.getValue(
    this.style,
    mxShapeMockupVerTabBar.prototype.cst.SEL_TEXT_COLOR,
    '#ffffff',
  );
  var fontSize = mxUtils
    .getValue(this.style, mxShapeMockupVerTabBar.prototype.cst.TEXT_SIZE, '17')
...
mxCellRenderer.registerShape(
  mxShapeMockupVerTabBar.prototype.cst.SHAPE_VER_TAB_BAR,
  mxShapeMockupVerTabBar,
);
...
mxShapeMockupAlertBox.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var closeColor = mxUtils.getValue(
    this.style,
    mxShapeMockupAlertBox.prototype.cst.STROKE_COLOR2,
    '#008cff',
  );
  var insideColor = mxUtils.getValue(
    this.style,
    mxShapeMockupAlertBox.prototype.cst.STROKE_COLOR3,
    '#c4c4c4',
  );
  c.translate(x, y);
...
mxShapeMockupAlertBox.prototype.foreground = function (
  c,
  x,
  y,
  w,
  ...
  var windowTitle = mxUtils
    .getValue(this.style, mxShapeMockupAlertBox.prototype.cst.MAIN_TEXT, 'Window Title')
    .toString();
  var subText = mxUtils
    .getValue(this.style, mxShapeMockupAlertBox.prototype.cst.SUB_TEXT, 'Sub Text')
    .toString()
    .split(',');
  var buttonText = mxUtils
    .getValue(this.style, mxShapeMockupAlertBox.prototype.cst.BUTTON_TEXT, 'OK,Cancel')
    .toString()
    .split(',');
  var fontColor = mxUtils.getValue(
    this.style,
    mxShapeMockupAlertBox.prototype.cst.TEXT_COLOR,
    '#666666',
  );
  var fontSize = mxUtils
    .getValue(this.style, mxShapeMockupAlertBox.prototype.cst.TEXT_SIZE, '17')
    .toString();
...
mxCellRenderer.registerShape(
  mxShapeMockupAlertBox.prototype.cst.SHAPE_ALERT_BOX,
...
mxShapeMockupContainersRRect.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var rSize = parseInt(
    mxUtils.getValue(this.style, mxShapeMockupContainersRRect.prototype.cst.R_SIZE, '10'),
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupContainersRRect.prototype.cst.RRECT,
...
mxCellRenderer.registerShape(
  mxShapeMockupContainersAnchor.prototype.cst.ANCHOR,
  mxShapeMockupContainersAnchor,
);
...
mxShapeMockupContrainersTopButton.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var rSize = parseInt(
    mxUtils.getValue(this.style, mxShapeMockupContrainersTopButton.prototype.cst.R_SIZE, '10'),
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupContrainersTopButton.prototype.cst.TOP_BUTTON,
  mxShapeMockupContrainersTopButton,
);
...
mxShapeMockupContainersLeftButton.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var rSize = parseInt(
    mxUtils.getValue(this.style, mxShapeMockupContainersLeftButton.prototype.cst.R_SIZE, '10'),
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupContainersLeftButton.prototype.cst.LEFT_BUTTON,
  mxShapeMockupContainersLeftButton,
);
...
mxShapeMockupContainersMarginRect.prototype.background = function (c, x, y, w, h, state) {
  var margin = parseFloat(
    mxUtils.getValue(this.style, mxShapeMockupContainersMarginRect.prototype.cst.MARGIN, '0'),
  );
  var marginTop = parseFloat(
    mxUtils.getValue(this.style, mxShapeMockupContainersMarginRect.prototype.cst.MARGIN_TOP, '0'),
  );
  var marginLeft = parseFloat(
    mxUtils.getValue(this.style, mxShapeMockupContainersMarginRect.prototype.cst.MARGIN_LEFT, '0'),
  );
  var marginBottom = parseFloat(
    mxUtils.getValue(
      this.style,
      mxShapeMockupContainersMarginRect.prototype.cst.MARGIN_BOTTOM,
      '0',
    ),
  );
  var marginRight = parseFloat(
    mxUtils.getValue(this.style, mxShapeMockupContainersMarginRect.prototype.cst.MARGIN_RIGHT, '0'),
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupContainersMarginRect.prototype.cst.SHAPE_MARGIN_RECT,
...
mxShapeMockupContainersMarginRect2.prototype.background = function (c, x, y, w, h, state) {
  var margin = parseFloat(
    mxUtils.getValue(this.style, mxShapeMockupContainersMarginRect2.prototype.cst.MARGIN, '0'),
  );
  var marginTop = parseFloat(
    mxUtils.getValue(this.style, mxShapeMockupContainersMarginRect2.prototype.cst.MARGIN_TOP, '0'),
  );
  var marginLeft = parseFloat(
    mxUtils.getValue(this.style, mxShapeMockupContainersMarginRect2.prototype.cst.MARGIN_LEFT, '0'),
  );
  var marginBottom = parseFloat(
    mxUtils.getValue(
      this.style,
      mxShapeMockupContainersMarginRect2.prototype.cst.MARGIN_BOTTOM,
      '0',
    ),
  );
  var marginRight = parseFloat(
    mxUtils.getValue(
      this.style,
      mxShapeMockupContainersMarginRect2.prototype.cst.MARGIN_RIGHT,
      '0',
    ),
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupContainersMarginRect2.prototype.cst.SHAPE_MARGIN_RECT,
