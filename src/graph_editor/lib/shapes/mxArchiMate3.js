...
mxArchiMate3Application.prototype.background = function (c, x, y, w, h) {
  var archiType = mxUtils.getValue(
    this.style,
    mxArchiMate3Application.prototype.cst.ARCHI_TYPE,
    'square',
  );
...
mxCellRenderer.registerShape(
  mxArchiMate3Application.prototype.cst.APPLICATION,
...
mxCellRenderer.registerShape(
  mxArchiMate3Collaboration.prototype.cst.COLLABORATION,
  mxArchiMate3Collaboration,
);
...
mxCellRenderer.registerShape(
  mxArchiMate3Interaction.prototype.cst.INTERACTION,
  mxArchiMate3Interaction,
);
...
mxArchiMate3Service.prototype.getConstraints = function (style, w, h) {
  ...
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, w1 + h * 0.355, h * 0.145),
  );
  constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, w1 + h * 0.5, h * 0.5));
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, w1 + h * 0.355, h * 0.855),
  );
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, w2 - h * 0.355, h * 0.145),
  );
  constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, w2 - h * 0.5, h * 0.5));
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, w2 - h * 0.355, h * 0.855),
  );
...
mxCellRenderer.registerShape(
  mxArchiMate3Requirement.prototype.cst.REQUIREMENT,
  mxArchiMate3Requirement,
);
...
mxCellRenderer.registerShape(
  mxArchiMate3Constraint.prototype.cst.CONSTRAINT,
  mxArchiMate3Constraint,
);
...
mxCellRenderer.registerShape(
  mxArchiMate3BusinessObject.prototype.cst.BUSINESS_OBJECT,
...
mxCellRenderer.registerShape(
  mxArchiMate3Representation.prototype.cst.REPRESENTATION,
  mxArchiMate3Representation,
);
...
mxCellRenderer.registerShape(
  mxArchiMate3Deliverable.prototype.cst.DELIVERABLE,
  mxArchiMate3Deliverable,
);
...
mxArchiMate3Tech.prototype.foreground = function (c, x, y, w, h) {
  var type = mxUtils.getValue(
    this.style,
    mxArchiMate3Tech.prototype.cst.TYPE,
    mxArchiMate3Tech.prototype.cst.DEVICE,
  );
...
mxCellRenderer.registerShape(
  mxArchiMate3Distribution.prototype.cst.DISTRIBUTION,
  mxArchiMate3Distribution,
);
...
mxCellRenderer.registerShape(
  mxArchiMate3Capability.prototype.cst.CAPABILITY,
  mxArchiMate3Capability,
);
