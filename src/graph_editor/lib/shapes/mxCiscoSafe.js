...
const { mxCellRenderer, mxShape, mxStencilRegistry, mxUtils } = require('../jgraph/mxClient.js');
...
mxShapeCiscoSafeCompositeIcon.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  if (bgIcon == 'ellipse') {
    ...
    if (stencil != null) {
      w < 100
        ? stencil.drawShape(c, this, w * 0.01, h * 0.01, w * 0.98, h * 0.98)
        : stencil.drawShape(c, this, 1, 1, w - 2, h - 2);
    }
  }
...
mxCellRenderer.registerShape(
  mxShapeCiscoSafeCompositeIcon.prototype.cst.SHAPE_COMPOSITE_ICON,
  mxShapeCiscoSafeCompositeIcon,
);
