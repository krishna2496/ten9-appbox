...
mxRackContainer.prototype.customProperties = [
  ...
  { name: 'textColor', dispName: 'Numbers Color', type: 'color' },
  {
    ...
    enumList: [
      ...
      { val: 'ascend', dispName: 'Ascending' },
      { val: 'descend', dispName: 'Descending' },
    ],
...
mxRackContainer.prototype.paintVertexShape = function (c, x, y, w, h) {
  var fontSize = 12;
  var displayNumbers = mxUtils.getValue(
    this.style,
...
mxRackContainer.prototype.sideText = function (c, w, h, fontSize) {
  ...
  for (var i = 0; i < units; i++) {
    var displayNumber =
      displayNumbers === mxRackContainer.prototype.cst.DIR_DESC
        ? (i + 1).toString()
        : (units - i).toString();
    c.text(
      -fontSize,
...
mxRackHorRoutingBank.prototype.foreground = function (c, w, h) {
  ...
  if (unitsAcross > 0 && unitsDown > 0) {
    for (var i = 0; i < unitsDown; i++) {
      var buffer =
        (spaceBuffer + rectWidth) / 2 +
        Math.floor((w - spaceBuffer - rectWidth - unitsAcross * unitSpacing) / 2) -
        rectWidth / 2;
...
mxRackRackNumbering.prototype.paintVertexShape = function (c, x, y, w, h) {
  var unitNum = parseFloat(
    mxUtils.getValue(this.style, mxRackRackNumbering.prototype.cst.UNIT_NUM, '42'),
  );
  var unitH = parseFloat(
    mxUtils.getValue(this.style, mxRackRackNumbering.prototype.cst.UNIT_HEIGHT, '14.8'),
  );
  var fontSize = parseFloat(
    mxUtils.getValue(this.style, mxRackRackNumbering.prototype.cst.TEXT_SIZE, '12'),
  );
  c.translate(x, y);
...
mxRackRackNumbering.prototype.sideText = function (c, w, h, unitNum, unitH, fontSize) {
  var fontColor = mxUtils.getValue(
    this.style,
    mxRackRackNumbering.prototype.cst.TEXT_COLOR,
    '#666666',
  );
  var numDir = mxUtils.getValue(
    this.style,
    mxRackRackNumbering.prototype.cst.NUM_DIR,
    mxRackRackNumbering.prototype.cst.DIR_DESC,
  );
  c.setFontSize(fontSize);
  c.setFontColor(fontColor);
...
mxRackRackCabinet.prototype.paintVertexShape = function (c, x, y, w, h) {
  var unitNum = parseFloat(
    mxUtils.getValue(this.style, mxRackRackCabinet.prototype.cst.UNIT_NUM, '12'),
  );
  var unitH = parseFloat(
    mxUtils.getValue(this.style, mxRackRackCabinet.prototype.cst.UNIT_HEIGHT, '14.8'),
  );
  var fontSize = parseFloat(
    mxUtils.getValue(this.style, mxRackRackCabinet.prototype.cst.TEXT_SIZE, '12'),
  );
  var numDis = mxUtils.getValue(
    this.style,
    mxRackRackCabinet.prototype.cst.NUMBER_DISPLAY,
    mxRackRackCabinet.prototype.cst.ON,
  );
...
mxRackRackCabinet.prototype.sideText = function (c, w, h, unitNum, unitH, fontSize) {
  var fontColor = mxUtils.getValue(
    this.style,
    mxRackRackCabinet.prototype.cst.TEXT_COLOR,
    '#666666',
  );
  var numDir = mxUtils.getValue(
    this.style,
    mxRackRackCabinet.prototype.cst.NUM_DIR,
    mxRackRackCabinet.prototype.cst.DIR_DESC,
  );
  c.setFontSize(fontSize);
  c.setFontColor(fontColor);
...
mxCellRenderer.registerShape(
  mxRackHorCableDuct.prototype.cst.SHAPE_RACK_HOR_CABLE_DUCT,
  mxRackHorCableDuct,
);
mxCellRenderer.registerShape(
  mxRackHorRoutingBank.prototype.cst.SHAPE_RACK_HOR_ROUTING_BANK,
  mxRackHorRoutingBank,
);
...
mxCellRenderer.registerShape(
  mxRackRackNumbering.prototype.cst.SHAPE_RACK_RACK_NUMBERING,
  mxRackRackNumbering,
);
mxCellRenderer.registerShape(
  mxRackRackCabinet.prototype.cst.SHAPE_RACK_RACK_CABINET,
  mxRackRackCabinet,
);
mxCellRenderer.registerShape(
  mxRackHorCableDuct1U.prototype.cst.SHAPE_RACK_HOR_CABLE_DUCT_1U,
  mxRackHorCableDuct1U,
);
mxCellRenderer.registerShape(
  mxRackHorCableDuct2U.prototype.cst.SHAPE_RACK_HOR_CABLE_DUCT_2U,
  mxRackHorCableDuct2U,
);
mxCellRenderer.registerShape(
  mxRackHorRoutingBank1U.prototype.cst.SHAPE_RACK_HOR_ROUTING_BANK_1U,
  mxRackHorRoutingBank1U,
);
mxCellRenderer.registerShape(
  mxRackHorRoutingBank2U.prototype.cst.SHAPE_RACK_HOR_ROUTING_BANK_2U,
  mxRackHorRoutingBank2U,
);
mxCellRenderer.registerShape(
  mxRackNeatPatch2U.prototype.cst.SHAPE_RACK_NEAT_PATCH_2U,
  mxRackNeatPatch2U,
);
...
mxCellRenderer.registerShape(
  mxRackChannelBase.prototype.cst.SHAPE_RACK_CHANNEL_BASE,
  mxRackChannelBase,
);
mxCellRenderer.registerShape(
  mxRackCabinetLeg.prototype.cst.SHAPE_RACK_CABINET_LEG,
  mxRackCabinetLeg,
);
