...
mxShapeEREntityExt.prototype.paintVertexShape = function (c, x, y, w, h) {
  var mainText = mxUtils.getValue(this.style, 'buttonText', 'Entity');
  var attributes = mxUtils
    .getValue(this.style, 'subText', '+ attribute 1,+ attribute 2,+ attribute 3')
    .toString()
    .split(',');
  ...
  for (var i = 0; i < attributes.length; i++) {
    var currWidth = mxUtils.getSizeForString(
      attributes[i],
      fontSize,
...
mxShapeEREntityExt.prototype.shapes = function (
  c,
  x,
  y,
  w,
...
mxShapeEREntityExt.prototype.attrText = function (
  c,
  x,
  y,
  w,
...
mxShapeERHierarchy.prototype.shapeText = function (
  c,
  x,
  y,
  w,
...
mxShapeERBachman.prototype.foreground = function (c, x, y, w, h, fontSize, fontColor) {
  ...
  var textWidth = mxUtils.getSizeForString('has/forms', fontSize, mxConstants.DEFAULT_FONTFAMILY)
    .width;
  c.begin();
