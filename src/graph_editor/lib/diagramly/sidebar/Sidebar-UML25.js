  ...
  Sidebar.prototype.addUml25Palette = function () {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        'shape=umlFrame;whiteSpace=wrap;html=1;width=120;height=30;boundedLbl=1;verticalAlign=middle;align=left;spacingLeft=5;',
        340,
        180,
        'Diagram1 heading',
        'Diagram',
      ...
      this.createVertexTemplateEntry(
        'shape=process2;fixedSize=1;size=5;fontStyle=1;',
        140,
        40,
        'Classifier1',
        'Classifier',
      ...
      this.addEntry(dt + 'interface generalization', function () {
        var edge = new mxCell(
          ...
          'html=1;verticalAlign=bottom;labelBackgroundColor=none;startArrow=oval;startFill=0;startSize=8;endArrow=none;',
        );
      ...
      this.addEntry(dt + 'required interface', function () {
        var edge = new mxCell(
          'Interface1',
          new mxGeometry(-1, 0, 0, 0),
          'html=1;verticalAlign=bottom;labelBackgroundColor=none;startArrow=halfCircle;startFill=0;startSize=2;endArrow=none;',
        );
        edge.geometry.setTerminalPoint(new mxPoint(0, 0), true);
        edge.geometry.setTerminalPoint(new mxPoint(160, 0), false);
        edge.geometry.relative = true;
      ...
      this.addEntry(dt + 'port provided interface lollipop notation', function () {
        ...
        var edge1 = new mxCell(
          '',
          new mxGeometry(0, 0, 0, 0),
          'endArrow=none;html=1;rounded=0;align=center;verticalAlign=top;endFill=0;labelBackgroundColor=none;endSize=2;',
        );
        ...
        var cell2 = new mxCell(
          '',
          new mxGeometry(52, 11, 8, 8),
          'ellipse;html=1;fontSize=11;align=center;fillColor=none;points=[];aspect=fixed;resizable=0;verticalAlign=bottom;labelPosition=center;verticalLabelPosition=top;flipH=1;',
        );
        cell2.vertex = true;
      ...
      this.addEntry(dt + 'port required interface lollipop notation', function () {
        ...
        var cell2 = new mxCell(
          '',
          new mxGeometry(55, 10, 5, 10),
          'shape=requiredInterface;html=1;fontSize=11;align=center;fillColor=none;points=[];aspect=fixed;resizable=0;verticalAlign=bottom;labelPosition=center;verticalLabelPosition=top;flipH=1;',
        );
        cell2.vertex = true;
        cell2.insertEdge(edge1, false);
        return sb.createEdgeTemplateFromCells(
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'shallow history pseudostate',
      ),
      this.createVertexTemplateEntry(
        'ellipse;fillColor=#ffffff;strokeColor=#000000;',
        30,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'choice pseudostate merge decision node',
      ),
      this.createVertexTemplateEntry(
        'shape=umlDestroy;',
        30,
      ...
      this.createVertexTemplateEntry(
        'html=1;shape=mxgraph.infographic.ribbonSimple;notch1=20;notch2=0;align=center;verticalAlign=middle;fontSize=14;fontStyle=0;flipH=1;fillColor=#FFFFFF;',
        160,
        40,
        'Trigger1 spec.',
        'Trigger',
      ...
      this.createVertexTemplateEntry(
        'html=1;shape=mxgraph.infographic.ribbonSimple;notch1=0;notch2=20;align=center;verticalAlign=middle;fontSize=14;fontStyle=0;fillColor=#FFFFFF;',
        160,
        40,
        'SendSignalAction1',
        'Send Signal Action',
        null,
        null,
        dt + 'send signal action',
      ),
      this.createVertexTemplateEntry(
        'html=1;align=right;verticalAlign=top;rounded=1;absoluteArcSize=1;arcSize=50;dashed=0;spacingTop=10;spacingRight=30;',
        300,
        160,
        '&lt;&lt;singleExecution&gt;&gt;',
        'Single Execution',
      ...
      this.addEntry(dt + 'parameter', function () {
        var cell1 = new mxCell(
          '',
          new mxGeometry(0, 10, 30, 30),
          'fillColor=#ffffff;strokeColor=#000000;',
        );
        cell1.vertex = true;
        var field1 = new mxCell(
          'Parameter1 spec.',
          new mxGeometry(40, 0, 100, 20),
          'text;verticalAlign=middle;align=center;',
        );
        field1.vertex = true;
        cell1.insert(field1);
      ...
      this.createVertexTemplateEntry(
        'html=1;align=center;verticalAlign=middle;rounded=1;absoluteArcSize=1;arcSize=10;dashed=0;',
        140,
        70,
        '&lt;&lt;external&gt;&gt;<br>Action1<br>(partition1)',
        'Activity Partition',
        null,
        null,
        dt + 'activity partition',
      ),
      this.addEntry(dt + 'object node', function () {
        var cell1 = new mxCell(
          'ObjectNode1<br><br>[State1, State2...]',
      ...
      this.createVertexTemplateEntry(
        'html=1;shape=mxgraph.infographic.ribbonSimple;notch1=20;notch2=20;align=center;verticalAlign=middle;fontSize=14;fontStyle=0;fillColor=#FFFFFF;',
        160,
        40,
        'ObjectNode1',
        'Object Node',
      ...
      this.createVertexTemplateEntry(
        'html=1;points=[];perimeter=orthogonalPerimeter;fillColor=#000000;strokeColor=none;align=left;verticalAlign=top;spacingLeft=10;',
        5,
        80,
        '{joinSpec = join spec}',
        'Join Node',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'interruptible activity region',
      ),
      this.createVertexTemplateEntry(
        'html=1;align=center;verticalAlign=middle;rounded=1;absoluteArcSize=1;arcSize=10;dashed=1;',
        140,
        40,
        'State1',
        'State',
      ...
      this.addEntry(
        'constraint precondition postcondition selection transformation decision input',
        function () {
          var cell = new mxCell(
            'Constraint1 spec.',
            new mxGeometry(0, 0, 160, 60),
      ...
      this.addEntry('object flow', function () {
        ...
        var edge1 = new mxCell(
          '',
          new mxGeometry(0, 0, 0, 0),
          'endArrow=open;html=1;rounded=0;align=center;verticalAlign=top;endFill=0;labelBackgroundColor=none;endSize=6;',
        );
      ...
      this.createVertexTemplateEntry(
        'fontStyle=0;labelPosition=right;verticalLabelPosition=middle;align=left;verticalAlign=middle;spacingLeft=2;html=1;points=[[0,0.5],[1,0.5]];fillColor=#000000;strokeColor=none;',
        30,
        30,
        '',
        'Pin ',
      ...
      this.createVertexTemplateEntry(
        'shape=mxgraph.uml25.inputPin;html=1;points=[[0,0.5],[1,0.5]];',
        30,
        30,
        '',
        'Input Pin',
      ...
      this.createVertexTemplateEntry(
        'shape=mxgraph.uml25.behaviorAction;html=1;rounded=1;absoluteArcSize=1;arcSize=10;align=left;spacingLeft=5;',
        190,
        60,
        'CallBehaviorAction1',
        'Behavior Action',
      ...
      this.createVertexTemplateEntry(
        ...
        140,
        40,
        'Action1<br>(Operation1)',
        'Call Operation Action',
        null,
        null,
        dt + 'call operation action',
      ),
      this.createVertexTemplateEntry(
        'html=1;align=center;verticalAlign=middle;rounded=1;absoluteArcSize=1;arcSize=10;dashed=0;',
        140,
        40,
        'ValueSpecAction1 spec.',
        'Value Specification Action',
        null,
        null,
        dt + 'value specification action',
      ),
      this.addEntry(dt + 'action with output', function () {
        var cell1 = new mxCell(
          'Action1',
          new mxGeometry(0, 20, 110, 40),
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'send object action',
      ),
      this.createVertexTemplateEntry(
        'html=1;shape=mxgraph.infographic.ribbonSimple;notch1=20;notch2=0;align=center;verticalAlign=middle;fontSize=14;fontStyle=0;fillColor=#FFFFFF;flipH=0;spacingRight=0;spacingLeft=14;',
        170,
        40,
        'AcceptEventAction1',
        'Accept Event Action',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'time event trigger',
      ),
      this.createVertexTemplateEntry(
        'shape=mxgraph.uml25.actionParams;html=1;align=center;verticalAlign=top;absoluteArcSize=1;arcSize=10;dashed=0;spacingLeft=10;spacingTop=5;',
        150,
        50,
        'Action1',
        ...
        null,
        null,
        dt + 'action with parameters',
      ),
      this.createVertexTemplateEntry(
        'dashed=1;rounded=1;absoluteArcSize=1;arcSize=20;html=1;verticalAlign=top;align=left;spacingTop=5;spacingLeft=10;',
        200,
        100,
        '&lt;&lt;structured&gt;&gt;',
      ...
      this.addEntry(dt + 'execution region', function () {
        ...
        var label1 = new mxCell(
          ...
          'text;resizeWidth=0;resizeHeight=0;points=[];part=1;verticalAlign=middle;align=center;',
        );
        label1.vertex = true;
      ...
      this.addEntry(dt + 'interaction', function () {
        ...
        cell1.vertex = true;
        var field1 = new mxCell('Property1', new mxGeometry(0, 0, 100, 20), 'text');
        field1.geometry.relative = true;
        ...
        var field2 = new mxCell(
          'Property2',
          new mxGeometry(0, 0, 150, 60),
          'shape=note2;boundedLbl=1;whiteSpace=wrap;html=1;size=25;verticalAlign=top;align=left;spacingLeft=10;',
        );
        field2.geometry.relative = true;
      ...
      this.addEntry(dt + 'interaction', function () {
        ...
        cell1.vertex = true;
        var field1 = new mxCell('[constraint1]', new mxGeometry(0, 0, 100, 20), 'text');
        field1.geometry.relative = true;
        field1.geometry.offset = new mxPoint(20, 40);
        field1.vertex = true;
        cell1.insert(field1);
        var field2 = new mxCell(
          ...
          'line;strokeWidth=1;dashed=1;labelPosition=center;verticalLabelPosition=bottom;align=left;verticalAlign=top;spacingLeft=20;spacingTop=15;',
        );
      ...
      this.addEntry(dt + 'use case', function () {
        ...
        var field1 = new mxCell(
          'heading1',
          new mxGeometry(0, 0, 140, 70),
          'shape=umlFrame;tabPosition=left;html=1;boundedLbl=1;labelInHeader=1;width=80;height=30;swimlaneFillColor=#ffffff;align=left;spacingLeft=5;',
        );
        field1.geometry.relative = true;
        field1.geometry.offset = new mxPoint(20, 50);
        field1.vertex = true;
        cell1.insert(field1);
        var field2 = new mxCell('Interaction1', new mxGeometry(0, 0, 100, 20), 'text;align=left;');
        field2.geometry.relative = true;
      ...
      this.addEntry('observation', function () {
        var edge = new mxCell(
          'observation',
          new mxGeometry(0, 0, 0, 0),
          'endArrow=none;html=1;endSize=12;startArrow=none;startSize=14;startFill=0;edgeStyle=orthogonalEdgeStyle;align=center;verticalAlign=bottom;endFill=0;',
        );
        edge.geometry.setTerminalPoint(new mxPoint(0, 0), true);
        edge.geometry.setTerminalPoint(new mxPoint(160, 0), false);
        edge.geometry.relative = true;
      ...
      this.addEntry('duration constraint', function () {
        var edge = new mxCell(
          ...
          new mxGeometry(0, 0, 0, 0),
          'endArrow=open;html=1;endSize=12;startArrow=open;startSize=14;startFill=0;edgeStyle=orthogonalEdgeStyle;align=center;verticalAlign=bottom;endFill=0;',
        );
        edge.geometry.setTerminalPoint(new mxPoint(0, 0), true);
        edge.geometry.setTerminalPoint(new mxPoint(160, 0), false);
        edge.geometry.relative = true;
      ...
      this.addEntry(dt + 'classifier', function () {
        ...
        var field1 = new mxCell(
          ...
          'html=1;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rotatable=0;',
        );
        field1.vertex = true;
        cell1.insert(field1);
        var divider1 = new mxCell(
          '',
          new mxGeometry(9, 30, 162, 10),
          'line;strokeWidth=1;fillColor=none;rotatable=0;labelPosition=right;points=[];portConstraint=eastwest;dashed=0;resizeWidth=1;',
        );
        divider1.vertex = true;
        cell1.insert(divider1);
        var field2 = new mxCell(
          'extension points',
          new mxGeometry(0, 40, 180, 30),
          'text;html=1;align=center;verticalAlign=middle;rotatable=0;',
        );
        field2.vertex = true;
        cell1.insert(field2);
        var field3 = new mxCell(
          'Extension point 1',
          new mxGeometry(0, 70, 180, 30),
          'text;html=1;align=left;verticalAlign=middle;rotatable=0;spacingLeft=25;',
        );
        field3.vertex = true;
        cell1.insert(field3);
      ...
      this.addEntry(dt + 'extension point classifier', function () {
        ...
        var cell2 = new mxCell(
          ...
          'html=1;align=left;spacingLeft=4;verticalAlign=middle;strokeColor=none;fillColor=none;fontStyle=1',
        );
        cell2.vertex = true;
        cell1.insert(cell2);
      ...
      this.createVertexTemplateEntry(
        'text;html=1;align=center;verticalAlign=middle;dashed=0;fillColor=#ffffff;strokeColor=#000000;',
        160,
        70,
      ...
      this.addEntry('deployment target diagram', function () {
        var cell1 = new mxCell(
          'DeploymentTarget1',
          new mxGeometry(0, 0, 130, 140),
          'verticalAlign=top;align=left;shape=cube;size=10;direction=south;fontStyle=0;html=1;boundedLbl=1;spacingLeft=5;',
        );
        cell1.vertex = true;
        var cell2 = new mxCell(
          'Node1',
          new mxGeometry(0, 0, 100, 80),
          'verticalAlign=top;align=center;shape=cube;size=10;direction=south;html=1;boundedLbl=1;spacingLeft=5;',
        );
      ...
      this.addEntry('information item', function () {
        var cell1 = new mxCell(
          ...
          'align=left;spacingLeft=10;html=1;dashed=0;',
        );
        cell1.vertex = true;
        var cell2 = new mxCell(
          '',
          new mxGeometry(1, 0.5, 30, 20),
          'shape=triangle;fillColor=#000000;',
        );
        cell2.geometry.relative = true;
      ...
      this.addEntry('template binding', function () {
        var edge = new mxCell(
          '&lt;&lt;bind&gt;&gt;',
          new mxGeometry(0, 0, 0, 0),
          'endArrow=open;html=1;rounded=0;align=center;verticalAlign=bottom;dashed=1;endFill=0;labelBackgroundColor=none;',
        );
        edge.geometry.setTerminalPoint(new mxPoint(0, 0), true);
        edge.geometry.setTerminalPoint(new mxPoint(160, 0), false);
        edge.geometry.relative = true;
        edge.edge = true;
        var cell1 = new mxCell(
          'Binding1 information',
          new mxGeometry(0, 0, 0, 0),
          'resizable=0;html=1;align=center;verticalAlign=top;labelBackgroundColor=none;',
        );
      ...
      this.createEdgeTemplateEntry(
        ...
        null,
        'element package import substitution merge',
      ),
      this.createEdgeTemplateEntry(
      ...
      this.addEntry('dependency', function () {
        var cell1 = new mxCell(
          '',
          new mxGeometry(68, 38, 4, 4),
          'ellipse;resizable=0;aspect=fixed;fillColor=#000000;',
        );
        cell1.vertex = true;
        var edge1 = new mxCell(
          '&lt;&lt;keyword&gt;&gt;',
          new mxGeometry(0, 0, 0, 0),
          'endArrow=open;html=1;rounded=0;align=center;verticalAlign=bottom;dashed=1;endFill=0;labelBackgroundColor=none;spacingBottom=35;',
        );
        ...
        var edge2 = new mxCell(
          '&lt;&lt;keyword&gt;&gt;',
          new mxGeometry(0, 0, 0, 0),
          'endArrow=open;html=1;rounded=0;align=center;verticalAlign=top;dashed=1;endFill=0;labelBackgroundColor=none;spacingTop=35;',
        );
      ...
      this.addEntry('generalization set', function () {
        var edge = new mxCell(
          'GeneralizationSet1',
          new mxGeometry(0, 0, 0, 0),
          'endArrow=block;html=1;rounded=0;align=center;verticalAlign=bottom;endFill=0;labelBackgroundColor=none;endSize=8;',
        );
        edge.geometry.setTerminalPoint(new mxPoint(0, 0), true);
        edge.geometry.setTerminalPoint(new mxPoint(160, 0), false);
        edge.geometry.relative = true;
      ...
      this.addEntry(
        ...
        function () {
          var edge1 = new mxCell(
            '',
            new mxGeometry(0, 0, 0, 0),
            'endArrow=none;html=1;rounded=0;align=center;verticalAlign=top;endFill=0;labelBackgroundColor=none;endSize=6;startArrow=oval;startFill=1;',
          );
          edge1.geometry.setTerminalPoint(new mxPoint(0, 0), true);
      ...
      this.createEdgeTemplateEntry(
        ...
        null,
        'association connector instance specification property connector end shared',
      ),
      this.createEdgeTemplateEntry(
        ...
        null,
        'association connector instance specification property connector end composite',
      ),
      ...
      this.addEntry('association instance specification connector', function () {
        var cell1 = new mxCell(
          '',
          new mxGeometry(65, 0, 6, 12),
          'triangle;aspect=fixed;fillColor=#000000;',
        );
        cell1.vertex = true;
        var edge1 = new mxCell(
          '',
      ...
      this.addEntry('Redefine', function () {
        var edge = new mxCell(
          '{redefines}',
          new mxGeometry(0, 0, 0, 0),
          'endArrow=none;html=1;rounded=0;align=center;verticalAlign=top;endFill=0;labelBackgroundColor=none;',
        );
        edge.geometry.setTerminalPoint(new mxPoint(0, 0), true);
        ...
        var cell1 = new mxCell(
          'end1',
          new mxGeometry(-1, 0, 0, 0),
          'resizable=0;html=1;align=left;verticalAlign=bottom;labelBackgroundColor=none;',
        );
        cell1.geometry.relative = true;
        cell1.setConnectable(false);
        cell1.vertex = true;
        ...
        var cell2 = new mxCell(
          '0..1',
          new mxGeometry(-1, 0, 0, 0),
          'resizable=0;html=1;align=left;verticalAlign=top;labelBackgroundColor=none;',
        );
        cell2.geometry.relative = true;
        ...
        var cell3 = new mxCell(
          'Association1',
          new mxGeometry(1, 0, 0, 0),
          'resizable=0;html=1;align=right;verticalAlign=bottom;labelBackgroundColor=none;',
        );
        ...
        var cell4 = new mxCell(
          '{modifier1}',
          new mxGeometry(1, 0, 0, 0),
          'resizable=0;html=1;align=right;verticalAlign=top;labelBackgroundColor=none;',
        );
      ...
      this.addEntry('structural feature', function () {
        var edge = new mxCell(
          'feature1',
          new mxGeometry(-1, 0, 0, 0),
          'html=1;verticalAlign=bottom;labelBackgroundColor=none;endArrow=none;endFill=0;endSize=6;align=left;',
        );
        edge.geometry.setTerminalPoint(new mxPoint(0, 0), true);
        edge.geometry.setTerminalPoint(new mxPoint(160, 0), false);
        edge.geometry.relative = true;
      ...
      this.addEntry('usage', function () {
        ...
        var edge1 = new mxCell(
          '',
          new mxGeometry(0, 0, 0, 0),
          'endArrow=halfCircle;html=1;rounded=0;align=center;verticalAlign=top;endFill=0;labelBackgroundColor=none;endSize=2;',
        );
      ...
      this.addEntry('collaboration', function () {
        var cell1 = new mxCell(
          'Collaboration1',
          new mxGeometry(0, 0, 100, 30),
          'ellipse;html=1;dashed=1;dashPattern=10 10;',
        );
        cell1.vertex = true;
        ...
        var edge1 = new mxCell(
          'ConnectableElement',
          new mxGeometry(0, 0, 0, 0),
          'html=1;rounded=0;labelBackgroundColor=none;align=left;spacingLeft=5;endArrow=none;endFill=0;',
        );
        edge1.geometry.relative = true;
        edge1.edge = true;
        cell1.insertEdge(edge1, true);
      ...
      this.addEntry('Extension', function () {
        var edge = new mxCell(
          '{required}',
          new mxGeometry(-1, 0, 0, 0),
          'html=1;verticalAlign=bottom;labelBackgroundColor=none;endArrow=block;endFill=1;endSize=6;align=left;',
        );
        edge.geometry.setTerminalPoint(new mxPoint(0, 0), true);
        edge.geometry.setTerminalPoint(new mxPoint(160, 0), false);
        edge.geometry.relative = true;
      ...
      this.addEntry('transition', function () {
        var edge = new mxCell(
          'Transition1 spec.',
          new mxGeometry(0, 0, 0, 0),
          'endArrow=open;html=1;rounded=0;align=center;verticalAlign=bottom;endFill=0;labelBackgroundColor=none;',
        );
        edge.geometry.setTerminalPoint(new mxPoint(0, 0), true);
        edge.geometry.setTerminalPoint(new mxPoint(160, 0), false);
        edge.geometry.relative = true;
      ...
      this.addEntry('activity', function () {
        var edge = new mxCell(
          '{annotation1}',
          new mxGeometry(0, 0, 0, 0),
          'endArrow=open;html=1;rounded=0;align=center;verticalAlign=top;endFill=0;labelBackgroundColor=none;',
        );
        edge.geometry.setTerminalPoint(new mxPoint(0, 0), true);
        edge.geometry.setTerminalPoint(new mxPoint(160, 0), false);
        edge.geometry.relative = true;
      ...
      this.addEntry('action', function () {
        var cell1 = new mxCell(
          'Action1',
          new mxGeometry(0, 5, 100, 30),
          'html=1;rounded=1;absoluteArcSize=1;arcSize=10;',
        );
        cell1.vertex = true;
        var cell2 = new mxCell(
          'Action2',
          new mxGeometry(180, 5, 100, 30),
          'html=1;rounded=1;absoluteArcSize=1;arcSize=10;',
        );
        cell2.vertex = true;
        var edge1 = new mxCell(
          '',
          new mxGeometry(0, 0, 0, 0),
          'html=1;rounded=0;labelBackgroundColor=none;align=left;spacingLeft=5;endArrow=open;endFill=0;',
        );
        edge1.geometry.relative = true;
        edge1.edge = true;
        cell1.insertEdge(edge1, true);
      ...
      this.addEntry('object node', function () {
        ...
        var edge1 = new mxCell(
          '',
          new mxGeometry(0, 0, 0, 0),
          'endArrow=block;html=1;rounded=0;align=center;verticalAlign=top;endFill=1;labelBackgroundColor=none;endSize=6;',
        );
        edge1.geometry.setTerminalPoint(new mxPoint(0, 15), true);
        edge1.geometry.relative = true;
        edge1.edge = true;
      ...
      this.createEdgeTemplateEntry(
        'shape=mxgraph.lean_mapping.electronic_info_flow_edge;html=1;',
        160,
        0,
        '',
        'Activity',
      ...
      this.createEdgeTemplateEntry(
        ...
        'Message',
        null,
        'message async asynchronous signal call',
      ),
      this.createEdgeTemplateEntry(
      ...
      this.addEntry('message lost', function () {
        var cell1 = new mxCell(
          '',
          new mxGeometry(160, 0, 4, 4),
          'ellipse;html=1;fillColor=#000000;',
        );
        cell1.vertex = true;
        var edge1 = new mxCell(
          '',
      ...
      this.addEntry(dt + 'lifeline execution', function () {
        var cell1 = new mxCell(
          '',
          new mxGeometry(0, 0, 160, 160),
          'rounded=0;dashed=0;container=0;collapsible=0;recursiveResize=0;',
        );
        cell1.vertex = true;
        var cell2 = new mxCell('LifeLine1', new mxGeometry(30, 10, 100, 30), 'rounded=0;dashed=0;');
        cell2.vertex = true;
        cell1.insert(cell2);
        ...
        var edge1 = new mxCell(
          '',
          new mxGeometry(0, 0, 0, 0),
          'html=1;verticalAlign=bottom;startArrow=none;endArrow=none;dashed=1;',
        );
        edge1.geometry.relative = true;
        edge1.edge = true;
        cell2.insertEdge(edge1, false);
        ...
        var edge3 = new mxCell(
          '',
          new mxGeometry(0, 0, 0, 0),
          'html=1;verticalAlign=bottom;startArrow=none;endArrow=open;endFill=0;',
        );
