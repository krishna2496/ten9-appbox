...
const { mxCell, mxPoint, mxResources } = require('../../jgraph/mxClient.js');
...
(function () {
  ...
  Sidebar.prototype.addErPalette = function () {
    ...
    var row = new mxCell(
      ...
      'text;strokeColor=none;fillColor=none;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;fontSize=12;',
    );
    row.vertex = true;
    ...
    function createEdge(style, m, n) {
      ...
      if (m != null) {
        var cell1 = new mxCell(
          ...
          'resizable=0;html=1;align=left;verticalAlign=bottom;',
        );
      ...
      if (n != null) {
        var cell2 = new mxCell(
          n,
          new mxGeometry(1, 0, 0, 0),
          'resizable=0;html=1;align=right;verticalAlign=bottom;',
        );
    ...
    var fns = [
      ...
      this.addEntry(dt + 'table row', function () {
        var cell = new mxCell(
          row.value,
          new mxGeometry(0, 0, 90, row.geometry.height),
        ...
        cell1.style =
          'shape=partialRectangle;top=0;left=0;bottom=0;fillColor=none;stokeWidth=1;dashed=1;align=left;verticalAlign=middle;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[];portConstraint=eastwest;part=1;';
      ...
      this.createVertexTemplateEntry(
        'rounded=1;arcSize=10;whiteSpace=wrap;html=1;align=center;',
        100,
        40,
        'Entity',
        'Entity (Rounded)',
      ...
      this.createVertexTemplateEntry(
        'shape=ext;margin=3;double=1;whiteSpace=wrap;html=1;align=center;',
        100,
        40,
        'Entity',
        'Weak Entity',
      ...
      this.createVertexTemplateEntry(
        'ellipse;whiteSpace=wrap;html=1;align=center;fontStyle=4;',
        100,
        40,
        'Attribute',
        'Key Attribute',
        null,
        null,
        dt + 'attribute key chen',
      ),
      this.createVertexTemplateEntry(
        'ellipse;whiteSpace=wrap;html=1;align=center;',
        100,
        40,
        '<span style="border-bottom: 1px dotted">Attribute</span>',
        'Weak Key Attribute',
        null,
        null,
        dt + 'attribute key weak chen',
      ),
      this.createVertexTemplateEntry(
        'ellipse;whiteSpace=wrap;html=1;align=center;dashed=1;',
        100,
        40,
        'Attribute',
        'Derived Attribute',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'attribute multivalue chen',
      ),
      this.createVertexTemplateEntry(
        'shape=associativeEntity;whiteSpace=wrap;html=1;align=center;',
        140,
        60,
        'Associative\nEntity',
        'Associative Entity',
      ...
      this.createVertexTemplateEntry(
        'ellipse;shape=cloud;whiteSpace=wrap;html=1;align=center;',
        100,
        60,
        'Cloud',
        'Cloud',
      ...
      this.addEntry(dt + 'hierarchy', function () {
        ...
        var cell1 = new mxCell(
          'main',
          new mxGeometry(0, 0, 50, 100),
          'html=1;shape=mxgraph.er.anchor;whiteSpace=wrap;',
        );
        cell1.vertex = true;
        cell.insert(cell1);
        ...
        var cell2 = new mxCell(
          'sub',
          new mxGeometry(50, 5, 45, 90),
          'rounded=1;absoluteArcSize=1;html=1;arcSize=10;whiteSpace=wrap;points=[];strokeColor=inherit;fillColor=inherit;',
        );
        cell2.vertex = true;
        cell.insert(cell2);
      ...
      this.createVertexTemplateEntry(
        'shape=note;size=20;whiteSpace=wrap;html=1;',
        w,
        h,
        'Note',
        'Note',
      ...
      this.createEdgeTemplateEntry(
        ...
        null,
        dt + 'one mandatory many optional',
      ),
      this.createEdgeTemplateEntry(
      ...
      this.createEdgeTemplateEntry(
        ...
        null,
        dt + 'one optional mandatory many',
      ),
      this.createEdgeTemplateEntry(
