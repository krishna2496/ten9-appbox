...
(function () {
  ...
  Sidebar.prototype.addIos7Palette = function () {
    ...
    var s =
      'html=1;verticalLabelPosition=bottom;align=center;labelBackgroundColor=#ffffff;verticalAlign=top;strokeWidth=2;strokeColor=#0080F0;shadow=0;dashed=0;shape=mxgraph.ios7.icons.';
    ...
    this.addPaletteFunctions('ios7icons', 'iOS Icons', false, [
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'add', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'alarm_clock;',
        90 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'alarm_clock', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'back;',
        100 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'back', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'backward;',
        100 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'backward', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'bag;',
        70 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'bag', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'basket_cancel;',
        100 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'basket_cancel', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'basketball;',
        100 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'basketball', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'battery;',
        100 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'battery', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'bell;',
        80 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'bell', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'bluetooth;pointerEvents=1',
        50 * sc,
        96 * sc,
        '',
        'Bluetooth',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'book', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'bookmark;',
        60 * sc,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'briefcase', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'calculator;',
        80 * sc,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'compose', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'controls;',
        90 * sc,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'credit_card', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'crop;',
        100 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'crop', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'cube;',
        100 * sc,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'cup', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'data;',
        80 * sc,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'delete', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'document;',
        70 * sc,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'down', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'edit;',
        98 * sc,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'envelope_(empty)', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'envelope_(message);',
        100 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'envelope_(message)', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'eye;',
        100 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'eye', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'flag;',
        100 * sc,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'flash', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'flashlight;',
        50 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'flashlight', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'folder;',
        100 * sc,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'folders_2', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'forward;',
        100 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'forward', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'gauge;',
        108 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'gauge', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'glasses;',
        100 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'glasses', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'globe;',
        100 * sc,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'info', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'keypad;',
        100 * sc,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'location_2', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'locked;',
        80 * sc,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'looking_glass', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'loud;',
        102 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'loud', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'magnet;pointerEvents=1',
        80 * sc,
        100 * sc,
        '',
        'Magnet',
        null,
        null,
        this.getTagsForStencil(gn, 'magnet', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'mail;',
        100 * sc,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'messages', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'microphone;',
        40 * sc,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'moon', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'most_viewed;pointerEvents=1',
        94 * sc,
        76 * sc,
        '',
        'Most Viewed',
        null,
        null,
        this.getTagsForStencil(gn, 'most_viewed', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'move_to_folder;',
        100 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'move_to_folder', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'note;pointerEvents=1',
        99 * sc,
        99 * sc,
        '',
        'Note',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'options', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'orientation_lock', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'page_navigation;pointerEvents=1',
        100 * sc,
        16 * sc,
        '',
        'Page Navigation',
        null,
        null,
        this.getTagsForStencil(gn, 'page_navigation', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'paint;',
        100 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'paint', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'pause;pointerEvents=1',
        50 * sc,
        80 * sc,
        '',
        'Pause',
        null,
        null,
        this.getTagsForStencil(gn, 'pause', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'pen;',
        98 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'pen', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'pie_chart;',
        100 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'pie_chart', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'play;',
        70 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'play', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'pointer;',
        100 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'pointer', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'preferences;pointerEvents=1',
        100 * sc,
        80 * sc,
        '',
        'Preferences',
        null,
        null,
        this.getTagsForStencil(gn, 'preferences', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'printer;',
        100 * sc,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'reload', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'repeat;pointerEvents=1',
        100 * sc,
        80 * sc,
        '',
        'Repeat',
        null,
        null,
        this.getTagsForStencil(gn, 'repeat', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'retry;',
        92 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'retry', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'select;',
        100 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'select', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'settings;',
        100 * sc,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'shopping_cart', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'shuffle;pointerEvents=1',
        100 * sc,
        70 * sc,
        '',
        'Shuffle',
        null,
        null,
        this.getTagsForStencil(gn, 'shuffle', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'silent;',
        100 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'silent', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'smartphone;',
        60 * sc,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'stopwatch', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'storage;',
        100 * sc,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'sun', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'tape;pointerEvents=1',
        100 * sc,
        40 * sc,
        '',
        'Tape',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'trashcan', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'trophy;',
        95 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'trophy', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'umbrella;',
        100 * sc,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'umbrella', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'unlocked;',
        80 * sc,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'up', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'user;',
        100 * sc,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'video_conversation', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'volume;pointerEvents=1',
        100 * sc,
        100 * sc,
        '',
        'Volume',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'volume_2', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'wallet;',
        100 * sc,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'wifi', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'window;',
        100 * sc,
    ...
    var s =
      'html=1;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;shadow=0;dashed=0;strokeWidth=1;shape=mxgraph.ios7ui.';
    ...
    var sm =
      'html=1;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;shadow=0;dashed=0;strokeWidth=2;shape=mxgraph.ios7.misc.';
    ...
    var fns = [
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'phone', dt + 'iphone portrait').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'tablet tab 7', dt + 'ipad portrait').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'tablet tab 10', dt + 'ipad portrait').join(' '),
      ),
      this.createVertexTemplateEntry(
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, dt + 'slider', null).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 +
          'downloadBar;verticalAlign=middle;fontSize=8;buttonText=;barPos=30;fillColor=#aaaaaa;strokeColor=#0080f0;align=center;',
        sizeX * 0.75,
        sizeY * 0.075,
        'Downloading 2 of 6\n\n',
        'Download bar',
        null,
        null,
        this.getTagsForStencil(gn, 'downloadBar', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'adjust', dt + '').join(' '),
      ),

      this.addEntry(dt + 'horizontal button bar', function () {
        var bg = new mxCell(
          '',
          new mxGeometry(0, 0, 164, 12.5),
          s2 + 'rrect;rSize=3;strokeColor=#0080F0;gradientColor=none;',
        );
        bg.vertex = true;
        var button1 = new mxCell(
          'Item 1',
          new mxGeometry(0, 0, 41, 12.5),
          inh + s2 + 'leftButton;rSize=3;fontSize=8;',
        );
        button1.vertex = true;
        bg.insert(button1);
        var button3 = new mxCell(
          'Item 3',
          new mxGeometry(82, 0, 41, 12.5),
          inh + s2 + 'rrect;rSize=0;fontSize=8;',
        );
        button3.vertex = true;
        bg.insert(button3);
        var button4 = new mxCell(
          'Item 4',
          new mxGeometry(123, 0, 41, 12.5),
          inh + s2 + 'rightButton;rSize=3;fontSize=8;',
        );
        button4.vertex = true;
        bg.insert(button4);
        var button2 = new mxCell(
          'Item 2',
          new mxGeometry(41, 0, 41, 12.5),
          s2 + 'rrect;rSize=0;strokeColor=#0080F0;fillColor=#0080F0;fontColor=#ffffff;fontSize=8;',
        );
        button2.vertex = true;
        bg.insert(button2);
      ...
      this.addEntry(dt + 'labels', function () {
        var bg = new mxCell(
          '',
          new mxGeometry(0, 0, 164, 20),
          'shape=rect;fillColor=#F6F6F8;strokeColor=none;',
        );
        bg.vertex = true;
        var text1 = new mxCell(
          'Label',
          new mxGeometry(55, 0, 54, 20),
          'text;fontSize=10;verticalAlign=middle;align=center;spacingTop=2;',
        );
        text1.vertex = true;
        bg.insert(text1);
        var text2 = new mxCell(
          'Label',
          new mxGeometry(109, 0, 55, 20),
          'text;fontColor=#0080f0;fontSize=10;verticalAlign=middle;align=right;spacingTop=2;spacingRight=4;',
        );
        text2.vertex = true;
        bg.insert(text2);
      ...
      this.addEntry(dt + 'search box', function () {
        var bg = new mxCell(
          '',
          new mxGeometry(0, 0, 164, 20),
          'shape=rect;fillColor=#e0e0e0;strokeColor=none;',
        );
        bg.vertex = true;
        var part1 = new mxCell(
          '',
          new mxGeometry(0, 0, 164, 20),
          s2 + 'marginRect;rx=3;ry=3;rectMargin=5;strokeColor=none;',
        );
        part1.vertex = true;
        bg.insert(part1);
        var icon1 = new mxCell(
          'Search',
          new mxGeometry(0.5, 0.5, 6, 6),
          'shape=mxgraph.ios7.icons.looking_glass;strokeColor=#e0e0e0;fillColor=none;fontColor=#e0e0e0;labelPosition=right;verticalLabelPosition=middle;align=left;verticalAlign=middle;fontSize=6;fontStyle=0;spacingTop=2;',
        );
      ...
      this.addEntry(dt + 'search box', function () {
        var bg = new mxCell(
          '',
          new mxGeometry(0, 0, 164, 20),
          'shape=rect;fillColor=#F6F6F6;strokeColor=none;',
        );
        bg.vertex = true;
        var part1 = new mxCell(
          '',
          new mxGeometry(0, 0, 164, 20),
          s2 + 'marginRect;rx=3;ry=3;rectMargin=5;fillColor=#E4E4E4;strokeColor=none;',
        );
        part1.vertex = true;
        bg.insert(part1);
        var icon1 = new mxCell(
          'Search',
          new mxGeometry(0.5, 0.5, 6, 6),
          'shape=mxgraph.ios7.icons.looking_glass;strokeColor=#878789;fillColor=none;fontColor=#878789;labelPosition=right;verticalLabelPosition=middle;align=left;verticalAlign=middle;fontSize=6;fontStyle=0;spacingTop=2;',
        );
        icon1.geometry.relative = true;
        icon1.geometry.offset = new mxPoint(-17, -3);
        icon1.vertex = true;
      ...
      this.addEntry(dt + 'alert', function () {
        var bg = new mxCell(
          "A dialog text that notifies you of something of which you don't need to make a decision, just to acknowledge it by pressing the close button.",
          new mxGeometry(0, 0, 120, 70),
          'shape=rect;rounded=1;strokeColor=none;fillColor=#F6F6F8;gradientColor=none;shadow=0;glass=0;dashed=1;fontFamily=Helvetica;fontSize=7;fontColor=#333333;align=center;html=0;verticalAlign=top;whiteSpace=wrap;spacing=8;spacingTop=0;',
        );
        bg.vertex = true;
        var text1 = new mxCell(
          'Close',
          new mxGeometry(0, 1, 120, 20),
          'shape=text;align=center;verticalAlign=middle;fontSize=8;fontColor=#0680FF;strokeColor=none;fillColor=none;spacingTop=3;resizeWidth=1;',
        );
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'broadcast', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'night', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'notification', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'text size', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
      ...
      this.createVertexTemplateEntry(
        s2 +
          'url;fillColor=#e0e0e0;strokeColor=#c0c0c0;buttonText=;strokeColor2=#222222;fontColor=#222222;fontSize=8;spacingTop=2;align=center;',
        sizeX * 0.825,
        sizeY * 0.03125,
        'draw.io',
        'URL',
        null,
        null,
        this.getTagsForStencil(gn, 'url', dt + 'url').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'iconGrid', dt + 'icon grid').join(' '),
      ),

      this.addEntry(dt + 'action dialog', function () {
        var bg = new mxCell(
          '',
          new mxGeometry(0, 0, 164, 60),
          'shape=rect;fillColor=#a0a0a0;strokeColor=none;shadow=0;',
        );
        bg.vertex = true;
        var button1 = new mxCell(
          'Action',
          new mxGeometry(8, 6, 148, 21),
          'html=1;strokeWidth=1;shadow=0;dashed=0;rounded=1;absoluteArcSize=1;arcSize=6;fontColor=#0080F0;fontSize=7;fontSize=14;fillColor=#e0e0e0;strokeColor=none;fontStyle=1;',
        );
        button1.vertex = true;
        bg.insert(button1);
        var button2 = new mxCell(
          'Cancel',
          new mxGeometry(8, 33, 148, 21),
          'html=1;strokeWidth=1;shadow=0;dashed=0;rounded=1;absoluteArcSize=1;arcSize=6;fontColor=#0080F0;fontSize=7;fontSize=14;fillColor=#e0e0e0;strokeColor=none;fontStyle=1;',
        );
        button2.vertex = true;
        bg.insert(button2);
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'keyboard letters', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s3 + 'iKeybNumb;',
        sizeX * 0.87,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'keyboard symbols', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s3 + 'iKeybLett;',
        sizeX * 1.66,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'call_pad', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'number_pad', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'keyboard_(letters)', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'scroll_(horizontal)', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'scroll_(vertical)', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'add', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'delete', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'select', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'remove', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'check', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'flagged', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'up', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'down', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'left', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'right', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'increase', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'info', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'more_2', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'more', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'options', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'pause', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'star', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'contacts_bar', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'edit_bar', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'message_bar', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'misc_bar', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s +
          'onOffButton;buttonState=on;strokeColor=#38D145;strokeColor2=#aaaaaa;fillColor=#38D145;fillColor2=#ffffff;',
        sizeX * 0.2175,
        sizeY * 0.0375,
        '',
        'On-off button (On)',
        null,
        null,
        this.getTagsForStencil(gn, 'onOffButton', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s +
          'onOffButton;buttonState=off;strokeColor=#38D145;strokeColor2=#aaaaaa;fillColor=#38D145;fillColor2=#ffffff;',
        sizeX * 0.2175,
        sizeY * 0.0375,
        '',
        'On-off button (Off)',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'icon', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        sm + 'loading_circle;',
        sizeX * 0.2,
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'loading_circle', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'circle', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'pageControl', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'current_location', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gnm, 'expand', dt + '').join(' '),
      ),
      this.addDataEntry(
        dt + 'volume control',
        160,
