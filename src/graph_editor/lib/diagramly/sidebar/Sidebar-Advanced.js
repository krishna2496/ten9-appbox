...
const { mxCell, mxGeometry } = require('../../jgraph/mxClient.js');
  ...
  Sidebar.prototype.createAdvancedShapes = function () {
    ...
    return fns.concat([
      ...
      this.addEntry('horizontal flow layout', function () {
        ...
        cell.style =
          'swimlane;html=1;startSize=20;horizontal=0;childLayout=flowLayout;flowOrientation=west;resizable=0;interRankCellSpacing=50;containerType=tree;';
