...
(function () {
  ...
  Sidebar.prototype.addBPMN2GeneralPalette = function (gn, r, sb) {
    ...
    var eh = 0;
    var s1 =
      'shape=mxgraph.bpmn.data;labelPosition=center;verticalLabelPosition=bottom;align=center;verticalAlign=top;size=15;';
    var s2 = 'swimlane;html=1;startSize=20;fontStyle=0;collapsible=0;';
    var s3 =
      'shape=mxgraph.bpmn.conversation;perimeter=hexagonPerimeter2;whiteSpace=wrap;html=1;aspect=fixed;bpmnConversationType=';
    ...
    var fns = [
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'data object collection',
      ),
      this.createVertexTemplateEntry(
        s1 + 'bpmnTransferType=input;',
        40,
        60,
        '',
        'Data Input',
      ...
      this.createVertexTemplateEntry(
        s1 + 'bpmnTransferType=input;isCollection=1;',
        40,
        60,
        '',
        ...
        null,
        null,
        dt + 'data input collection',
      ),
      this.createVertexTemplateEntry(
        s1 + 'bpmnTransferType=output;',
        40,
        60,
        '',
        'Data Output',
      ...
      this.createVertexTemplateEntry(
        s1 + 'bpmnTransferType=output;isCollection=1;',
        40,
        60,
        '',
        ...
        null,
        null,
        dt + 'data output collection',
      ),
      this.createVertexTemplateEntry(
        'shape=datastore;whiteSpace=wrap;html=1;labelPosition=center;verticalLabelPosition=bottom;align=center;verticalAlign=top;',
        100,
        100,
        '',
        'Data Store',
      ...
      this.createVertexTemplateEntry(
        'points=[[0.25,0,0],[0.5,0,0],[0.75,0,0],[1,0.25,0],[1,0.5,0],[1,0.75,0],[0.75,1,0],[0.5,1,0],[0.25,1,0],[0,0.75,0],[0,0.5,0],[0,0.25,0]];rounded=1;dashed=1;dashPattern=5 2 1 2;labelPosition=center;verticalLabelPosition=top;align=right;verticalAlign=bottom;fontSize=8;',
        140,
        80,
        '',
        'Data Object',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'text annotation label',
      ),
      this.createVertexTemplateEntry(
        s2 + 'horizontal=0;swimlaneLine=0;fillColor=none;',
        440,
        100,
        '',
        'Horizontal Lane',
      ...
      this.createVertexTemplateEntry(
        s2 + 'horizontal=1;swimlaneLine=0;fillColor=none;',
        440,
        100,
        '',
        'Vertical Lane',
      ...
      this.createVertexTemplateEntry(
        s2 + 'horizontal=0;swimlaneLine=1;swimlaneFillColor=#ffffff;strokeWidth=2;',
        440,
        100,
        '',
        'Horizontal Lane',
      ...
      this.createVertexTemplateEntry(
        'shape=mxgraph.bpmn.swimlane;html=1;startSize=20;horizontal=0;swimlaneLine=1;collapsible=0;fontStyle=0;swimlaneFillColor=#ffffff;strokeWidth=2;isCollection=1;',
        440,
        100,
        '',
        'Horizontal Lane',
      ...
      this.createVertexTemplateEntry(
        s2 + 'horizontal=1;swimlaneLine=1;strokeWidth=2;swimlaneFillColor=#ffffff;',
        220,
        100,
        '',
        'Vertical Lane',
      ...
      this.createVertexTemplateEntry(
        'shape=mxgraph.bpmn.swimlane;html=1;startSize=20;horizontal=1;swimlaneLine=1;collapsible=0;fontStyle=0;strokeWidth=2;swimlaneFillColor=#ffffff;isCollection=1;',
        220,
        100,
        '',
        'Vertical Lane',
      ...
      this.createVertexTemplateEntry(
        'points=[[0.25,0,0],[0.5,0,0],[0.75,0,0],[1,0.25,0],[1,0.5,0],[1,0.75,0],[0.75,1,0],[0.5,1,0],[0.25,1,0],[0,0.75,0],[0,0.5,0],[0,0.25,0]];rounded=1;arcSize=10;dashed=1;strokeColor=#000000;fillColor=none;gradientColor=none;dashPattern=8 3 1 3;strokeWidth=2;',
        200,
        200,
        '',
        'Group',
      ...
      this.createEdgeTemplateEntry(
        s5 + 'openThin;startArrow=none;',
        ew,
        eh,
        '',
        'Directional / Directed Data Association',
        null,
        dt + 'directed data directional association',
      ),
      this.createEdgeTemplateEntry(
        s5 + 'openThin;startArrow=openThin;',
        ew,
        eh,
        '',
        'Bi-Directional Association',
        null,
        dt + 'bi directional bidirectional association',
      ),
      this.createEdgeTemplateEntry(
        s5 + 'none;startArrow=none;',
        ew,
      ...
      this.createEdgeTemplateEntry(
        'edgeStyle=elbowEdgeStyle;fontSize=12;html=1;shape=link;',
        ew,
        eh,
        '',
        'Conversation Link',
        null,
        dt + 'conversation link',
      ),
      ...
      this.createEdgeTemplateEntry(
        s4 + 'startArrow=diamondThin;startFill=0;endSize=6;startSize=10;',
        ew,
        eh,
        '',
        'Conditional Sequence Flow',
        null,
        dt + 'conditional sequence flow',
      ),
      this.createEdgeTemplateEntry(
        s4 + 'startArrow=dash;startFill=0;endSize=6;startSize=6;',
        ew,
        eh,
        '',
        'Default Sequence Flow',
        null,
        dt + 'default sequence flow',
      ),
      this.createEdgeTemplateEntry(
        'dashed=1;dashPattern=8 4;endArrow=blockThin;endFill=1;startArrow=oval;startFill=0;endSize=6;startSize=4;',
        ew,
        eh,
        '',
        'Message Flow',
      ...
      this.addEntry(
        'edge shape symbol message mail email initiating message flow with decorator',
      ...
      this.addEntry(
        'edge shape symbol message mail email non initiating message flow with decorator',
        mxUtils.bind(this, function () {
          var edge = new mxCell(
            '',
            new mxGeometry(0, 0, 0, 0),
  ...
  Sidebar.prototype.addBPMN2TasksPalette = function (gn, r, sb) {
    ...
    var s3 =
      pts +
      'shape=mxgraph.bpmn.task;rectStyle=rounded;size=10;taskMarker=abstract;bpmnShapeType=subprocess;isLoopSub=1;outline=';
    ...
    var fns = [
      ...
      this.createVertexTemplateEntry(
        s1 + 'isLoopStandard=1;isLoopSub=1;',
        120,
        80,
        '',
        'Standard Loop',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'multi instance parallel',
      ),
      this.createVertexTemplateEntry(
        s1 + 'isLoopSub=1;isLoopMultiParallel=1;',
        120,
        80,
        '',
        'Multi-Instance, Parallel',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'multi instance sequential',
      ),
      this.createVertexTemplateEntry(
        s1 + 'isLoopSub=1;isLoopMultiSeq=1;',
        120,
        80,
        '',
        'Multi-Instance, Sequential',
      ...
      this.createVertexTemplateEntry(
        s1 + 'isLoopComp=1;isLoopStandard=1;',
        120,
        80,
        '',
        ...
        null,
        null,
        dt + 'loop compensation',
      ),
      this.createVertexTemplateEntry(
        s1 + 'isLoopComp=1;isLoopStandard=1;isLoopSub=1;',
        120,
        80,
        '',
        'Loop and Compensation',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'sub process subprocess collapsed',
      ),

      this.createVertexTemplateEntry(
        s2 + 'abstract;bpmnShapeType=transaction;isLoopSub=1;',
        120,
        80,
        '',
        ...
        null,
        null,
        dt + 'transaction collapsed',
      ),
      this.createVertexTemplateEntry(
        s2 + 'abstract;bpmnShapeType=transaction;',
        120,
        80,
        '',
        ...
        null,
        null,
        dt + 'transaction expanded',
      ),

      this.createVertexTemplateEntry(
        s3 + 'eventNonint;symbol=message;',
        120,
        80,
        '',
        ...
        null,
        null,
        dt + 'non interrupting message event sub process collapsed',
      ),
      this.createVertexTemplateEntry(
        s3 + 'eventInt;symbol=message;',
        120,
        80,
        '',
        ...
        null,
        null,
        dt + 'interrupting message event sub process collapsed',
      ),
      this.createVertexTemplateEntry(
        s3 + 'eventNonint;symbol=timer;',
        120,
        80,
        '',
        ...
        null,
        null,
        dt + 'non interrupting timer event sub process collapsed',
      ),
      this.createVertexTemplateEntry(
        s3 + 'eventInt;symbol=timer;',
        120,
        80,
        '',
        ...
        null,
        null,
        dt + 'interrupting timer event sub process collapsed',
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'non interrupting conditional event sub process collapsed',
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'interrupting conditional event sub process collapsed',
      ),
      this.createVertexTemplateEntry(
        s3 + 'eventNonint;symbol=signal;',
        120,
        80,
        '',
        ...
        null,
        null,
        dt + 'non interrupting signal event sub process collapsed',
      ),
      this.createVertexTemplateEntry(
        s3 + 'eventInt;symbol=signal;',
        120,
        80,
        '',
        ...
        null,
        null,
        dt + 'interrupting signal event sub process collapsed',
      ),
      this.createVertexTemplateEntry(
        s3 + 'eventNonint;symbol=multiple;',
        120,
        80,
        '',
        ...
        null,
        null,
        dt + 'non interrupting multiple event sub process collapsed',
      ),
      this.createVertexTemplateEntry(
        s3 + 'eventInt;symbol=multiple;',
        120,
        80,
        '',
        ...
        null,
        null,
        dt + 'interrupting multiple event sub process collapsed',
      ),
      this.createVertexTemplateEntry(
        s3 + 'eventNonint;symbol=parallelMultiple;',
        120,
        80,
        '',
        ...
        null,
        null,
        dt + 'non interrupting parallel multiple event sub process collapsed',
      ),
      this.createVertexTemplateEntry(
        s3 + 'eventInt;symbol=parallelMultiple;',
        120,
        80,
        '',
        ...
        null,
        null,
        dt + 'interrupting parallel multiple event sub process collapsed',
      ),
      this.createVertexTemplateEntry(
        s3 + 'eventNonint;symbol=escalation;',
        120,
        80,
        '',
        ...
        null,
        null,
        dt + 'non interrupting escalation event sub process collapsed',
      ),
      this.createVertexTemplateEntry(
        s3 + 'eventInt;symbol=escalation;',
        120,
        80,
        '',
        ...
        null,
        null,
        dt + 'interrupting escalation event sub process collapsed',
      ),
      this.createVertexTemplateEntry(
        s3 + 'eventInt;symbol=error;',
        120,
        80,
        '',
        ...
        null,
        null,
        dt + 'interrupting error event sub process collapsed',
      ),
      this.createVertexTemplateEntry(
        s3 + 'eventInt;symbol=compensation;',
        120,
        80,
        '',
        ...
        null,
        null,
        dt + 'interrupting compensation event sub process collapsed',
      ),
      this.createVertexTemplateEntry(
        'points=[[0.25,0,0],[0.5,0,0],[0.75,0,0],[1,0.25,0],[1,0.5,0],[1,0.75,0],[0.75,1,0],[0.5,1,0],[0.25,1,0],[0,0.75,0],[0,0.5,0],[0,0.25,0]];shape=mxgraph.bpmn.task;arcSize=10;taskMarker=abstract;outline=none;symbol=general;bpmnShapeType=subprocess;isLoopSub=0;verticalAlign=top;align=left;spacingLeft=5;',
        180,
        100,
        '',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'user call activity',
      ),
      this.createVertexTemplateEntry(
        s4 + 'taskMarker=manual;',
        120,
        80,
        '',
        ...
        null,
        null,
        dt + 'manual call activity',
      ),
      this.createVertexTemplateEntry(
        s4 + 'taskMarker=businessRule;',
        120,
        80,
        '',
        ...
        null,
        null,
        dt + 'business rule call activity',
      ),
      this.createVertexTemplateEntry(
        s4 + 'taskMarker=script;',
        120,
        80,
        '',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'call activity collapsed',
      ),
      this.createVertexTemplateEntry(
        s4 + 'verticalAlign=top;align=left;spacingLeft=5;',
        180,
        100,
        '',
    ...
    var fns = [
      ...
      this.addEntry(dt + 'sub choreography sequential multi instance collapsed', function () {
        ...
        return sb.createVertexTemplateFromCells(
          ...
          bg.geometry.width,
          bg.geometry.height,
          'Sub-Choreography, Sequential Multi Instance, Collapsed',
        );
      }),
      ...
      this.addEntry(dt + 'sub choreography parallel multi instance collapsed', function () {
        ...
        return sb.createVertexTemplateFromCells(
          ...
          bg.geometry.width,
          bg.geometry.height,
          'Sub-Choreography, Parallel Multi Instance, Collapsed',
        );
      }),
      ...
      this.addEntry(dt + 'call choreography activity calling global task loop', function () {
        ...
        return sb.createVertexTemplateFromCells(
          ...
          bg.geometry.width,
          bg.geometry.height,
          'Call Choreography calling Global, Loop',
        );
      }),

      this.addEntry(
        dt + 'call choreography activity calling global task sequential multi instance',
        function () {
          var bg = new mxCell(
            '',
            new mxGeometry(0, 0, 120, 100),
          ...
          return sb.createVertexTemplateFromCells(
            ...
            bg.geometry.width,
            bg.geometry.height,
            'Call Choreography calling Global, Sequential Multi Instance',
          );
        },
      ),

      this.addEntry(
        dt + 'call choreography activity calling global task parallel multi instance',
        function () {
          var bg = new mxCell(
            '',
            new mxGeometry(0, 0, 120, 100),
          ...
          return sb.createVertexTemplateFromCells(
            ...
            bg.geometry.width,
            bg.geometry.height,
            'Call Choreography calling Global, Parallel Multi Instance',
          );
        },
      ),
      ...
      this.addEntry(dt + 'call choreography activity calling', function () {
        ...
        return sb.createVertexTemplateFromCells(
          ...
          bg.geometry.width,
          bg.geometry.height,
          'Call Choreography calling a Choreography',
        );
      }),
      ...
      this.addEntry(dt + 'call choreography activity calling loop', function () {
        ...
        return sb.createVertexTemplateFromCells(
          ...
          bg.geometry.width,
          bg.geometry.height,
          'Call Choreography calling a Choreography, Loop',
        );
      }),

      this.addEntry(
        dt + 'call choreography activity calling sequential multi instance',
        function () {
          var bg = new mxCell(
            '',
            new mxGeometry(0, 0, 120, 100),
          ...
          return sb.createVertexTemplateFromCells(
            ...
            bg.geometry.width,
            bg.geometry.height,
            'Call Choreography calling a Choreography, Sequential Multi Instance',
          );
        },
      ),
      ...
      this.addEntry(dt + 'call choreography activity calling parallel multi instance', function () {
        ...
        return sb.createVertexTemplateFromCells(
          ...
          bg.geometry.width,
          bg.geometry.height,
          'Call Choreography calling a Choreography, Parallel Multi Instance',
        );
      }),
      ...
      this.addEntry(dt + 'initiating participant top with decorator', function () {
        ...
        var cell2 = new mxCell('', new mxGeometry(40, 0, 40, 30), 'shape=message;');
        cell2.vertex = true;
      ...
      this.createVertexTemplateEntry(
        'shape=mxgraph.bpmn.task;part=1;taskMarker=abstract;rectStyle=square;',
        120,
        20,
        '',
        ...
        null,
        null,
        dt + 'initiating additional participant',
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'initiating participant bottom',
      ),
      ...
      this.addEntry(dt + 'initiating participant bottom with decorator', function () {
        ...
        var cell2 = new mxCell('', new mxGeometry(40, 50, 40, 30), 'shape=message;');
        cell2.vertex = true;
      ...
      this.addEntry(dt + 'initiating participant multi instance top with decorator', function () {
        ...
        return sb.createVertexTemplateFromCells(
          ...
          120,
          100,
          'Participant, Initiating, Multi-Instance Top with Decorator',
        );
      }),

      this.createVertexTemplateEntry(
        'shape=mxgraph.bpmn.task;part=1;taskMarker=abstract;rectStyle=square;verticalAlign=top;isLoopMultiParallel=1;',
        120,
        40,
        '',
        ...
        null,
        null,
        dt + 'initiating additional participant multi instance bottom',
      ),
      this.createVertexTemplateEntry(
        'shape=mxgraph.bpmn.task;part=1;taskMarker=abstract;rectStyle=rounded;verticalAlign=top;isLoopMultiParallel=1;topLeftStyle=square;topRightStyle=square;',
        120,
        40,
        '',
        ...
        null,
        null,
        dt + 'initiating participant multi instance bottom',
      ),

      this.addEntry(
        dt + 'initiating participant multi instance bottom with decorator',
        function () {
          var cell1 = new mxCell(
            '',
          ...
          var cell2 = new mxCell('', new mxGeometry(40, 70, 40, 30), 'shape=message;');
          cell2.vertex = true;
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'non initiating participant top',
      ),
      ...
      this.createVertexTemplateEntry(
        'shape=mxgraph.bpmn.task;part=1;taskMarker=abstract;rectStyle=square;fillColor=#C0C0C0;',
        120,
        20,
        '',
        ...
        null,
        null,
        dt + 'non initiating additional participant',
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'non initiating participant bottom',
      ),
      ...
      this.addEntry(dt + 'non initiating participant bottom with decorator', function () {
        ...
        return sb.createVertexTemplateFromCells(
          ...
          120,
          80,
          'Participant, Non-Initiating, Bottom with Decorator',
        );
      }),
      ...
      this.addEntry(
        dt + 'non initiating participant multi instance top with decorator',
        function () {
          var cell1 = new mxCell(
            '',
            new mxGeometry(0, 60, 120, 40),
          ...
          return sb.createVertexTemplateFromCells(
            ...
            120,
            100,
            'Participant, Non-Initiating, Multi-Instance, Top with Decorator',
          );
        },
      ),

      this.createVertexTemplateEntry(
        'shape=mxgraph.bpmn.task;part=1;taskMarker=abstract;rectStyle=square;verticalAlign=top;isLoopMultiParallel=1;fillColor=#C0C0C0;',
        120,
        40,
        '',
        ...
        null,
        null,
        dt + 'non initiating additional participant multi instance bottom',
      ),
      this.createVertexTemplateEntry(
        'shape=mxgraph.bpmn.task;part=1;taskMarker=abstract;rectStyle=rounded;verticalAlign=top;isLoopMultiParallel=1;topLeftStyle=square;topRightStyle=square;fillColor=#C0C0C0;',
        120,
        40,
        '',
        ...
        null,
        null,
        dt + 'non initiating participant multi instance bottom',
      ),

      this.addEntry(
        dt + 'non initiating participant multi instance bottom with decorator',
        function () {
          var cell1 = new mxCell(
            '',
            new mxGeometry(0, 0, 120, 40),
  ...
  Sidebar.prototype.addBPMN2EventsPalette = function (gn, r, sb) {
    ...
    var s =
      'points=[[0.145,0.145,0],[0.5,0,0],[0.855,0.145,0],[1,0.5,0],[0.855,0.855,0],[0.5,1,0],[0.145,0.855,0],[0,0.5,0]];shape=mxgraph.bpmn.event;html=1;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;align=center;perimeter=ellipsePerimeter;outlineConnect=0;aspect=fixed;outline=';
    var w = 50;
    var h = 50;
    ...
    var fns = [
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'none intermediate throwing',
      ),
      this.createVertexTemplateEntry(
        s + 'end;symbol=terminate2;',
        w,
        h,
        '',
        'End',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'message start interrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'eventNonint;symbol=message;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'message start non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'throwing;symbol=message;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'message intermediate throwing',
      ),
      this.createVertexTemplateEntry(
        s + 'catching;symbol=message;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'message intermediate catching',
      ),
      this.createVertexTemplateEntry(
        s + 'boundInt;symbol=message;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'message intermediate boundary interrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'boundNonint;symbol=message;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'message intermediate boundary non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'end;symbol=message;',
        w,
        h,
        '',
        'Message End',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'timer start interrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'eventNonint;symbol=timer;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'timer start non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'catching;symbol=timer;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'timer intermediate catching',
      ),
      this.createVertexTemplateEntry(
        s + 'boundInt;symbol=timer;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'timer intermediate boundary interrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'boundNonint;symbol=timer;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'timer intermediate boundary non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'eventInt;symbol=escalation;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'escalation start interrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'eventNonint;symbol=escalation;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'escalation start non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'throwing;symbol=escalation;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'escalation intermediate boundary throwing',
      ),
      this.createVertexTemplateEntry(
        s + 'boundInt;symbol=escalation;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'escalation intermediate boundary interrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'boundNonint;symbol=escalation;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'escalation intermediate non interrupting nonimpterrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'end;symbol=escalation;',
        w,
        h,
        '',
        'Escalation End',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'error start interrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'boundInt;symbol=error;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'error intermediate boundary interrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'end;symbol=error;',
        w,
      ...
      this.createVertexTemplateEntry(
        s + 'eventInt;symbol=compensation;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'compensation start interrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'throwing;symbol=compensation;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'compensation intermediate throwing',
      ),
      this.createVertexTemplateEntry(
        s + 'boundInt;symbol=compensation;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'compensation intermediate boundary interrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'end;symbol=compensation;',
        w,
        h,
        '',
        'Compensation End',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'conditional start interrupting',
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'conditional start non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'conditional intermediate catching',
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'conditional intermediate boundary interrupting',
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'conditional intermediate boundary non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'catching;symbol=link;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'link intermediate catching',
      ),
      this.createVertexTemplateEntry(
        s + 'throwing;symbol=link;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'link intermediate throwing',
      ),
      this.createVertexTemplateEntry(
        s + 'standard;symbol=signal;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'signal start interrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'eventNonint;symbol=signal;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'signal start non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'catching;symbol=signal;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'signal intermediate catching',
      ),
      this.createVertexTemplateEntry(
        s + 'throwing;symbol=signal;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'signal intermediate throwing',
      ),
      this.createVertexTemplateEntry(
        s + 'boundInt;symbol=signal;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'signal intermediate boundary interrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'boundNonint;symbol=signal;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'signal intermediate noundary non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'end;symbol=signal;',
        w,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'multiple start interrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'eventNonint;symbol=multiple;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'multiple start non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'catching;symbol=multiple;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'multiple intermediate catching',
      ),
      this.createVertexTemplateEntry(
        s + 'throwing;symbol=multiple;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'multiple intermediate throwing',
      ),
      this.createVertexTemplateEntry(
        s + 'boundInt;symbol=multiple;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'multiple intermediate boundary interrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'boundNonint;symbol=multiple;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'multiple intermediate boundary non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'end;symbol=multiple;',
        w,
        h,
        '',
        'Multiple End',
      ...
      this.createVertexTemplateEntry(
        s + 'eventInt;symbol=parallelMultiple;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'parallel multiple start interrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'eventNonint;symbol=parallelMultiple;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'parallel multiple start non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'catching;symbol=parallelMultiple;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'parallel multiple intermediate catching',
      ),
      this.createVertexTemplateEntry(
        s + 'boundInt;symbol=parallelMultiple;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'parallel multiple intermediate boundary interrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'boundNonint;symbol=parallelMultiple;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'parallel multiple intermediate boundary non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'cancel intermediate boundary interrupting',
      ),
      this.createVertexTemplateEntry(
        s + 'end;symbol=cancel;',
        w,
  ...
  Sidebar.prototype.addBPMN2GatewaysPalette = function (gn, r, sb) {
    ...
    var fns = [
      ...
      this.createVertexTemplateEntry(
        s2 + 'none;symbol=none;gwType=exclusive;',
        w,
        h,
        '',
        'Exclusive',
      ...
      this.createVertexTemplateEntry(
        s2 + 'none;symbol=none;gwType=parallel;',
        w,
        h,
        '',
        'Parallel',
      ...
      this.createVertexTemplateEntry(
        s2 + 'none;symbol=none;gwType=complex;',
        w,
        h,
        '',
        'Complex',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'message interrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'eventNonint;symbol=message;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'message non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'catching;symbol=message;',
        w,
        h,
        '',
        'Message (Catching)',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'message boundary interrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'boundNonint;symbol=message;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'message boundary non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'throwing;symbol=message;',
        w,
        h,
        '',
        'Message (Throwing)',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'timer interrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'eventNonint;symbol=timer;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'timer non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'catching;symbol=timer;',
        w,
        h,
        '',
        'Timer (Catching)',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'timer boundary interrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'boundNonint;symbol=timer;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'timer boundary non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'eventInt;symbol=escalation;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'escalation interrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'eventNonint;symbol=escalation;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'escalation non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'boundInt;symbol=escalation;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'escalation boundary interrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'boundNonint;symbol=escalation;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'escalation boundary non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'throwing;symbol=escalation;',
        w,
        h,
        '',
        'Escalation (Throwing)',
        null,
        null,
        dt + 'escalation throwing',
      ),
      this.createVertexTemplateEntry(
        s2 + 'end;symbol=escalation;',
        w,
        h,
        '',
        'Escalation End',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'conditional non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'conditional boundary interrupting',
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'conditional boundary non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'catching;symbol=link;',
        w,
        h,
        '',
        'Link (Catching)',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'error interrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'boundInt;symbol=error;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'error boundary interrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'end;symbol=error;',
        w,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'cancel boundary interrupting',
      ),
      this.createVertexTemplateEntry(
      ...
      this.createVertexTemplateEntry(
        s2 + 'eventInt;symbol=compensation;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'compensation interrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'boundInt;symbol=compensation;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'compensation boundary interrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'throwing;symbol=compensation;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'compensation throwing',
      ),
      this.createVertexTemplateEntry(
        s2 + 'end;symbol=compensation;',
        w,
        h,
        '',
        'Compensation End',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'signal interrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'eventNonint;symbol=signal;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'signal non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'catching;symbol=signal;',
        w,
        h,
        '',
        'Signal (Catching)',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'signal boundary interrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'boundNonint;symbol=signal;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'signal boundary non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'throwing;symbol=signal;',
        w,
        h,
        '',
        'Signal (Throwing)',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        dt + 'multiple standard',
      ),
      this.createVertexTemplateEntry(
        s2 + 'eventInt;symbol=multiple;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'multiple interrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'eventNonint;symbol=multiple;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'multiple non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'catching;symbol=multiple;',
        w,
        h,
        '',
        'Multiple (Catching)',
        null,
        null,
        dt + 'multiple catching',
      ),
      this.createVertexTemplateEntry(
        s2 + 'boundInt;symbol=multiple;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'multiple boundary interrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'boundNonint;symbol=multiple;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'multiple boundary non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'throwing;symbol=multiple;',
        w,
        h,
        '',
        'Multiple (Throwing)',
        null,
        null,
        dt + 'multiple throwing',
      ),
      this.createVertexTemplateEntry(
        s2 + 'end;symbol=multiple;',
        w,
        h,
        '',
        'Multiple End',
      ...
      this.createVertexTemplateEntry(
        s2 + 'standard;symbol=parallelMultiple;',
        w,
        h,
        '',
        'Parallel Multiple',
        null,
        null,
        dt + 'parallel multiple standard',
      ),
      this.createVertexTemplateEntry(
        s2 + 'eventInt;symbol=parallelMultiple;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'parallel multiple interrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'eventNonint;symbol=parallelMultiple;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'parallel multiple non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'catching;symbol=parallelMultiple;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'parallel multiple catching',
      ),
      this.createVertexTemplateEntry(
        s2 + 'boundInt;symbol=parallelMultiple;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'parallel multiple boundary interrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'boundNonint;symbol=parallelMultiple;',
        w,
        h,
        '',
        ...
        null,
        null,
        dt + 'parallel multiple boundary non interrupting noninterrupting',
      ),
      this.createVertexTemplateEntry(
        s2 + 'end;symbol=terminate;',
        w,
        h,
        '',
        'Terminate',
