...
const { mxCell, mxConstants, mxGeometry, mxPoint } = require('../../jgraph/mxClient.js');
...
(function () {
  Sidebar.prototype.addInfographicPalette = function () {
    ...
    var s2 =
      ...
      '=top;html=1;shape=mxgraph.infographic.';
    var s3 =
      mxConstants.STYLE_VERTICAL_LABEL_POSITION +
      '=bottom;' +
      mxConstants.STYLE_VERTICAL_ALIGN +
    ...
    this.addPaletteFunctions('infographic', 'Infographic', false, [
      ...
      this.createVertexTemplateEntry(
        s4 +
          'partConcEllipse;fillColor=#10739E;strokeColor=none;startAngle=0.25;endAngle=0.1;arcWidth=0.5;',
        w,
        h,
        '',
      ...
      this.addEntry(dt + 'numbered entry', function () {
        ...
        var ellipse1 = new mxCell(
          ...
          'shape=ellipse;perimeter=ellipsePerimeter;fontSize=22;fontStyle=1;shadow=0;strokeColor=#ffffff;fillColor=#10739E;strokeWidth=4;fontColor=#ffffff;align=center;',
        );
      ...
      this.createVertexTemplateEntry(
        mxConstants.STYLE_VERTICAL_LABEL_POSITION +
          '=middle;' +
          mxConstants.STYLE_VERTICAL_ALIGN +
          '=top;html=1;shape=mxgraph.infographic.numberedEntryVert;dy=25;fillColor=#10739E;strokeColor=none;fontSize=17;fontColor=#FFFFFF;align=center;labelPosition=center;spacingTop=32;fontStyle=1;',
        w * 0.8,
        h * 1.6,
        'Label',
      ...
      this.createVertexTemplateEntry(
        'verticalLabelPosition=middle;verticalAlign=middle;html=1;shape=mxgraph.infographic.bendingArch;startAngle=0.75;endAngle=0.25;arcWidth=0.25;fillColor=#10739E;strokeColor=none;fontSize=19;fontColor=#FFFFFF;labelPosition=center;align=center;fontStyle=1',
        w,
        h,
        '50%',
        'Bending Arch',
      ...
      this.addEntry(dt + 'circular dial', function () {
        ...
        var part2 = new mxCell(
          '65%',
          new mxGeometry(0, 0, 100, 100),
          'verticalLabelPosition=middle;verticalAlign=middle;html=1;shape=mxgraph.basic.partConcEllipse;startAngle=0;endAngle=0.65;arcWidth=0.2;strokeColor=none;fillColor=#10739E;fontSize=22;fontColor=#10739E;align=center;fontStyle=1',
        );
        part2.vertex = true;
        part1.insert(part2);
        return sb.createVertexTemplateFromCells(
          [part1],
          part1.geometry.width,
          part1.geometry.height,
          'Circular Dial',
        );
      }),
      ...
      this.addEntry(dt + 'angled entry', function () {
        var part1 = new mxCell(
          ...
          'shape=mxgraph.infographic.parallelogram;dx=5;html=1;fillColor=#10739E;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=center;fontStyle=1;',
        );
        part1.vertex = true;
        var part2 = new mxCell(
          'Label',
          new mxGeometry(45, 0, 95, 30),
          'shape=mxgraph.infographic.parallelogram;dx=5;;html=1;fillColor=#B1DDF0;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=left;spacingLeft=10;fontStyle=1;',
        );
        part2.vertex = true;
      ...
      this.addEntry(dt + 'numbered list', function () {
        ...
        var ellipse2 = new mxCell(
          ...
          'shape=ellipse;perimeter=ellipsePerimeter;fontSize=22;fontStyle=1;shadow=0;strokeColor=#ffffff;fillColor=#F2931E;strokeWidth=4;fontColor=#ffffff;align=center;',
        );
        ...
        var ellipse3 = new mxCell(
          ...
          'shape=ellipse;perimeter=ellipsePerimeter;fontSize=22;fontStyle=1;shadow=0;strokeColor=#ffffff;fillColor=#AE4132;strokeWidth=4;fontColor=#ffffff;align=center;',
        );
        ...
        var ellipse4 = new mxCell(
          ...
          'shape=ellipse;perimeter=ellipsePerimeter;fontSize=22;fontStyle=1;shadow=0;strokeColor=#ffffff;fillColor=#23445D;strokeWidth=4;fontColor=#ffffff;align=center;',
        );
        ...
        var ellipse5 = new mxCell(
          ...
          'shape=ellipse;perimeter=ellipsePerimeter;fontSize=22;fontStyle=1;shadow=0;strokeColor=#ffffff;fillColor=#12AAB5;strokeWidth=4;fontColor=#ffffff;align=center;',
        );
        ellipse5.vertex = true;

        return sb.createVertexTemplateFromCells(
          [rect1, ellipse1, rect2, ellipse2, rect3, ellipse3, rect4, ellipse4, rect5, ellipse5],
          200,
          320,
          'Numbered List',
        );
      ...
      this.addEntry(dt + 'list', function () {
        var st1 =
          ...
          '=middle;' +
          mxConstants.STYLE_VERTICAL_ALIGN +
          '=top;html=1;shape=mxgraph.infographic.numberedEntryVert;dy=25;strokeColor=none;fontSize=17;fontColor=#FFFFFF;align=center;labelPosition=center;spacingTop=32;fontStyle=1;fillColor=#';
      ...
      this.addEntry(dt + 'rodmap horizontal', function () {
        var arch1 = new mxCell(
          '',
          new mxGeometry(0, 90, 120, 120),
          s4 +
            'partConcEllipse;startAngle=0.25;endAngle=0.75;arcWidth=0.25;fillColor=#10739E;strokeColor=none;',
        );
        arch1.vertex = true;
        var arch2 = new mxCell(
          '',
          new mxGeometry(105, 90, 120, 120),
          s4 +
            'partConcEllipse;startAngle=0.75;endAngle=0.25;arcWidth=0.25;fillColor=#F2931E;strokeColor=none;',
        );
        arch2.vertex = true;
        var arch3 = new mxCell(
          '',
          new mxGeometry(210, 90, 120, 120),
          s4 +
            'partConcEllipse;startAngle=0.25;endAngle=0.75;arcWidth=0.25;fillColor=#AE4132;strokeColor=none;',
        );
        arch3.vertex = true;
        var arch4 = new mxCell(
          '',
          new mxGeometry(315, 90, 120, 120),
          s4 +
            'partConcEllipse;startAngle=0.75;endAngle=0.25;arcWidth=0.25;fillColor=#23445D;strokeColor=none;',
        );
        arch4.vertex = true;
        var arch5 = new mxCell(
          '',
          new mxGeometry(420, 90, 120, 120),
          s4 +
            'partConcEllipse;startAngle=0.25;endAngle=0.75;arcWidth=0.25;fillColor=#15AA96;strokeColor=none;',
        );
        arch5.vertex = true;
        ...
        var circle1 = new mxCell(
          ...
          'shape=ellipse;strokeWidth=6;strokeColor=#10739E;fontSize=15;html=0;fontStyle=1;fontColor=#10739E;',
        );
        circle1.vertex = true;
        var circle2 = new mxCell(
          '2',
          new mxGeometry(140, 125, 50, 50),
          'shape=ellipse;strokeWidth=6;strokeColor=#F2931E;fontSize=15;html=0;fontStyle=1;fontColor=#F2931E;',
        );
        circle2.vertex = true;
        var circle3 = new mxCell(
          '3',
          new mxGeometry(245, 125, 50, 50),
          'shape=ellipse;strokeWidth=6;strokeColor=#AE4132;fontSize=15;html=0;fontStyle=1;fontColor=#AE4132;',
        );
        circle3.vertex = true;
        var circle4 = new mxCell(
          '4',
          new mxGeometry(350, 125, 50, 50),
          'shape=ellipse;strokeWidth=6;strokeColor=#23445D;fontSize=15;html=0;fontStyle=1;fontColor=#23445D;',
        );
        circle4.vertex = true;
        var circle5 = new mxCell(
          '5',
          new mxGeometry(455, 125, 50, 50),
          'shape=ellipse;strokeWidth=6;strokeColor=#12AAB5;fontSize=15;html=0;fontStyle=1;fontColor=#12AAB5;',
        );
        circle5.vertex = true;
      ...
      this.addEntry(dt + 'roadmap diagonal', function () {
        var arch1 = new mxCell(
          ...
          s4 +
            'partConcEllipse;startAngle=0.75;endAngle=0.5;arcWidth=0.25;fillColor=#10739E;strokeColor=none;shadow=0;',
        );
        arch1.vertex = true;
        var arch2 = new mxCell(
          '',
          ...
          s4 +
            'partConcEllipse;startAngle=0.25;endAngle=0;arcWidth=0.25;fillColor=#F2931E;strokeColor=none;shadow=0;',
        );
        arch2.vertex = true;
        var arch3 = new mxCell(
          '',
          ...
          s4 +
            'partConcEllipse;startAngle=0.75;endAngle=0.5;arcWidth=0.25;fillColor=#AE4132;strokeColor=none;shadow=0;',
        );
        arch3.vertex = true;
        var arch4 = new mxCell(
          '',
          ...
          s4 +
            'partConcEllipse;startAngle=0.25;endAngle=0;arcWidth=0.25;fillColor=#23445D;strokeColor=none;shadow=0;',
        );
        arch4.vertex = true;
        var arch5 = new mxCell(
          '',
          ...
          s4 +
            'partConcEllipse;startAngle=0.75;endAngle=0.5;arcWidth=0.25;fillColor=#12AAB5;strokeColor=none;shadow=0;',
        );
        arch5.vertex = true;
        ...
        var circle1 = new mxCell(
          ...
          'shape=ellipse;strokeWidth=6;strokeColor=#10739E;fontSize=15;html=1;fontStyle=1;fontColor=#10739E;shadow=1;',
        );
        circle1.vertex = true;
        var circle2 = new mxCell(
          '2',
          new mxGeometry(225, 140, 50, 50),
          'shape=ellipse;strokeWidth=6;strokeColor=#F2931E;fontSize=15;html=1;fontStyle=1;fontColor=#F2931E;shadow=1;',
        );
        circle2.vertex = true;
        var circle3 = new mxCell(
          '3',
          new mxGeometry(330, 140, 50, 50),
          'shape=ellipse;strokeWidth=6;strokeColor=#AE4132;fontSize=15;html=1;fontStyle=1;fontColor=#AE4132;shadow=1;',
        );
        circle3.vertex = true;
        var circle4 = new mxCell(
          '4',
          new mxGeometry(330, 245, 50, 50),
          'shape=ellipse;strokeWidth=6;strokeColor=#23445D;fontSize=15;html=1;fontStyle=1;fontColor=#23445D;shadow=1;',
        );
        circle4.vertex = true;
        var circle5 = new mxCell(
          '5',
          new mxGeometry(435, 245, 50, 50),
          'shape=ellipse;strokeWidth=6;strokeColor=#12AAB5;fontSize=15;html=1;fontStyle=1;fontColor=#12AAB5;shadow=1;',
        );
        circle5.vertex = true;
      ...
      this.addEntry(dt + 'arrow list', function () {
        var part1 = new mxCell(
          ...
          'html=1;fillColor=#10739E;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=center;fontStyle=1;rounded=0;',
        );
        part1.vertex = true;
        var part2 = new mxCell(
          'Label',
          new mxGeometry(45, 0, 95, 40),
          'shape=mxgraph.infographic.ribbonSimple;notch1=0;notch2=10;notch=0;html=1;fillColor=#64BBE2;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=left;spacingLeft=10;fontStyle=1;',
        );
        part2.vertex = true;
        var part3 = new mxCell(
          '2',
          new mxGeometry(0, 45, 40, 40),
          'html=1;fillColor=#F2931E;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=center;fontStyle=1;rounded=0;',
        );
        part3.vertex = true;
        var part4 = new mxCell(
          'Label',
          new mxGeometry(45, 45, 115, 40),
          'shape=mxgraph.infographic.ribbonSimple;notch1=0;notch2=10;notch=0;html=1;fillColor=#F8C382;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=left;spacingLeft=10;fontStyle=1;',
        );
        part4.vertex = true;
        var part5 = new mxCell(
          '3',
          new mxGeometry(0, 90, 40, 40),
          'html=1;fillColor=#AE4132;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=center;fontStyle=1;rounded=0;',
        );
        part5.vertex = true;
        var part6 = new mxCell(
          'Label',
          new mxGeometry(45, 90, 135, 40),
          'shape=mxgraph.infographic.ribbonSimple;notch1=0;notch2=10;notch=0;html=1;fillColor=#F08E81;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=left;spacingLeft=10;fontStyle=1;',
        );
        part6.vertex = true;
        var part7 = new mxCell(
          '4',
          new mxGeometry(0, 135, 40, 40),
          'html=1;fillColor=#23445D;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=center;fontStyle=1;rounded=0;',
        );
        part7.vertex = true;
        var part8 = new mxCell(
          'Label',
          new mxGeometry(45, 135, 155, 40),
          'shape=mxgraph.infographic.ribbonSimple;notch1=0;notch2=10;notch=0;html=1;fillColor=#5D7F99;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=left;spacingLeft=10;fontStyle=1;',
        );
        part8.vertex = true;
        var part9 = new mxCell(
          '5',
          new mxGeometry(0, 180, 40, 40),
          'html=1;fillColor=#12AAB5;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=center;fontStyle=1;rounded=0;',
        );
        part9.vertex = true;
        var part10 = new mxCell(
          'Label',
          new mxGeometry(45, 180, 175, 40),
          'shape=mxgraph.infographic.ribbonSimple;notch1=0;notch2=10;notch=0;html=1;fillColor=#61C6CE;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=left;spacingLeft=10;fontStyle=1;',
        );
        part10.vertex = true;
        return sb.createVertexTemplateFromCells(
      ...
      this.addEntry(dt + 'angled list', function () {
        ...
        var part2 = new mxCell(
          'Label',
          new mxGeometry(45, 0, 95, 30),
          'shape=mxgraph.infographic.parallelogram;dx=5;;html=1;fillColor=#64BBE2;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=left;spacingLeft=10;fontStyle=1;',
        );
        part2.vertex = true;
        var part3 = new mxCell(
          '2',
          new mxGeometry(0, 35, 50, 30),
          'shape=mxgraph.infographic.parallelogram;dx=5;html=1;fillColor=#F2931E;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=center;fontStyle=1;',
        );
        part3.vertex = true;
        var part4 = new mxCell(
          'Label',
          new mxGeometry(45, 35, 115, 30),
          'shape=mxgraph.infographic.parallelogram;dx=5;;html=1;fillColor=#F8C382;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=left;spacingLeft=10;fontStyle=1;',
        );
        part4.vertex = true;
        var part5 = new mxCell(
          '3',
          new mxGeometry(0, 70, 50, 30),
          'shape=mxgraph.infographic.parallelogram;dx=5;html=1;fillColor=#AE4132;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=center;fontStyle=1;',
        );
        part5.vertex = true;
        var part6 = new mxCell(
          'Label',
          new mxGeometry(45, 70, 135, 30),
          'shape=mxgraph.infographic.parallelogram;dx=5;;html=1;fillColor=#F08E81;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=left;spacingLeft=10;fontStyle=1;',
        );
        part6.vertex = true;
        var part7 = new mxCell(
          '4',
          new mxGeometry(0, 105, 50, 30),
          'shape=mxgraph.infographic.parallelogram;dx=5;html=1;fillColor=#23445D;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=center;fontStyle=1;',
        );
        part7.vertex = true;
        var part8 = new mxCell(
          'Label',
          new mxGeometry(45, 105, 155, 30),
          'shape=mxgraph.infographic.parallelogram;dx=5;;html=1;fillColor=#5D7F99;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=left;spacingLeft=10;fontStyle=1;',
        );
        part8.vertex = true;
        var part9 = new mxCell(
          '5',
          new mxGeometry(0, 140, 50, 30),
          'shape=mxgraph.infographic.parallelogram;dx=5;html=1;fillColor=#12AAB5;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=center;fontStyle=1;',
        );
        part9.vertex = true;
        var part10 = new mxCell(
          'Label',
          new mxGeometry(45, 140, 175, 30),
          'shape=mxgraph.infographic.parallelogram;dx=5;;html=1;fillColor=#61C6CE;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=left;spacingLeft=10;fontStyle=1;',
        );
        part10.vertex = true;
        return sb.createVertexTemplateFromCells(
          [part1, part2, part3, part4, part5, part6, part7, part8, part9, part10],
      ...
      this.addEntry(dt + 'arc list', function () {
        var arc1 = new mxCell(
          ...
          s4 +
            'partConcEllipse;fillColor=#10739E;strokeColor=#ffffff;startAngle=0.75;endAngle=0.08;arcWidth=0.16;strokeWidth=3;',
        );
        arc1.vertex = true;
        var arc2 = new mxCell(
          '',
          ...
          s4 +
            'partConcEllipse;fillColor=#F2931E;strokeColor=#ffffff;startAngle=0.91;endAngle=0.17;arcWidth=0.18;strokeWidth=3;',
        );
        arc2.vertex = true;
        var arc3 = new mxCell(
          '',
          ...
          s4 +
            'partConcEllipse;fillColor=#AE4132;strokeColor=#ffffff;startAngle=0.75;endAngle=0.11;arcWidth=0.22;strokeWidth=3;',
        );
        arc3.vertex = true;
        var arc4 = new mxCell(
          '',
          ...
          s4 +
            'partConcEllipse;fillColor=#12AAB5;strokeColor=#ffffff;startAngle=0.02;endAngle=0.25;arcWidth=0.29;strokeWidth=3;',
        );
        arc4.vertex = true;
        var arc5 = new mxCell(
          '',
          ...
          s4 +
            'partConcEllipse;fillColor=#CCCCCC;strokeColor=#ffffff;startAngle=0.75;endAngle=0.25;arcWidth=0.4;strokeWidth=3;',
        );
        arc5.vertex = true;
        var part1 = new mxCell(
          '2018',
        ...
        return sb.createVertexTemplateFromCells(
          [arc1, arc2, arc3, arc4, arc5, part1],
          200,
          200,
          'Arc list',
        );
      ...
      this.addEntry(dt + 'arc list', function () {
        var circle1 = new mxCell(
          '',
          new mxGeometry(0, 0, 250, 250),
          'ellipse;fillColor=none;strokeColor=#444444;',
        );
        circle1.vertex = true;
        var circle2 = new mxCell(
          '',
          new mxGeometry(20, 20, 210, 210),
          'ellipse;fillColor=none;strokeColor=#444444;',
        );
        circle2.vertex = true;
        var circle3 = new mxCell(
          '',
          new mxGeometry(40, 40, 170, 170),
          'ellipse;fillColor=none;strokeColor=#444444;',
        );
        circle3.vertex = true;
        var circle4 = new mxCell(
          '',
          new mxGeometry(60, 60, 130, 130),
          'ellipse;fillColor=none;strokeColor=#444444;',
        );
        circle4.vertex = true;
        var circle5 = new mxCell(
          '',
          new mxGeometry(80, 80, 90, 90),
          'ellipse;fillColor=none;strokeColor=#444444;',
        );
        circle5.vertex = true;
        ...
        var arc1 = new mxCell(
          ...
          new mxGeometry(0, 0, 250, 250),
          s4 +
            'arc;fillColor=none;strokeColor=#10739E;startAngle=0.75;endAngle=0.08;strokeWidth=16;',
        );
        arc1.vertex = true;
        var arc2 = new mxCell(
          '',
          new mxGeometry(20, 20, 210, 210),
          s4 +
            'arc;fillColor=none;strokeColor=#F2931E;startAngle=0.91;endAngle=0.17;strokeWidth=16;',
        );
        arc2.vertex = true;
        var arc3 = new mxCell(
          '',
          new mxGeometry(40, 40, 170, 170),
          s4 +
            'arc;fillColor=none;strokeColor=#AE4132;startAngle=0.75;endAngle=0.11;strokeWidth=16;',
        );
        arc3.vertex = true;
        var arc4 = new mxCell(
          '',
          new mxGeometry(60, 60, 130, 130),
          s4 +
            'arc;fillColor=none;strokeColor=#12AAB5;startAngle=0.02;endAngle=0.25;strokeWidth=16;',
        );
        arc4.vertex = true;
        var arc5 = new mxCell(
          '',
          new mxGeometry(80, 80, 90, 90),
          s4 +
            'arc;fillColor=none;strokeColor=#CCCCCC;startAngle=0.75;endAngle=0.25;strokeWidth=16;',
        );
        arc5.vertex = true;
        var part1 = new mxCell(
          '2018',
        ...
        return sb.createVertexTemplateFromCells(
          [circle1, circle2, circle3, circle4, circle5, arc1, arc2, arc3, arc4, arc5, part1],
          200,
          200,
          'Arc list',
        );
      ...
      this.addEntry(dt + 'triangle graph', function () {
        var part1 = new mxCell(
          ...
          'verticalLabelPosition=middle;verticalAlign=bottom;html=1;shape=mxgraph.infographic.shadedTriangle;fillColor=#10739E;strokeColor=none;fontSize=10;labelPosition=center;align=center;fontColor=#FFFFFF;fontStyle=1;shadow=0;',
        );
        part1.vertex = true;
        var part2 = new mxCell(
          'Label',
          new mxGeometry(60, 10, 80, 130),
          'verticalLabelPosition=middle;verticalAlign=bottom;html=1;shape=mxgraph.infographic.shadedTriangle;fillColor=#F2931E;strokeColor=none;fontSize=10;labelPosition=center;align=center;fontColor=#FFFFFF;fontStyle=1;shadow=0;',
        );
        part2.vertex = true;
        var part3 = new mxCell(
          'Label',
          new mxGeometry(120, 0, 80, 140),
          'verticalLabelPosition=middle;verticalAlign=bottom;html=1;shape=mxgraph.infographic.shadedTriangle;fillColor=#AE4132;strokeColor=none;fontSize=10;labelPosition=center;align=center;fontColor=#FFFFFF;fontStyle=1;shadow=0;',
        );
        part3.vertex = true;
        var part4 = new mxCell(
          'Label',
          new mxGeometry(180, 40, 80, 100),
          'verticalLabelPosition=middle;verticalAlign=bottom;html=1;shape=mxgraph.infographic.shadedTriangle;fillColor=#12AAB5;strokeColor=none;fontSize=10;labelPosition=center;align=center;fontColor=#FFFFFF;fontStyle=1;shadow=0;',
        );
        part4.vertex = true;
        var part5 = new mxCell(
          'Label',
          new mxGeometry(240, 60, 80, 80),
          'verticalLabelPosition=middle;verticalAlign=bottom;html=1;shape=mxgraph.infographic.shadedTriangle;fillColor=#23445D;strokeColor=none;fontSize=10;labelPosition=center;align=center;fontColor=#FFFFFF;fontStyle=1;shadow=0;',
        );
        part5.vertex = true;
      ...
      this.addEntry(dt + 'change graph', function () {
        var part1 = new mxCell(
          '',
          new mxGeometry(0, 30, 30, 100),
          'fillColor=#10739E;strokeColor=none;',
        );
        part1.vertex = true;
        var arrow1 = new mxCell(
          '',
          new mxGeometry(3, 30, 24, 70),
          'shape=mxgraph.arrows2.arrow;dy=0.4;dx=16;notch=0;direction=north;fillColor=#1699D3;strokeColor=none;',
        );
        arrow1.vertex = true;
        part1.insert(arrow1);
        var text1 = new mxCell(
          ...
          'text;html=1;align=center;verticalAlign=middle;whiteSpace=wrap;fontColor=#FFFFFF;fontSize=10;',
        );
        text1.vertex = true;
        part1.insert(text1);
        ...
        var part2 = new mxCell(
          '',
          new mxGeometry(35, 10, 30, 120),
          'fillColor=#F2931E;strokeColor=none;',
        );
        part2.vertex = true;
        var arrow2 = new mxCell(
          '',
          new mxGeometry(3, 0, 24, 80),
          'shape=mxgraph.arrows2.arrow;dy=0.4;dx=16;notch=0;direction=south;fillColor=#F5AB50;strokeColor=none;',
        );
        arrow2.vertex = true;
        part2.insert(arrow2);
        ...
        var part3 = new mxCell(
          '',
          new mxGeometry(70, 0, 30, 130),
          'fillColor=#AE4132;strokeColor=none;',
        );
        part3.vertex = true;
        var arrow3 = new mxCell(
          '',
          new mxGeometry(3, 80, 24, 50),
          'shape=mxgraph.arrows2.arrow;dy=0.4;dx=16;notch=0;direction=north;fillColor=#E85642;strokeColor=none;',
        );
        arrow3.vertex = true;
        part3.insert(arrow3);
        ...
        var part4 = new mxCell(
          '',
          new mxGeometry(105, 50, 30, 80),
          'fillColor=#12AAB5;strokeColor=none;',
        );
        part4.vertex = true;
        var arrow4 = new mxCell(
          '',
          new mxGeometry(3, 0, 24, 30),
          'shape=mxgraph.arrows2.arrow;dy=0.4;dx=16;notch=0;direction=south;fillColor=#64BBE2;strokeColor=none;',
        );
        arrow4.vertex = true;
        part4.insert(arrow4);
        ...
        var part5 = new mxCell(
          '',
          new mxGeometry(140, 60, 30, 70),
          'fillColor=#23445D;strokeColor=none;',
        );
        part5.vertex = true;
        var arrow5 = new mxCell(
          '',
          new mxGeometry(3, 10, 24, 60),
          'shape=mxgraph.arrows2.arrow;dy=0.4;dx=16;notch=0;direction=north;fillColor=#2F5B7C;strokeColor=none;',
        );
        arrow5.vertex = true;
        part5.insert(arrow5);
      ...
      this.addEntry(dt + 'circular dial list horizontal', function () {
        ...
        var part4 = new mxCell(
          '40%',
          new mxGeometry(0, 0, 100, 100),
          'verticalLabelPosition=middle;verticalAlign=middle;html=1;shape=mxgraph.basic.partConcEllipse;startAngle=0;endAngle=0.4;arcWidth=0.2;strokeColor=none;fillColor=#F2931E;fontSize=22;fontColor=#F2931E;align=center;fontStyle=1',
        );
        part4.vertex = true;
        part3.insert(part4);
        ...
        var part6 = new mxCell(
          '25%',
          new mxGeometry(0, 0, 100, 100),
          'verticalLabelPosition=middle;verticalAlign=middle;html=1;shape=mxgraph.basic.partConcEllipse;startAngle=0;endAngle=0.25;arcWidth=0.2;strokeColor=none;fillColor=#AE4132;fontSize=22;fontColor=#AE4132;align=center;fontStyle=1',
        );
        part6.vertex = true;
        part5.insert(part6);
        ...
        var part8 = new mxCell(
          '60%',
          new mxGeometry(0, 0, 100, 100),
          'verticalLabelPosition=middle;verticalAlign=middle;html=1;shape=mxgraph.basic.partConcEllipse;startAngle=0;endAngle=0.6;arcWidth=0.2;strokeColor=none;fillColor=#23445D;fontSize=22;fontColor=#23445D;align=center;fontStyle=1',
        );
        part8.vertex = true;
        part7.insert(part8);
        ...
        var part10 = new mxCell(
          '80%',
          new mxGeometry(0, 0, 100, 100),
          'verticalLabelPosition=middle;verticalAlign=middle;html=1;shape=mxgraph.basic.partConcEllipse;startAngle=0;endAngle=0.8;arcWidth=0.2;strokeColor=none;fillColor=#12AAB5;fontSize=22;fontColor=#12AAB5;align=center;fontStyle=1',
        );
        part10.vertex = true;
        part9.insert(part10);
      ...
      this.addEntry(dt + 'circular dial list horizontal', function () {
        var label1 = new mxCell(
          ...
          'verticalLabelPosition=middle;verticalAlign=middle;html=1;html=1;fillColor=none;strokeColor=none;fontSize=15;fontColor=#10739E;align=center;fontStyle=1;',
        );
        label1.vertex = true;
        var part1 = new mxCell(
          '65%',
          new mxGeometry(0, 30, 100, 100),
          'verticalLabelPosition=middle;verticalAlign=middle;html=1;html=1;shape=mxgraph.infographic.partConcEllipse;startAngle=0;endAngle=0.65;arcWidth=0.4;strokeColor=none;fillColor=#10739E;fontSize=22;fontColor=#10739E;align=center;fontStyle=1;',
        );
        part1.vertex = true;
        var text1 = new mxCell(
        ...
        var label2 = new mxCell(
          ...
          'verticalLabelPosition=middle;verticalAlign=middle;html=1;html=1;fillColor=none;strokeColor=none;fontSize=15;fontColor=#F2931E;align=center;fontStyle=1;',
        );
        label2.vertex = true;
        var part2 = new mxCell(
          '40%',
          new mxGeometry(110, 30, 100, 100),
          'verticalLabelPosition=middle;verticalAlign=middle;html=1;html=1;shape=mxgraph.infographic.partConcEllipse;startAngle=0;endAngle=0.4;arcWidth=0.4;strokeColor=none;fillColor=#F2931E;fontSize=22;fontColor=#F2931E;align=center;fontStyle=1;',
        );
        part2.vertex = true;
        var text2 = new mxCell(
          'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
        ...
        var label3 = new mxCell(
          ...
          'verticalLabelPosition=middle;verticalAlign=middle;html=1;html=1;fillColor=none;strokeColor=none;fontSize=15;fontColor=#AE4132;align=center;fontStyle=1;',
        );
        label3.vertex = true;
        var part3 = new mxCell(
          '25%',
          new mxGeometry(220, 30, 100, 100),
          'verticalLabelPosition=middle;verticalAlign=middle;html=1;html=1;shape=mxgraph.infographic.partConcEllipse;startAngle=0;endAngle=0.25;arcWidth=0.4;strokeColor=none;fillColor=#AE4132;fontSize=22;fontColor=#AE4132;align=center;fontStyle=1;',
        );
        part3.vertex = true;
        var text3 = new mxCell(
          'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
        ...
        var label4 = new mxCell(
          ...
          'verticalLabelPosition=middle;verticalAlign=middle;html=1;html=1;fillColor=none;strokeColor=none;fontSize=15;fontColor=#23445D;align=center;fontStyle=1;',
        );
        label4.vertex = true;
        var part4 = new mxCell(
          '60%',
          new mxGeometry(330, 30, 100, 100),
          'verticalLabelPosition=middle;verticalAlign=middle;html=1;html=1;shape=mxgraph.infographic.partConcEllipse;startAngle=0;endAngle=0.6;arcWidth=0.4;strokeColor=none;fillColor=#23445D;fontSize=22;fontColor=#23445D;align=center;fontStyle=1;',
        );
        part4.vertex = true;
        var text4 = new mxCell(
          'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
        ...
        var label5 = new mxCell(
          ...
          'verticalLabelPosition=middle;verticalAlign=middle;html=1;html=1;fillColor=none;strokeColor=none;fontSize=15;fontColor=#12AAB5;align=center;fontStyle=1;',
        );
        label5.vertex = true;
        var part5 = new mxCell(
          '80%',
          new mxGeometry(440, 30, 100, 100),
          'verticalLabelPosition=middle;verticalAlign=middle;html=1;html=1;shape=mxgraph.infographic.partConcEllipse;startAngle=0;endAngle=0.8;arcWidth=0.4;strokeColor=none;fillColor=#12AAB5;fontSize=22;fontColor=#12AAB5;align=center;fontStyle=1;',
        );
        part5.vertex = true;
        var text5 = new mxCell(
          'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
      ...
      this.addEntry(dt + 'circular dial list vertical', function () {
        ...
        return sb.createVertexTemplateFromCells(
          [part1, part2, part3, part4, part5, label1, label2, label3, label4, label5],
          320,
          540,
          'Circular Dial List (vertical)',
        );
      ...
      this.addEntry(dt + 'bar graph', function () {
        var part1 = new mxCell(
          ...
          s2 +
            'shadedCube;isoAngle=15;fillColor=#10739E;strokeColor=none;fontStyle=1;fontColor=#10739E;fontSize=12;shadow=0;',
        );
        part1.vertex = true;
        ...
        var part2 = new mxCell(
          ...
          s2 +
            'shadedCube;isoAngle=15;fillColor=#F2931E;strokeColor=none;fontStyle=1;fontColor=#F2931E;fontSize=12;shadow=0;',
        );
        part2.vertex = true;
        ...
        var part3 = new mxCell(
          ...
          s2 +
            'shadedCube;isoAngle=15;fillColor=#AE4132;strokeColor=none;fontStyle=1;fontColor=#AE4132;fontSize=12;shadow=0;',
        );
        part3.vertex = true;
        ...
        var part4 = new mxCell(
          ...
          s2 +
            'shadedCube;isoAngle=15;fillColor=#23445D;strokeColor=none;fontStyle=1;fontColor=#23445D;fontSize=12;shadow=0;',
        );
        part4.vertex = true;
        ...
        var part5 = new mxCell(
          ...
          s2 +
            'shadedCube;isoAngle=15;fillColor=#12AAB5;strokeColor=none;fontStyle=1;fontColor=#12AAB5;fontSize=12;shadow=0;',
        );
        part5.vertex = true;
      ...
      this.addEntry(dt + 'bar graph', function () {
        ...
        return sb.createVertexTemplateFromCells(
          [part1, part2, part3, part4, part5, bg1, bg2, bg3, bg4, bg5],
          240,
          120,
          'Bar Graph',
        );
      ...
      this.addEntry(dt + 'bar graph', function () {
        var part1 = new mxCell(
          '',
          new mxGeometry(0, 38, 40, 80),
          s2 + 'shadedCube;isoAngle=15;fillColor=#10739E;strokeColor=none;shadow=0;',
        );
        part1.vertex = true;

        var part2 = new mxCell(
          '',
          new mxGeometry(25, 6, 40, 100),
          s2 + 'shadedCube;isoAngle=15;fillColor=#F2931E;strokeColor=none;shadow=0;',
        );
        part2.vertex = true;

        var part3 = new mxCell(
          '',
          new mxGeometry(50, 4, 40, 90),
          s2 + 'shadedCube;isoAngle=15;fillColor=#AE4132;strokeColor=none;shadow=0;',
        );
        part3.vertex = true;

        var part4 = new mxCell(
          '',
          new mxGeometry(75, 32, 40, 50),
          s2 + 'shadedCube;isoAngle=15;fillColor=#23445D;strokeColor=none;shadow=0;',
        );
        part4.vertex = true;

        var part5 = new mxCell(
          '',
          new mxGeometry(100, 0, 40, 70),
          s2 + 'shadedCube;isoAngle=15;fillColor=#12AAB5;strokeColor=none;shadow=0;',
        );
        part5.vertex = true;
      ...
      this.addEntry(dt + 'bar graph', function () {
        var part1 = new mxCell(
          ...
          new mxGeometry(0, 40, 40, 80),
          s2 +
            'cylinder;isoAngle=15;fillColor=#10739E;strokeColor=none;fontStyle=1;fontColor=#10739E;fontSize=12;shadow=0;',
        );
        part1.vertex = true;
        var bg1 = new mxCell(
          '',
        ...
        var part2 = new mxCell(
          ...
          new mxGeometry(50, 20, 40, 100),
          s2 +
            'cylinder;isoAngle=15;fillColor=#F2931E;strokeColor=none;fontStyle=1;fontColor=#F2931E;fontSize=12;shadow=0;',
        );
        part2.vertex = true;
        var bg2 = new mxCell(
          '',
        ...
        var part3 = new mxCell(
          ...
          new mxGeometry(100, 30, 40, 90),
          s2 +
            'cylinder;isoAngle=15;fillColor=#AE4132;strokeColor=none;fontStyle=1;fontColor=#AE4132;fontSize=12;shadow=0;',
        );
        part3.vertex = true;
        var bg3 = new mxCell(
          '',
        ...
        var part4 = new mxCell(
          ...
          new mxGeometry(150, 70, 40, 50),
          s2 +
            'cylinder;isoAngle=15;fillColor=#23445D;strokeColor=none;fontStyle=1;fontColor=#23445D;fontSize=12;shadow=0;',
        );
        part4.vertex = true;
        var bg4 = new mxCell(
          '',
        ...
        var part5 = new mxCell(
          ...
          new mxGeometry(200, 50, 40, 70),
          s2 +
            'cylinder;isoAngle=15;fillColor=#12AAB5;strokeColor=none;fontStyle=1;fontColor=#12AAB5;fontSize=12;shadow=0;',
        );
        part5.vertex = true;
        var bg5 = new mxCell(
          '',
      ...
      this.addEntry(dt + 'bar graph', function () {
        var part1 = new mxCell(
          ...
          'html=1;shape=mxgraph.infographic.barCallout;dx=60;dy=30;fillColor=#10739E;strokeColor=none;align=center;verticalAlign=top;fontColor=#ffffff;fontSize=14;fontStyle=1;shadow=0;spacingTop=5;',
        );
        part1.vertex = true;
        ...
        var part2 = new mxCell(
          ...
          'html=1;shape=mxgraph.infographic.barCallout;dx=80;dy=30;fillColor=#F2931E;strokeColor=none;align=center;verticalAlign=top;fontColor=#ffffff;fontSize=14;fontStyle=1;shadow=0;spacingTop=5;',
        );
        part2.vertex = true;
        ...
        var part3 = new mxCell(
          ...
          'html=1;shape=mxgraph.infographic.barCallout;dx=40;dy=30;fillColor=#AE4132;strokeColor=none;align=center;verticalAlign=top;fontColor=#ffffff;fontSize=14;fontStyle=1;shadow=0;spacingTop=5;',
        );
        part3.vertex = true;
        ...
        var part4 = new mxCell(
          ...
          'html=1;shape=mxgraph.infographic.barCallout;dx=100;dy=30;fillColor=#23445D;strokeColor=none;align=center;verticalAlign=top;fontColor=#ffffff;fontSize=14;fontStyle=1;shadow=0;spacingTop=5;',
        );
        part4.vertex = true;
        ...
        var part5 = new mxCell(
          ...
          'html=1;shape=mxgraph.infographic.barCallout;dx=70;dy=30;fillColor=#12AAB5;strokeColor=none;align=center;verticalAlign=top;fontColor=#ffffff;fontSize=14;fontStyle=1;shadow=0;spacingTop=5;',
        );
        part5.vertex = true;
        ...
        return sb.createVertexTemplateFromCells(
          [part1, part2, part3, part4, part5, dial1, dial2, dial3, dial4, dial5],
          700,
          115,
          'Bar Graph',
        );
      ...
      this.addEntry(dt + 'swirl', function () {
        ...
        return sb.createVertexTemplateFromCells(
          [part5, part4, part3, part2, part1, text1, text2, text3, text4, text5],
          300,
          456,
          'Swirl',
        );
      ...
      this.addEntry(dt + 'roadmap vertical', function () {
        ...
        var label1 = new mxCell(
          ...
          'fillColor=#10739E;strokecolor=none;rounded=1;fontColor=#FFFFFF;strokeColor=none;fontStyle=1;fontSize=14;',
        );
        label1.vertex = true;
        var label2 = new mxCell(
          'Label',
          new mxGeometry(250, 85, 160, 30),
          'fillColor=#F2931E;strokecolor=none;rounded=1;fontColor=#FFFFFF;strokeColor=none;fontStyle=1;fontSize=14;',
        );
        label2.vertex = true;
        var label3 = new mxCell(
          'Label',
          new mxGeometry(70, 160, 160, 30),
          'fillColor=#AE4132;strokecolor=none;rounded=1;fontColor=#FFFFFF;strokeColor=none;fontStyle=1;fontSize=14;',
        );
        label3.vertex = true;
        var label4 = new mxCell(
          'Label',
          new mxGeometry(250, 225, 160, 30),
          'fillColor=#23445D;strokecolor=none;rounded=1;fontColor=#FFFFFF;strokeColor=none;fontStyle=1;fontSize=14;',
        );
        label4.vertex = true;
        var label5 = new mxCell(
          'Label',
          new mxGeometry(70, 300, 160, 30),
          'fillColor=#12AAB5;strokecolor=none;rounded=1;fontColor=#FFFFFF;strokeColor=none;fontStyle=1;fontSize=14;',
        );
        label5.vertex = true;
        var label6 = new mxCell(
          'Label',
          new mxGeometry(250, 365, 160, 30),
          'fillColor=#56517E;strokecolor=none;rounded=1;fontColor=#FFFFFF;strokeColor=none;fontStyle=1;fontSize=14;',
        );
        label6.vertex = true;
      ...
      this.addEntry(dt + 'roadmap horizontal', function () {
        var part1 = new mxCell(
          '',
          new mxGeometry(0, 90, 840, 30),
          'fillColor=#dddddd;rounded=0;strokeColor=none;',
        );
        part1.vertex = true;
        var part2 = new mxCell(
          'Label',
          new mxGeometry(40, 80, 120, 50),
          'shape=mxgraph.infographic.ribbonSimple;notch1=0;notch2=10;notch=0;html=1;fillColor=#10739E;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=left;spacingLeft=10;fontStyle=1;',
        );
        part2.vertex = true;
        var part3 = new mxCell(
          'Label',
          new mxGeometry(200, 80, 120, 50),
          'shape=mxgraph.infographic.ribbonSimple;notch1=0;notch2=10;notch=0;html=1;fillColor=#F2931E;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=left;spacingLeft=10;fontStyle=1;',
        );
        part3.vertex = true;
        var part4 = new mxCell(
          'Label',
          new mxGeometry(360, 80, 120, 50),
          'shape=mxgraph.infographic.ribbonSimple;notch1=0;notch2=10;notch=0;html=1;fillColor=#AE4132;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=left;spacingLeft=10;fontStyle=1;',
        );
        part4.vertex = true;
        var part5 = new mxCell(
          'Label',
          new mxGeometry(520, 80, 120, 50),
          'shape=mxgraph.infographic.ribbonSimple;notch1=0;notch2=10;notch=0;html=1;fillColor=#23445D;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=left;spacingLeft=10;fontStyle=1;',
        );
        part5.vertex = true;
        var part6 = new mxCell(
          'Label',
          new mxGeometry(680, 80, 120, 50),
          'shape=mxgraph.infographic.ribbonSimple;notch1=0;notch2=10;notch=0;html=1;fillColor=#12AAB5;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=left;spacingLeft=10;fontStyle=1;',
        );
        part6.vertex = true;
        ...
        return sb.createVertexTemplateFromCells(
          [part1, part2, part3, part4, part5, part6, label1, label2, label3, label4, label5],
          840,
          210,
          'Roadmap (horizontal)',
        );
