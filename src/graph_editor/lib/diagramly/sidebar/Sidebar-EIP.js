...
const { mxCell, mxUtils } = require('../../jgraph/mxClient.js');
...
(function () {
  ...
  Sidebar.prototype.addEipMessageConstructionPalette = function (expand) {
    ...
    var fns = [
      this.createEdgeTemplateEntry(
        ...
        'Pipe',
        null,
        this.getTagsForStencil(gn, '', dt + 'pipe').join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'rect;fillColor=#c0f5a9;verticalLabelPosition=bottom;verticalAlign=top;',
        150,
        90,
        '',
        'Filter',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'filter').join(' '),
      ),
      this.addEntry(dt + 'command message', function () {
        var bg1 = new mxCell(
          '',
          new mxGeometry(0, 0, 12, 12),
          s + 'ellipse;fillColor=#808080;strokeColor=none;',
        );
        bg1.vertex = true;
        var bg2 = new mxCell(
          'C',
          new mxGeometry(16, 18, 12, 12),
          s + 'rect;fillColor=#FF8080;fontStyle=1;',
        );
        bg2.vertex = true;
      ...
      this.addEntry(dt + 'document message', function () {
        ...
        var bg2 = new mxCell(
          'D',
          new mxGeometry(16, 18, 12, 12),
          s + 'rect;fillColor=#C7A0FF;fontStyle=1;',
        );
        bg2.vertex = true;
        var edge1 = new mxCell(
          '',
      ...
      this.addEntry(dt + 'event message', function () {
        ...
        var bg2 = new mxCell(
          'E',
          new mxGeometry(16, 18, 12, 12),
          s + 'rect;fillColor=#83BEFF;fontStyle=1;',
        );
        bg2.vertex = true;
        var edge1 = new mxCell(
          '',
      ...
      this.createVertexTemplateEntry(
        s3 + 'messExp;html=1;verticalLabelPosition=bottom;verticalAlign=top',
        48,
        48,
        '',
        'Message Expiration',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'message expiration').join(' '),
      ),
      this.addDataEntry(
        dt + 'message sequence',
        60,
      ...
      this.createVertexTemplateEntry(
        s3 + 'retAddr;html=1;verticalLabelPosition=bottom;fillColor=#FFE040;verticalAlign=top;',
        78,
        48,
        '',
        'Return Address',
        null,
        null,
        this.getTagsForStencil(gn, 'retAddr', dt + 'return address').join(' '),
      ),
    ];
  ...
  Sidebar.prototype.addEipMessageRoutingPalette = function (expand) {
    ...
    var s2 =
      'strokeWidth=2;outlineConnect=0;dashed=0;align=center;fontSize=8;fillColor=#c0f5a9;verticalLabelPosition=bottom;verticalAlign=top;shape=mxgraph.eip.';
    ...
    var fns = [
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'aggregator', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'composed_message_processor', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'content_based_router;',
        150,
        90,
        '',
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'content_based_router', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'dynamic_router;',
        150,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'dynamic_router', dt + '').join(' '),
      ),
      this.addDataEntry(
        dt + 'message broker',
        120,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'message_filter', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'process_manager;',
        150,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'process_manager', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'recipient_list;',
        150,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'recipient_list', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'resequencer;',
        150,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'resequencer', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'routing_slip;',
        150,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'routing_slip', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'splitter;',
        150,
  ...
  Sidebar.prototype.addEipMessageTransformationPalette = function (expand) {
    ...
    this.addPaletteFunctions('eipMessage Transformation', 'EIP / Message Transformation', false, [
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'claim_check', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'content_enricher;',
        150,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'content_enricher', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'content_filter;',
        150,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'content_filter', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'envelope_wrapper;',
        150,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'envelope_wrapper', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'normalizer;',
        150,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'normalizer', dt + '').join(' '),
      ),
    ]);
  };
  ...
  Sidebar.prototype.addEipMessagingChannelsPalette = function (expand) {
    ...
    var s2 =
      'strokeWidth=2;outlineConnect=0;dashed=0;align=center;html=1;fontSize=8;shape=mxgraph.eip.';
    var s3 =
      'strokeWidth=1;outlineConnect=0;dashed=0;align=center;html=1;fontSize=8;shape=mxgraph.eip.';
    var gn = 'mxgraph.eip';
    ...
    var fns = [
      this.createEdgeTemplateEntry(
        ...
        null,
        this.getTagsForStencil(gn, '', dt + 'point').join(' '),
      ),
      this.addDataEntry(
        dt + 'publish subscribe',
        80,
        160,
      ...
      this.createVertexTemplateEntry(
        s2 + 'channel_adapter;fillColor=#9ddbef;',
        45,
        90,
        '',
        'Channel Adapter',
        null,
        null,
        this.getTagsForStencil(gn, 'channel_adapter', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s3 +
          'messageChannel;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;',
        100,
        20,
        '',
        'Message Channel',
        null,
        null,
        this.getTagsForStencil(gn, 'messageChannel', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s3 +
          'dataChannel;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;',
        100,
        20,
        '',
        'Datatype Channel',
        null,
        null,
        this.getTagsForStencil(gn, 'dataChannel', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s3 +
          'deadLetterChannel;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;',
        100,
        20,
        '',
        'Dead Letter Channel',
        null,
        null,
        this.getTagsForStencil(gn, 'deadLetterChannel', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s3 +
          'invalidMessageChannel;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;',
        100,
        20,
        '',
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'invalidMessageChannel', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'messaging_bridge;verticalLabelPosition=bottom;verticalAlign=top;fillColor=#c0f5a9;',
        150,
        90,
        '',
        'Messaging Bridge',
        null,
        null,
        this.getTagsForStencil(gn, 'messaging_bridge', dt + '').join(' '),
      ),
      this.addDataEntry(
        dt + 'message bus',
        120,
  ...
  Sidebar.prototype.addEipMessagingEndpointsPalette = function (expand) {
    var s =
      'dashed=0;outlineConnect=0;strokeWidth=2;html=1;align=center;fontSize=8;verticalLabelPosition=bottom;verticalAlign=top;shape=mxgraph.eip.';
    ...
    this.addPaletteFunctions('eipMessaging Endpoints', 'EIP / Messaging Endpoints', false, [
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'competing_consumers', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'durable_subscriber;fillColor=#a0a0a0;',
        30,
        35,
        '',
        'Durable Subscriber',
        null,
        null,
        this.getTagsForStencil(gn, 'durable_subscriber', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'event_driven_consumer;',
        150,
        90,
        '',
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'event_driven_consumer', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'message_dispatcher;',
        150,
        90,
        '',
        'Message Dispatcher',
        null,
        null,
        this.getTagsForStencil(gn, 'message_dispatcher', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'messaging_gateway;',
        150,
        90,
        '',
        'Messaging Gateway',
        null,
        null,
        this.getTagsForStencil(gn, 'messaging_gateway', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'polling_consumer;',
        150,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'polling_consumer', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'selective_consumer;',
        150,
        90,
        '',
        'Selective Consumer',
        null,
        null,
        this.getTagsForStencil(gn, 'selective_consumer', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'service_activator;',
        150,
        90,
        '',
        'Service Activator',
        null,
        null,
        this.getTagsForStencil(gn, 'service_activator', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'transactional_client;',
        150,
        90,
        '',
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'transactional_client', dt + '').join(' '),
      ),
    ]);
  };
  ...
  Sidebar.prototype.addEipMessagingSystemsPalette = function (expand) {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        s2 +
          'content_based_router;verticalLabelPosition=bottom;verticalAlign=top;fillColor=#c0f5a9;',
        150,
        90,
        '',
        'Message Router',
      ...
      this.createVertexTemplateEntry(
        s4 + 'messageChannel;html=1;verticalLabelPosition=bottom;verticalAlign=top;',
        100,
        20,
        '',
        'Message Channel',
      ...
      this.addEntry(dt + 'message endpoint', function () {
        var bg1 = new mxCell(
          '',
          new mxGeometry(0, 0, 150, 90),
          s + 'rect;verticalLabelPosition=bottom;verticalAlign=top;fillColor=#c0f5a9;',
        );
        bg1.vertex = true;
      ...
      this.addEntry(dt + 'message', function () {
        ...
        var bg2 = new mxCell(
          '',
          new mxGeometry(16, 18, 12, 12),
          s + 'rect;fillColor=#80FF6C;fontStyle=1;',
        );
        bg2.vertex = true;
        var edge1 = new mxCell(
          '',
      ...
      this.addEntry(dt + 'message', function () {
        ...
        var bg2 = new mxCell(
          '',
          new mxGeometry(16, 18, 12, 12),
          s2 + 'message_1;fillColor=#ff5500;fontStyle=1;',
        );
        bg2.vertex = true;
        var edge1 = new mxCell(
          '',
      ...
      this.addEntry(dt + 'message', function () {
        ...
        var bg2 = new mxCell(
          '',
          new mxGeometry(16, 18, 12, 12),
          s2 + 'message_2;fillColor=#00cc00;fontStyle=1;',
        );
        bg2.vertex = true;
        var edge1 = new mxCell(
          '',
      ...
      this.createVertexTemplateEntry(
        s2 + 'message_translator;fillColor=#c0f5a9;verticalLabelPosition=bottom;verticalAlign=top;',
        150,
        90,
        '',
        'Message-Translator',
        null,
        null,
        this.getTagsForStencil(gn, 'message_translator', dt + '').join(' '),
      ),
    ];

    this.addPalette(
      'eipMessaging Systems',
  ...
  Sidebar.prototype.addEipSystemManagementPalette = function (expand) {
    var s2 =
      'strokeWidth=2;outlineConnect=0;dashed=0;align=center;fontSize=8;verticalLabelPosition=bottom;verticalAlign=top;shape=mxgraph.eip.';
    var gn = 'mxgraph.eip';
    ...
    this.addPaletteFunctions('eipSystem Management', 'EIP / System Management', false, [
      this.createVertexTemplateEntry(
        s2 + 'channel_purger;fillColor=#c0f5a9',
        150,
        90,
        '',
        'Channel Purger',
        null,
        null,
        this.getTagsForStencil(gn, 'channel_purger', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'control_bus;fillColor=#c0f5a9',
        60,
        40,
        '',
        'Control Bus',
        null,
        null,
        this.getTagsForStencil(gn, 'control_bus', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'detour;fillColor=#c0f5a9',
        150,
        90,
        '',
        'Detour',
        null,
        null,
        this.getTagsForStencil(gn, 'detour', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'message_store;fillColor=#c0f5a9',
        150,
        90,
        '',
        'Message Store',
        null,
        null,
        this.getTagsForStencil(gn, 'message_store', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'smart_proxy;fillColor=#c0f5a9',
        70,
        90,
        '',
        'Smart Proxy',
        null,
        null,
        this.getTagsForStencil(gn, 'smart_proxy', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'test_message;fillColor=#c0f5a9',
        150,
        90,
        '',
        'Test Message',
        null,
        null,
        this.getTagsForStencil(gn, 'test_message', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'wire_tap;fillColor=#c0f5a9',
        150,
        90,
        '',
        'Wire Tap',
        null,
        null,
        this.getTagsForStencil(gn, 'wire_tap', dt + '').join(' '),
      ),
    ]);
  };
})();
