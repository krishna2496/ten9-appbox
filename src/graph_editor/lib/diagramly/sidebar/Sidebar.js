...
require('./Sidebar-Advanced.js');
require('./Sidebar-Arrows2.js');
require('./Sidebar-Basic.js');
require('./Sidebar-Flowchart.js');

require('./Sidebar-ActiveDirectory.js');
require('./Sidebar-AlliedTelesis.js');
require('./Sidebar-Android.js');
require('./Sidebar-ArchiMate.js');
require('./Sidebar-ArchiMate3.js');
require('./Sidebar-Atlassian.js');
require('./Sidebar-AWS.js');
require('./Sidebar-AWS3.js');
require('./Sidebar-AWS3D.js');
require('./Sidebar-AWS4.js');
require('./Sidebar-AWS4b.js');
require('./Sidebar-Azure.js');
require('./Sidebar-Azure2.js');
require('./Sidebar-Basic.js');
require('./Sidebar-Bootstrap.js');
require('./Sidebar-BPMN.js');
require('./Sidebar-C4.js');
require('./Sidebar-Cabinet.js');
require('./Sidebar-Cisco.js');
require('./Sidebar-Cisco19.js');
require('./Sidebar-CiscoSafe.js');
require('./Sidebar-Citrix.js');
require('./Sidebar-Cumulus.js');
require('./Sidebar-DFD.js');
require('./Sidebar-EIP.js');
require('./Sidebar-Electrical.js');
require('./Sidebar-ER.js');
require('./Sidebar-Floorplan.js');
require('./Sidebar-Flowchart.js');
require('./Sidebar-FluidPower.js');
require('./Sidebar-GCP.js');
require('./Sidebar-GCP2.js');
require('./Sidebar-Gmdl.js');
require('./Sidebar-IBM.js');
require('./Sidebar-Infographic.js');
require('./Sidebar-Ios.js');
require('./Sidebar-Ios7.js');
require('./Sidebar-Kubernetes.js');
require('./Sidebar-LeanMapping.js');
require('./Sidebar-Mockup.js');
require('./Sidebar-MSCAE.js');
require('./Sidebar-Network.js');
require('./Sidebar-Office.js');
require('./Sidebar-PID.js');
require('./Sidebar-Rack.js');
require('./Sidebar-Signs.js');
...
(function () {
  ...
  Sidebar.prototype.showEntries = function (entries, remember, force) {
    ...
    // TEN9: Save to settings if defined
    remember = true;
    if (remember && entries != undefined) {
              ...
              mxUtils.bind(this, function (body) {
                ...
                this.editorUi.confirm(
                  ...
                  mxUtils.bind(this, function () {
                    new mxXmlRequest(
                      EXPORT_URL,
                      'w=456&h=' + h + '&html=' + encodeURIComponent(Graph.compress(html)),
          ...
          for (var k = 0; k < entry.libs.length; k++) {
            mxUtils.bind(this, function (lib) {
              ...
              var showError = mxUtils.bind(this, function (err, c) {
                ...
                c.innerHTML =
                  '<img align="top" src="' + mxGraph.prototype.warningImage.src + '"/> ';
                c.appendChild(div);
              });
  ...
  Sidebar.prototype.searchEntries = function (searchTerms, count, page, success, error) {
    ...
    // TEN9: Disable external search
    ICONSEARCH_PATH = null;
