...
(function () {
      ...
      try {
        ...
        if (
          ...
          if (urlParams['pages'] != '0' && this.getFileNode() == null) {
            ...
            graph.model.execute(
              new ChangePage(this, this.getCurrentPage(), this.getCurrentPage(), 0),
            );
          }
    ...
    if (node == null) {
      ...
      if (!compact) {
        ...
        fileNode.setAttribute(
          'selectedPageId',
          this.getCurrentPage() ? this.getCurrentPage().getId() : '',
        );
  ...
  EditorUi.prototype.getBaseFilename = function (ignorePageName) {
    ...
    if (
      ...
      this.getCurrentPage().node.getAttribute('name') != null &&
  ...
  EditorUi.prototype.fileLoaded = function (file, noDialogs) {
    ...
    if (file != null) {
      try {
        ...
        if (!file.isEditable()) {
          this.editor.setStatus(
            '<span class="geStatusAlert" style="margin-left:8px;">' +
   ...
   * @param {number} dy Y-coordinate of the translation.
   */
  EditorUi.prototype.scratchpadLoaded = false;
                  ...
                  mxUtils.bind(this, function (data, mimeType, x, y, w, h, img, doneFn, file) {
                    if (data != null && mimeType.substring(0, 6) == 'image/') {
                          ...
                          if (doc.documentElement.nodeName == 'mxlibrary') {
                            ...
                            try {
                              ...
                              for (var i = 0; i < pages.length; i++) {
                                ...
                                addCells(
                                  cells,
                                  new mxRectangle(0, 0, size.width, size.height),
                                  evt,
                                );
                              }
                      ...
                      if (
                        file != null &&
                        img != null &&
                        (/(\.v(dx|sdx?))($|\?)/i.test(img) || /(\.vs(x|sx?))($|\?)/i.test(img))
                      ) {
                        this.importVisio(
                          file,
                          function (xml) {
  ...
  EditorUi.initTheme = function () {
    if (uiTheme == 'atlas') {
      ...
      if (typeof Toolbar !== 'undefined') {
        Toolbar.prototype.unselectedBackground = mxClient.IS_QUIRKS
          ? 'none'
                ...
                : mxUtils.htmlEntities(
                    mxResources.get('fileNotFoundOrDenied') +
                      (this.drive != null && this.drive.user != null
                        ? ' (' + this.drive.user.displayName + ', ' + this.drive.user.email + ')'
                        : ''),
                  );
          }
  ...
  EditorUi.prototype.showRemoteExportDialog = function (
    ...
    var include = hideInclude
      ? null
      : this.addCheckbox(div, mxResources.get('includeCopyOfMyDiagram'), true);
  ...
  EditorUi.prototype.showExportDialog = function (
    ...
    var hasPages = this.pages != null && this.pages.length > 1;
    var allPages = this.addCheckbox(
      div,
      hasPages && format != 'svg' ? mxResources.get('allPages') : '',
      hasPages,
      !hasPages,
      null,
      format != 'jpeg',
  ...
  EditorUi.prototype.convertLucidChart = function (data, success, error) {
    var delayed = mxUtils.bind(this, function () {
      ...
      if (typeof window.LucidImporter !== 'undefined') {
        try {
          EditorUi.logEvent({ category: 'LUCIDCHART-IMPORT-FILE', action: 'size_' + data.length });
  ...
  EditorUi.prototype.importFile = function (
    ...
    if (mimeType.substring(0, 5) == 'image') {
      ...
      file != null &&
      filename != null &&
      (/(\.v(dx|sdx?))($|\?)/i.test(filename) || /(\.vs(x|sx?))($|\?)/i.test(filename))
    ) {
      ...
      // Returns empty cells array as it is aysynchronous
      this.parseFile(
        file != null ? file : new Blob([data], { type: 'application/octet-stream' }),
        mxUtils.bind(this, function (xhr) {
          if (xhr.readyState == 4) {
            if (xhr.status >= 200 && xhr.status <= 299) {
  ...
  EditorUi.prototype.confirmImageResize = function (fn, force) {
    ...
    var resume =
      this.spinner != null && this.spinner.pause != null ? this.spinner.pause() : function () {};
    var resizeImages =
      isLocalStorage || mxClient.IS_CHROMEAPP ? mxSettings.getResizeImages() : null;
  ...
  EditorUi.prototype.init = function () {
    ...
    ui.actions.get('print').funct = function () {
      ui.showDialog(
        ...
        360,
        ui.pages != null && ui.pages.length > 1 ? 450 : 370,
        true,
        true,
      );
    };
    ...
    graph.getExportVariables = function () {
      ...
      vars['pagenumber'] =
        ui.pages != null && ui.getCurrentPage() != null
          ? mxUtils.indexOf(ui.pages, ui.getCurrentPage()) + 1
          : 1;
    ...
    var y =
      Math.max(document.body.clientHeight || 0, document.documentElement.clientHeight || 0) / 2;
  ...
  EditorUi.prototype.openLocalFile = function (data, name, temp, fileHandle, desc) {
    ...
    if (data != null && data.length > 0) {
      // TEN9: No prompting at all... forcing true
      if (
        true ||
        currentFile == null ||
    ...
    if (parent != window) {
      if (
        ...
        this.installMessageHandler(
          mxUtils.bind(this, function (xml, evt, modified) {
            this.spinner.stop();
            ...
            if (cell.vertex) {
              ...
              if (height.charAt(0) == '@' && cell.getAttribute(height.substring(1)) != null) {
                ...
                cell.geometry.height =
                  height == 'auto' ? size.height + padding : parseFloat(height);
              }
  ...
  EditorUi.prototype.createOutline = function (wnd) {
    ...
    outline.getSourceGraphBounds = function () {
      if (
        ...
        graph.pageVisible &&
        this.source.minimumGraphSize != null
      ) {
        ...
        var result = new mxRectangle(
          0,
          0,
          Math.ceil(this.source.minimumGraphSize.width - (2 * pb.x) / s),
    ...
    outline.getSourceContainerSize = function () {
      if (mxUtils.hasScrollbars(graph.container) && this.source.minimumGraphSize != null) {
        ...
        return new mxRectangle(
          0,
          0,
          Math.ceil(this.source.minimumGraphSize.width * s - 2 * pad.x),
    ...
    outline.getOutlineOffset = function (scale) {
      if (mxUtils.hasScrollbars(graph.container) && this.source.minimumGraphSize != null) {
        ...
        var dx = Math.max(
          0,
          (outline.outline.container.clientWidth / scale -
            (this.source.minimumGraphSize.width - 2 * pb.x)) /
            2,
        );
        var dy = Math.max(
          0,
          (outline.outline.container.clientHeight / scale -
            (this.source.minimumGraphSize.height - 2 * pb.y)) /
            2,
        );
        ...
        try {
          ...
          req.onsuccess = function (e) {
            ...
            var temp = {
              data: {
                type: 'draft',
                created: 1607343992029,
                modified: 1607344069929,
                data:
                  '<mxfile host="localhost" modified="2020-12-07T12:27:49.931Z" agent="5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.66 Safari/537.36" etag="0qNZf31FybfwgL2tJ1lD" version="@DRAWIO-VERSION@"><diagram id="qhYVMg6a4_YdBo9QcgAd" name="Page-1">ddHNEoIgEADgp+Gu7PR3NqtLJw+dGdmEGXQdpNF6+nTAjLFOLN8uLD8Msno4W9GqK0k0jCdyYHBknKew2YzDJE8vkHIPldUyFC1Q6BcGTII+tMQuKnRExuk2xpKaBksXmbCW+rjsTibu2ooKV1CUwqz1pqVTXvd8t/gFdaXmzun24DO1mIvDTTolJPVfBDmDzBI5H9VDhmZ6vPld/LrTn+znYBYb92PBGCx7j5PohyB/Aw==</diagram></mxfile>',
                title: 'Untitled Diagram',
              },
              key: '.draft_-o-EqlGnRRupDn_MtX31',
            };
...
var CommentsWindow = function (editorUi, x, y, w, h, saveCallback) {
    ...
    if (!readOnly && !comment.isLocked && level == 0) {
      ...
      function toggleResolve(evt) {
        function doToggle() {
          ...
          var replies = collectReplies(comment).replies;
          var color =
            uiTheme == 'dark' ? 'transparent' : comment.isResolved ? 'ghostWhite' : 'white';
  ...
  resolvedLink.innerHTML =
    '<img src="' + IMAGE_PATH + '/check.png" style="width: 16px; padding: 2px;">';
  ...
  if (editorUi.commentsRefreshNeeded()) {
    ...
    refreshLink.innerHTML =
      '<img src="' + IMAGE_PATH + '/update16.png" style="width: 16px; padding: 2px;">';
...
EditorUi.initMinimalTheme = function () {
  ...
  function toggleFormat(ui, visible) {
    ...
    if (ui.formatWindow == null) {
      ui.formatWindow = new WrapperWindow(
        ...
        56,
        240,
        Math.min(566, graph.container.clientHeight - 10),
        function (container) {
      ...
      ui.formatWindow.window.setVisible(
        visible != null ? visible : !ui.formatWindow.window.isVisible(),
      );
    }
  ...
  function toggleShapes(ui, visible) {
    ...
    if (ui.sidebarWindow == null) {
      ...
      ui.sidebarWindow = new WrapperWindow(
        ui,
        mxResources.get('shapes'),
        10,
        56,
        w - 6,
        Math.min(650, graph.container.clientHeight - 30),
        function (container) {
          var div = document.createElement('div');
          div.style.cssText =
            'position:absolute;left:0;right:0;border-top:1px solid lightgray;' +
          ...
          function addMenu(id, label) {
            ...
            elt.style.cssText =
              'position:absolute;border-top:1px solid lightgray;width:50%;' +
          ...
          if (
            ...
            if (ui.actions.get('newLibrary') != null) {
              var div = document.createElement('div');
              div.style.cssText =
                'position:absolute;left:0px;width:50%;border-top:1px solid lightgray;' +
              ...
              var div = document.createElement('div');
              div.style.cssText =
                'position:absolute;left:50%;width:50%;border-top:1px solid lightgray;' +
      ...
      ui.sidebarWindow.window.setVisible(
        visible != null ? visible : !ui.sidebarWindow.window.isVisible(),
      );
    }
  ...
  Editor.checkmarkImage = Graph.createSvgImage(
    22,
    18,
    '<path transform="translate(4 0)" d="M7.181,15.007a1,1,0,0,1-.793-0.391L3.222,10.5A1,1,0,1,1,4.808,9.274L7.132,12.3l6.044-8.86A1,1,0,1,1,14.83,4.569l-6.823,10a1,1,0,0,1-.8.437H7.181Z" fill="' +
      fill +
      '"/>',
  ).src;
  ...
  App.prototype.updateUserElement = function () {
    ...
    if (this.userElement != null) {
      ...
      elt.style.cssText =
        'position:relative;margin-right:4px;cursor:pointer;display:' + elt.style.display;
  ...
  App.prototype.updateButtonContainer = function () {
    ...
    if (this.shareButton != null) {
      ...
      elt.style.cssText =
        'display:inline-block;position:relative;box-sizing:border-box;margin-right:4px;cursor:pointer;';
      elt.className = 'geToolbarButton';
      elt.innerHTML = '';
  ...
  Menus.prototype.createPopupMenu = function (menu, cell, evt) {
    ...
    if (graph.getSelectionCount() == 1) {
      ...
      this.addMenuItems(
        menu,
        ['editTooltip', '-', 'editStyle', /* 'editGeometry', */ '-'],
        null,
        evt,
      );
  ...
  EditorUi.prototype.toggleFormatPanel = function (visible) {
    if (this.formatWindow != null) {
      this.formatWindow.window.setVisible(
  ...
  Menus.prototype.init = function () {
    ...
    ui.actions.put(
      'toggleFormat',
      new Action(mxResources.get('format') + '...', function () {
        toggleFormat(ui);
      }),
    );
        ...
        mxUtils.bind(this, function (menu, parent) {
          ...
          if (mxClient.IS_CHROMEAPP || EditorUi.isElectronApp) {
            ui.menus.addMenuItems(
              menu,
              ['new', 'open', '-', 'synchronize', '-', 'save', 'saveAs', '-'],
              parent,
            );
          ...
          if (file != null && ui.fileNode != null) {
            var filename = file.getTitle() != null ? file.getTitle() : ui.defaultFilename;
    ...
    this.put(
      ...
      new Menu(
        mxUtils.bind(this, function (menu, parent) {
          ui.menus.addMenuItems(
            menu,
            ['grid', 'guides', 'ruler', '-', 'connectionArrows', 'connectionPoints', '-'],
            parent,
          );

          if (typeof MathJax !== 'undefined') {
            var item = ui.menus.addMenuItem(menu, 'mathematicalTypesetting', parent);
            ui.menus.addLinkToItem(
              item,
  ...
  EditorUi.prototype.init = function () {
    ...
    var div = document.createElement('div');
    div.style.cssText =
      'position:absolute;left:0px;right:0px;top:0px;overflow-y:auto;overflow-x:hidden;';
    ...
    menubar.style.cssText =
      'position:absolute;left:0px;right:0px;top:0px;height:30px;padding:8px;border-bottom:1px solid lightgray;background-color:#ffffff;text-align:left;white-space:nowrap;';
    ...
    ui.buttonContainer.style.cssText =
      'position:absolute;right:0px;padding-right:34px;top:10px;' +
    ...
    ui.tabContainer.style.cssText =
      'position:absolute;left:0px;right:0px;bottom:0px;height:30px;white-space:nowrap;' +
      ...
      ui.setGraphEnabled = function () {
        ...
        if (this.tabContainer != null) {
          ...
          this.diagramContainer.style.bottom =
            this.tabContainer.style.visibility != 'hidden' ? this.tabContainerHeight + 'px' : '0px';
        }
      };
    }
    ...
    function refreshMenu() {
      ...
      createGroup(
        [
          ...
          addMenuItem(
            ...
            null,
            mxResources.get('shapes'),
            ui.actions.get('image'),
            small
              ? 'data:image/svg+xml;base64,'
              : null,
          ),
          addMenuItem(
            mxResources.get('format'),
            ui.actions.get('toggleFormat').funct,
            null,
            mxResources.get('format') + ' (' + ui.actions.get('formatPanel').shortcut + ')',
            ui.actions.get('image'),
            small
      ...
      createGroup(
        [
          ...
          addMenuItem(
            ...
            null,
            mxResources.get('delete'),
            ui.actions.get('delete'),
            small
              ? 'data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIyNCIgaGVpZ2h0PSIyNCIgdmlld0JveD0iMCAwIDI0IDI0Ij48cGF0aCBkPSJNNiAxOWMwIDEuMS45IDIgMiAyaDhjMS4xIDAgMi0uOSAyLTJWN0g2djEyek0xOSA0aC0zLjVsLTEtMWgtNWwtMSAxSDV2MmgxNFY0eiIvPjwvc3ZnPg=='
              : null,
          ),
        ],
        small ? 60 : null,
      ...
      if (iw >= 411) {
        ...
        var undoElt = addMenuItem(
          '',
          undoAction.funct,
          null,
          mxResources.get('undo') + ' (' + undoAction.shortcut + ')',
          undoAction,
          'data:image/svg+xml;base64,',
        );
        var redoElt = addMenuItem(
          '',
          redoAction.funct,
          null,
          mxResources.get('redo') + ' (' + redoAction.shortcut + ')',
          redoAction,
          ...
          createGroup(
            [
              addMenuItem(
                ...
                true,
                mxResources.get('fit') + ' (' + Editor.ctrlKey + '+H)',
                resetViewAction,
      ...
      if (langMenu != null && !mxClient.IS_CHROMEAPP && !EditorUi.isElectronApp && iw >= 600) {
        if (langMenuElt == null) {
