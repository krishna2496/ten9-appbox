...
(function () {
  ...
  Editor.prototype.libraryFileTypes = [
    { description: 'Library (.drawiolib, .xml)', extensions: ['drawiolib', 'xml'] },
  ];
  ...
  Editor.commonVertexProperties = [
    { type: 'separator' },
    {
      ...
      isVisible: function (state, format) {
        ...
        return (
          state.vertices.length == 1 && state.edges.length == 0 && graph.isTable(state.vertices[0])
        );
      },
    },
    {
    ...
    },
    {
      ...
      isVisible: function (state, format) {
        return (
          state.vertices.length > 0 && format.editorUi.editor.graph.isContainer(state.vertices[0])
        );
      },
    },
  ].concat(Editor.commonProperties);
  ...
  (function () {
    ...
    RoughCanvas.prototype.getStyle = function (stroke, fill) {
      ...
      if (stroke) {
        style.stroke =
          this.canvas.state.strokeColor === 'none' ? 'transparent' : this.canvas.state.strokeColor;
      } else {
        delete style.stroke;
      }
      ...
      if (fill) {
        ...
        gradient =
          this.canvas.state.gradientColor === 'none' ? null : this.canvas.state.gradientColor;
      } else {
        style.fill == '';
      }
      ...
      if (fillStyle == 'auto') {
        ...
        fillStyle =
          style.fill != null &&
          (gradient != null || (bg != null && style.fill.toLowerCase() == bg.toLowerCase()))
            ? 'solid'
            : defs['fillStyle'];
      }
    ...
    mxShape.prototype.paint = function (c) {
      ...
      if (this.style != null) {
        ...
        if (this.state != null && fillStyle == 'auto') {
          ...
          if (
            this.fill != null &&
            (this.gradient != null || (bg != null && this.fill.toLowerCase() == bg.toLowerCase()))
          ) {
            fillStyle = 'solid';
          }
        }
    ...
    if (node != null && !allowMxFile) {
      ...
      if (node.nodeName == 'diagram') {
        ...
        if (diagrams.length > 0) {
          diagramNode =
            diagrams[Math.max(0, Math.min(diagrams.length - 1, urlParams['page'] || 0))];
        }
      }
        ...
        mxUtils.bind(this, function (pos, type, length) {
          ...
          if (type == 'zTXt') {
            ...
            if (value.substring(0, idx) == 'mxGraphModel') {
              ...
              var xmlData = pako
                .inflateRaw(value.substring(idx + 2), { to: 'string' })
                .replace(/\+/g, ' ');
  ...
  Editor.configure = function (config, untrusted) {
    if (config != null) {
      ...
      ColorDialog.prototype.presetColors =
        config.presetColors || ColorDialog.prototype.presetColors;
      ColorDialog.prototype.defaultColors =
        config.defaultColors || ColorDialog.prototype.defaultColors;
      StyleFormatPanel.prototype.defaultColorSchemes =
        config.defaultColorSchemes || StyleFormatPanel.prototype.defaultColorSchemes;
      Graph.prototype.defaultEdgeLength =
        config.defaultEdgeLength || Graph.prototype.defaultEdgeLength;
      DrawioFile.prototype.autosaveDelay =
        config.autosaveDelay || DrawioFile.prototype.autosaveDelay;
      ...
      if (config.customColorSchemes != null) {
        StyleFormatPanel.prototype.defaultColorSchemes = config.customColorSchemes.concat(
          StyleFormatPanel.prototype.defaultColorSchemes,
        );
      }
  ...
  Editor.guid = function (length) {
    ...
    for (var i = 0; i < len; i++) {
      rtn.push(
        Editor.GUID_ALPHABET.charAt(Math.floor(Math.random() * Editor.GUID_ALPHABET.length)),
      );
    }
  ...
  Editor.prototype.resetGraph = function () {
    ...
    mxClient.NO_FO =
      this.graph.mathEnabled && !this.useForeignObjectForMath ? true : this.originalNoForeignObject;
  ...
  Editor.prototype.updateGraphComponents = function () {
    ...
    mxClient.NO_FO =
      this.graph.mathEnabled && !this.useForeignObjectForMath && Editor.MathJaxRender != null
        ? true
        : this.originalNoForeignObject;
  ...
  Editor.initMath = function (src, config) {
    ...
    var font = urlParams['math-font'] != null ? decodeURIComponent(urlParams['math-font']) : 'TeX';
      ...
      config != null
        ...
        : {
            jax: ['input/TeX', 'input/MathML', 'input/AsciiMath'].concat([
              urlParams['math-output'] == 'html' ? 'output/HTML-CSS' : 'output/SVG',
            ]),
            ...
            img.onload = mxUtils.bind(this, function () {
              try {
                ...
                if (grid) {
                  ...
                  var gridImage = btoa(
                    unescape(encodeURIComponent(view.createSvgGrid(view.gridColor))),
                  );
    ...
    do {
      ...
      if (chunk == 'IDAT') {
        ...
        if (type == 'pHYs' && key == 'dpi') {
          ...
          var chunkData =
            key + String.fromCharCode(0) + (type == 'zTXt' ? String.fromCharCode(0) : '') + value;
        }
  ...
  if (window.StyleFormatPanel != null) {
    ...
    StyleFormatPanel.prototype.defaultColorSchemes = [
      ...
      [
        ...
        { fill: '#fa6800', stroke: '#C73500', font: '#ffffff' },
        { fill: '#f0a30a', stroke: '#BD7000', font: '#ffffff' },
        { fill: '#e3c800', stroke: '#B09500', font: '#ffffff' },
    ...
    StyleFormatPanel.prototype.init = function () {
      ...
      if (Editor.enableCustomProperties) {
        ...
        if (
          ...
          Object.getOwnPropertyNames(properties).length > 0
        ) {
    ...
    StyleFormatPanel.prototype.addStyleOps = function (div) {
      ...
      btn.setAttribute('title', mxResources.get('copyStyle') + ' (Ctrl+Shift+C)');
      ...
      btn.setAttribute('title', mxResources.get('pasteStyle') + ' (Ctrl+Shift+V)');
      btn.style.marginBottom = '2px';
      btn.style.width = '100px';
    ...
    StyleFormatPanel.prototype.addProperties = function (div, properties, state) {
      ...
      function createColorBtn(pName, pValue, prop) {
        ...
        clrDiv.style.background =
          !pValue || pValue == 'none' ? "url('" + Dialog.prototype.noColorImage + "')" : pValue;
        ...
        btn = mxUtils.button(
          ...
          mxUtils.bind(that, function (evt) {
            this.editorUi.pickColor(pValue, function (color) {
              clrDiv.style.background =
                color == 'none' ? "url('" + Dialog.prototype.noColorImage + "')" : color;
      ...
      function createPropertyRow(pName, pValue, prop, isOdd, flipBkg) {
        ...
        row.className =
          'gePropRow' + (flipBkg ? 'Dark' : '') + (isOdd ? 'Alt' : '') + ' gePropNonHeaderRow';
          ...
          mxEvent.addListener(
            ...
            mxUtils.bind(that, function () {
              ...
              for (var i = 0; i < pEnumList.length; i++) {
                ...
                opElem.innerHTML = mxUtils.htmlEntities(
          ...
          mxEvent.addListener(
            ...
            mxUtils.bind(that, function () {
              ...
              function setInputVal() {
                ...
                var newVal = mxUtils.htmlEntities(
      ...
      for (var key in properties) {
        ...
        if (prop.type == 'separator') {
          ...
          prop.size =
            parseInt(state.style[prop.sizeProperty] || properties[prop.sizeProperty].defVal) || 0;
    ...
    StyleFormatPanel.prototype.addEditOps = function (div) {
      ...
      if (this.editorUi.editor.graph.getSelectionCount() == 1) {
        ...
        btn.setAttribute('title', mxResources.get('editStyle') + ' (Ctrl+E)');
  ...
  Graph.processFontAttributes = function (elt) {
    ...
    for (var i = 0; i < elts.length; i++) {
      ...
      if (url != null) {
        var name =
          elts[i].nodeName == 'FONT' ? elts[i].getAttribute('face') : elts[i].style.fontFamily;
      ...
      if (style != null) {
        if (style['childLayout'] == 'rack') {
          ...
          if (style['rackUnitSize'] != null) {
            ...
            rackLayout.gridSize =
              typeof mxRackContainer !== 'undefined' ? mxRackContainer.unitSize : unitSize;
          }
          ...
          tableLayout.equalColumns =
            mxUtils.getValue(style, 'equalColumns', tableLayout.colPercentages ? '0' : '1') == '1';
          tableLayout.equalRows =
            mxUtils.getValue(style, 'equalRows', tableLayout.rowPercentages ? '0' : '1') == '1';
          ...
          tableLayout.autoAddRow =
            mxUtils.getValue(style, 'autoAddRow', tableLayout.autoAddCol ? '0' : '1') == '1';
  ...
  Graph.prototype.isFastZoomEnabled = function () {
    return (
      graphIsFastZoomEnabled.apply(this, arguments) && (!this.shadowVisible || !mxClient.IS_SF)
    );
  };
  ...
  mxGraphView.prototype.validateBackgroundPage = function () {
    ...
    if (mxClient.IS_GC && this.getDrawPane() != null) {
      ...
      if (
        this.graph.mathEnabled &&
        !mxClient.NO_FO &&
        (this.webKitForceRepaintNode == null || this.webKitForceRepaintNode.parentNode == null) &&
  ...
  Graph.prototype.getCellsForTags = function (tagList, cells, propertyName, includeLayers) {
    ...
    if (tagList != null) {
      ...
      for (var i = 0; i < cells.length; i++) {
        if (
          (includeLayers && this.model.getParent(cells[i]) == this.model.root) ||
          this.model.isVertex(cells[i]) ||
          this.model.isEdge(cells[i])
        ) {
          var tags =
            cells[i].value != null && typeof cells[i].value == 'object'
  ...
  // TEN9: add more shapes js file import
  ...
  mxStencilRegistry.libraries['arrows2'] = [
    //SHAPES_PATH + '/mxArrows.js'
  ];
  ...
  mxStencilRegistry.libraries['dfd'] = [
    //SHAPES_PATH + '/mxDFD.js'
  ];
  mxStencilRegistry.libraries['er'] = [
    //SHAPES_PATH + '/er/mxER.js'
  ];
  ...
  mxStencilRegistry.libraries['ios'] = [
    // SHAPES_PATH + '/mockup/mxMockupiOS.js'
  ];
  ...
  mxStencilRegistry.libraries['archimate'] = [
    //SHAPES_PATH + '/mxArchiMate.js'
  ];
  mxStencilRegistry.libraries['archimate3'] = [
    //SHAPES_PATH + '/mxArchiMate3.js'
  ];
  mxStencilRegistry.libraries['sysml'] = [
    //SHAPES_PATH + '/mxSysML.js'
  ];
  ...
  PrintDialog.prototype.create = function (editorUi, titleText) {
    ...
    pagesSection.style.cssText =
      'border-bottom:1px solid lightGray;padding-bottom:12px;margin-bottom:12px;';
    ...
    spanFitRadio.style.cssText =
      'display:inline-block;height:100%;vertical-align:top;padding-top:2px;';
        ...
        if (pv == null) {
          ...
          if (typeof MathJax !== 'undefined') {
            ...
            pv.renderPage = function (w, h, dx, dy, content, pageNumber) {
              ...
              mxClient.NO_FO =
                this.graph.mathEnabled && !editorUi.editor.useForeignObjectForMath
                  ? true
                  : editorUi.editor.originalNoForeignObject;
