...
App.main = function (createUi) {
    ...
    if (
      ...
      if (scripts != null && scripts.length > 0) {
        ...
        if (CryptoJS.MD5(content).toString() != 'b02227617087e21bd49f2faa15164112') {
          ...
          // TEN9: no alerts needed for this test project
  ...
  function doLoad(bundle) {
    ...
    mxUtils.getAll(
      urlParams['dev'] != '1'
        ? [bundle]
        : [bundle, STYLE_PATH + '/default.xml', STYLE_PATH + '/dark-default.xml'],
      function (xhr) {
    ...
    try {
      if (mxSettings.settings != null) {
        document.body.style.backgroundColor =
          uiTheme == 'dark' || mxSettings.settings.darkMode ? '#2a2a2a' : '#ffffff';
...
App.prototype.defaultUserPicture =
  'https://lh3.googleusercontent.com/-HIzvXUy6QUY/AAAAAAAAAAI/AAAAAAAAAAA/giuR7PQyjEk/photo.jpg?sz=64';
        ...
        if (
          ...
          if (urlParams['open'] != null && window.history && window.history.replaceState) {
            window.history.replaceState(
              null,
              null,
              window.location.pathname + this.getSearch(['open']),
            );
...
try {
  ...
  // TEN9: comment onerror() as it doesn't exists.
  //onerror();
}
          ...
          if (this.userPanel.parentNode != null) {
            ...
            if (this.drive != null) {
              ...
              if (driveUsers.length > 0) {
                ...
                driveUserTable.style.cssText =
                  'font-size:10pt;padding: 20px 0 0 0;min-width: 300px;border-spacing: 0;';
            ...
            var addUser = mxUtils.bind(this, function (user, logo, logout, label) {
              if (user != null) {
                ...
                userTable.style.cssText =
                  'font-size:10pt;padding:' + (connected ? '10' : '20') + 'px 20px 10px 10px;';

                userTable.innerHTML +=
                  '<tr><td valign="top">' +
                  (logo != null
                    ? '<img style="margin-right:6px;" src="' +
                      logo +
