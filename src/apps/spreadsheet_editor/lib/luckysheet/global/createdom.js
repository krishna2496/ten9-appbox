...
export default function luckysheetcreatedom(colwidth, rowheight, data, menu, title) {
    ...
    let addControll = 
    /* TEN9 : value="100" and margin-right:5px;margin-left:5px;color:#000000;font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif; added  to make it look like google sheet
    '<button id="luckysheet-bottom-add-row" class="btn btn-default">'+locale_info.add+'</button><input id="luckysheet-bottom-add-row-input" type="text" class="luckysheet-datavisual-config-input luckysheet-mousedown-cancel" placeholder="100"><span style="font-size: 14px;">'+ locale_info.row +'</span><span style="font-size: 14px;color: #9c9c9c;">('+locale_info.addLast+')</span>'; */
    '<button id="luckysheet-bottom-add-row" class="btn btn-default">'+locale_info.add+'</button><input id="luckysheet-bottom-add-row-input" value="100" type="text" class="luckysheet-datavisual-config-input luckysheet-mousedown-cancel" placeholder="100"><span style="font-size: 14px;">'+ locale_info.row +'</span><span style="font-size: 13px;color: #9c9c9c;margin-right:5px;margin-left:5px;color:#000000;font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;">'+locale_info.addLast+'</span>';
