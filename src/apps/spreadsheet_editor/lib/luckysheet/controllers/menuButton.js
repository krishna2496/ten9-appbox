...
const menuButton = {
    ...
    changeBackgroundColor:function(id) {
        ...
        if ( id == "#luckysheet-icon-fmt-other" || id == '#luckysheet-icon-paintformat' ||
            id == '#luckysheet-icon-zoom' || id == "#luckysheet-icon-font-family" ||
            id == '#luckysheet-icon-font-size' || id == "#luckysheet-icon-text-color-menu" ||
            id == '#luckysheet-icon-border-menu' || id == '#luckysheet-icon-merge-menu' ||
    ...
    initialMenuButton: function(){
        ...
        $("#luckysheet-icon-text-color-menu").click(function(){
            /* TEN9 : Background changes  */
            if($("#luckysheet-icon-text-color-menu").hasClass("luckysheet-toolbar-button-hover")) {
                $("#luckysheet-icon-text-color-menu").removeClass("luckysheet-toolbar-button-hover");
                return false;
            }
        ...
        $("#luckysheet-icon-cell-color-menu").click(function(){
            /* TEN9 : Background changes  */
            if($("#luckysheet-icon-cell-color-menu").hasClass("luckysheet-toolbar-button-hover")) {
                $("#luckysheet-icon-cell-color-menu").removeClass("luckysheet-toolbar-button-hover");
                return false;
            }
        ...
        $("#luckysheet-icon-font-size").click(function(){
            /* TEN9 : Background changes  */
            if($("#luckysheet-icon-font-size").hasClass("luckysheet-toolbar-button-hover")) {
                $("#luckysheet-icon-font-size").removeClass("luckysheet-toolbar-button-hover");
                return false;
            }
        ...
        $("#luckysheet-icon-border-menu").click(function(){
            /* TEN9 : Background changes  */
            if($("#luckysheet-icon-border-menu").hasClass("luckysheet-toolbar-button-hover")) {
                $("#luckysheet-icon-border-menu").removeClass("luckysheet-toolbar-button-hover");
                return false;
            }
            ...
            if($menuButton.length == 0){
                ...
                const locale_button = _locale.button;
                let itemdata = [
                    // TEN9 : <span class="material-icons">border_top</span> icon added
                    {"text": locale_border.borderTop, "value": "border-top", "example": '<div class="luckysheet-icon luckysheet-inline-block luckysheet-material-icon luckysheet-mousedown-cancel" style="user-select: none;opacity:1;"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-border-top iconfont luckysheet-iconfont-shangbiankuang" style="user-select: none;"><span class="material-icons">border_top</span></div> </div>'},
                    ...
                    {"text": locale_border.borderNone, "value": "border-none", "example": '<div class="luckysheet-icon luckysheet-inline-block luckysheet-material-icon luckysheet-mousedown-cancel" style="user-select: none;opacity:1;"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-border-none iconfont luckysheet-iconfont-wubiankuang" style="user-select: none;"><span class="material-icons">border_clear</span></div> </div>'},
                      // TEN9 : <span class="material-icons">border_all</span> icon added
                    {"text": locale_border.borderAll, "value": "border-all", "example": '<div class="luckysheet-icon luckysheet-inline-block luckysheet-material-icon luckysheet-mousedown-cancel" style="user-select: none;opacity:1;"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-border-all iconfont luckysheet-iconfont-quanjiabiankuang" style="user-select: none;"><span class="material-icons">border_all</span></div> </div>'},
                      // TEN9 : <span class="material-icons">border_outside</span> icon added
                    {"text": locale_border.borderOutside, "value": "border-outside", "example": '<div class="luckysheet-icon luckysheet-inline-block luckysheet-material-icon luckysheet-mousedown-cancel" style="user-select: none;opacity:1;"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-border-outside iconfont luckysheet-iconfont-sizhoujiabiankuang" style="user-select: none;"><span class="material-icons">border_outer</span></div> </div>'},
                    {"text": "", "value": "split", "example": ""},
                      // TEN9 : <span class="material-icons">border_inside</span> icon added
                    {"text": locale_border.borderInside, "value": "border-inside", "example": '<div class="luckysheet-icon luckysheet-inline-block luckysheet-material-icon luckysheet-mousedown-cancel" style="user-select: none;opacity:1;"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-border-inside iconfont luckysheet-iconfont-neikuangxian" style="user-select: none;"><span class="material-icons">border_inner</span></div> </div>'},
        ...
        $("#luckysheet-icon-merge-menu").click(function(){
            /* TEN9 : Background changes  */
            if($("#luckysheet-icon-merge-menu").hasClass("luckysheet-toolbar-button-hover")) {
                $("#luckysheet-icon-merge-menu").removeClass("luckysheet-toolbar-button-hover");
                return false;
            }
        ...
        $("#luckysheet-icon-align").click(function(){
            /* TEN9 : Background changes  */
            if ($("#luckysheet-icon-align").hasClass("luckysheet-toolbar-button-hover")) {
                $("#luckysheet-icon-align").removeClass("luckysheet-toolbar-button-hover");
                return false;
            }
        ...
        $("#luckysheet-icon-align-menu").click(function(){
            /* TEN9 : Background changes  */
            if($("#luckysheet-icon-align-menu").hasClass("luckysheet-toolbar-button-hover")) {
                $("#luckysheet-icon-align-menu").removeClass("luckysheet-toolbar-button-hover");
                return false;
            }
            ...
            if($menuButton.length == 0){
                ...
                let itemdata = [
                    /*  TEN9: <span class="material-icons">&#xe236;</span> added for better layout
                    ...
                    {"text": locale_align.left, "value": "left", "example": '<div class="luckysheet-icon luckysheet-inline-block" style="user-select: none;opacity:1;"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-align-left iconfont luckysheet-iconfont-wenbenzuoduiqi" style="user-select: none;"><span class="material-icons">format_align_left</span></div> </div>'},
                    /*  TEN9: <span class="material-icons">&#xe234;</span>  added for better layout
                    ...
                    {"text": locale_align.center, "value": "center", "example": '<div class="luckysheet-icon luckysheet-inline-block" style="user-select: none;opacity:1;"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-align-center iconfont luckysheet-iconfont-wenbenjuzhongduiqi" style="user-select: none;"><span class="material-icons">format_align_center</span></div> </div>'},
                    /*  TEN9: <span class="material-icons">&#xe237;</span>  added for better layout
                    ...
                    {"text": locale_align.right, "value": "right", "example": '<div class="luckysheet-icon luckysheet-inline-block" style="user-select: none;opacity:1;"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-align-right iconfont luckysheet-iconfont-wenbenyouduiqi" style="user-select: none;"><span class="material-icons">format_align_right</span></div> </div>'}
                ];
        ...
        $("#luckysheet-icon-valign-menu").click(function(){
            /* TEN9 : Background changes  */
            if($("#luckysheet-icon-valign-menu").hasClass("luckysheet-toolbar-button-hover")) {
                $("#luckysheet-icon-valign-menu").removeClass("luckysheet-toolbar-button-hover");
                return false;
            }
            ...
            if($menuButton.length == 0){
                let itemdata = [
                    ...
                    {"text": locale_align.middle, "value": "middle", "example": '<div class="luckysheet-icon luckysheet-inline-block" style="user-select: none;opacity:1;"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-valign-middle iconfont luckysheet-iconfont-shuipingduiqi" style="user-select: none;"><span class="material-icons" style="line-height: 0.9;">vertical_align_center</span></div> </div>'},
                    {"text": locale_align.bottom, "value": "bottom", "example": '<div class="luckysheet-icon luckysheet-inline-block" style="user-select: none;opacity:1;"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-valign-bottom iconfont luckysheet-iconfont-dibuduiqi" style="user-select: none;"><span class="material-icons">vertical_align_bottom</span></div> </div>'}
                ];
        ...
        $("#luckysheet-icon-textwrap-menu").click(function(){
            /* TEN9 : Background changes  */
            if($("#luckysheet-icon-textwrap-menu").hasClass("luckysheet-toolbar-button-hover")) {
                $("#luckysheet-icon-textwrap-menu").removeClass("luckysheet-toolbar-button-hover");
                return false;
            }
            ...
            if($menuButton.length == 0){
                ...
                let itemdata = [
                    // TEN9 : <i class="ten9-icon ten9-icon-wrap-overflow" style="font-size:16px"></i> ten9 icon added
                    {"text": locale_textWrap.overflow, "value": "overflow", "example": '<div class="luckysheet-icon luckysheet-inline-block" style="user-select: none;opacity:1;"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-textwrap-overflow iconfont luckysheet-iconfont-yichu1" style="user-select: none;"><i class="ten9-icon ten9-icon-wrap-overflow" style="font-size:16px"></i></div> </div>'},
        ...
        $("#luckysheet-icon-rotation-menu").click(function(){
            /* TEN9 : Background changes  */
            if($("#luckysheet-icon-rotation-menu").hasClass("luckysheet-toolbar-button-hover")) {
                $("#luckysheet-icon-rotation-menu").removeClass("luckysheet-toolbar-button-hover");
                return false;
            }
            ...
            if($menuButton.length == 0){
                ...
                let itemdata = [
                    /* TEN9 : rotation none icon added */
                    {"text": locale_rotation.none, "value": "none", "example": '<div class="luckysheet-icon luckysheet-inline-block" style="user-select: none;opacity:1;"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-rotation-none iconfont luckysheet-iconfont-wuxuanzhuang" style="user-select: none;line-height:1"><span class="material-icons">text_rotation_none</span></div> </div>'},
                    /* TEN9 : rotation angleup icon added */
                    {"text": locale_rotation.angleup, "value": "angleup", "example": '<div class="luckysheet-icon luckysheet-inline-block" style="user-select: none;opacity:1;"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-rotation-angleup iconfont luckysheet-iconfont-xiangshangqingxie" style="user-select: none;"><span class="material-icons">text_rotation_angleup</span></div> </div>'},
                    /* TEN9 : rotation angledown icon added */
                    {"text": locale_rotation.angledown, "value": "angledown", "example": '<div class="luckysheet-icon luckysheet-inline-block" style="user-select: none;opacity:1;"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-rotation-angledown iconfont luckysheet-iconfont-xiangxiaqingxie" style="user-select: none;"><span class="material-icons">text_rotation_angledown</span></div> </div>'},
                    /* TEN9 : rotation vertical icon added */
                    {"text": locale_rotation.vertical, "value": "vertical", "example": '<div class="luckysheet-icon luckysheet-inline-block" style="user-select: none;opacity:1;"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-rotation-vertical iconfont luckysheet-iconfont-shupaiwenzi" style="user-select: none;"><span class="material-icons">text_rotate_vertical</span></div> </div>'},
                    /* TEN9 : rotation up icon added added */
                    {"text": locale_rotation.rotationUp, "value": "rotation-up", "example": '<div class="luckysheet-icon luckysheet-inline-block" style="user-select: none;opacity:1;"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-rotation-rotation-up iconfont luckysheet-iconfont-wenbenxiangshang" style="user-select: none;"><span class="material-icons">text_rotate_up</span></div> </div>'},
                    /* TEN9 : rotation down icon added  */
                    {"text": locale_rotation.rotationDown, "value": "rotation-down", "example": '<div class="luckysheet-icon luckysheet-inline-block" style="user-select: none;opacity:1;"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-rotation-rotation-down iconfont luckysheet-iconfont-xiangxia90" style="user-select: none;"><span class="material-icons">text_rotation_down</span></div> </div>'},
                ];
        ...
        $("#luckysheet-icon-freezen-menu").click(function(){
            /* TEN9 : Background changes  */
            if($("#luckysheet-icon-freezen-menu").hasClass("luckysheet-toolbar-button-hover")) {
                $("#luckysheet-icon-freezen-menu").removeClass("luckysheet-toolbar-button-hover");
                return false;
            }
        ...
        $("#luckysheet-icon-autofilter").click(function(){
            /* TEN9 : Background changes  */
            if($("#luckysheet-icon-autofilter").hasClass("luckysheet-toolbar-button-hover")) {
                $("#luckysheet-icon-autofilter").removeClass("luckysheet-toolbar-button-hover");
                return false;
            }
        ...
        $("#luckysheet-icon-function-menu").click(function(){
            /* TEN9 : Background changes  */
            if($("#luckysheet-icon-function-menu").hasClass("luckysheet-toolbar-button-hover")) {
                $("#luckysheet-icon-function-menu").removeClass("luckysheet-toolbar-button-hover");
                return false;
            }
