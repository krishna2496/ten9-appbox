...
// TEN9: TODO: Get this functionality back in
...
// TEN9: Override tooltips on hover
...
Graph.prototype.getTooltipForCell = function (cell) {
  ...
  if (geo != null) {
    if (geo.sourcePoint != null) {
      tip +=
        'source=' + parseFloat(geo.sourcePoint.x) + ',' + parseFloat(geo.sourcePoint.y) + '<br>';
    }

    if (geo.targetPoint != null) {
      tip +=
        'target=' + parseFloat(geo.targetPoint.x) + ',' + parseFloat(geo.targetPoint.y) + '<br>';
    }
    ...
    if (state != null && state.absolutePoints != null) {
      ...
      for (var i = 0; i < state.absolutePoints.length; i++) {
        tip +=
          parseFloat(state.absolutePoints[i].x) + ',' + parseFloat(state.absolutePoints[i].y) + ';';
      }
      ...
      tip +=
        ...
        '<br>' +
        'w/h=' +
        parseFloat(geo.width) +
        'x' +
        parseFloat(geo.height);
