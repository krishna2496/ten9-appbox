...
(function () {
  ...
  mxShapeBasicRect2.prototype.strictDrawShape = function (c, x, y, w, h, os) {
    ...
    var strokeColor =
      os && os.strokeColor
        ? os.strokeColor
        : mxUtils.getValue(this.style, 'strokeColor', '#000000');
    var strokeWidth =
            ...
            function (bounds) {
              var size = Math.max(
                ...
                Math.min(
                  bounds.height,
                  parseFloat(
                    mxUtils.getValue(this.state.style, 'size', UmlLifeline.prototype.size),
                  ),
                ),
              );
            ...
            function (bounds) {
              ...
              var size =
                (Math.max(
                  ...
                  Math.min(
                    1,
                    mxUtils.getValue(this.state.style, 'size', CrossShape.prototype.size),
                  ),
                ) *
                  m) /
                2;
