  ...
  Sidebar.prototype.addThreatModelingPalette = function () {
    ...
    this.addPaletteFunctions('threatModeling', 'Threat Modeling', false, [
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'external entity', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'multi process', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
      ...
      this.createEdgeTemplateEntry(
        'endArrow=classic;html=1;fontColor=#FF3333;',
        w * 0.5,
        h * 0.5,
        '',
        'Data Flow',
      ...
      this.createEdgeTemplateEntry(
        'endArrow=classic;startArrow=classic;html=1;fontColor=#FF3333;',
        w * 0.5,
        h * 0.5,
        '',
        'Bidirectional Data Flow',
        null,
        dt + 'bidirectional data flow',
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'trust boundary', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        'shape=requiredInterface;html=1;verticalLabelPosition=bottom;dashed=1;strokeColor=#FF3333;strokeWidth=2;fillColor=none;fontColor=#FF3333;align=left;',
        w * 0.2,
        h * 3.3,
        '',
        'Trust Boundary',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'label', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'asset label', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'security control label', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'threat actor label', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        'text;html=1;strokeColor=#c0c0c0;fillColor=#ffffff;overflow=fill;rounded=0;shadow=1;labelBackgroundColor=#ffffff;fontColor=#000000;align=left;',
        w * 3.9,
        h * 1.1,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'asset table', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        'text;html=1;strokeColor=#c0c0c0;fillColor=#ffffff;overflow=fill;rounded=0;shadow=1;labelBackgroundColor=#ffffff;fontColor=#000000;align=left;',
        w * 3.65,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'threat actor table', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        'text;html=1;strokeColor=#c0c0c0;fillColor=#ffffff;overflow=fill;rounded=0;shadow=1;labelBackgroundColor=#ffffff;fontColor=#000000;align=left;',
        w * 3.65,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'security control table', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'note', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'and gate', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'or gate', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'leaf node', dt).join(' '),
      ),
    ]);
