...
const { mxCell, mxConstants, mxPoint } = require('../../jgraph/mxClient.js');
...
(function () {
  Sidebar.prototype.addDFDPalette = function () {
    ...
    var s2 =
      ...
      '=top;html=1;strokeWidth=2;shape=mxgraph.dfd.';
    var s3 =
      mxConstants.STYLE_VERTICAL_LABEL_POSITION +
      '=bottom;' +
      mxConstants.STYLE_VERTICAL_ALIGN +
      '=top;html=1;strokeWidth=2;shape=';
    ...
    this.addPaletteFunctions('dfd', 'Data Flow Diagram', false, [
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'start end', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'activity process entity external interactor', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'decision entity relationship', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'product result', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        'shape=manualInput;whiteSpace=wrap;html=1;dashed=0;size=15;',
        w,
        h * 0.5,
        '',
        'Order / Command',
        null,
        null,
        this.getTagsForStencil(gn, 'order command', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'information data carrier sop', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        'triangle;whiteSpace=wrap;html=1;dashed=0;direction=south;',
        w * 0.6,
        h * 0.6,
        '',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'final report archive', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'check', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'check2',
        w,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'data process', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        'shape=ellipse;html=1;dashed=0;whitespace=wrap;aspect=fixed;perimeter=ellipsePerimeter;',
        w * 0.6,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'multiple process start state multi', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'stop state', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'data store', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        'html=1;dashed=0;whitespace=wrap;shape=partialRectangle;right=0;',
        w,
        h * 0.3,
        '',
        'Data Store',
      ...
      this.createVertexTemplateEntry(
        s +
          'dataStoreID;align=left;spacingLeft=3;points=[[0,0],[0.5,0],[1,0],[0,0.5],[1,0.5],[0,1],[0.5,1],[1,1]];',
        w,
        h * 0.3,
        '',
        'Data Store with ID',
        null,
        null,
        this.getTagsForStencil(gn, 'data store with id identification', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'entity', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'oval process', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
      ...
      this.addEntry(dt + 'external entity', function () {
        ...
        var item1 = new mxCell(
          ...
          'autosize=1;part=1;resizable=0;strokeColor=inherit;fillColor=inherit;gradientColor=inherit;',
        );
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'loop', dt).join(' '),
      ),
