...
const { mxCell, mxConstants, mxGeometry, mxPoint, mxUtils } = require('../../jgraph/mxClient.js');
...
(function () {
  ...
  Sidebar.prototype.addSysMLModelElementsPalette = function (expand) {
    ...
    var fns = [
      ...
      this.createVertexTemplateEntry(
        s +
          'composite;symbol0=folder;fontStyle=1;spacingTop=15;tabWidth=80;tabHeight=20;tabPosition=left;symbol1=triangle;symbol1Width=7;symbol1Height=10;symbol1Align=right;symbol1VerticalAlign=top;symbol1Spacing=8;symbol1VSpacing=25;symbol1Direction=north;strokeWidth=2;whiteSpace=wrap;align=center;',
        160,
        90,
        'Model',
        'Model',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'model').join(' '),
      ),

      this.addEntry(dt + 'package diagram', function () {
        var bg = new mxCell(
          '<p style="margin:0px;margin-top:4px;margin-left:10px;text-align:left;"><b>pkg</b>   Name</p>',
          new mxGeometry(0, 0, 300, 120),
          s +
            'package;xSize=90;align=left;spacingLeft=10;overflow=fill;strokeWidth=1;recursiveResize=0;',
        );
        bg.vertex = true;
        var cardCell2 = new mxCell(
          '\nSubpackage1',
          new mxGeometry(15, 60, 100, 50),
          inh +
            'shape=folder;spacingLeft=10;tabWidth=40;tabHeight=14;tabPosition=left;fontSize=10;html=1;whiteSpace=wrap;',
        );
        cardCell2.vertex = true;
        bg.insert(cardCell2);
        var cardCell3 = new mxCell(
          '\nSubpackage2',
          new mxGeometry(190, 20, 100, 50),
          inh +
            'shape=folder;spacingLeft=10;tabWidth=40;tabHeight=14;tabPosition=left;fontSize=10;html=1;whiteSpace=wrap;',
        );
      ...
      this.addEntry(dt + 'package tab', function () {
        var bg = new mxCell(
          'Package1',
          new mxGeometry(0, 0, 300, 120),
          'shape=folder;xSize=90;align=left;spacingLeft=10;align=left;verticalAlign=top;spacingLeft=5;spacingTop=-4;tabWidth=70;tabHeight=20;tabPosition=left;html=1;strokeWidth=1;recursiveResize=0;',
        );
        bg.vertex = true;
        var cardCell2 = new mxCell(
          '\nSubpackage1',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'package name').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'problem').join(' '),
      ),
      this.createVertexTemplateEntry(
        'shape=note;size=15;align=left;spacingLeft=10;html=1;whiteSpace=wrap;',
        160,
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'rationale').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'view name').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'view').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'viewpoint').join(' '),
      ),
      this.createEdgeTemplateEntry(
        ...
        'Conform',
        null,
        this.getTagsForStencil(gn, '', dt + 'conform').join(' '),
      ),
      this.createEdgeTemplateEntry(
        'edgeStyle=none;html=1;endArrow=open;endSize=12;dashed=1;verticalAlign=bottom;',
        160,
        ...
        'Dependency',
        null,
        this.getTagsForStencil(gn, '', dt + 'dependency').join(' '),
      ),
      this.createEdgeTemplateEntry(
        'edgeStyle=none;html=1;endArrow=open;endSize=12;dashed=1;verticalAlign=bottom;',
        160,
        ...
        null,
        this.getTagsForStencil(gn, '', dt + 'public package import').join(' '),
      ),
      this.createEdgeTemplateEntry(
        'edgeStyle=none;html=1;endArrow=open;endSize=12;dashed=1;verticalAlign=bottom;',
        160,
        ...
        null,
        this.getTagsForStencil(gn, '', dt + 'private package import').join(' '),
      ),
      this.createEdgeTemplateEntry(
        'edgeStyle=none;html=1;' +
          mxConstants.STYLE_STARTARROW +
          '=sysMLPackCont;startSize=12;' +
        ...
        'Package Containment',
        null,
        this.getTagsForStencil(gn, '', dt + 'package containment').join(' '),
      ),
      this.createEdgeTemplateEntry(
        ...
        'Realization',
        null,
        this.getTagsForStencil(gn, '', dt + 'realization').join(' '),
      ),
      this.createEdgeTemplateEntry(
        'edgeStyle=none;html=1;endArrow=open;endSize=12;dashed=1;verticalAlign=bottom;',
        160,
        ...
        'Refine',
        null,
        this.getTagsForStencil(gn, '', dt + 'refine').join(' '),
      ),
    ];
  ...
  Sidebar.prototype.addSysMLBlocksPalette = function (expand) {
    ...
    var fns = [
      this.addEntry(dt + 'block definition diagram', function () {
        var bg = new mxCell(
          '<p style="margin:0px;margin-top:4px;margin-left:10px;text-align:left;"><b>bdd</b>   Namespace1</p>',
          new mxGeometry(0, 0, 300, 100),
          s + 'package;labelX=120;align=left;spacingLeft=10;overflow=fill;recursiveResize=0;',
        );
        bg.vertex = true;
        var cardCell2 = new mxCell(
          'Block1',
          new mxGeometry(15, 30, 100, 50),
          inh + 'shape=rect;fontStyle=1;html=1;whiteSpace=wrap;align=center;',
        );
        cardCell2.vertex = true;
        bg.insert(cardCell2);
        var cardCell3 = new mxCell(
        ...
        assoc.edge = true;
        bg.insert(assoc);
        var sourceLabel = new mxCell(
          '1',
          new mxGeometry(-1, 0, 0, 0),
          'resizable=0;html=1;align=left;verticalAlign=top;labelBackgroundColor=none;fontSize=10',
        );
        sourceLabel.geometry.relative = true;
        sourceLabel.setConnectable(false);
        sourceLabel.vertex = true;
        assoc.insert(sourceLabel);
        var targetLabel = new mxCell(
          '0..*',
          new mxGeometry(1, 0, 0, 0),
          'resizable=0;html=1;align=right;verticalAlign=top;labelBackgroundColor=none;fontSize=10',
        );
      ...
      this.createVertexTemplateEntry(
        'shape=rect;html=1;overflow=fill;verticalAlign=top;align=left;whiteSpace=wrap;',
        220,
        340,
        '<p style="margin:0px;margin-top:4px;text-align:center;">' +
          '&lt;&lt;block&gt;&gt;<br/>' +
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'block').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'actor').join(' '),
      ),
      this.createVertexTemplateEntry(
        'shape=rect;html=1;overflow=fill;whiteSpace=wrap;align=center;',
        160,
        80,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'value type valuetype').join(' '),
      ),
      this.createVertexTemplateEntry(
        'shape=rect;html=1;overflow=fill;whiteSpace=wrap;',
        200,
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'enumeration').join(' '),
      ),
      this.createVertexTemplateEntry(
        'shape=rect;html=1;overflow=fill;whiteSpace=wrap;align=center;',
        80,
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'abstract definition').join(' '),
      ),
      this.createVertexTemplateEntry(
        'shape=rect;html=1;overflow=fill;whiteSpace=wrap;align=center;',
        80,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'stereotype property compartment').join(' '),
      ),
      ...
      this.addEntry(dt + 'namespace compartment', function () {
        var bg = new mxCell(
          ...
          new mxGeometry(0, 0, 300, 120),
          'shape=rect;align=left;html=1;overflow=fill;whiteSpace=wrap;strokeWidth=1;recursiveResize=0;',
        );
        bg.vertex = true;
        var cardCell2 = new mxCell(
          'Block2',
          new mxGeometry(15, 60, 100, 50),
          inh + 'shape=rect;html=1;fontStyle=1;whiteSpace=wrap;align=center;',
        );
        cardCell2.vertex = true;
        bg.insert(cardCell2);
        var cardCell3 = new mxCell(
          'Block3',
          new mxGeometry(190, 60, 100, 50),
          inh + 'shape=rect;html=1;fontStyle=1;whiteSpace=wrap;align=center;',
        );
        cardCell3.vertex = true;
        bg.insert(cardCell3);
        var assoc = new mxCell(
          ...
          new mxGeometry(0, 0, 0, 0),
          inh +
            'align=right;verticalAlign=bottom;endArrow=none;startArrow=diamondThin;startSize=14;startFill=1;edgeStyle=none;html=1;labelBackgroundColor=none;',
        );
        assoc.geometry.relative = true;
        assoc.geometry.x = 1;
        assoc.edge = true;
      ...
      this.addEntry(dt + 'structure compartment', function () {
        ...
        targetLabel.vertex = true;
        assoc.insert(targetLabel);
        var targetLabel2 = new mxCell(
          '1',
          new mxGeometry(1, 0, 0, 0),
          'resizable=0;html=1;align=right;verticalAlign=bottom;labelBackgroundColor=none;fontSize=10',
        );
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'unit').join(' '),
      ),
      this.createVertexTemplateEntry(
        'shape=rect;html=1;overflow=fill;whiteSpace=wrap;',
        200,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'quantity kind').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'instance specification').join(' '),
      ),
      this.addDataEntry(
        dt + 'instance specification',
        280,
        30,
        'Instance Specification',
      ...
      this.addEntry(dt + 'instance specification', function () {
        var bg = new mxCell(
          '<p style="margin:0px;margin-top:5px;text-align:center;text-decoration:underline;">' +
            ': Type1<hr/></p>',
          new mxGeometry(0, 0, 200, 180),
          'shape=rect;html=1;overflow=fill;whiteSpace=wrap;strokeWidth=1;recursiveResize=0;',
        );
        bg.vertex = true;
        var cardCell2 = new mxCell(
          '<p style="margin:0px;margin-top:5px;text-align:center;text-decoration:underline;">' +
            'instance1 / property1: Type2<hr/></p>',
          new mxGeometry(10, 30, 180, 140),
          inh + 'shape=rect;html=1;overflow=fill;whiteSpace=wrap;',
        );
        cardCell2.vertex = true;
        bg.insert(cardCell2);
        var cardCell3 = new mxCell(
      ...
      this.addDataEntry(
        dt + 'multibranch part association',
        250,
        50,
      ...
      this.addDataEntry(
        dt + 'multibranch shared association',
        250,
        50,
      ...
      this.createEdgeTemplateEntry(
        'edgeStyle=none;html=1;endSize=12;endArrow=block;endFill=0;',
        160,
        0,
        '',
        'Generalization',
        null,
        this.getTagsForStencil(gn, '', dt + 'generalization').join(' '),
      ),
      this.addDataEntry(
        dt + 'multibranch generalization',
        140,
        50,
      ...
      this.addDataEntry(
        dt + 'block namespace containment',
        140,
        70,
      ...
      this.addEntry(dt + 'participant property', function () {
        var cardCell = new mxCell(
          'Block2',
          new mxGeometry(0, 0, 50, 20),
          'shape=rect;html=1;strokeWidth=1;fontStyle=1;whiteSpace=wrap;align=center;',
        );
        cardCell.vertex = true;
        var cardCell2 = new mxCell(
          'Block1',
          new mxGeometry(350, 0, 50, 20),
          'shape=rect;html=1;strokeWidth=1;fontStyle=1;whiteSpace=wrap;align=center;',
        );
        cardCell2.vertex = true;
        var bg = new mxCell(
          ...
          new mxGeometry(20, 60, 360, 150),
          'shape=rect;html=1;strokeWidth=1;overflow=fill;whiteSpace=wrap;recursiveResize=0;',
        );
        bg.vertex = true;
        var cardCell4 = new mxCell(
          '<p style="margin:0px;margin-top:4px;text-align:center;">' +
            ...
            '<b>p2 : Block 2</b></p>',
          new mxGeometry(20, 50, 150, 80),
          inh + 'shape=rect;html=1;overflow=fill;dashed=1;whiteSpace=wrap;',
        );
        ...
        var edge1 = new mxCell(
          'Association1',
          new mxGeometry(0, 0, 0, 0),
          'edgeStyle=none;html=1;endArrow=none;verticalAlign=bottom;',
        );
        ...
        var edge2 = new mxCell(
          '',
          new mxGeometry(0, 0, 0, 0),
          'edgeStyle=none;html=1;endArrow=none;dashed=1;',
        );
        ...
        var label1 = new mxCell(
          'property2',
          new mxGeometry(-1, 0, 0, 0),
          'spacingLeft=3;html=1;align=left;verticalAlign=bottom;labelPosition=right;labelBackgroundColor=none;fontSize=10',
        );
        ...
        var label2 = new mxCell(
          '1',
          new mxGeometry(-1, 0, 0, 0),
          'spacingLeft=3;html=1;align=left;verticalAlign=top;labelPosition=right;labelBackgroundColor=none;fontSize=10',
        );
        ...
        var label3 = new mxCell(
          'property1',
          new mxGeometry(1, 0, 0, 0),
          'spacingRight=3;html=1;align=right;verticalAlign=bottom;labelPosition=left;labelBackgroundColor=none;fontSize=10',
        );
        ...
        var label4 = new mxCell(
          '{ordered} 0..*',
          new mxGeometry(1, 0, 0, 0),
          'spacingRight=3;html=1;align=right;verticalAlign=top;labelPosition=left;labelBackgroundColor=none;fontSize=10',
        );
        ...
        return sb.createVertexTemplateFromCells(
          [cardCell, cardCell2, bg, edge1, edge2],
          400,
          260,
          'Participant Property',
        );
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'association').join(' '),
      ),
      this.createVertexTemplateEntry(
        'shape=rect;html=1;overflow=fill;whiteSpace=wrap;',
        300,
      ...
      this.createVertexTemplateEntry(
        'shape=rect;html=1;overflow=fill;dashed=1;whiteSpace=wrap;',
        150,
        80,
        '<p style="margin:0px;margin-top:4px;text-align:center;">' +
          '&lt;&lt;participant&gt;&gt;<br/>' +
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'participant').join(' '),
      ),
      ...
      this.addEntry(dt + 'connector property', function () {
        var bg = new mxCell(
          '<p style="margin:0px;margin-top:4px;text-align:center;">' +
            ...
            '<i>structure</i></p>',
          new mxGeometry(0, 0, 400, 250),
          'shape=rect;html=1;overflow=fill;whiteSpace=wrap;strokeWidth=1;recursiveResize=0;',
        );
        bg.vertex = true;
        var cardCell2 = new mxCell(
          'p1:\nType1',
          new mxGeometry(20, 100, 80, 40),
          inh + 'shape=rect;html=1;fontStyle=1;whiteSpace=wrap;align=center;',
        );
        cardCell2.vertex = true;
        bg.insert(cardCell2);
        ...
        var edge1 = new mxCell(
          ...
          new mxGeometry(0, 0, 0, 0),
          inh +
            'edgeStyle=none;html=1;endArrow=none;verticalAlign=bottom;labelBackgroundColor=none;',
        );
        edge1.geometry.relative = true;
        edge1.edge = true;
        ...
        var edge2 = new mxCell(
          '',
          new mxGeometry(0, 0, 0, 0),
          inh + 'edgeStyle=none;html=1;endArrow=none;',
        );
        edge2.geometry.relative = true;
        edge2.edge = true;
        ...
        label4.vertex = true;
        edge2.insert(label4);
        var cardCell6 = new mxCell(
          'c2: Association2',
          new mxGeometry(140, 210, 120, 20),
          inh + 'shape=rect;html=1;align=center;',
        );
        cardCell6.vertex = true;
        bg.insert(cardCell6);
        var edge3 = new mxCell(
          '',
          new mxGeometry(0, 0, 0, 0),
          inh + 'edgeStyle=none;html=1;endArrow=none;dashed=1;',
        );
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'connector property').join(' '),
      ),

      this.addEntry(dt + 'internal block diagram', function () {
        var bg = new mxCell(
          '<p style="margin:0px;margin-top:4px;margin-left:10px;text-align:left;"><b>ibd</b>   Block1</p>',
          new mxGeometry(0, 0, 300, 100),
          s +
            'package;labelX=100;align=left;spacingLeft=10;html=1;overflow=fill;whiteSpace=wrap;strokeWidth=0;recursiveResize=0;',
        );
        bg.vertex = true;
        var cardCell2 = new mxCell(
          'p1:\nType1',
      ...
      this.addEntry(dt + 'property', function () {
        var bg = new mxCell(
          '',
          new mxGeometry(0, 0, 300, 120),
          'shape=rect;html=1;strokeWidth=2;whiteSpace=wrap;strokeWidth=1;recursiveResize=0;',
        );
        bg.vertex = true;
        var cardCell2 = new mxCell(
          '<p style="margin:0px;margin-top:4px;margin-right:4px;text-align:right;font-size:10px;">' +
            ...
            '<b>p1 : Type1</b><hr/>' +
            'x : Integer = 4</p>',
          new mxGeometry(20, 20, 140, 80),
          inh + 'shape=rect;html=1;overflow=fill;strokeWidth=2;whiteSpace=wrap;align=center;',
        );
        cardCell2.vertex = true;
        bg.insert(cardCell2);
        var cardCell3 = new mxCell(
          'r1: Type2',
          new mxGeometry(180, 30, 100, 50),
          inh +
            'shape=rect;html=1;fontStyle=1;dashed=1;strokeWidth=2;whiteSpace=wrap;align=center;',
        );
        cardCell3.vertex = true;
        bg.insert(cardCell3);
      ...
      this.createVertexTemplateEntry(
        s + 'package;html=1;overflow=fill;whiteSpace=wrap;',
        300,
        135,
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'package').join(' '),
      ),
      this.createVertexTemplateEntry(
        'shape=rect;html=1;overflow=fill;whiteSpace=wrap;align=center;',
        100,
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'property').join(' '),
      ),
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'property specific type').join(' '),
      ),
      this.createVertexTemplateEntry(
        'shape=rect;html=1;overflow=fill;whiteSpace=wrap;',
        100,
    ...
    var fns = [
      this.addEntry(dt + 'port', function () {
        ...
        var cardCell = new mxCell(
          ...
          s + 'port1;fontStyle=1;whiteSpace=wrap;align=center;points=[[0,0.5,0],[1,0.5,0]];',
        );
        cardCell.vertex = true;
        var label1 = new mxCell(
          'p1',
          new mxGeometry(0, 20, 20, 20),
          inh +
        ...
        var label2 = new mxCell(
          'p2',
          new mxGeometry(140, 20, 20, 20),
          inh +
            'shape=rect;points=[[1,0.5,0]];html=1;resizable=1;labelBackgroundColor=none;fontSize=10;part=1;',
        );
        ...
        return sb.createVertexTemplateFromCells(
          [cardCell],
          cardCell.geometry.width,
          cardCell.geometry.height,
          'Port',
        );
      }),
      ...
      this.addEntry(dt + 'port conjugated', function () {
        var cardCell = new mxCell(
          ...
          s + 'port2;fontStyle=1;spacingRight=20;whiteSpace=wrap;align=center;',
        );
        cardCell.vertex = true;
        var label1 = new mxCell(
          'p1 : ~T1',
          new mxGeometry(0, 20, 20, 20),
          inh +
            'shape=rect;points=[[0,0.5,0]];html=1;resizable=1;align=right;verticalAlign=bottom;labelPositin=left;verticalLabelPosition=top;labelBackgroundColor=none;fontSize=10;part=1;',
        );
        label1.geometry.relative = false;
        label1.vertex = true;
        cardCell.insert(label1);
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'port compartment notation').join(' '),
      ),
      this.addDataEntry(
        dt + 'nested port',
        160,
      ...
      this.addEntry(dt + 'proxy port', function () {
        var cardCell = new mxCell(
          'Transmission',
          new mxGeometry(0, 0, 160, 60),
          s + 'port1;fontStyle=1;whiteSpace=wrap;align=center;',
        );
        cardCell.vertex = true;
        var label1 = new mxCell(
          '&lt;&lt;proxy&gt;&gt;\np1',
      ...
      this.addEntry(dt + 'full port', function () {
        ...
        var label1 = new mxCell(
          ...
          new mxGeometry(0, 20, 20, 20),
          inh +
            'shape=rect;points=[[0,0.5,0]];html=1;resizable=1;align=right;verticalAlign=bottom;labelPosition=left;verticalLabelPosition=top;labelBackgroundColor=none;fontSize=10;paart=1;',
        );
        label1.geometry.relative = false;
        label1.vertex = true;
        cardCell.insert(label1);
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'flow property').join(' '),
      ),
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'required provided feature').join(' '),
      ),
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'interface block').join(' '),
      ),
      this.addDataEntry(
        dt + 'item flow',
        120,
      ...
      this.addDataEntry(
        dt + 'item flow property',
        140,
        180,
        'Item Flow (Item Property)',
      ...
      this.createVertexTemplateEntry(
        s + 'itemFlow;fontStyle=1;flowDir=n;flowType=in;whiteSpace=wrap;align=center;',
        200,
        80,
        'eng:Engine',
        'Item Flow North In',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'item flow north in').join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'itemFlow;fontStyle=1;flowDir=e;flowType=out;whiteSpace=wrap;align=center;',
        200,
        80,
        'eng:Engine',
        'Item Flow East Out',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'item flow east out').join(' '),
      ),

      this.addEntry(dt + 'item flow', function () {
        var cardCell = new mxCell(
          'eng: engine',
          new mxGeometry(40, 0, 100, 60),
          s +
            'itemFlow;fontStyle=1;strokeWidth=1;flowDir=e;flowType=none;spacingRight=20;whiteSpace=wrap;align=center;',
        );
        cardCell.vertex = true;
        var cardCell2 = new mxCell(
          'trns: Translation',
          new mxGeometry(260, 0, 140, 60),
          s +
            'itemFlow;strokeWidth=1;fontStyle=1;flowDir=w;flowType=none;spacingLeft=15;whiteSpace=wrap;align=center;',
        );
        cardCell2.vertex = true;
        var assoc1 = new mxCell(
          'Torque',
        ...
        var label1 = new mxCell(
          'ep:EP',
          new mxGeometry(0, 0, 0, 0),
          'resizable=0;html=1;align=left;spacingLeft=5;verticalAlign=bottom;labelPosition=left;verticalLabelPosition=bottom;labelBackgroundColor=none;fontSize=10',
        );
        label1.geometry.relative = true;
        label1.geometry.x = -1;
        label1.setConnectable(false);
        ...
        var label2 = new mxCell(
          'tp:TP',
          new mxGeometry(0, 0, 0, 0),
          'resizable=0;html=1;align=right;spacingRight=5;verticalAlign=bottom;labelPosition=left;verticalLabelPosition=bottom;labelBackgroundColor=none;fontSize=10',
        );
        label2.geometry.relative = true;
        label2.geometry.x = 1;
        label2.setConnectable(false);
        ...
        var cardCell4 = new mxCell(
          'epInLink : EP',
          new mxGeometry(30, 100, 160, 120),
          inh + s + 'itemFlowRight;fontStyle=1;spacingRight=40;whiteSpace=wrap;align=center;',
        );
        cardCell4.vertex = true;
        bg.insert(cardCell4);
        var label3 = new mxCell(
          'ep.1',
          new mxGeometry(160, 30, 0, 0),
          'resizable=0;html=1;align=right;spacingRight=22;verticalAlign=middle;labelPosition=right;verticalLabelPosition=top;labelBackgroundColor=none;fontSize=10',
        );
        ...
        var cardCell5 = new mxCell(
          'tpInLink : TP',
          new mxGeometry(280, 100, 160, 120),
          inh + s + 'itemFlowLeft;fontStyle=1;spacingLeft=40;whiteSpace=wrap;align=center;',
        );
        cardCell5.vertex = true;
        bg.insert(cardCell5);
        var label6 = new mxCell(
          'tp.1',
          new mxGeometry(0, 30, 0, 0),
          'resizable=0;html=1;align=left;spacingLeft=22;verticalAlign=middle;labelPosition=left;verticalLabelPosition=top;labelBackgroundColor=none;fontSize=10',
        );
        ...
        var assoc3 = new mxCell(
          'Vibration',
          new mxGeometry(0, 0, 0, 0),
          inh +
            'edgeStyle=none;html=1;verticalAlign=bottom;endArrow=none;exitX=1;exitY=0.25;entryX=0;entryY=0.25;labelBackgroundColor=none;',
        );
        ...
        bg.insert(assoc3);
        var assoc4 = new mxCell(
          'Heat',
          new mxGeometry(0, 0, 0, 0),
          inh +
            'edgeStyle=none;html=1;verticalAlign=bottom;endArrow=none;exitX=1;exitY=0.5;entryX=0;entryY=0.5;labelBackgroundColor=none;',
        );
        ...
        bg.insert(assoc4);
        var assoc5 = new mxCell(
          'Current',
          new mxGeometry(0, 0, 0, 0),
          inh +
            'edgeStyle=none;html=1;verticalAlign=bottom;endArrow=none;exitX=1;exitY=0.75;entryX=0;entryY=0.75;labelBackgroundColor=none;',
        );
        ...
        return sb.createVertexTemplateFromCells(
          [cardCell, cardCell2, assoc1, bg, assoc2],
          470,
          370,
          'Item Flow',
        );
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'interface').join(' '),
      ),

      this.addEntry(dt + 'required interface', function () {
        var cardCell = new mxCell(
          'Transmission',
          new mxGeometry(90, 0, 160, 60),
          s + 'port4;fontStyle=1;whiteSpace=wrap;align=center;',
        );
        cardCell.vertex = true;
        var label1 = new mxCell(
          'p1',
          new mxGeometry(0, 20, 20, 20),
          inh +
            'shape=rect;html=1;resizable=0;align=left;verticalAlign=bottom;labelPosition=right;verticalLabelPosition=top;labelBackgroundColor=none;fontSize=10;',
        );
        label1.geometry.relative = false;
        label1.setConnectable(false);
        label1.vertex = true;
      ...
      this.addEntry(dt + 'provided interface', function () {
        ...
        var label1 = new mxCell(
          'p1',
          new mxGeometry(0, 20, 20, 20),
          inh + 'shape=rect;html=1;resizable=0;labelBackgroundColor=none;fontSize=10;',
        );
        label1.geometry.relative = false;
        label1.setConnectable(false);
        label1.vertex = true;
  ...
  Sidebar.prototype.addSysMLConstraintBlocksPalette = function (expand) {
    ...
    var fns = [
      ...
      this.addEntry(dt + 'parametric diagram', function () {
        var bg = new mxCell(
          '<p style="margin:0px;margin-top:4px;margin-left:10px;text-align:left;"><b>par</b>   Block1</p>',
          new mxGeometry(0, 0, 300, 170),
          s +
            'package;labelX=120;align=left;spacingLeft=10;overflow=fill;whiteSpace=wrap;strokeWidth=1;recursiveResize=0;',
        );
        bg.vertex = true;
        var cardCell2 = new mxCell(
          'C1: Constraint',
          new mxGeometry(130, 50, 150, 100),
          inh + s + 'paramDgm;fontStyle=1;whiteSpace=wrap;align=center;',
        );
        cardCell2.vertex = true;
        bg.insert(cardCell2);
        var label1 = new mxCell(
          'x:',
          new mxGeometry(0, 25, 0, 0),
          'html=1;resizable=0;align=left;verticalAlign=middle;labelPosition=left;verticalLabelPosition=middle;labelBackgroundColor=none;fontSize=10;spacingLeft=22;fontStyle=1;',
        );
        label1.geometry.relative = false;
        label1.setConnectable(false);
        label1.vertex = true;
        ...
        var cardCell3 = new mxCell(
          'length: Real',
          new mxGeometry(30, 65, 20, 20),
          inh + 'shape=rect;html=1;fontSize=10;verticalLabelPosition=top;verticalAlign=bottom;',
        );
        cardCell3.vertex = true;
        bg.insert(cardCell3);
        var cardCell4 = new mxCell(
          'width: Real',
          new mxGeometry(30, 115, 20, 20),
          inh + 'shape=rect;html=1;fontSize=10;verticalLabelPosition=top;verticalAlign=bottom;',
        );
        cardCell4.vertex = true;
        bg.insert(cardCell4);
        var assoc1 = new mxCell(
          '',
          new mxGeometry(0, 0, 0, 0),
          inh + 'endArrow=none;html=1;edgeStyle=none;exitY=0.25;exitX=0;entryY=0.5;entryX=1;',
        );
        assoc1.geometry.relative = true;
        assoc1.geometry.x = 1;
        assoc1.edge = true;
        ...
        var assoc2 = new mxCell(
          '',
          new mxGeometry(0, 0, 0, 0),
          inh + 'endArrow=none;html=1;edgeStyle=none;exitY=0.75;exitX=0;entryY=0.5;entryX=1;',
        );
        assoc2.geometry.relative = true;
        assoc2.geometry.x = 1;
        assoc2.edge = true;
  ...
  Sidebar.prototype.addSysMLActivitiesPalette = function (expand) {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'action').join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'callBehAct;whiteSpace=wrap;align=center;',
        160,
        80,
        'action name:\nbehavior name',
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'callBehAct', dt + 'call behavior action').join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'accEvent;strokeWidth=2;whiteSpace=wrap;align=center;',
        100,
        60,
        'Event',
        'Accept Event Action',
        null,
        null,
        this.getTagsForStencil(gn, 'accEvent', dt + 'accept event action').join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'timeEvent;strokeWidth=2;verticalLabelPosition=bottom;verticalAlignment=top;',
        35,
        40,
        '',
        'Time Event',
        null,
        null,
        this.getTagsForStencil(gn, 'timeEvent', dt + 'time event').join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'sendSigAct;strokeWidth=2;whiteSpace=wrap;align=center;',
        100,
        60,
        'Signal',
        'Send Signal Action',
        null,
        null,
        this.getTagsForStencil(gn, 'sendSigAct', dt + 'send signal action').join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'actFinal;strokeWidth=2;verticalLabelPosition=bottom;verticalAlignment=top;',
        40,
        40,
        '',
        'Activity Final',
        null,
        null,
        this.getTagsForStencil(gn, 'actFinal', dt + 'activity final').join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'actParamNode;align=left;spacingLeft=15;verticalAlign=top;spacingTop=-3;',
        300,
        135,
        'act',
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'act', dt + 'activity parameter node').join(' '),
      ),
      this.createVertexTemplateEntry(
        'shape=rect;rounded=1;html=1;whiteSpace=wrap;align=center;',
        160,
        80,
        '&lt;&lt;controlOperator&gt;&gt;\nCallBehaviorAction',
        'Control Operator',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'control operator').join(' '),
      ),
      this.createVertexTemplateEntry(
        s +
          'package;align=left;spacingLeft=5;verticalAlign=top;spacingTop=-3;labelX=135;html=1;overflow=fill;',
        250,
        120,
        '<p style="margin:0px;margin-top:4px;margin-left:10px;text-align:left;"><b>act</b>   [ControlOperator]</p>',
        'Control Operator',
        null,
        null,
        this.getTagsForStencil(gn, 'package', dt + 'control operator').join(' '),
      ),
      this.addDataEntry(
        dt + 'decision node',
        200,
      ...
      this.createVertexTemplateEntry(
        s + 'flowFinal;strokeWidth=2;verticalLabelPosition=bottom;verticalAlignment=top;',
        40,
        40,
        '',
        'Flow Final',
        null,
        null,
        this.getTagsForStencil(gn, 'flowFinal', dt + 'flow final').join(' '),
      ),
      this.addDataEntry(
        dt + 'fork node',
        200,
      ...
      this.createVertexTemplateEntry(
        'shape=ellipse;html=1;fillColor=#000000;strokeWidth=2;verticalLabelPosition=bottom;verticalAlignment=top;perimeter=ellipsePerimeter;',
        40,
        40,
        '',
        'Initial Node',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'initial node').join(' '),
      ),
      this.addDataEntry(
        dt + 'join node',
        200,
      ...
      this.addEntry(dt + 'is stream', function () {
        var cardCell = new mxCell(
          ...
          s + 'isActStream;align=left;spacingLeft=5;verticalAlign=top;spacingTop=-3;',
        );
        cardCell.vertex = true;
        var label1 = new mxCell(
          '{stream}',
          new mxGeometry(200, 50, 0, 0),
          'resizable=0;html=1;align=left;verticalAlign=top;labelPosition=left;verticalLabelPosition=middle;labelBackgroundColor=none;fontSize=10;spacingTop=5;',
        );
        label1.geometry.relative = false;
        label1.setConnectable(false);
        label1.vertex = true;
      ...
      this.addDataEntry(
        dt + 'local pre precondition post postcondition',
        150,
        180,
      ...
      this.createVertexTemplateEntry(
        'shape=rect;html=1;whiteSpace=wrap;align=center;',
        160,
        80,
        'object node name:\n type name\n[state, state ...]',
        'Object Node',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'object node').join(' '),
      ),
      ...
      this.addEntry(dt + 'object node', function () {
        var cardCell = new mxCell(
          ...
          s + 'isControl;whiteSpace=wrap;align=center;',
        );
        cardCell.vertex = true;
        var label1 = new mxCell(
          'pin name: type name\n[state, state ...]',
          new mxGeometry(0, 30, 0, 0),
          'resizable=0;html=1;align=right;verticalAlign=middle;labelPosition=left;verticalLabelPosition=middle;labelBackgroundColor=none;spacingRight=5;',
        );
        label1.geometry.relative = false;
        label1.setConnectable(false);
        label1.vertex = true;
      ...
      this.addEntry(dt + 'optional', function () {
        var cardCell = new mxCell(
          'act',
          new mxGeometry(0, 0, 200, 100),
          s + 'isActStream;align=left;spacingLeft=5;verticalAlign=top;spacingTop=-3;fontStyle=1;',
        );
        cardCell.vertex = true;
        var label1 = new mxCell(
          '&lt;&lt;optional&gt;&gt;',
      ...
      this.createVertexTemplateEntry(
        s + 'paramSet;whiteSpace=wrap;align=center;',
        160,
        100,
        'Action',
        'Parameter Set',
        null,
        null,
        this.getTagsForStencil(gn, 'paramSet', dt + 'parameter set').join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'paramActSet;align=left;spacingLeft=15;verticalAlign=top;spacingTop=-3;fontStyle=1;',
        250,
        120,
        'act',
        'Parameter Set',
        null,
        null,
        this.getTagsForStencil(gn, 'paramActSet', dt + 'parameter set').join(' '),
      ),
      this.addDataEntry(
        dt + 'probability',
        120,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'rate').join(' '),
      ),
      this.createVertexTemplateEntry(
        'shape=rect;html=1;whiteSpace=wrap;align=center;',
        120,
      ...
      this.addEntry(dt + 'control flow', function () {
        var cardCell = new mxCell(
          ...
          'shape=rect;html=1;rounded=1;whiteSpace=wrap;',
        );
        cardCell.vertex = true;
        var cardCell2 = new mxCell(
          '',
          new mxGeometry(100, 0, 60, 40),
          'shape=rect;html=1;rounded=1;whiteSpace=wrap;',
        );
        cardCell2.vertex = true;
        var edge1 = new mxCell(
      ...
      this.addEntry(dt + 'object flow', function () {
        var cardCell = new mxCell(
          '',
          new mxGeometry(0, 0, 60, 40),
          s + 'objFlowR;strokeWidth=2;whiteSpace=wrap;',
        );
        cardCell.vertex = true;
        var cardCell2 = new mxCell(
          '',
          new mxGeometry(140, 0, 60, 40),
          s + 'objFlowL;strokeWidth=2;whiteSpace=wrap;',
        );
        cardCell2.vertex = true;
        var edge1 = new mxCell(
          '',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'objFlowR', dt + 'object flow').join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'objFlowL;whiteSpace=wrap;',
        120,
        60,
        '',
        'Object Flow',
        null,
        null,
        this.getTagsForStencil(gn, 'objFlowL', dt + 'object flow').join(' '),
      ),
      this.addDataEntry(
        dt + 'probability',
        350,
      ...
      this.addEntry(dt + 'in block definition diagram activity association', function () {
        var bg = new mxCell(
          'bdd',
          new mxGeometry(0, 0, 330, 250),
          s +
            'package;labelX=45;align=left;spacingLeft=5;verticalAlign=top;spacingTop=-3;fontStyle=1;strokeWidth=1;recursiveResize=0;',
        );
        bg.vertex = true;
        var cardCell2 = new mxCell(
          '&lt;&lt;activity&gt;&gt;\nactivity name',
          new mxGeometry(30, 40, 120, 60),
          inh + 'shape=rect;html=1;whiteSpace=wrap;align=center;',
        );
        cardCell2.vertex = true;
        bg.insert(cardCell2);
        var cardCell3 = new mxCell(
          '&lt;&lt;activity&gt;&gt;\nactivity name',
          new mxGeometry(30, 160, 120, 60),
          inh + 'shape=rect;html=1;whiteSpace=wrap;align=center;',
        );
        cardCell3.vertex = true;
        bg.insert(cardCell3);
        var assoc1 = new mxCell(
          ...
          new mxGeometry(0, 0, 0, 0),
          inh +
            'endArrow=none;html=1;edgeStyle=none;endFill=0;startArrow=diamondThin;startFill=1;startSize=12;align=left;verticalAlign=bottom;labelBackgroundColor=none;',
        );
        assoc1.geometry.relative = true;
        assoc1.geometry.x = 1;
        assoc1.edge = true;
        ...
        var assoc2 = new mxCell(
          ...
          new mxGeometry(0, 0, 0, 0),
          inh +
            'endArrow=none;html=1;edgeStyle=none;endFill=0;startFill=1;startSize=12;align=left;verticalAlign=bottom;labelBackgroundColor=none;',
        );
        assoc2.geometry.relative = true;
        assoc2.geometry.x = 1;
        assoc2.edge = true;
      ...
      this.createVertexTemplateEntry(
        s + 'actPart;strokeWidth=3;verticalAlign=top;rotation=-90;whiteSpace=wrap;',
        100,
        100,
        'Partition Name',
        'Activity Partition',
        null,
        null,
        this.getTagsForStencil(gn, 'actPart', dt + 'activity partition').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'activity partition').join(' '),
      ),
      ...
      this.createVertexTemplateEntry(
        ...
        160,
        60,
        '&lt;&lt;structured&gt;&gt; node name',
        'Structured Activity Node',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'structured activity node').join(' '),
      ),
    ];
  ...
  Sidebar.prototype.addSysMLInteractionsPalette = function (expand) {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        s +
          'package;overflow=fill;labelX=95;align=left;spacingLeft=5;verticalAlign=top;spacingTop=-3;',
        160,
        80,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'package', dt + 'sequence diagram').join(' '),
      ),
      ...
      this.addEntry(dt + 'use', function () {
        var cardCell = new mxCell(
          'Interaction3',
          new mxGeometry(0, 0, 160, 60),
          s + 'package;labelX=40;whiteSpace=wrap;align=center;',
        );
        cardCell.vertex = true;
        var label1 = new mxCell(
          'ref',
          new mxGeometry(0, 0, 0, 0),
          'html=1;align=left;verticalAlign=top;labelPosition=left;verticalLabelPosition=top;labelBackgroundColor=none;spacingLeft=5;spacingTop=-2;fontStyle=1;',
        );
        label1.geometry.relative = false;
        label1.setConnectable(false);
        label1.vertex = true;
      ...
      this.addEntry(dt + 'combined fragment', function () {
        var bg = new mxCell(
          '<p style="margin:0px;margin-top:4px;margin-left:10px;text-align:left;"><b>sd</b>   Interaction1</p>',
          new mxGeometry(0, 0, 350, 320),
          s + 'package;labelX=100;html=1;overflow=fill;strokeWidth=1;recursiveResize=0;',
        );
        bg.vertex = true;
        var cardCell2 = new mxCell(
          'b1: Block1',
          new mxGeometry(30, 40, 80, 30),
          inh + 'shape=rect;html=1;whiteSpace=wrap;align=center;',
        );
        cardCell2.vertex = true;
        bg.insert(cardCell2);
        ...
        var cardCell5 = new mxCell(
          'alt',
          new mxGeometry(20, 90, 200, 160),
          inh +
            s +
            'package;labelX=35;fontStyle=1;align=left;verticalAlign=top;spacingLeft=5;spacingTop=-3;',
        );
        cardCell5.vertex = true;
        bg.insert(cardCell5);
        var assoc1 = new mxCell(
          '',
          new mxGeometry(0, 0, 0, 0),
          inh + 'endArrow=none;html=1;edgeStyle=none;dashed=1;',
        );
        ...
        var assoc5 = new mxCell(
          ...
          new mxGeometry(0, 0, 0, 0),
          inh +
            'endArrow=open;html=1;edgeStyle=none;verticalAlign=bottom;labelBackgroundColor=none;endSize=12;',
        );
        ...
        var label1 = new mxCell(
          'msg1',
          new mxGeometry(1, 0, 0, 0),
          'align=right;html=1;verticalAlign=bottom;labelBackgroundColor=none;',
        );
        label1.geometry.relative = true;
        label1.setConnectable(false);
        label1.vertex = true;
        assoc5.insert(label1);
        var assoc6 = new mxCell(
          '[else]',
          new mxGeometry(0, 0, 0, 0),
          inh +
            'endArrow=open;html=1;edgeStyle=none;verticalAlign=bottom;labelBackgroundColor=none;align=right;endSize=12;',
        );
      ...
      this.addDataEntry(
        dt + 'state invariant configuration',
        120,
        220,
      ...
      this.createEdgeTemplateEntry(
        ...
        'Lost Message',
        null,
        this.getTagsForStencil(gn, '', dt + 'lost message').join(' '),
      ),
      this.createEdgeTemplateEntry(
        ...
        'Found Message',
        null,
        this.getTagsForStencil(gn, '', dt + 'found message').join(' '),
      ),
      this.createEdgeTemplateEntry(
        ...
        'General Ordering',
        null,
        this.getTagsForStencil(gn, '', dt + 'general ordering').join(' '),
      ),
    ];
  ...
  Sidebar.prototype.addSysMLStateMachinesPalette = function (expand) {
    ...
    var fns = [
      ...
      this.addEntry(dt + 'composite state', function () {
        var bg = new mxCell(
          'CompositeState1',
          new mxGeometry(0, 0, 220, 190),
          s +
            'compState;align=left;verticalAlign=top;spacingTop=-3;spacingLeft=18;strokeWidth=1;recursiveResize=0;',
        );
        bg.vertex = true;
        var cardCell2 = new mxCell(
          '',
          new mxGeometry(20, 50, 20, 20),
          'shape=ellipse;html=1;fillColor=#000000;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;',
        );
        cardCell2.vertex = true;
        bg.insert(cardCell2);
        var cardCell3 = new mxCell(
          'State1',
          new mxGeometry(80, 60, 100, 40),
          inh + 'shape=rect;html=1;rounded=1;whiteSpace=wrap;align=center;',
        );
        cardCell3.vertex = true;
        bg.insert(cardCell3);
        var cardCell4 = new mxCell(
          'State2',
          new mxGeometry(80, 130, 100, 40),
          inh + 'shape=rect;html=1;rounded=1;whiteSpace=wrap;align=center;',
        );
        cardCell4.vertex = true;
        bg.insert(cardCell4);
        var edge1 = new mxCell(
          '',
          new mxGeometry(0, 0, 0, 0),
          inh + 'edgeStyle=none;html=1;endArrow=open;endSize=12;',
        );
        edge1.geometry.relative = true;
        edge1.edge = true;
        cardCell2.insertEdge(edge1, true);
      ...
      this.createVertexTemplateEntry(
        s + 'compState;html=1;align=left;verticalAlign=top;spacingTop=-3;spacingLeft=18;',
        200,
        160,
        'CompositeState1',
        'Composite State',
        null,
        null,
        this.getTagsForStencil(gn, 'compState', dt + 'composite state').join(' '),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'compState', dt + 'entry point').join(' '),
      ),

      this.addEntry(dt + 'exit point', function () {
        var cardCell = new mxCell(
          'aborted',
          new mxGeometry(0, 10, 20, 20),
          s +
            'flowFinal;labelPosition=right;verticalLabelPosition=top;spacingTop=5;spacingLeft=3;align=left;verticalAlign=top;resizable=0;',
        );
        cardCell.vertex = true;
      ...
      this.createVertexTemplateEntry(
        s +
          'actFinal;html=1;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;',
        40,
        40,
        '',
        'Final State',
        null,
        null,
        this.getTagsForStencil(gn, 'actFinal', dt + 'final state').join(' '),
      ),
      this.createVertexTemplateEntry(
        'shape=ellipse;html=1;fontSize=18;align=center;',
        40,
        40,
        'H*',
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'history deep pseudo state').join(' '),
      ),
      this.createVertexTemplateEntry(
        'shape=ellipse;html=1;fontSize=18;align=center;',
        40,
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'history shallow pseudo state').join(' '),
      ),
      this.createVertexTemplateEntry(
        'shape=ellipse;html=1;fillColor=#000000;fontSize=18;fontColor=#ffffff;',
        40,
        40,
        '',
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'initial pseudo state').join(' '),
      ),
      this.createVertexTemplateEntry(
        'shape=ellipse;html=1;fillColor=#000000;fontSize=18;fontColor=#ffffff;',
        40,
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'junction pseudo state').join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'accEvent;flipH=1;whiteSpace=wrap;align=center;',
        140,
        40,
        'Req(Id)',
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'accEvent', dt + 'receive signal action').join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'sendSigAct;whiteSpace=wrap;align=center;',
        140,
        40,
        'TurnOn',
        'Send Signal Action',
      ...
      this.createVertexTemplateEntry(
        s + 'region;align=left;verticalAlign=top;spacingTop=-3;spacingLeft=25;',
        200,
        160,
        'S',
        'Region',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'region').join(' '),
      ),
      this.createVertexTemplateEntry(
        'shape=rect;rounded=1;html=1;whiteSpace=wrap;align=center;',
        100,
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'simple state').join(' '),
      ),

      this.createVertexTemplateEntry(
        s + 'simpleState;html=1;overflow=fill;whiteSpace=wrap;align=center;',
        200,
        100,
        '<p style="margin:0px;margin-top:4px;text-align:center;">' +
          'State2<hr/></p>' +
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'simpleState', dt + 'simple state').join(' '),
      ),
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'state list').join(' '),
      ),

      this.addEntry(dt + 'state machine', function () {
        var cardCell = new mxCell(
          'ReadAmountSM',
          new mxGeometry(0, 0, 160, 120),
          s + 'stateMachine;verticalAlign=top;whiteSpace=wrap;align=center;',
        );
        cardCell.vertex = true;
        var label1 = new mxCell(
          'aborted',
          new mxGeometry(160, 60, 0, 0),
          'resizable=0;html=1;verticalAlign=top;align=left;labelBackgroundColor=none;spacingLeft=5;spacingTop=-2;',
        );
        label1.geometry.relative = false;
        label1.setConnectable(false);
        label1.vertex = true;
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'x', dt + 'terminate node').join(' '),
      ),
      ...
      this.addEntry(dt + 'submachine state', function () {
        var cardCell = new mxCell(
          'ReadAmount :\nReadAmountSM',
          new mxGeometry(0, 0, 160, 120),
          s + 'submState;whiteSpace=wrap;align=center;',
        );
        cardCell.vertex = true;
        var label1 = new mxCell(
          'aborted',
          new mxGeometry(160, 60, 0, 0),
          'resizable=0;html=1;verticalAlign=bottom;align=left;labelBackgroundColor=none;spacingLeft=5;spacingBottom=2;',
        );
        label1.geometry.relative = false;
        label1.setConnectable(false);
        label1.vertex = true;
      ...
      this.createEdgeTemplateEntry(
        ...
        'Transition',
        null,
        this.getTagsForStencil(gn, '', dt + 'transition').join(' '),
      ),
    ];
  ...
  Sidebar.prototype.addSysMLUseCasesPalette = function (expand) {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'use case').join(' '),
      ),
      ...
      this.addEntry(dt + '', function () {
        var cardCell = new mxCell(
          ...
          s + 'useCaseExtPt;whiteSpace=wrap;align=center;',
        );
        cardCell.vertex = true;
        var label1 = new mxCell(
          'UseCaseName',
          new mxGeometry(80, 17, 0, 0),
          'resizable=0;html=1;verticalAlign=middle;align=center;labelBackgroundColor=none;fontStyle=1;',
        );
        label1.geometry.relative = false;
        label1.setConnectable(false);
        label1.vertex = true;
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'umlActor', dt + '').join(' '),
      ),
      this.createVertexTemplateEntry(
        'shape=rect;html=1;overflow=fill;html=1;whiteSpace=wrap;align=center;',
        80,
        40,
        '<p style="margin:0px;margin-top:4px;text-align:center;">' +
          '&lt;&lt;actor&gt;&gt;<br/>' +
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'subject').join(' '),
      ),
      this.createEdgeTemplateEntry(
        'edgeStyle=none;html=1;endArrow=none;verticalAlign=bottom;',
        160,
        ...
        'Communication Path',
        null,
        this.getTagsForStencil(gn, '', dt + 'communication path').join(' '),
      ),
      this.createEdgeTemplateEntry(
        ...
        'Include',
        null,
        this.getTagsForStencil(gn, '', dt + 'include').join(' '),
      ),
      this.createEdgeTemplateEntry(
        ...
        'Extend',
        null,
        this.getTagsForStencil(gn, '', dt + 'extend').join(' '),
      ),
      this.addDataEntry(
        dt + 'extend condition',
        250,
  ...
  Sidebar.prototype.addSysMLAllocationsPalette = function (expand) {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'allocated stereotype').join(' '),
      ),

      this.createVertexTemplateEntry(
        'shape=rect;html=1;overflow=fill;strokeWidth=2;whiteSpace=wrap;align=center;',
        200,
        120,
        '<p style="margin:0px;margin-top:4px;text-align:center;">' +
          '<b>BlockName</b></p><hr/>' +
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'derived property block').join(' '),
      ),
      this.addDataEntry(
        dt + 'derived property comment',
        270,
        140,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'derived property activity diagram').join(' '),
      ),
      ...
      this.addEntry(dt + 'activity partition', function () {
        ...
        var cardCell2 = new mxCell(
          'ActionName',
          new mxGeometry(65, 70, 120, 60),
          s + 'cont;fontStyle=1;whiteSpace=wrap;align=center;',
        );
        cardCell2.vertex = true;
      ...
      this.addEntry(dt + 'general', function () {
        var cardCell = new mxCell(
          'Client',
          new mxGeometry(0, 0, 100, 60),
          'shape=rect;html=1;fontStyle=1;whiteSpace=wrap;align=center;',
        );
        cardCell.vertex = true;
        var cardCell2 = new mxCell(
          'Supplier',
          new mxGeometry(200, 0, 100, 60),
          'shape=rect;html=1;fontStyle=1;whiteSpace=wrap;align=center;',
        );
        cardCell2.vertex = true;
        var edge1 = new mxCell(
  ...
  Sidebar.prototype.addSysMLRequirementsPalette = function (expand) {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        s + 'package;overflow=fill;labelX=110;strokeWidth=2;align=center;',
        160,
        80,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'package', dt + 'diagram').join(' '),
      ),

      this.createVertexTemplateEntry(
        'shape=rect;overflow=fill;html=1;whiteSpace=wrap;align=center;',
        200,
        100,
        '<p style="margin:0px;margin-top:4px;text-align:center;">' +
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'package', dt + '').join(' '),
      ),
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'package', dt + 'test case').join(' '),
      ),
      this.addDataEntry(
        dt + 'containment relationship',
        300,
        180,
      ...
      this.addEntry(dt + 'copy dependency', function () {
        ...
        var edge1 = new mxCell(
          '&lt;&lt;copy&gt;&gt;',
          new mxGeometry(0, 0, 0, 0),
          'endArrow=open;edgeStyle=none;endSize=12;dashed=1;html=1;',
        );
        edge1.geometry.relative = true;
        edge1.edge = true;
        cardCell.insertEdge(edge1, true);
      ...
      this.addEntry(dt + 'master callout', function () {
        ...
        var edge1 = new mxCell(
          '',
          new mxGeometry(0, 0, 0, 0),
          'endArrow=none;html=1;edgeStyle=none;dashed=1;',
        );
        edge1.geometry.relative = true;
        edge1.edge = true;
        cardCell.insertEdge(edge1, true);
      ...
      this.addEntry(dt + 'derive dependency', function () {
        ...
        var edge1 = new mxCell(
          '&lt;&lt;deriveReq&gt;&gt;',
          new mxGeometry(0, 0, 0, 0),
          'endArrow=open;html=1;edgeStyle=none;endSize=12;dashed=1;',
        );
        edge1.geometry.relative = true;
        edge1.edge = true;
        cardCell.insertEdge(edge1, true);
      ...
      this.addEntry(dt + 'derive callout', function () {
        ...
        var edge1 = new mxCell(
          '',
          new mxGeometry(0, 0, 0, 0),
          'endArrow=none;edgeStyle=none;dashed=1;html=1;',
        );
        edge1.geometry.relative = true;
        edge1.edge = true;
        cardCell.insertEdge(edge1, true);
  ...
  Sidebar.prototype.addSysMLProfilesPalette = function (expand) {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'stereotype').join(' '),
      ),
      this.createVertexTemplateEntry(
        'shape=rect;html=1;whiteSpace=wrap;align=center;',
        160,
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'metaclass').join(' '),
      ),
      this.createVertexTemplateEntry(
        'shape=folder;tabWidth=80;tabHeight=20;tabPosition=left;html=1;whiteSpace=wrap;align=center;',
        160,
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'profile').join(' '),
      ),
      this.createVertexTemplateEntry(
        'shape=folder;tabWidth=80;tabHeight=20;tabPosition=left;html=1;whiteSpace=wrap;align=center;',
        160,
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'model library').join(' '),
      ),
      ...
      this.createEdgeTemplateEntry(
        ...
        'Profile Application',
        null,
        this.getTagsForStencil(gn, '', dt + 'profile application').join(' '),
      ),
      this.createEdgeTemplateEntry(
        ...
        'Metamodel Reference',
        null,
        this.getTagsForStencil(gn, '', dt + 'metamodel reference').join(' '),
      ),
      this.createEdgeTemplateEntry(
        ...
        null,
        this.getTagsForStencil(gn, '', dt + 'unidirectional association').join(' '),
      ),
    ];
  ...
  Sidebar.prototype.addSysMLStereotypesPalette = function (expand) {
    ...
    var fns = [
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'node').join(' '),
      ),
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'compartment').join(' '),
      ),
      this.addDataEntry(
        dt + 'edge',
        200,
