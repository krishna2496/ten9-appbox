...
const { mxCell, mxPoint, mxUtils } = require('../../jgraph/mxClient.js');
...
(function () {
  ...
  Sidebar.prototype.addArchimate3ApplicationPalette = function () {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        am2 + 'application;appType=comp;archiType=square;',
        w * 150,
        h * 75,
        '',
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'component').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'component;',
        w * 70,
      ...
      this.createVertexTemplateEntry(
        am2 + 'application;appType=collab;archiType=square;',
        w * 150,
        h * 75,
        '',
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'collaboration').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'collaboration;',
        w * 60,
      ...
      this.createVertexTemplateEntry(
        am2 + 'application;appType=interface;archiType=square;',
        w * 150,
        h * 75,
        '',
      ...
      this.createVertexTemplateEntry(
        am2 + 'application;appType=proc;archiType=rounded;',
        w * 150,
        h * 75,
        '',
        'Application Process',
      ...
      this.createVertexTemplateEntry(
        am2 + 'application;appType=func;archiType=rounded;',
        w * 150,
        h * 75,
        '',
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'function').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'function;',
        w * 75,
      ...
      this.createVertexTemplateEntry(
        am2 + 'application;appType=interaction;archiType=rounded;',
        w * 150,
        h * 75,
        '',
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'interaction').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'interaction;',
        w * 75,
      ...
      this.createVertexTemplateEntry(
        am2 + 'application;appType=serv;archiType=rounded',
        w * 150,
        h * 75,
        '',
        'Application Service',
      ...
      this.createVertexTemplateEntry(
        am2 + 'application;appType=event;archiType=rounded',
        w * 150,
        h * 75,
        '',
        'Application Event',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'event').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'event;',
        w * 60,
      ...
      this.createVertexTemplateEntry(
        am2 + 'businessObject;overflow=fill',
        w * 150,
        h * 75,
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'data object').join(' '),
      ),
    ];
  ...
  Sidebar.prototype.addArchimate3BusinessPalette = function () {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        am2 + 'application;appType=actor;archiType=square;',
        w * 150,
        h * 75,
        '',
        'Business Actor',
      ...
      this.createVertexTemplateEntry(
        am2 + 'application;appType=role;archiType=square;',
        w * 150,
        h * 75,
        '',
        'Business Role',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'role').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'role;',
        w * 85,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'contract').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'product;',
        w * 150,
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'product').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'representation;',
        w * 150,
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'representation').join(' '),
      ),
    ];
  ...
  Sidebar.prototype.addArchimate3CompositePalette = function () {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        am2 + 'application;appType=location;archiType=square;',
        w * 150,
        h * 75,
        '',
        'Location',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'location').join(' '),
      ),
      this.createVertexTemplateEntry(
  ...
  Sidebar.prototype.addArchimate3ImplementationAndMigrationPalette = function () {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        am2 + 'application;archiType=rounded;',
        w * 150,
        h * 75,
        '',
        'Work Package',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'work package').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'application;appType=event;archiType=rounded;',
        w * 150,
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'implementation event').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'event;',
        w * 60,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'deliverable').join(' '),
      ),
      this.createVertexTemplateEntry(
        am3 + 'tech;techType=plateau;',
        w * 150,
        h * 75,
        '',
        'Plateau',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'plateau').join(' '),
      ),
      this.createVertexTemplateEntry(
        am3 + 'gap;',
        w * 150,
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'gap').join(' '),
      ),
    ];
  ...
  Sidebar.prototype.addArchimate3MotivationPalette = function () {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        am2 + 'application;appType=role;archiType=oct;',
        w * 150,
        h * 75,
        '',
        'Stakeholder',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'stakeholder').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'application;appType=driver;archiType=oct;',
        w * 150,
        h * 75,
        '',
        'Driver',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'driver').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'application;appType=assess;archiType=oct;',
        w * 150,
        h * 75,
        '',
        'Assesment',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'assessment').join(' '),
      ),
      this.createVertexTemplateEntry(
        'shape=ellipse;html=1;whiteSpace=wrap;fillColor=#CCCCFF;perimeter=ellipsePerimeter;',
        w * 150,
        h * 75,
        '',
        'Value',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'value').join(' '),
      ),
      this.createVertexTemplateEntry(
        'shape=cloud;html=1;whiteSpace=wrap;fillColor=#CCCCFF;',
        w * 150,
        h * 75,
        '',
        'Meaning',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'meaning').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'application;appType=goal;archiType=oct;',
        w * 150,
        h * 75,
        '',
        'Goal',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'goal').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'application;appType=outcome;archiType=oct;',
        w * 150,
        h * 75,
        '',
        'Outcome',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'outcome').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'application;appType=principle;archiType=oct;',
        w * 150,
        h * 75,
        '',
        'Principle',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'principle').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'application;appType=requirement;archiType=oct;',
        w * 150,
        h * 75,
        '',
        'Requirement',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'requirement').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'requirement;',
        w * 100,
      ...
      this.createVertexTemplateEntry(
        am2 + 'application;appType=constraint;archiType=oct;',
        w * 150,
        h * 75,
        '',
        'Constraint',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'constraint').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'constraint;',
        w * 100,
  ...
  Sidebar.prototype.addArchimate3PhysicalPalette = function () {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'facility').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'tech;techType=equipment;',
        w * 150,
        h * 75,
        '',
        'Equipment',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'equipment').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'application;appType=material;archiType=square;',
        w * 150,
        h * 75,
        '',
        'Material',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'material').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'application;appType=distribution;archiType=square;',
        w * 150,
        h * 75,
        '',
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'distribution').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'distribution;',
        w * 90,
  ...
  Sidebar.prototype.addArchimate3RelationshipsPalette = function () {
    ...
    var fns = [
      this.createEdgeTemplateEntry(
        'html=1;endArrow=diamondThin;endFill=1;edgeStyle=elbowEdgeStyle;elbow=vertical;endSize=10;',
        w * 160,
        0,
        '',
        'Composition',
        null,
        this.getTagsForStencil(gn, '', dt + 'composition').join(' '),
      ),
      this.createEdgeTemplateEntry(
        'html=1;endArrow=diamondThin;endFill=0;edgeStyle=elbowEdgeStyle;elbow=vertical;endSize=10;',
        w * 160,
        0,
        '',
        'Aggregation',
        null,
        this.getTagsForStencil(gn, '', dt + 'aggregation').join(' '),
      ),
      this.createEdgeTemplateEntry(
        ...
        'Assignment',
        null,
        this.getTagsForStencil(gn, '', dt + 'assignment').join(' '),
      ),
      this.createEdgeTemplateEntry(
      ...
      this.createEdgeTemplateEntry(
        ...
        'Serving',
        null,
        this.getTagsForStencil(gn, '', dt + 'serving').join(' '),
      ),
      this.createEdgeTemplateEntry(
        ...
        'Access',
        null,
        this.getTagsForStencil(gn, '', dt + 'access').join(' '),
      ),
      this.createEdgeTemplateEntry(
      ...
      this.createEdgeTemplateEntry(
        ...
        'Triggering',
        null,
        this.getTagsForStencil(gn, '', dt + 'triggering').join(' '),
      ),
      this.createEdgeTemplateEntry(
        ...
        'Flow',
        null,
        this.getTagsForStencil(gn, '', dt + 'flow').join(' '),
      ),
      this.createEdgeTemplateEntry(
        ...
        'Specialization',
        null,
        this.getTagsForStencil(gn, '', dt + 'specialization').join(' '),
      ),
      this.createEdgeTemplateEntry(
      ...
      this.createVertexTemplateEntry(
        'ellipse;html=1;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;fillColor=#000000',
        10,
        10,
        '',
        'And Junction',
        null,
        this.getTagsForStencil(gn, '', dt + 'junction').join(' '),
      ),
      this.createVertexTemplateEntry(
  ...
  Sidebar.prototype.addArchimate3StrategyPalette = function () {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        am2 + 'application;appType=resource;archiType=square;',
        w * 150,
        h * 75,
        '',
        'Resource',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'resource').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'application;appType=capability;archiType=rounded;',
        w * 150,
        h * 75,
        '',
        'Capability',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'capability').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'application;appType=course;archiType=rounded;',
        w * 150,
        h * 75,
        '',
        'Course of Action',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'course action').join(' '),
      ),
    ];
  ...
  Sidebar.prototype.addArchimate3TechnologyPalette = function () {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        am2 + 'application;appType=node;archiType=square;',
        w * 150,
        h * 75,
        '',
        'Node',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'device').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'device;',
        w * 80,
      ...
      this.createVertexTemplateEntry(
        am2 + 'application;appType=sysSw;archiType=square;',
        w * 150,
        h * 75,
        '',
        'System Software',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'system software').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'tech;techType=sysSw;',
        w * 120,
        h * 75,
        '',
        'System Software',
      ...
      this.createVertexTemplateEntry(
        am2 + 'application;appType=artifact;archiType=square;',
        w * 150,
        h * 75,
        '',
        'Technology Artifact',
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'artifact').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'artifact;',
        w * 50,
      ...
      this.createVertexTemplateEntry(
        am2 + 'application;appType=netw;archiType=square;',
        w * 150,
        h * 75,
        '',
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'communication network').join(' '),
      ),
      this.createVertexTemplateEntry(
        am2 + 'commNetw;strokeWidth=6;',
        w * 100,
        h * 30,
        '',
        'Communication Network',
      ...
      this.createVertexTemplateEntry(
        am2 + 'application;appType=path;archiType=square;',
        w * 150,
        h * 75,
        '',
        'Path',
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, '', dt + 'path').join(' '),
      ),
    ];
