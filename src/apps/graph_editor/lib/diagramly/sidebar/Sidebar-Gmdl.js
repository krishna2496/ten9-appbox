...
const { mxCell, mxGeometry, mxPoint, mxUtils } = require('../../jgraph/mxClient.js');
...
(function () {
  ...
  Sidebar.prototype.addGMDLBottomSheetsPalette = function (expand) {
    ...
    var fns = [
      ...
      this.addDataEntry(
        dt + 'grid style all options',
        358,
        642,
        'Grid Style With All Options',
      ...
      this.addDataEntry(
        dt + 'bottom sheet menu items subtext',
        358,
        360,
        'Bottom Sheet (menu items with subtext)',
      ...
      this.addDataEntry(
        dt + 'deep linked modal bottom sheet',
        358,
        642,
        'Deep-linked modal bottom sheet',
  ...
  Sidebar.prototype.addGMDLButtonsPalette = function (expand) {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        s + 'rect;fillColor=#e0e0e0;strokeColor=none;fontStyle=1;shadow=1',
        100,
        36,
        'NORMAL',
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'button', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s + 'rect;fillColor=#e0e0e0;strokeColor=none;fontStyle=1;shadow=1',
        100,
      ...
      this.createVertexTemplateEntry(
        s + 'rect;fillColor=#000000;strokeColor=none;fontStyle=1;opacity=12;fontColor=#BDBDBD;',
        100,
        36,
        'DISABLED',
        'Raised Button (Pressed)',
      ...
      this.createVertexTemplateEntry(
        s + 'rect;fillColor=#2196F3;strokeColor=none;fontStyle=1;shadow=1;fontColor=#ffffff;',
        100,
        36,
        'NORMAL',
        'Raised Button (Normal)',
      ...
      this.createVertexTemplateEntry(
        s + 'rect;strokeColor=none;fontStyle=1;opacity=12;fontColor=#BDBDBD;shadow=0;',
        100,
        36,
        'DISABLED',
        'Raised Button (Pressed)',
      ...
      this.createVertexTemplateEntry(
        s + 'rect;fillColor=none;strokeColor=none;fontStyle=1;shadow=0;',
        100,
        36,
        'NORMAL',
        'Raised Button (Normal)',
      ...
      this.createVertexTemplateEntry(
        s + 'rect;fillColor=#999999;opacity=20;strokeColor=none;fontStyle=1;shadow=0;',
        100,
        36,
        'HOVER',
        'Raised Button (Hover)',
      ...
      this.createVertexTemplateEntry(
        s + 'rect;fillColor=#999999;opacity=40;strokeColor=none;fontStyle=1;',
        100,
        36,
        'PRESSED',
        'Raised Button (Pressed)',
      ...
      this.createVertexTemplateEntry(
        s + 'rect;opacity=26;strokeColor=none;fontStyle=1;opacity=12;fontColor=#BDBDBD;shadow=0;',
        100,
        36,
        'DISABLED',
        'Raised Button (Pressed)',
      ...
      this.createVertexTemplateEntry(
        s + 'rect;fillColor=none;strokeColor=none;fontStyle=1;fontColor=#ffffff;shadow=0;',
        100,
        36,
        'NORMAL',
        'Raised Button (Normal)',
      ...
      this.createVertexTemplateEntry(
        s +
          'rect;fillColor=#cccccc;opacity=15;strokeColor=none;fontStyle=1;fontColor=#ffffff;shadow=0;',
        100,
        36,
        'HOVER',
        'Raised Button (Hover)',
      ...
      this.createVertexTemplateEntry(
        s +
          'rect;fillColor=#cccccc;opacity=25;strokeColor=none;fontStyle=1;fontColor=#ffffff;shadow=0;',
        100,
        36,
        'PRESSED',
        'Raised Button (Pressed)',
      ...
      this.createVertexTemplateEntry(
        s +
          'rect;fillColor=none;strokeColor=none;fontStyle=1;opacity=12;fontColor=#BDBDBD;shadow=1;',
        100,
        36,
        'DISABLED',
        'Raised Button (Pressed)',
      ...
      this.addDataEntry(
        dt + 'dropdown button selected editable',
        100,
        150,
      ...
      this.addDataEntry(
        dt + 'persistent footer button fixed',
        300,
        40,
        'Persistent Footer Buttons (fixed)',
      ...
      this.addEntry(dt + 'floating action button', function () {
        var bg1 = new mxCell(
          '',
          new mxGeometry(0, 0, 56, 56),
          'shape=ellipse;fillColor=#FF4081;strokeColor=none;shadow=1;aspect=fixed;',
        );
        bg1.vertex = true;
        var part1 = new mxCell(
          '',
          new mxGeometry(20, 20, 16, 16),
          s2 + 'plus;strokeColor=#ffffff;strokeWidth=2;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(18, 18, 20, 20),
          s2 + 'edit;strokeColor=none;fillColor=#737373;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(18, 18, 20, 20),
          s2 + 'star;strokeColor=none;fillColor=#737373;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(18, 19, 20, 18),
          s2 + 'heart;strokeColor=none;fillColor=#737373;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(18, 19, 20, 18),
          s2 + 'reply;strokeColor=none;fillColor=#737373;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(18, 20, 24, 16),
          s2 + 'users;strokeColor=#ffffff;fillColor=#737373;strokeWidth=2;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(18, 18, 20, 20),
          s2 + 'gps;strokeColor=#737373;fillColor=#737373;strokeWidth=2;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(18, 18, 20, 20),
          s2 + 'share2;strokeColor=none;fillColor=#737373;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(18, 18, 20, 20),
          s2 + 'navigate;strokeColor=none;fillColor=#737373;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(18, 18, 20, 20),
          s2 + 'chat;strokeColor=#737373;fillColor=#737373;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(22, 18, 12, 20),
          s2 + 'voice;strokeColor=#737373;fillColor=#737373;strokeWidth=2;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(20, 16, 16, 24),
          s2 + 'google;strokeColor=none;fillColor=#737373;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(16, 20, 24, 16),
          s2 + 'video;strokeColor=none;fillColor=#737373;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(16, 17, 24, 22),
          s2 + 'gallery;strokeColor=none;fillColor=#737373;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(16, 17, 24, 22),
          s2 + 'birthday;strokeColor=none;fillColor=#737373;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(16, 20, 24, 16),
          s2 + 'cloud;strokeColor=none;fillColor=#737373;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(20, 20, 16, 16),
          s2 + 'x;strokeColor=#737373;strokeWidth=2;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(22, 18, 12, 20),
          s2 + 'bookmark;strokeColor=none;fillColor=#737373;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(18, 18, 20, 20),
          s2 + 'calendar;strokeColor=none;fillColor=#737373;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(17, 20, 22, 16),
          s2 + 'attractions;strokeColor=#ffffff;fillColor=#737373;strokeWidth=1;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(20, 18, 16, 20),
          s2 + 'dining;strokeColor=none;fillColor=#737373;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(18, 18, 20, 20),
          s2 + 'education;strokeColor=none;fillColor=#737373;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(18, 18, 20, 20),
          s2 + 'family;strokeColor=none;fillColor=#737373;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(18, 19, 20, 18),
          s2 + 'health;strokeColor=none;fillColor=#737373;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(18, 18, 20, 20),
          s2 + 'office;strokeColor=none;fillColor=#737373;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(18, 18, 20, 20),
          s2 + 'promotions;strokeColor=none;fillColor=#737373;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(18, 18, 20, 20),
          s2 + 'radio;strokeColor=none;fillColor=#737373;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(18, 18, 20, 20),
          s2 + 'recipes;strokeColor=none;fillColor=#737373;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(18, 18, 20, 20),
          s2 + 'sports;strokeColor=none;fillColor=#737373;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(18, 18, 20, 20),
          s2 + 'travel;strokeColor=none;fillColor=#737373;direction=south;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells([bg1], 56, 56, 'Floating Action Button');
      ...
      this.addEntry(dt + 'floating action button mini', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(12, 12, 16, 16),
          s2 + 'plus;strokeColor=#737373;strokeWidth=2;shadow=0;',
        );
        part1.vertex = true;
        bg1.insert(part1);
  ...
  Sidebar.prototype.addGMDLCardsPalette = function (expand) {
    ...
    var fns = [
      ...
      this.addDataEntry(
        dt + 'card collection varied layouts',
        358,
        642,
        'Card collection with varied layouts',
      ...
      this.addEntry(dt + 'card', function () {
        var bg1 = new mxCell(
          '',
          new mxGeometry(0, 0, 344, 254),
          'shape=rect;fillColor=#BDBDBD;strokeColor=#BDBDBD;shadow=1;',
        );
        bg1.vertex = true;
        var part1 = new mxCell(
          'Greyhound divisively hello couldly wonderfully marginally far upon excluding.',
          new mxGeometry(0, 172, 344, 82),
          'shape=rect;strokeColor=none;whiteSpace=wrap;align=left;spacingLeft=16;fontColor=#666666;fontSize=14;',
        );
        part1.vertex = true;
        bg1.insert(part1);
      ...
      this.addDataEntry(
        dt + 'card ui controls user interface',
        342,
        522,
  ...
  Sidebar.prototype.addGMDLChipsPalette = function (expand) {
    ...
    var fns = [
      ...
      this.addEntry(dt + 'chip', function () {
        var bg = new mxCell(
          'ANZ Bank',
          new mxGeometry(0, 0, 170, 32),
          'shape=rect;arcSize=50;strokeColor=none;fillColor=#eeeeee;rounded=1;spacingLeft=24;fontSize=13;align=center;',
        );
        bg.vertex = true;
        var part1 = new mxCell(
          'A',
          new mxGeometry(0, 0, 32, 32),
          'shape=ellipse;strokeColor=none;fillColor=#009587;fontColor=#ffffff;fontSize=14;',
        );
  ...
  Sidebar.prototype.addGMDLDialogsPalette = function (expand) {
    ...
    var fns = [
      ...
      this.addDataEntry(
        dt + 'scrollable dialog persistent footer',
        280,
        345,
  ...
  Sidebar.prototype.addGMDLDividersPalette = function (expand) {
    ...
    var fns = [
      this.addDataEntry(
        dt + 'email list full bleed divider',
        358,
        642,
        'Full-bleed dividers',
      ...
      this.addDataEntry(
        dt + 'full bleed divider compose email',
        358,
        642,
        'Full-bleed dividers (Compose email)',
      ...
      this.addDataEntry(
        dt + 'image based content divider',
        358,
        642,
        'Image based content dividers',
  ...
  Sidebar.prototype.addGMDLIconsPalette = function (expand) {
    var s2 =
      'dashed=0;aspect=fixed;verticalLabelPosition=bottom;verticalAlign=top;align=center;shape=mxgraph.gmdl.';
    var gn = 'mxgraph.gmdl';
    ...
    var fns = [
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'edit', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'star;strokeColor=none;fillColor=#737373;shadow=0;',
        20,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'star', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'heart;strokeColor=none;fillColor=#737373;shadow=0;',
        20,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'reply', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'users;strokeColor=none;fillColor=#737373;shadow=0;',
        24,
        16,
        '',
        'Users',
      ...
      this.createVertexTemplateEntry(
        s2 + 'gps;strokeColor=#737373;fillColor=#737373;shadow=0;strokeWidth=2;',
        20,
        20,
        '',
        'GPS',
        null,
        null,
        this.getTagsForStencil(gn, 'gps', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'share2;strokeColor=none;fillColor=#737373;shadow=0;',
        20,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'share', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'navigate;strokeColor=none;fillColor=#737373;shadow=0;',
        20,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'navigate', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'chat;strokeColor=none;fillColor=#737373;shadow=0;',
        20,
        20,
        '',
        'Chat',
        null,
        null,
        this.getTagsForStencil(gn, 'chat', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'voice;strokeColor=#737373;fillColor=#737373;shadow=0;strokeWidth=2;',
        12,
        20,
        '',
        'Voice',
        null,
        null,
        this.getTagsForStencil(gn, 'voice', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'google;strokeColor=none;fillColor=#737373;shadow=0;',
        16,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'google', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'video;strokeColor=none;fillColor=#737373;shadow=0;',
        24,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'video', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'gallery;strokeColor=none;fillColor=#737373;shadow=0;',
        24,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'gallery', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'birthday;strokeColor=none;fillColor=#737373;shadow=0;',
        24,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'birthday', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'cloud;strokeColor=none;fillColor=#737373;shadow=0;',
        24,
      ...
      this.createVertexTemplateEntry(
        s2 + 'x;strokeColor=#737373;fillColor=#737373;shadow=0;strokeWidth=2;',
        16,
        16,
        '',
        'X',
        null,
        null,
        this.getTagsForStencil(gn, 'x', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'bookmark;strokeColor=none;fillColor=#737373;shadow=0;',
        12,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'bookmark', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'calendar;strokeColor=none;fillColor=#737373;shadow=0;',
        20,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'calendar', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'attractions;strokeColor=#ffffff;fillColor=#737373;shadow=0;strokeWidth=1;',
        22,
        18,
        '',
        'Attraction',
        null,
        null,
        this.getTagsForStencil(gn, 'attraction', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'dining;strokeColor=none;fillColor=#737373;shadow=0;',
        18,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'dining', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'education;strokeColor=none;fillColor=#737373;shadow=0;',
        20,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'family', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'health;strokeColor=none;fillColor=#737373;shadow=0;',
        20,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'office', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'promotions;strokeColor=none;fillColor=#737373;shadow=0;',
        20,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'promotion', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'radio;strokeColor=none;fillColor=#737373;shadow=0;',
        20,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'radio', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'recipes;strokeColor=none;fillColor=#737373;shadow=0;',
        20,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'recipe', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'sports;strokeColor=none;fillColor=#737373;shadow=0;',
        20,
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'sports', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 + 'travel;strokeColor=none;fillColor=#737373;shadow=0;direction=south;',
        20,
        20,
        '',
        'Travel',
  ...
  Sidebar.prototype.addGMDLListsPalette = function (expand) {
    ...
    var fns = [
      ...
      this.addDataEntry(
        dt + 'three line list avatar icon',
        358,
        642,
        'Three-line list with avatar and icons',
  ...
  Sidebar.prototype.addGMDLMenusPalette = function (expand) {
    ...
    var fns = [
      ...
      this.addDataEntry(
        dt + 'simple menu multi line',
        280,
        328,
        'Simple menu (multi-line)',
  ...
  Sidebar.prototype.addGMDLMiscPalette = function (expand) {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        'shape=rect;fillColor=#eeeeee;strokeColor=none;',
        358,
        642,
        '',
        'Background (Light)',
        null,
        null,
        this.getTagsForStencil(gn, 'background', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
      ...
      this.addEntry(dt + 'snackbar', function () {
        var bg1 = new mxCell(
          'Archived',
          new mxGeometry(0, 0, 358, 48),
          'shape=rect;strokeColor=none;fillColor=#333333;fontColor=#FFFFFF;align=left;spacing=16;fontSize=13;spacingLeft=8;',
        );
        bg1.vertex = true;
        var text1 = new mxCell(
          'UNDO',
          new mxGeometry(1, 0, 88, 48),
          'text;verticalAlign=middle;align=center;fontColor=#EEFF41;fontSize=14;resizeHeight=1;',
        );
  ...
  Sidebar.prototype.addGMDLPickersPalette = function (expand) {
    ...
    var fns = [
      ...
      this.addDataEntry(
        dt + 'time picker landscape light',
        512,
        304,
        'Time picker (landscape, light)',
      ...
      this.addDataEntry(
        dt + 'time picker landscape dark',
        512,
        304,
        'Time picker (landscape, dark)',
      ...
      this.addDataEntry(
        dt + 'date picker landscape light',
        512,
        304,
        'Date picker (landscape, light)',
  ...
  Sidebar.prototype.addGMDLSelectionControlsPalette = function (expand) {
    ...
    var fns = [
      this.addEntry(dt + 'checkbox on hover light dark', function () {
        var bg1 = new mxCell(
          '',
          new mxGeometry(0, 0, 16, 16),
          s2 + 'checkbox;strokeColor=none;fillColor=#009587;strokeWidth=2;aspect=fixed;',
        );
        bg1.vertex = true;
      ...
      this.addEntry(dt + 'checkbox on focused pressed light dark', function () {
        var bg1 = new mxCell(
          '',
          new mxGeometry(0, 0, 48, 48),
          'shape=ellipse;labelPosition=right;align=left;strokeColor=none;fillColor=#009587;opacity=10;',
        );
        bg1.vertex = true;
        var part1 = new mxCell(
          '',
          new mxGeometry(16, 16, 16, 16),
          s2 + 'checkbox;strokeColor=none;fillColor=#009587;strokeWidth=2;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells(
      ...
      this.addEntry(dt + 'checkbox on disabled light', function () {
        var bg1 = new mxCell(
          '',
          new mxGeometry(0, 0, 16, 16),
          s2 + 'checkbox;strokeColor=none;fillColor=#B0B0B0;strokeWidth=2;aspect=fixed;',
        );
        bg1.vertex = true;
      ...
      this.addEntry(dt + 'checkbox on disabled focused light', function () {
        var bg1 = new mxCell(
          '',
          new mxGeometry(0, 0, 48, 48),
          'shape=ellipse;labelPosition=right;align=left;strokeColor=none;fillColor=#B0B0B0;opacity=10;',
        );
        bg1.vertex = true;
        var part1 = new mxCell(
          '',
          new mxGeometry(16, 16, 16, 16),
          s2 + 'checkbox;strokeColor=none;fillColor=#B0B0B0;strokeWidth=2;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells(
      ...
      this.addEntry(dt + 'checkbox off hover light', function () {
        var bg1 = new mxCell(
          '',
          new mxGeometry(0, 0, 16, 16),
          s2 + 'checkbox;strokeColor=#666666;fillColor=none;strokeWidth=2;aspect=fixed;',
        );
        bg1.vertex = true;
      ...
      this.addEntry(dt + 'checkbox off focused pressed light', function () {
        var bg1 = new mxCell(
          '',
          new mxGeometry(0, 0, 48, 48),
          'shape=ellipse;labelPosition=right;align=left;strokeColor=none;fillColor=#666666;opacity=10;',
        );
        bg1.vertex = true;
        var part1 = new mxCell(
          '',
          new mxGeometry(16, 16, 16, 16),
          s2 + 'checkbox;strokeColor=#666666;fillColor=none;strokeWidth=2;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells(
      ...
      this.addEntry(dt + 'checkbox off disabled light', function () {
        var bg1 = new mxCell(
          '',
          new mxGeometry(0, 0, 16, 16),
          s2 + 'checkbox;strokeColor=#B0B0B0;fillColor=none;strokeWidth=2;aspect=fixed;',
        );
        bg1.vertex = true;
      ...
      this.addEntry(dt + 'checkbox off disabled focused light', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(16, 16, 16, 16),
          s2 + 'checkbox;strokeColor=#B0B0B0;fillColor=none;strokeWidth=2;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells(
          ...
          48,
          48,
          'Checkbox (off, disabled, focused, light))',
        );
      }),
      this.addEntry(dt + 'checkbox on disabled dark', function () {
        var bg1 = new mxCell(
          '',
          new mxGeometry(0, 0, 16, 16),
          s2 + 'checkbox;strokeColor=none;fillColor=#676767;strokeWidth=2;aspect=fixed;',
        );
        bg1.vertex = true;
      ...
      this.addEntry(dt + 'checkbox on disabled focused dark', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(16, 16, 16, 16),
          s2 + 'checkbox;strokeColor=none;fillColor=#676767;strokeWidth=2;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells(
          ...
          48,
          48,
          'Checkbox (on, disabled, focused, dark))',
        );
      }),
      this.addEntry(dt + 'checkbox off hover dark', function () {
        var bg1 = new mxCell(
          '',
          new mxGeometry(0, 0, 16, 16),
          s2 + 'checkbox;strokeColor=#ffffff;fillColor=none;strokeWidth=2;aspect=fixed;',
        );
        bg1.vertex = true;
      ...
      this.addEntry(dt + 'checkbox off focused pressed dark', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(16, 16, 16, 16),
          s2 + 'checkbox;strokeColor=#ffffff;fillColor=none;strokeWidth=2;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells(
          ...
          48,
          48,
          'Checkbox (off, focused or pressed, dark))',
        );
      }),
      ...
      this.addEntry(dt + 'checkbox off disabled focused dark', function () {
        ...
        return sb.createVertexTemplateFromCells(
          ...
          48,
          48,
          'Checkbox (off, disabled, focused, dark))',
        );
      }),
      this.addEntry(dt + 'radio button on hover light dark', function () {
        var bg1 = new mxCell(
          '',
          new mxGeometry(0, 0, 16, 16),
          s2 + 'radiobutton;strokeColor=#009587;fillColor=#009587;strokeWidth=2;aspect=fixed;',
        );
        bg1.vertex = true;
      ...
      this.addEntry(dt + 'radio button on focused pressed light dark', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(16, 16, 16, 16),
          s2 + 'radiobutton;strokeColor=#009587;fillColor=#009587;strokeWidth=2;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells(
          ...
          48,
          48,
          'Radio button (on, focused or pressed))',
        );
      }),
      this.addEntry(dt + 'radio button on disabled light', function () {
        var bg1 = new mxCell(
          '',
          new mxGeometry(0, 0, 16, 16),
          s2 + 'radiobutton;strokeColor=#B0B0B0;fillColor=#B0B0B0;strokeWidth=2;aspect=fixed;',
        );
        bg1.vertex = true;
        return sb.createVertexTemplateFromCells(
          [bg1],
      ...
      this.addEntry(dt + 'radio button on disabled focused light', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(16, 16, 16, 16),
          s2 + 'radiobutton;strokeColor=#B0B0B0;fillColor=#B0B0B0;strokeWidth=2;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells(
          ...
          48,
          48,
          'Radio button (on, disabled, focused, light))',
        );
      }),
      this.addEntry(dt + 'radio button off hover light', function () {
        var bg1 = new mxCell(
          '',
          new mxGeometry(0, 0, 16, 16),
          s2 + 'radiobutton;strokeColor=#666666;fillColor=none;strokeWidth=2;aspect=fixed;',
        );
        bg1.vertex = true;
      ...
      this.addEntry(dt + 'radio button off focused pressed light', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(16, 16, 16, 16),
          s2 + 'radiobutton;strokeColor=#666666;fillColor=none;strokeWidth=2;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells(
          ...
          48,
          48,
          'Radio button (off, focused or pressed, light))',
        );
      }),
      this.addEntry(dt + 'radio button off disabled light', function () {
        var bg1 = new mxCell(
          '',
          new mxGeometry(0, 0, 16, 16),
          s2 + 'radiobutton;strokeColor=#B0B0B0;fillColor=none;strokeWidth=2;aspect=fixed;',
        );
        bg1.vertex = true;
        return sb.createVertexTemplateFromCells(
          [bg1],
      ...
      this.addEntry(dt + 'radio button off disabled focused light', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(16, 16, 16, 16),
          s2 + 'radiobutton;strokeColor=#B0B0B0;fillColor=none;strokeWidth=2;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells(
          ...
          48,
          48,
          'Radio button (off, disabled, focused, light))',
        );
      }),
      this.addEntry(dt + 'radio button on disabled dark', function () {
        var bg1 = new mxCell(
          '',
          new mxGeometry(0, 0, 16, 16),
          s2 + 'radiobutton;strokeColor=#676767;fillColor=#676767;strokeWidth=2;aspect=fixed;',
        );
        bg1.vertex = true;
        return sb.createVertexTemplateFromCells(
          [bg1],
      ...
      this.addEntry(dt + 'radio button on disabled focused dark', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(16, 16, 16, 16),
          s2 + 'radiobutton;strokeColor=#676767;fillColor=#676767;strokeWidth=2;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells(
          ...
          48,
          48,
          'Radio button (on, disabled, focused, dark))',
        );
      }),
      this.addEntry(dt + 'radio button off hover dark', function () {
        var bg1 = new mxCell(
          '',
          new mxGeometry(0, 0, 16, 16),
          s2 + 'radiobutton;strokeColor=#ffffff;fillColor=none;strokeWidth=2;aspect=fixed;',
        );
        bg1.vertex = true;
      ...
      this.addEntry(dt + 'radio button off focused pressed dark', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(16, 16, 16, 16),
          s2 + 'radiobutton;strokeColor=#ffffff;fillColor=none;strokeWidth=2;',
        );
        part1.vertex = true;
        bg1.insert(part1);
        return sb.createVertexTemplateFromCells(
          ...
          48,
          48,
          'Radio button (off, focused or pressed, dark))',
        );
      }),
      this.addEntry(dt + 'radio button off disabled dark', function () {
        ...
        return sb.createVertexTemplateFromCells(
          ...
          16,
          16,
          'Radio button (off, disabled, dark))',
        );
      }),
      this.addEntry(dt + 'radio button off disabled focused dark', function () {
        ...
        return sb.createVertexTemplateFromCells(
          ...
          48,
          48,
          'Radio button (off, disabled, focused, dark))',
        );
      }),
      this.addEntry(dt + 'switch on light', function () {
        var bg1 = new mxCell(
          '',
          new mxGeometry(0, 0, 36, 20),
          s2 + 'switch;aspect=fixed;switchState=on;strokeColor=none;fillColor=#0E9D57;',
        );
        bg1.vertex = true;
      ...
      this.addEntry(dt + 'switch on dark', function () {
        var bg1 = new mxCell(
          '',
          new mxGeometry(0, 0, 36, 20),
          s2 + 'switch;aspect=fixed;switchState=on;strokeColor=none;fillColor=#80CBC4;',
        );
        bg1.vertex = true;
      ...
      this.addEntry(dt + 'switch off light dark', function () {
        var bg1 = new mxCell(
          '',
          new mxGeometry(0, 0, 36, 20),
          s2 + 'switch;aspect=fixed;switchState=off;strokeColor=none;fillColor=#0E9D57;',
        );
        bg1.vertex = true;
  ...
  Sidebar.prototype.addGMDLSlidersPalette = function (expand) {
    var s = 'dashed=0;shape=';
    var s2 =
      'dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;shape=mxgraph.gmdl.';
    var gn = 'mxgraph.gmdl';
    ...
    var fns = [
      this.createVertexTemplateEntry(
        s2 +
          'slider2;barPos=0;strokeColor=#bbbbbb;opacity=100;strokeWidth=2;handleSize=10;shadow=0;',
        200,
        10,
        '',
        'Slider (normal)',
        null,
        null,
        this.getTagsForStencil(gn, 'slider normal', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 +
          'slider2;barPos=50;strokeColor=#3F51B5;opacity=100;strokeWidth=2;fillColor=#3F51B5;handleSize=10;shadow=0;',
        200,
        10,
        '',
        'Slider (normal)',
      ...
      this.createVertexTemplateEntry(
        s2 +
          'slider2;barPos=100;strokeColor=#3F51B5;opacity=100;strokeWidth=2;fillColor=#3F51B5;handleSize=10;shadow=0;',
        200,
        10,
        '',
        'Slider (normal)',
      ...
      this.createVertexTemplateEntry(
        s2 +
          'sliderFocused;barPos=0;strokeColor=#bbbbbb;opacity=100;strokeWidth=2;handleSize=30;shadow=0;',
        200,
        30,
        '',
        'Slider (focused)',
        null,
        null,
        this.getTagsForStencil(gn, 'slider focused', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 +
          'sliderFocused;barPos=50;strokeColor=#3F51B5;opacity=100;strokeWidth=2;fillColor=#3F51B5;handleSize=30;shadow=0;',
        200,
        30,
        '',
        'Slider (focused)',
      ...
      this.createVertexTemplateEntry(
        s2 +
          'sliderFocused;barPos=100;strokeColor=#3F51B5;opacity=100;strokeWidth=2;fillColor=#3F51B5;handleSize=30;shadow=0;',
        200,
        30,
        '',
        'Slider (focused)',
      ...
      this.createVertexTemplateEntry(
        s2 +
          'slider2;barPos=0;strokeColor=#bbbbbb;opacity=100;strokeWidth=2;handleSize=20;shadow=0;',
        200,
        20,
        '',
        'Slider (click)',
        null,
        null,
        this.getTagsForStencil(gn, 'slider click', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 +
          'slider2;barPos=50;strokeColor=#3F51B5;opacity=100;strokeWidth=2;fillColor=#3F51B5;handleSize=20;shadow=0;',
        200,
        20,
        '',
        'Slider (click)',
      ...
      this.createVertexTemplateEntry(
        s2 +
          'slider2;barPos=100;strokeColor=#3F51B5;opacity=100;strokeWidth=2;fillColor=#3F51B5;handleSize=20;shadow=0;',
        200,
        20,
        '',
        'Slider (click)',
      ...
      this.createVertexTemplateEntry(
        s2 +
          'sliderDisabled2;strokeColor=#b0b0b0;strokeWidth=2;fillColor=none;handleSize=6;shadow=0;hPos=0;',
        210,
        20,
        '',
        'Slider (disabled)',
        null,
        null,
        this.getTagsForStencil(gn, 'slider disabled', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 +
          'sliderDisabled2;strokeColor=#b0b0b0;strokeWidth=2;fillColor=#b0b0b0;handleSize=6;shadow=0;hPos=50;',
        210,
        20,
        '',
        'Slider (disabled)',
      ...
      this.createVertexTemplateEntry(
        s2 +
          'sliderDisabled2;strokeColor=#b0b0b0;strokeWidth=2;fillColor=#b0b0b0;handleSize=6;shadow=0;hPos=100;',
        210,
        20,
        '',
        'Slider (disabled)',
      ...
      this.createVertexTemplateEntry(
        s2 + 'slider2;barPos=0;opacity=100;strokeWidth=2;fillColor=#000000;handleSize=10;shadow=0;',
        200,
        10,
        '',
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'discrete slider normal light', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 +
          'slider2;barPos=60;strokeColor=#0F9D58;opacity=100;strokeWidth=2;fillColor=#0F9D58;handleSize=10;shadow=0;',
        200,
        10,
        '',
      ...
      this.createVertexTemplateEntry(
        s2 +
          'slider2;barPos=100;strokeColor=#0F9D58;opacity=100;strokeWidth=2;fillColor=#0F9D58;handleSize=10;shadow=0;',
        200,
        10,
        '',
        'Discrete slider (normal)',
      ...
      this.createVertexTemplateEntry(
        s2 +
          'sliderDiscrete;barPos=1;strokeColor=#BEBEBE;opacity=100;strokeWidth=2;fillColor=#BEBEBE;handleSize=10;shadow=0;fontSize=12;fontColor=#ffffff;',
        200,
        45,
        '',
      ...
      this.createVertexTemplateEntry(
        s2 +
          'sliderDiscrete;barPos=60;strokeColor=#0F9D58;opacity=100;strokeWidth=2;fillColor=#0F9D58;handleSize=10;shadow=0;fontSize=12;fontColor=#ffffff;',
        200,
        45,
        '',
        'Discrete slider (focused)',
      ...
      this.createVertexTemplateEntry(
        s2 +
          'sliderDiscrete;barPos=100;strokeColor=#0F9D58;opacity=100;strokeWidth=2;fillColor=#0F9D58;handleSize=10;shadow=0;fontSize=12;fontColor=#ffffff;',
        200,
        45,
        '',
        'Discrete slider (focused)',
      ...
      this.createVertexTemplateEntry(
        s2 +
          'sliderDiscreteDots;barPos=0;bright=1;strokeColor=#0F9D58;opacity=100;strokeWidth=2;fillColor=#0F9D58;handleSize=10;shadow=0;fontSize=12;fontColor=#ffffff;',
        200,
        45,
        '',
      ...
      this.createVertexTemplateEntry(
        s2 +
          'sliderDiscreteDots;barPos=60;bright=1;strokeColor=#0F9D58;opacity=100;strokeWidth=2;fillColor=#0F9D58;handleSize=10;shadow=0;fontSize=12;fontColor=#ffffff;',
        200,
        45,
        '',
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'slider click light', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 +
          'sliderDiscreteDots;barPos=100;bright=1;strokeColor=#0F9D58;opacity=100;strokeWidth=2;fillColor=#0F9D58;handleSize=10;shadow=0;fontSize=12;fontColor=#ffffff;',
        200,
        45,
        '',
        'Discrete slider (click, light)',
      ...
      this.createVertexTemplateEntry(
        s2 +
          'sliderDisabled2;strokeColor=#b0b0b0;strokeWidth=2;fillColor=#b0b0b0;handleSize=6;shadow=0;hPos=0;',
        200,
        20,
        '',
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'discrete slider disabled', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 +
          'sliderDisabled2;strokeColor=#b0b0b0;strokeWidth=2;fillColor=#b0b0b0;handleSize=6;shadow=0;hPos=50;',
      ...
      this.createVertexTemplateEntry(
        s2 +
          'slider2;barPos=0;strokeColor=#ffffff;opacity=100;strokeWidth=2;handleSize=10;shadow=0;',
        200,
        10,
        '',
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'discrete slider normal dark', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 +
          'sliderDiscreteDots;barPos=0;bright=0;strokeColor=#0F9D58;opacity=100;strokeWidth=2;fillColor=#0F9D58;handleSize=10;shadow=0;fontSize=12;fontColor=#ffffff;',
        200,
        45,
        '',
        ...
        null,
        null,
        this.getTagsForStencil(gn, 'discrete slider click dark', dt).join(' '),
      ),
      this.createVertexTemplateEntry(
        s2 +
          'sliderDiscreteDots;barPos=60;bright=0;strokeColor=#0F9D58;opacity=100;strokeWidth=2;fillColor=#0F9D58;handleSize=10;shadow=0;fontSize=12;fontColor=#ffffff;',
        200,
        45,
        '',
        'Discrete slider (click, dark)',
      ...
      this.createVertexTemplateEntry(
        s2 +
          'sliderDiscreteDots;barPos=100;bright=0;strokeColor=#0F9D58;opacity=100;strokeWidth=2;fillColor=#0F9D58;handleSize=10;shadow=0;fontSize=12;fontColor=#ffffff;',
        200,
        45,
        '',
        'Discrete slider (click, dark)',
  ...
  Sidebar.prototype.addGMDLSteppersPalette = function (expand) {
    ...
    var fns = [
      ...
      this.addDataEntry(
        dt + 'noneditable non editable steps',
        704,
        72,
        'Non-editable Steps',
      ...
      this.addDataEntry(
        dt + 'editable steps optional',
        704,
        72,
        'Editable Steps (with optional steps)',
      ...
      this.addDataEntry(
        dt + 'noneditable non editable steps optional',
        704,
        72,
        'Non-editable Steps (with optional steps)',
      ...
      this.addDataEntry(
        dt + 'stepper alternative label placing',
        404,
        50,
      ...
      this.addDataEntry(
        dt + 'stepper alternative label placing optional',
        404,
        50,
  ...
  Sidebar.prototype.addGMDLTabsPalette = function (expand) {
    ...
    var fns = [
      ...
      this.addDataEntry(
        dt + 'fixed tab bar icons',
        358,
        642,
        'Fixed tab bar with icons',
      ...
      this.addDataEntry(
        dt + 'desktop tab bar overflow',
        758,
        152,
        'Desktop tab bar with overflow',
  ...
  Sidebar.prototype.addGMDLTextFieldsPalette = function (expand) {
    ...
    var fns = [
      ...
      this.addEntry(dt + 'single line text field normal light dark', function () {
        var text1 = new mxCell(
          'Hint text',
          new mxGeometry(0, 0, 346, 30),
          'text;fontColor=#808080;fontSize=16;verticalAlign=middle;strokeColor=none;fillColor=none;',
        );
        text1.vertex = true;
        var part1 = new mxCell(
          '',
          new mxGeometry(0, 25, 346, 10),
          s + 'line;strokeWidth=1;noLabel=1;strokeColor=#eeeeee;opacity=50;',
        );
        part1.vertex = true;
        return sb.createVertexTemplateFromCells(
          [text1, part1],
      ...
      this.addEntry(dt + 'single line text field hover light dark', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(0, 25, 346, 10),
          s + 'line;strokeWidth=1;noLabel=1;strokeColor=#cccccc;opacity=50;',
        );
        part1.vertex = true;
        return sb.createVertexTemplateFromCells(
          [text1, part1],
      ...
      this.addEntry(dt + 'single line text field press light dark', function () {
        var text1 = new mxCell(
          'Input text',
          new mxGeometry(0, 0, 346, 30),
          'text;fontColor=#808080;fontSize=16;verticalAlign=middle;strokeColor=none;fillColor=none;opacity=50;',
        );
        text1.vertex = true;
        var part1 = new mxCell(
          '',
          new mxGeometry(0, 25, 346, 10),
          s + 'line;strokeWidth=2;noLabel=1;strokeColor=#0C8CF2;opacity=50;',
        );
        part1.vertex = true;
        return sb.createVertexTemplateFromCells(
          [text1, part1],
      ...
      this.addEntry(dt + 'single line text field focus light', function () {
        var text1 = new mxCell(
          'Input text',
          new mxGeometry(0, 0, 346, 30),
          'text;fontSize=16;verticalAlign=middle;strokeColor=none;fillColor=none;',
        );
        text1.vertex = true;
        var part1 = new mxCell(
          '',
      ...
      this.addEntry(dt + 'single line text field normal light', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(0, 25, 346, 10),
          s + 'line;strokeWidth=1;noLabel=1;strokeColor=#eeeeee;',
        );
        part1.vertex = true;
        return sb.createVertexTemplateFromCells(
          [text1, part1],
      ...
      this.addEntry(dt + 'single line text field error light', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(0, 25, 346, 10),
          s + 'line;strokeWidth=2;noLabel=1;strokeColor=#ff0000;',
        );
        part1.vertex = true;
        var text2 = new mxCell(
          'Username or Password is incorrect',
          new mxGeometry(0, 30, 346, 25),
          'text;fontColor=#ff0000;fontSize=12;verticalAlign=middle;strokeColor=none;fillColor=none;',
        );
        text2.vertex = true;
        return sb.createVertexTemplateFromCells(
          [text1, part1, text2],
      ...
      this.addEntry(dt + 'single line text field focus dark', function () {
        var text1 = new mxCell(
          'Input text',
          new mxGeometry(0, 0, 346, 30),
          'text;fontColor=#ffffff;fontSize=16;verticalAlign=middle;strokeColor=none;fillColor=none;',
        );
        text1.vertex = true;
        var part1 = new mxCell(
          '',
      ...
      this.addEntry(dt + 'single line text field normal dark', function () {
        var text1 = new mxCell(
          'Input text',
          new mxGeometry(0, 0, 346, 30),
          'text;fontColor=#999999;fontSize=16;verticalAlign=middle;strokeColor=none;fillColor=none;',
        );
        text1.vertex = true;
        var part1 = new mxCell(
          '',
      ...
      this.addEntry(dt + 'single line text field error dark', function () {
        ...
        return sb.createVertexTemplateFromCells(
          ...
          346,
          55,
          'Single-line text field (error, dark)',
        );
      }),
      this.addDataEntry(
        dt + 'single line text field icon normal light',
        346,
        35,
      ...
      this.addDataEntry(
        dt + 'single line text field icon focus light',
        342,
        35,
        'Single-line text field with icon (focus, light)',
      ...
      this.addDataEntry(
        dt + 'single line text field icon normal dark',
        342,
        35,
        'Single-line text field with icon (normal, dark)',
      ...
      this.addDataEntry(
        dt + 'single line text field icon focus dark',
        342,
        35,
        'Single-line text field with icon (focus, dark)',
      ...
      this.addEntry(dt + 'single line text field normal light dark', function () {
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(0, 25, 346, 10),
          s + 'line;strokeWidth=1;noLabel=1;strokeColor=#999999;opacity=80;',
        );
        part1.vertex = true;
        return sb.createVertexTemplateFromCells(
          [text1, part1],
      ...
      this.addEntry(dt + 'single line text field focus light', function () {
        var text1 = new mxCell(
          'Label text',
          new mxGeometry(0, 0, 346, 30),
          'text;fontColor=#1F9BFD;fontSize=12;verticalAlign=middle;strokeColor=none;fillColor=none;',
        );
        text1.vertex = true;
        var text2 = new mxCell(
          'Input text',
          new mxGeometry(0, 20, 346, 30),
          'text;fontSize=16;verticalAlign=middle;strokeColor=none;fillColor=none;',
        );
        text2.vertex = true;
        var part1 = new mxCell(
          '',
          new mxGeometry(0, 45, 346, 10),
          s + 'line;strokeWidth=2;noLabel=1;strokeColor=#1F9BFD;',
        );
        part1.vertex = true;
        return sb.createVertexTemplateFromCells(
          [text1, text2, part1],
      ...
      this.addEntry(dt + 'single line text field focus light', function () {
        var text1 = new mxCell(
          'Label text',
          new mxGeometry(0, 0, 346, 30),
          'text;fontColor=#cccccc;fontSize=12;verticalAlign=middle;strokeColor=none;fillColor=none;',
        );
        text1.vertex = true;
        var text2 = new mxCell(
          'Input text',
        ...
        var part1 = new mxCell(
          '',
          new mxGeometry(0, 45, 346, 10),
          s + 'line;strokeWidth=2;noLabel=1;strokeColor=#eeeeee;',
        );
        part1.vertex = true;
        return sb.createVertexTemplateFromCells(
          [text1, text2, part1],
      ...
      this.addEntry(dt + 'single line text field focus light dark', function () {
        var text1 = new mxCell(
          'Label text',
          new mxGeometry(0, 0, 346, 30),
          'text;fontColor=#999999;fontSize=12;verticalAlign=middle;strokeColor=none;fillColor=none;textOpacity=80;',
        );
        text1.vertex = true;
        var text2 = new mxCell(
          'Input text',
          new mxGeometry(0, 20, 346, 30),
          'text;fontColor=#999999;fontSize=16;verticalAlign=middle;strokeColor=none;fillColor=none;textOpacity=80;',
        );
        text2.vertex = true;
        var part1 = new mxCell(
          '',
      ...
      this.addEntry(dt + 'single line text field focus dark', function () {
        var text1 = new mxCell(
          'Label text',
          new mxGeometry(0, 0, 346, 30),
          'text;fontColor=#999999;fontSize=12;verticalAlign=middle;strokeColor=none;fillColor=none;',
        );
        text1.vertex = true;
        var text2 = new mxCell(
          'Input text',
          new mxGeometry(0, 20, 346, 30),
          'text;fontColor=#cccccc;fontSize=16;verticalAlign=middle;strokeColor=none;fillColor=none;',
        );
        text2.vertex = true;
        var part1 = new mxCell(
          '',
          new mxGeometry(0, 45, 346, 10),
          s + 'line;strokeWidth=1;noLabel=1;strokeColor=#999999;',
        );
        part1.vertex = true;
        return sb.createVertexTemplateFromCells(
          [text1, text2, part1],
      ...
      this.addDataEntry(
        dt + 'focus card suggestion',
        362,
        246,
        'Focus card suggestions',
