...
const { MoreShapesDialog, TextareaDialog } = require('../jgraph/Dialogs.js');
const {
  CustomDialog,
  EditGeometryDialog,
  EditShapeDialog,
  ...
  Menus.prototype.init = function () {
    ...
    editorUi.actions.addAction('new...', function () {
      ...
      var dlg = new NewDialog(
        editorUi,
        compact,
        !(editorUi.mode == App.MODE_DEVICE && 'chooseFileSystemEntries' in window),
      );
      ...
      new Action(mxResources.get('formatPdf') + '...', function () {
        if (!EditorUi.isElectronApp && (editorUi.isOffline() || editorUi.printPdfExport)) {
          ...
          if (editorUi.pdfPageExport && !noPages) {
            ...
            var currentPage = editorUi.addRadiobox(
              div,
              'pages',
          ...
          if (EditorUi.isElectronApp || isDrawioWeb) {
            include = editorUi.addCheckbox(div, mxResources.get('includeCopyOfMyDiagram'), true);
            dlgH += 30;
          }
      ...
      new Action(mxResources.get('formatJpg') + '...', function () {
        if (editorUi.isExportToCanvas()) {
          ...
          editorUi.showRemoteExportDialog(
            mxResources.get('export'),
            null,
            mxUtils.bind(this, function (ignoreSelection, editable, tranaparent, scale, border) {
              editorUi.downloadFile(
                'jpeg',
                null,
                null,
    ...
    action = editorUi.actions.addAction(
      ...
      mxUtils.bind(this, function () {
        ...
        var xml = mxUtils.getXml(
          cells.length == 0 ? editorUi.editor.getGraphXml() : graph.encodeCells(cells),
        );
    ...
    editorUi.actions.put(
      'about',
      new Action(mxResources.get('about') + ' ' + EditorUi.VERSION + '...', function () {
        ...
        mxUtils.bind(this, function (menu, parent) {
          if (!mxClient.IS_CHROMEAPP && editorUi.isOffline()) {
            ...
            if (EditorUi.isElectronApp) {
              ...
              this.addMenuItems(
                menu,
                ['-', 'keyboardShortcuts', 'quickStart', 'support', '-', 'forkme', '-', 'about'],
                parent,
              );
            } else {
              this.addMenuItems(
        ...
        var fn = function () {
          ...
          var msg =
            urlParams['proto'] == 'json'
              ? JSON.stringify({ event: 'exit', modified: editorUi.editor.modified })
              : '';
          var parent = window.opener || window.parent;
      ...
      mxUtils.bind(this, function () {
        ...
        if (file != null) {
          if (file.constructor == LocalFile && file.fileHandle != null) {
            editorUi.chooseFileSystemEntries(
            ...
            var filename =
              file.getTitle() != null ? file.getTitle() : this.editorUi.defaultFilename;
    ...
    this.put(
      ...
      new Menu(
        mxUtils.bind(this, function (menu, parent) {
          ...
          this.addMenuItems(
            menu,
            ['-', 'connectionArrows', 'connectionPoints', '-', 'resetView', 'zoomIn', 'zoomOut'],
            parent,
          );
                      ...
                      ? callback([
                          {
                            url: '123',
                            title:
                              'Test 1Test 1Test 1Test 1Test 1Test 1Test 11Test 1Test 11Test 1Test 1dgdsgdfg fdg dfgdfg dfg dfg',
                          },
                          {
                            url: '123',
                            title: 'Test 2',
                            imgUrl:
                              'https://www.google.com.eg/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png',
                          },
                          {
                            url: '123',
                            title: 'Test 3',
                    ...
                    callback(
                      username
                        ? [
                            {
                              url: '123',
                              title: str + 'Test 1Test 1Test 1Test 1Test 1Test 1Test 1',
                            },
    ...
    // TEN9: remove file menu and add old file menu
    ...
    // 		else
    // 		{
    // 			// TEN9: remove file new from menu
        ...
        mxUtils.bind(this, function (menu, parent) {
          ...
          for (var i = 0; i < this.defaultFonts.length; i++) {
            ...
            if (typeof value === 'string') {
              ...
              reserved[
                encodeURIComponent(value.fontFamily) + '@' + encodeURIComponent(value.fontUrl)
              ] = true;
              addItem(value.fontFamily, value.fontUrl);
            }
          }

          // TEN9: Disable separator before custom fonts for our app
          // menu.addSeparator(parent);
          ...
          // TEN9: Disable custom fonts for our app
