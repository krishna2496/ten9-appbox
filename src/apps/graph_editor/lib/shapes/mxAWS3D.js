...
const { mxCellRenderer, mxShape, mxUtils } = require('../jgraph/mxClient.js');
...
mxCellRenderer.registerShape(
  mxShapeAws3dArrowlessNE.prototype.cst.ARROWLESS_NE,
...
mxCellRenderer.registerShape(
  mxShapeAws3dDashedEdgeDouble.prototype.cst.DASHED_EDGE_DOUBLE,
...
mxCellRenderer.registerShape(
  mxShapeAws3dDashedArrowlessEdge.prototype.cst.DASHED_ARROWLESS_EDGE,
  mxShapeAws3dDashedArrowlessEdge,
);
...
mxCellRenderer.registerShape(
  mxShapeAws3dDashedEdge.prototype.cst.DASHED_EDGE,
  mxShapeAws3dDashedEdge,
);
...
mxCellRenderer.registerShape(
  mxShapeAws3dFlatDoubleEdge.prototype.cst.FLAT_DOUBLE_EDGE,
  mxShapeAws3dFlatDoubleEdge,
);
...
mxShapeAws3dAMI.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dAMI.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
...
mxShapeAws3dSnapshot.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dSnapshot.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[1]) : c.setAlpha(shading[0]);
...
mxShapeAws3dApplication.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dApplication.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxCellRenderer.registerShape(
  mxShapeAws3dApplication.prototype.cst.APPLICATION,
...
mxShapeAws3dApplicationServer.prototype.foreground = function (c, x, y, w, h, strokeWidth) {
  ...
  var shading = mxUtils
    .getValue(
      this.state.style,
      mxShapeAws3dApplicationServer.prototype.cst.SHADING_COLORS,
      '0.1,0.3',
    )
    .toString()
    .split(',');
...
mxCellRenderer.registerShape(
  mxShapeAws3dApplicationServer.prototype.cst.APPLICATION_SERVER,
...
mxShapeAws3dCloudFront.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dCloudFront.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxCellRenderer.registerShape(
  mxShapeAws3dCloudFront.prototype.cst.CLOUDFRONT,
  mxShapeAws3dCloudFront,
);
...
mxShapeAws3dDataCenter.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dDataCenter.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxCellRenderer.registerShape(
  mxShapeAws3dDataCenter.prototype.cst.DATA_CENTER,
  mxShapeAws3dDataCenter,
);
...
mxShapeAws3dDataServer.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dDataServer.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxCellRenderer.registerShape(
  mxShapeAws3dDataServer.prototype.cst.DATA_SERVER,
...
mxShapeAws3dElasticLoadBalancing.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var shading = mxUtils
    .getValue(
      this.state.style,
      mxShapeAws3dElasticLoadBalancing.prototype.cst.SHADING_COLORS,
      '0.1,0.3',
    )
    .toString()
    .split(',');
...
mxCellRenderer.registerShape(
  mxShapeAws3dElasticLoadBalancing.prototype.cst.ELASTIC_LOAD_BALANCING,
  mxShapeAws3dElasticLoadBalancing,
);
...
mxShapeAws3dInstance.prototype.foreground = function (c, x, y, w, h, strokeWidth) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dInstance.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxShapeAws3dInternetGateway.prototype.background = function (c, x, y, w, h, strokeWidth) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dInternetGateway.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxCellRenderer.registerShape(
  mxShapeAws3dInternetGateway.prototype.cst.INTERNET_GATEWAY,
...
mxCellRenderer.registerShape(
  mxShapeAws3dOracleDataCenter.prototype.cst.ORACLE_DATA_CENTER,
...
mxCellRenderer.registerShape(
  mxShapeAws3dOracleDatabaseServer.prototype.cst.ORACLE_DB_SERVER,
  mxShapeAws3dOracleDatabaseServer,
); //zzz
...
mxShapeAws3dRdsMaster.prototype.foreground = function (c, x, y, w, h, strokeWidth) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dRdsMaster.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxShapeAws3dRds.prototype.foreground = function (c, x, y, w, h, strokeWidth) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dRds.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxShapeAws3dRoute53.prototype.foreground = function (c, x, y, w, h, strokeWidth) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dRoute53.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxShapeAws3dS3Bucket.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dS3Bucket.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxShapeAws3dS3.prototype.foreground = function (c, x, y, w, h, strokeWidth) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dS3.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxShapeAws3dSimpleDB.prototype.foreground = function (c, x, y, w, h, strokeWidth) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dSimpleDB.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxShapeAws3dSqs.prototype.foreground = function (c, x, y, w, h, strokeWidth) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dSqs.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxShapeAws3dVpcGateway.prototype.background = function (c, x, y, w, h, strokeWidth) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dVpcGateway.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[1]) : c.setAlpha(shading[0]);
...
mxCellRenderer.registerShape(
  mxShapeAws3dVpcGateway.prototype.cst.VPC_GATEWAY,
  mxShapeAws3dVpcGateway,
);
...
mxShapeAws3dWebServer.prototype.foreground = function (c, x, y, w, h, strokeWidth) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dWebServer.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxShapeAws3dDynamoDB.prototype.foreground = function (c, x, y, w, h, strokeWidth) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dDynamoDB.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxCellRenderer.registerShape(
  mxShapeAws3dElasticMapReduce.prototype.cst.ELASTIC_MAP_REDUCE,
  mxShapeAws3dElasticMapReduce,
);
...
mxShapeAws3dAMI2.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dAMI2.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxShapeAws3dEbs.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dEbs.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxCellRenderer.registerShape(
  mxShapeAws3dOracleServer.prototype.cst.ORACLE_SERVER,
  mxShapeAws3dOracleServer,
);
...
mxCellRenderer.registerShape(
  mxShapeAws3dSecureConnection.prototype.cst.SECURE_CONNECTION,
...
mxShapeAws3dEmailService.prototype.foreground = function (c, x, y, w, h, strokeWidth) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dEmailService.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxCellRenderer.registerShape(
  mxShapeAws3dEmailService.prototype.cst.EMAIL_SERVICE,
...
mxShapeAws3dWorker.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dWorker.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxShapeAws3dApplication2.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dApplication2.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxCellRenderer.registerShape(
  mxShapeAws3dApplication2.prototype.cst.APPLICATION2,
  mxShapeAws3dApplication2,
);
...
mxShapeAws3dElasticBeanstalk.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var shading = mxUtils
    .getValue(
      this.state.style,
      mxShapeAws3dElasticBeanstalk.prototype.cst.SHADING_COLORS,
      '0.1,0.3',
    )
    .toString()
    .split(',');
...
mxCellRenderer.registerShape(
  mxShapeAws3dElasticBeanstalk.prototype.cst.ELASTIC_BEANSTALK,
...
mxShapeAws3dSimpleDB2.prototype.foreground = function (c, x, y, w, h, strokeWidth) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dSimpleDB2.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxCellRenderer.registerShape(
  mxShapeAws3dSimpleDB2.prototype.cst.SIMPLE_DB_2,
...
mxShapeAws3dWorkflowService.prototype.foreground = function (c, x, y, w, h, strokeWidth) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dWorkflowService.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxCellRenderer.registerShape(
  mxShapeAws3dWorkflowService.prototype.cst.WORKFLOW_SERVICE,
...
mxShapeAws3dDecider.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dDecider.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxShapeAws3dSearchEngine.prototype.foreground = function (c, x, y, w, h, strokeWidth) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dSearchEngine.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxCellRenderer.registerShape(
  mxShapeAws3dSearchEngine.prototype.cst.SEARCH_ENGINE,
...
mxShapeAws3dSecurityTokenService.prototype.foreground = function (c, x, y, w, h, strokeWidth) {
  ...
  var shading = mxUtils
    .getValue(
      this.state.style,
      mxShapeAws3dSecurityTokenService.prototype.cst.SHADING_COLORS,
      '0.1,0.3',
    )
    .toString()
    .split(',');
...
mxCellRenderer.registerShape(
  mxShapeAws3dSecurityTokenService.prototype.cst.SECURITY_TOKEN_SERVICE,
  mxShapeAws3dSecurityTokenService,
);
...
mxShapeAws3dGlacier.prototype.foreground = function (c, x, y, w, h, strokeWidth) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dGlacier.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxShapeAws3dCustomerGateway.prototype.background = function (c, x, y, w, h, strokeWidth) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dCustomerGateway.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxCellRenderer.registerShape(
  mxShapeAws3dCustomerGateway.prototype.cst.CUSTOMER_GATEWAY,
  mxShapeAws3dCustomerGateway,
);
...
mxShapeAws3dRedshift.prototype.foreground = function (c, x, y, w, h, strokeWidth) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dRedshift.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxShapeAws3dLambda.prototype.foreground = function (c, x, y, w, h, strokeWidth) {
  ...
  c.setFillColor('#000000');
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dLambda.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
...
mxShapeAws3dEbs2.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var shading = mxUtils
    .getValue(this.state.style, mxShapeAws3dEbs2.prototype.cst.SHADING_COLORS, '0.1,0.3')
    .toString()
    .split(',');
  var flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
  flipH == '0' ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]);
