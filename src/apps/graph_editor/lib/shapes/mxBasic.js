        ...
        this.state.style['dx'] =
          Math.round(
            100 *
              Math.max(
                0,
                Math.min(bounds.height / 2, bounds.width / 2, pt.x - bounds.x - bounds.width / 2),
              ),
          ) / 100;
      },
    ),
...
mxShapeBasicRectCallout.prototype.getLabelMargins = function () {
  if (mxUtils.getValue(this.style, 'boundedLbl', false)) {
    return new mxRectangle(
      ...
      0,
      0,
      parseFloat(mxUtils.getValue(this.style, 'dy', this.dy)) * this.scale,
    );
  }
...
mxCellRenderer.registerShape(
  mxShapeBasicRectCallout.prototype.cst.RECT_CALLOUT,
  ...
  var handles = [
    Graph.createHandle(
      ...
      function (bounds, pt) {
        ...
        this.state.style['dx'] =
          Math.round(100 * Math.max(y, Math.min(bounds.width - y, pt.x - bounds.x))) / 100;
...
mxShapeBasicRoundRectCallout.prototype.getLabelMargins =
  mxShapeBasicRectCallout.prototype.getLabelMargins;
...
Graph.handleFactory[mxShapeBasicRoundRectCallout.prototype.cst.ROUND_RECT_CALLOUT] = function (
  state,
) {
  return [
    Graph.createHandle(
    ...
    Graph.createHandle(
      ...
      function (bounds) {
        var size = Math.max(
          0,
          Math.min(bounds.width, parseFloat(mxUtils.getValue(this.state.style, 'size', this.size))),
        );
...
mxShapeBasicRoundRectCallout.prototype.getConstraints = function (style, w, h) {
  ...
  constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, (h - dy) * 0.5));
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - r * 0.293, h - dy - r * 0.293),
  );
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, r * 0.293, h - dy - r * 0.293),
  );
  constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx - dy, h));
  ...
  var handles = [
    Graph.createHandle(
      ...
      function (bounds, pt) {
        this.state.style['dx'] =
          Math.round(
            100 * Math.max(0, Math.min(bounds.height / 4, bounds.width / 4, pt.x - bounds.x)),
          ) / 100;
      },
    ),
  ];
  ...
  var handles = [
    Graph.createHandle(
      ...
      function (bounds) {
        var dx = Math.max(
          0,
          Math.min(1, parseFloat(mxUtils.getValue(this.state.style, 'dx', this.dx))),
        );
...
mxShapeBasicTriangleAcute.prototype.getConstraints = function (style, w, h) {
  ...
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - (w - dx) * 0.5, h * 0.5),
  );
...
Graph.handleFactory[mxShapeBasicPyramid.prototype.cst.PYRAMID] = function (state) {
  var handles = [
    Graph.createHandle(
      ...
      function (bounds) {
        var dx1 = Math.max(
          0,
          Math.min(1, parseFloat(mxUtils.getValue(this.state.style, 'dx1', this.dx1))),
        );
  ...
  var handle2 = Graph.createHandle(
    ...
    function (bounds) {
      var dx2 = Math.max(
        0,
        Math.min(1, parseFloat(mxUtils.getValue(this.state.style, 'dx2', this.dx2))),
      );
  ...
  var handle4 = Graph.createHandle(
    ...
    function (bounds) {
      var dy2 = Math.max(
        0,
        Math.min(1, parseFloat(mxUtils.getValue(this.state.style, 'dy2', this.dy2))),
      );
...
mxShapeBasicPyramid.prototype.getConstraints = function (style, w, h) {
  ...
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, (w + dx1) * 0.5, dy2 * 0.5),
  );
  constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, dy2));
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, (w + dx2) * 0.5, (h + dy2) * 0.5),
  );
  constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx2, h));
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx2 * 0.5, (h + dy1) * 0.5),
  );
...
mxCellRenderer.registerShape(
  mxShapeBasic4PointStar2.prototype.cst.FOUR_POINT_STAR_2,
  mxShapeBasic4PointStar2,
);
...
Graph.handleFactory[mxShapeBasic4PointStar2.prototype.cst.FOUR_POINT_STAR_2] = function (state) {
  var handles = [
    Graph.createHandle(
      ...
      function (bounds, pt) {
        this.state.style['dx'] =
          Math.round(100 * Math.max(0, Math.min(1, (2 * (pt.x - bounds.x)) / bounds.width))) / 100;
      },
    ),
  ];
...
Graph.handleFactory[mxShapeBasicCornerRoundRect.prototype.cst.CORNER_ROUND_RECT] = function (
  state,
) {
  var handles = [
    Graph.createHandle(
...
mxShapeBasicFrame.prototype.getConstraints = function (style, w, h) {
  ...
  constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx, dx));
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, (w - 2 * dx) * 0.25 + dx, dx),
  );
  ...
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - dx, (h - 2 * dx) * 0.25 + dx),
  );
  constr.push(new mxConnectionConstraint(new mxPoint(1, 0.5), false, null, -dx, 0));
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - dx, (h - 2 * dx) * 0.75 + dx),
  );
  constr.push(new mxConnectionConstraint(new mxPoint(1, 1), false, null, -dx, -dx));
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, (w - 2 * dx) * 0.75 + dx, h - dx),
  );
  constr.push(new mxConnectionConstraint(new mxPoint(0.5, 1), false, null, 0, -dx));
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, (w - 2 * dx) * 0.25 + dx, h - dx),
  );
  constr.push(new mxConnectionConstraint(new mxPoint(0, 1), false, null, dx, -dx));
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx, (h - 2 * dx) * 0.75 + dx),
  );
  constr.push(new mxConnectionConstraint(new mxPoint(0, 0.5), false, null, dx, 0));
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx, (h - 2 * dx) * 0.25 + dx),
  );
...
mxCellRenderer.registerShape(
  mxShapeBasicPlaqueFrame.prototype.cst.PLAQUE_FRAME,
...
mxCellRenderer.registerShape(
  mxShapeBasicFrameCorner.prototype.cst.FRAME_CORNER,
...
mxShapeBasicFrameCorner.prototype.getConstraints = function (style, w, h) {
  ...
  constr.push(new mxConnectionConstraint(new mxPoint(1, 0), false, null, -dx, dx));
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, (w - 2 * dx) * 0.5 + dx, dx),
  );
  constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx, dx));
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx, (h - 2 * dx) * 0.5 + dx),
  );
  constr.push(new mxConnectionConstraint(new mxPoint(0, 1), false, null, dx, -dx));
  constr.push(new mxConnectionConstraint(new mxPoint(0, 1), false));
  constr.push(new mxConnectionConstraint(new mxPoint(0, 0.5), false));
...
mxCellRenderer.registerShape(
  mxShapeBasicDiagStripe.prototype.cst.DIAG_STRIPE,
...
mxShapeBasicDiagStripe.prototype.getConstraints = function (style, w, h) {
  ...
  constr.push(
    new mxConnectionConstraint(
      ...
      null,
      w,
      Math.min((dx * 100) / w, h) * 0.5,
    ),
  );
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, Math.min((dx * 100) / w, h)),
  );
  constr.push(
    new mxConnectionConstraint(
      new mxPoint(0, 0),
      false,
      null,
      (w + Math.min((dx * 100) / h, w)) * 0.5,
      (Math.min((dx * 100) / w, h) + h) * 0.5,
    ),
  );
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, Math.min((dx * 100) / h, w), h),
  );
  constr.push(
    new mxConnectionConstraint(
      new mxPoint(0, 0),
...
mxCellRenderer.registerShape(
  mxShapeBasicLayeredRect.prototype.cst.LAYERED_RECT,
        ...
        this.state.style['dx'] =
          Math.round(
            100 *
              Math.max(
                0,
                Math.min(bounds.height / 2, bounds.width / 2, -pt.x + bounds.width + bounds.x),
              ),
          ) / 100;
      },
    ),
...
mxShapeBasicPie.prototype.paintVertexShape = function (c, x, y, w, h) {
  c.translate(x, y);
  var startAngleSource = Math.max(
    0,
    Math.min(1, parseFloat(mxUtils.getValue(this.style, 'startAngle', this.startAngle))),
  );
  var endAngleSource = Math.max(
    0,
    Math.min(1, parseFloat(mxUtils.getValue(this.style, 'endAngle', this.endAngle))),
  );
...
Graph.handleFactory[mxShapeBasicPartConcEllipse.prototype.cst.PART_CONC_ELLIPSE] = function (
  state,
) {
  var handles = [
    Graph.createHandle(
...
mxCellRenderer.registerShape(
  mxShapeBasicBendingArch.prototype.cst.BENDING_ARCH,
...
mxShapeBasicRect2.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var absoluteCornerSize = mxUtils.getValue(
    this.style,
    'absoluteCornerSize',
  ...
  var indent = Math.max(
    0,
    Math.min(w, parseFloat(mxUtils.getValue(this.style, 'indent', this.indent))),
  );
  ...
  if ((top || right || bottom || left) && rectOutline != 'frame') {
    ...
    mxShapeBasicRect2.prototype.paintRight(
      c,
      x,
      y,
      w,
    ...
    if (!top) {
      ...
      mxShapeBasicRect2.prototype.moveNWInner(
        c,
        x,
        y,
        w,
    ...
    mxShapeBasicRect2.prototype.paintLeftInner(
      c,
      x,
      y,
      w,
    ...
    if (left && bottom) {
      mxShapeBasicRect2.prototype.paintSWInner(
        c,
        x,
        y,
        w,
    ...
    mxShapeBasicRect2.prototype.paintBottomInner(
      c,
      x,
      y,
      w,
    ...
    if (bottom && right) {
      mxShapeBasicRect2.prototype.paintSEInner(
        c,
        x,
        y,
        w,
    ...
    mxShapeBasicRect2.prototype.paintRightInner(
      c,
      x,
      y,
      w,
    ...
    if (right && top) {
      mxShapeBasicRect2.prototype.paintNEInner(
        c,
        x,
        y,
        w,
    ...
    mxShapeBasicRect2.prototype.paintTopInner(
      c,
      x,
      y,
      w,
    ...
    if (top && left) {
      mxShapeBasicRect2.prototype.paintNWInner(
        c,
        x,
        y,
        w,
    ...
    if (fillColor == 'none') {
      c.begin();
      mxShapeBasicRect2.prototype.paintFolds(
        c,
        x,
        y,
        w,
  ...
  if (!top && !right && !bottom && left) {
    if (rectOutline != 'frame') {
      ...
      mxShapeBasicRect2.prototype.moveSW(c, x, y, w, h, rectStyle, topLeftStyle, size, bottom);
      mxShapeBasicRect2.prototype.paintLeft(c, x, y, w, h, rectStyle, topLeftStyle, size, top);
      mxShapeBasicRect2.prototype.lineNWInner(
        c,
        x,
        y,
        w,
    ...
    if (rectOutline != 'frame') {
      ...
      mxShapeBasicRect2.prototype.paintBottom(
        c,
        x,
        y,
        w,
      ...
      if (rectOutline == 'double') {
        mxShapeBasicRect2.prototype.moveSWInner(
          c,
          x,
          y,
          w,
      ...
      mxShapeBasicRect2.prototype.lineSWInner(
        c,
        x,
        y,
        w,
    ...
    if (rectOutline != 'frame') {
      ...
      if (rectOutline == 'double') {
        mxShapeBasicRect2.prototype.moveSEInner(
          c,
          x,
          y,
          w,
      ...
      mxShapeBasicRect2.prototype.lineSEInner(
        c,
        x,
        y,
        w,
    ...
    if (rectOutline != 'frame') {
      ...
      if (rectOutline == 'double') {
        mxShapeBasicRect2.prototype.moveNEInner(
          c,
          x,
          y,
          w,
      ...
      mxShapeBasicRect2.prototype.moveNW(c, x, y, w, h, rectStyle, topLeftStyle, size, left);
      mxShapeBasicRect2.prototype.paintTop(c, x, y, w, h, rectStyle, topRightStyle, size, right);
      mxShapeBasicRect2.prototype.lineNEInner(
        c,
        x,
        y,
        w,
  ...
  var handle2 = Graph.createHandle(
    ...
    function (bounds, pt) {
      this.state.style['indent'] =
        Math.round(100 * Math.max(0, Math.min(100, (200 * (pt.y - bounds.y)) / bounds.height))) /
        100;
    },
  );
      ...
      (function (index) {
        handles.push(
          Graph.createHandle(
            ...
            function (bounds) {
              return new mxPoint(
                bounds.x + c[index][0] * bounds.width,
                bounds.y + c[index][1] * bounds.height,
              );
            },
            function (bounds, pt) {
              var x =
...
mxCellRenderer.registerShape(
  mxShapeBasicPatternFillRect.prototype.cst.PATTERN_FILL_RECT,
