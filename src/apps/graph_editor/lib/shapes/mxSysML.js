...
mxShapeSysMLPackage.prototype.foreground = function (c, x, y, w, h) {
  var xSize = parseInt(
    mxUtils.getValue(this.style, mxShapeSysMLPackage.prototype.cst.LABEL_X, '90'),
  );
  var ySize = 20;
  ...
  var handles = [
    Graph.createHandle(
      ...
      function (bounds) {
        var labelX = Math.max(
          0,
          Math.min(bounds.width, parseFloat(mxUtils.getValue(this.state.style, 'labelX', 90))),
        );

        return new mxPoint(bounds.x + labelX, bounds.y + 10);
      },
      function (bounds, pt) {
        this.state.style['labelX'] =
...
mxShapeSysMLPackage2.prototype.foreground = function (c, x, y, w, h) {
  var xSize = parseInt(
    mxUtils.getValue(this.style, mxShapeSysMLPackage2.prototype.cst.LABEL_X, '90'),
  );
  var ySize = 20;
...
mxShapeSysMLItemFlow.prototype.paintVertexShape = function (c, x, y, w, h) {
  var flowDir = mxUtils
    .getValue(this.style, mxShapeSysMLItemFlow.prototype.cst.FLOW_DIR, 'none')
    .toLowerCase();
...
mxCellRenderer.registerShape(
  mxShapeSysMLItemFlowLeft.prototype.cst.ITEM_FLOW_LEFT,
  mxShapeSysMLItemFlowLeft,
);
...
mxCellRenderer.registerShape(
  mxShapeSysMLItemFlowRight.prototype.cst.ITEM_FLOW_RIGHT,
  mxShapeSysMLItemFlowRight,
);
...
mxCellRenderer.registerShape(
  mxShapeSysMLNestedPort.prototype.cst.NESTED_PORT,
  mxShapeSysMLNestedPort,
);
...
mxCellRenderer.registerShape(
  mxShapeSysMLParametricDiagram.prototype.cst.PARAM_DGM,
  mxShapeSysMLParametricDiagram,
);
...
mxCellRenderer.registerShape(
  mxShapeSysMLConstraintProperty.prototype.cst.CONS_PROP,
  mxShapeSysMLConstraintProperty,
);
...
mxCellRenderer.registerShape(
  mxShapeSysMLCallBehaviorAction.prototype.cst.CALL_BEH_ACT,
...
mxCellRenderer.registerShape(
  mxShapeSysMLAcceptEventAction.prototype.cst.ACC_EVENT,
  mxShapeSysMLAcceptEventAction,
);
...
mxCellRenderer.registerShape(
  mxShapeSysMLSendSignalAction.prototype.cst.SEND_SIG_ACT,
...
mxCellRenderer.registerShape(
  mxShapeSysMLActivityFinal.prototype.cst.ACT_FINAL,
...
mxCellRenderer.registerShape(
  mxShapeSysMLActivityParameterNode.prototype.cst.ACT_PARAM_NODE,
  mxShapeSysMLActivityParameterNode,
);
...
mxCellRenderer.registerShape(
  mxShapeSysMLControlOperator.prototype.cst.CONT_OPER,
  mxShapeSysMLControlOperator,
);
...
mxCellRenderer.registerShape(
  mxShapeSysMLIsActStream.prototype.cst.IS_ACT_STREAM,
  mxShapeSysMLIsActStream,
);
...
mxCellRenderer.registerShape(
  mxShapeSysMLParameterSet.prototype.cst.PARAM_SET,
  mxShapeSysMLParameterSet,
);
...
mxCellRenderer.registerShape(
  mxShapeSysMLParameterActivitySet.prototype.cst.PARAM_ACT_SET,
  mxShapeSysMLParameterActivitySet,
);
...
mxCellRenderer.registerShape(
  mxShapeSysMLProbability.prototype.cst.PROBABILITY,
  mxShapeSysMLProbability,
);
...
mxCellRenderer.registerShape(
  mxShapeSysMLActivityProbability.prototype.cst.ACT_PROB,
  mxShapeSysMLActivityProbability,
);
...
mxCellRenderer.registerShape(
  mxShapeSysMLObjectFlowRight.prototype.cst.OBJ_FLOW_R,
...
mxCellRenderer.registerShape(
  mxShapeSysMLObjectFlowLeft.prototype.cst.OBJ_FLOW_L,
  mxShapeSysMLObjectFlowLeft,
);
...
mxCellRenderer.registerShape(
  mxShapeSysMLActivityPartition.prototype.cst.ACT_PART,
  mxShapeSysMLActivityPartition,
);
...
mxShapeSysMLContinuation.prototype.getConstraints = function (style, w, h) {
  ...
  constr.push(
    new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - r * 0.29, h - r * 0.29),
  );
...
mxCellRenderer.registerShape(
  mxShapeSysMLCompositeState.prototype.cst.COMP_STATE,
  mxShapeSysMLCompositeState,
);
...
mxCellRenderer.registerShape(
  mxShapeSysMLSimpleState.prototype.cst.SIMPLE_STATE,
...
mxCellRenderer.registerShape(
  mxShapeSysMLStateMachine.prototype.cst.STATE_MACHINE,
  mxShapeSysMLStateMachine,
);
...
mxCellRenderer.registerShape(
  mxShapeSysMLSubmachineState.prototype.cst.SUBMACHINE_STATE,
...
mxCellRenderer.registerShape(
  mxShapeSysMLUseCaseExtensionPoints.prototype.cst.USE_CASE_EXT_PT,
