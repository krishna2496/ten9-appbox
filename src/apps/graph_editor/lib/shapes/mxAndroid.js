...
const { Graph } = require('../jgraph/Graph');
...
mxShapeAndroidTabBar.prototype.paintVertexShape = function (c, x, y, w, h) {
  var textStrings = mxUtils
    .getValue(this.style, mxShapeAndroidTabBar.prototype.cst.MAIN_TEXT, '+Tab 1, Tab 2, Tab 3')
    .toString()
    .split(',');
  var fontColor = mxUtils.getValue(
    this.style,
    mxShapeAndroidTabBar.prototype.cst.TEXT_COLOR,
    'none',
  );
  var selectedFontColor = mxUtils.getValue(
    this.style,
    mxShapeAndroidTabBar.prototype.cst.TEXT_COLOR2,
    'none',
  );
  var fontSize = mxUtils
    .getValue(this.style, mxShapeAndroidTabBar.prototype.cst.TEXT_SIZE, '17')
    .toString();
  var frameColor = mxUtils.getValue(this.style, mxConstants.STYLE_STROKECOLOR, 'none');
  var separatorColor = mxUtils.getValue(
    this.style,
    mxShapeAndroidTabBar.prototype.cst.STROKE_COLOR2,
    'none',
  );
  var bgColor = mxUtils.getValue(this.style, mxConstants.STYLE_FILLCOLOR, 'none');
  var selectedFillColor = mxUtils.getValue(
    this.style,
    mxShapeAndroidTabBar.prototype.cst.FILL_COLOR2,
    'none',
  );
...
mxShapeAndroidTabBar.prototype.background = function (
  c,
  w,
  h,
  buttonNum,
...
mxShapeAndroidTabBar.prototype.buttonText = function (
  c,
  w,
  h,
  textString,
...
mxCellRenderer.registerShape(
  mxShapeAndroidTabBar.prototype.cst.SHAPE_TAB_BAR,
  mxShapeAndroidTabBar,
);
...
mxShapeAndroidCheckboxGroup.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var optionText = mxUtils
    .getValue(this.style, mxShapeAndroidCheckboxGroup.prototype.cst.BUTTON_TEXT, 'Option 1')
    .toString()
    .split(',');
  var strokeColor = mxUtils.getValue(this.style, mxConstants.STYLE_STROKECOLOR, 'none');
  var strokeColor2 = mxUtils.getValue(
    this.style,
    mxShapeAndroidCheckboxGroup.prototype.cst.STYLE_STROKECOLOR2,
    'none',
  );
...
mxShapeAndroidRadioGroup.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var fontSize = mxUtils.getValue(this.style, mxConstants.STYLE_FONTSIZE, '8').toString();
  var optionText = mxUtils
    .getValue(this.style, mxShapeAndroidRadioGroup.prototype.cst.BUTTON_TEXT, 'Option 1')
    .toString()
    .split(',');
  var strokeColor = mxUtils.getValue(this.style, mxConstants.STYLE_STROKECOLOR, 'none');
  var strokeColor2 = mxUtils.getValue(
    this.style,
    mxShapeAndroidRadioGroup.prototype.cst.STYLE_STROKECOLOR2,
    'none',
  );
...
mxShapeAndroidMenuBar.prototype.paintVertexShape = function (c, x, y, w, h) {
  var textStrings = mxUtils
    .getValue(this.style, mxShapeAndroidMenuBar.prototype.cst.MENU_TEXT, 'Item 1, Item 2, Item 3')
    .toString()
    .split(',');
...
mxCellRenderer.registerShape(
  ...
  mxShapeAndroidIndeterminateSpinner,
);
...
mxShapeAndroidRRect.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var rSize = parseInt(
    mxUtils.getValue(this.style, mxShapeAndroidRRect.prototype.cst.R_SIZE, '10'),
  );
...
mxCellRenderer.registerShape(
  mxShapeAndroidProgressBar.prototype.cst.PROGRESS_BAR,
  mxShapeAndroidProgressBar,
);
...
mxCellRenderer.registerShape(
  mxShapeAndroidProgressScrubberDisabled.prototype.cst.PROGRESS_SCRUBBER_DISABLED,
  mxShapeAndroidProgressScrubberDisabled,
);
...
mxCellRenderer.registerShape(
  mxShapeAndroidProgressScrubberFocused.prototype.cst.PROGRESS_SCRUBBER_FOCUSED,
  mxShapeAndroidProgressScrubberFocused,
);
...
mxCellRenderer.registerShape(
  mxShapeAndroidProgressScrubberPressed.prototype.cst.PROGRESS_SCRUBBER_PRESSED,
...
mxShapeAndroidQuickscroll2.prototype.paintVertexShape = function (c, x, y, w, h) {
  var dy = Math.min(
    ...
    Math.max(
      20,
      h * Math.max(0, Math.min(h, parseFloat(mxUtils.getValue(this.style, 'dy', this.dy)))),
    ),
  );
  var fillColor = mxUtils.getValue(this.style, 'fillColor', '#ffffff');
...
mxCellRenderer.registerShape(
  mxShapeAndroidQuickscroll2.prototype.cst.QUICKSCROLL,
    ...
    Graph.createHandle(
      ...
      function (bounds) {
        ...
        return new mxPoint(
          ...
          bounds.y + Math.min(bounds.height - 20, Math.max(20, dy * bounds.height)),
        );
      },
      function (bounds, pt) {
        this.state.style['dy'] =
          Math.round(1000 * Math.max(0, Math.min(1, (pt.y - bounds.y) / bounds.height))) / 1000;
      },
    ),
  ];
...
mxCellRenderer.registerShape(
  mxShapeAndroidQuickscroll3.prototype.cst.QUICKSCROLL,
  mxShapeAndroidQuickscroll3,
);
    ...
    Graph.createHandle(
      ...
      function (bounds) {
        ...
        return new mxPoint(
          ...
          bounds.y + Math.min(bounds.height - 10, Math.max(10, dy * bounds.height)),
        );
      },
      function (bounds, pt) {
        this.state.style['dy'] =
...
mxCellRenderer.registerShape(
  mxShapeAndroidScrollbars2.prototype.cst.SCROLLBARS,
  mxShapeAndroidScrollbars2,
);
