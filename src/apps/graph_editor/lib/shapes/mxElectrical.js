...
mxCellRenderer.registerShape(
  mxShapeElectricalTestPoint.prototype.cst.SHAPE_TEST_POINT,
  mxShapeElectricalTestPoint,
);
...
mxCellRenderer.registerShape(
  mxShapeElectricalStraightBus.prototype.cst.SHAPE_STRAIGHT_BUS,
...
mxCellRenderer.registerShape(
  mxShapeElectricalTwoLineBusElbow.prototype.cst.SHAPE_TWO_LINE_BUS_ELBOW,
    ...
    Graph.createHandle(
      ...
      function (bounds, pt) {
        this.state.style['notch'] =
          Math.round(0.2 * Math.max(0, bounds.width - pt.y + bounds.y)) / 0.2;
      },
    ),
  ];
...
mxCellRenderer.registerShape(
  mxShapeElectricalThreeLineBusElbow.prototype.cst.SHAPE_THREE_LINE_BUS_ELBOW,
  mxShapeElectricalThreeLineBusElbow,
);
...
mxCellRenderer.registerShape(
  mxShapeElectricalFourLineBusElbow.prototype.cst.SHAPE_FOUR_LINE_BUS_ELBOW,
  mxShapeElectricalFourLineBusElbow,
);
...
mxCellRenderer.registerShape(
  mxShapeElectricalEightLineBusElbow.prototype.cst.SHAPE_EIGHT_LINE_BUS_ELBOW,
  mxShapeElectricalEightLineBusElbow,
);
...
mxCellRenderer.registerShape(
  mxShapeElectricalLogicGate.prototype.cst.SHAPE_LOGIC_GATE,
  mxShapeElectricalLogicGate,
);
...
mxCellRenderer.registerShape(
  mxShapeElectricalBuffer.prototype.cst.SHAPE_BUFFER2,
  mxShapeElectricalBuffer,
);
      ...
      while (pinCount * pinSpacing <= h) {
        ...
        if (pinLabelType == 'gen') {
          ...
          c.text(
            ...
            0,
            0,
            labelNames[currPinNum - 1].toString(),
            mxConstants.ALIGN_LEFT,
            mxConstants.ALIGN_MIDDLE,
            0,
            null,
...
mxCellRenderer.registerShape(
  mxShapeElectricalDualInLineIC.prototype.cst.SHAPE_DUAL_INLINE_IC,
...
mxCellRenderer.registerShape(
  mxShapeElectricalQFPIC.prototype.cst.SHAPE_QFP_IC,
...
mxCellRenderer.registerShape(
  mxShapeElectricalBatteryStack.prototype.cst.SHAPE_BATTERY_STACK,
...
mxCellRenderer.registerShape(
  mxShapeElectricalDCSource3_v2.prototype.cst.SHAPE_DC_SOURCE_3_V2,
  mxShapeElectricalDCSource3_v2,
);
...
mxShapeElectricalSource.prototype.customProperties = [
  {
    ...
    defVal: 'independent',
    enumList: [
      { val: 'independent', dispName: 'Independent' },
...
mxCellRenderer.registerShape(
  mxShapeElectricalSource.prototype.cst.SHAPE_SOURCE,
