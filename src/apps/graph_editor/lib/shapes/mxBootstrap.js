...
mxShapeBootstrapRRect.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var rSize = parseInt(
    mxUtils.getValue(this.style, mxShapeBootstrapRRect.prototype.cst.R_SIZE, '10'),
  );
...
mxShapeBootstrapTopButton.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var rSize = parseInt(
    mxUtils.getValue(this.style, mxShapeBootstrapTopButton.prototype.cst.R_SIZE, '10'),
  );
...
mxCellRenderer.registerShape(
  mxShapeBootstrapTopButton.prototype.cst.TOP_BUTTON,
  mxShapeBootstrapTopButton,
);
...
mxShapeBootstrapBottomButton.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var rSize = parseInt(
    mxUtils.getValue(this.style, mxShapeBootstrapBottomButton.prototype.cst.R_SIZE, '10'),
  );
...
mxCellRenderer.registerShape(
  mxShapeBootstrapBottomButton.prototype.cst.BOTTOM_BUTTON,
  mxShapeBootstrapBottomButton,
);
...
mxShapeBootstrapRightButton.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var rSize = parseInt(
    mxUtils.getValue(this.style, mxShapeBootstrapRightButton.prototype.cst.R_SIZE, '10'),
  );
...
mxCellRenderer.registerShape(
  mxShapeBootstrapRightButton.prototype.cst.RIGHT_BUTTON,
  mxShapeBootstrapRightButton,
);
...
mxShapeBootstrapLeftButton.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var rSize = parseInt(
    mxUtils.getValue(this.style, mxShapeBootstrapLeftButton.prototype.cst.R_SIZE, '10'),
  );
...
mxCellRenderer.registerShape(
  mxShapeBootstrapLeftButton.prototype.cst.LEFT_BUTTON,
  mxShapeBootstrapLeftButton,
);
...
mxCellRenderer.registerShape(
  mxShapeBootstrapLeftButtonStriped.prototype.cst.LEFT_BUTTON_STRIPED,
  mxShapeBootstrapLeftButtonStriped,
);
...
mxCellRenderer.registerShape(
  mxShapeBootstrapRoundedButton.prototype.cst.ROUNDED_BUTTON,
  mxShapeBootstrapRoundedButton,
);
...
mxShapeBootstrapImage.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var rSize = Math.max(
    0,
    parseInt(mxUtils.getValue(this.style, mxShapeBootstrapTopButton.prototype.cst.R_SIZE, '10')),
  );
  var strokeColor = mxUtils.getValue(this.style, mxConstants.STYLE_STROKECOLOR, '#000000');
  var fillColor = mxUtils.getValue(this.style, mxConstants.STYLE_FILLCOLOR, '#ffffff');
...
mxCellRenderer.registerShape(
  mxShapeBootstrapCheckbox.prototype.cst.CHECKBOX,
  mxShapeBootstrapCheckbox,
);
...
mxCellRenderer.registerShape(
  mxShapeBootstrapCheckbox2.prototype.cst.CHECKBOX2,
  mxShapeBootstrapCheckbox2,
);
...
mxCellRenderer.registerShape(
  mxShapeBootstrapRadioButton.prototype.cst.RADIO_BUTTON,
  mxShapeBootstrapRadioButton,
);
...
mxCellRenderer.registerShape(
  mxShapeBootstrapRadioButton2.prototype.cst.RADIO_BUTTON2,
  mxShapeBootstrapRadioButton2,
);
...
mxCellRenderer.registerShape(
  mxShapeBootstrapHorLines.prototype.cst.HOR_LINES,
...
mxShapeBootstrapRating.prototype.paintVertexShape = function (c, x, y, w, h) {
  var ratingStyle = mxUtils.getValue(
    this.style,
    mxShapeBootstrapRating.prototype.cst.RATING_STYLE,
    mxShapeBootstrapRating.prototype.cst.RATING_STAR,
  );
  var grade = mxUtils.getValue(this.style, mxShapeBootstrapRating.prototype.cst.GRADE, '5');
  var ratingScale = mxUtils.getValue(
    this.style,
    mxShapeBootstrapRating.prototype.cst.RATING_SCALE,
    '10',
  );
  ...
  var emptyFillColor = mxUtils.getValue(
    this.style,
    mxShapeBootstrapRating.prototype.cst.EMPTY_FILL_COLOR,
    '#ffffff',
  );
...
mxCellRenderer.registerShape(
  mxShapeBootstrapRangeInput.prototype.cst.RANGE_INPUT,
...
mxCellRenderer.registerShape(
  mxShapeBootstrapSwitch.prototype.cst.SHAPE_SWITCH,
...
mxCellRenderer.registerShape(
  mxShapeInfographicPopover.prototype.cst.SHAPE_POPOVER,
  mxShapeInfographicPopover,
);
