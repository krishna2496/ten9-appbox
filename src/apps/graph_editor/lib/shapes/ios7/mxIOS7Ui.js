...
mxShapeIOS7horButtonBar.prototype.paintVertexShape = function (c, x, y, w, h) {
  var textStrings = mxUtils
    .getValue(this.style, mxIOS7C.BUTTON_TEXT, '+Button 1, Button 2, Button 3')
    .toString()
    .split(',');
...
mxShapeIOS7horButtonBar.prototype.background = function (
  c,
  w,
  h,
  rSize,
...
mxShapeIOS7horButtonBar.prototype.buttonText = function (
  c,
  w,
  h,
  textString,
...
mxShapeIOS7LeftButton.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var rSize = parseInt(
    mxUtils.getValue(this.style, mxShapeIOS7LeftButton.prototype.cst.R_SIZE, '10'),
  );
...
mxCellRenderer.registerShape(
  mxShapeIOS7LeftButton.prototype.cst.LEFT_BUTTON,
  mxShapeIOS7LeftButton,
);
...
mxShapeIOS7RightButton.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var rSize = parseInt(
    mxUtils.getValue(this.style, mxShapeIOS7RightButton.prototype.cst.R_SIZE, '10'),
  );
...
mxCellRenderer.registerShape(
  mxShapeIOS7RightButton.prototype.cst.RIGHT_BUTTON,
...
mxShapeIOS7TopButton.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var rSize = parseInt(
    mxUtils.getValue(this.style, mxShapeIOS7TopButton.prototype.cst.R_SIZE, '10'),
  );
...
mxShapeIOS7BottomButton.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var rSize = parseInt(
    mxUtils.getValue(this.style, mxShapeIOS7BottomButton.prototype.cst.R_SIZE, '10'),
  );
...
mxCellRenderer.registerShape(
  mxShapeIOS7BottomButton.prototype.cst.BOTTOM_BUTTON,
...
mxShapeIOS7MarginRect.prototype.background = function (c, x, y, w, h, state) {
  var margin = parseFloat(
    mxUtils.getValue(this.style, mxShapeIOS7MarginRect.prototype.cst.MARGIN, '0'),
  );
  var marginTop = parseFloat(
    mxUtils.getValue(this.style, mxShapeIOS7MarginRect.prototype.cst.MARGIN_TOP, '0'),
  );
  var marginLeft = parseFloat(
    mxUtils.getValue(this.style, mxShapeIOS7MarginRect.prototype.cst.MARGIN_LEFT, '0'),
  );
  var marginBottom = parseFloat(
    mxUtils.getValue(this.style, mxShapeIOS7MarginRect.prototype.cst.MARGIN_BOTTOM, '0'),
  );
  var marginRight = parseFloat(
    mxUtils.getValue(this.style, mxShapeIOS7MarginRect.prototype.cst.MARGIN_RIGHT, '0'),
  );
...
mxCellRenderer.registerShape(
  mxShapeIOS7MarginRect.prototype.cst.SHAPE_MARGIN_RECT,
  mxShapeIOS7MarginRect,
);
...
Graph.handleFactory[mxShapeIOS7SelectBar.prototype.cst.SELECT_BAR] = function (state) {
  ...
  var handle2 = Graph.createHandle(
    ...
    function (bounds) {
      ...
      return new mxPoint(
        bounds.x + parseFloat(mxUtils.getValue(this.state.style, 'dx', this.dx)),
        bounds.y + bounds.height + dy,
      );
    },
    function (bounds, pt) {
      this.state.style['dy'] =
        Math.round(100 * Math.max(0, Math.min(bounds.height, pt.y - bounds.y - bounds.height))) /
        100;
    },
  );
      ...
      this.state.style['size'] =
        Math.round(
          100 *
            Math.max(
              0,
              Math.min(bounds.width / 2, bounds.height / 2, bounds.x + bounds.width - pt.x),
            ),
        ) / 100;
    },
  );
...
mxShapeIOS7Slider2.prototype.background = function (c, x, y, w, h) {
  var hSize = parseFloat(
    mxUtils.getValue(this.style, mxShapeIOS7Slider2.prototype.cst.HANDLE_SIZE, '10'),
  );
  var barPos =
    parseFloat(mxUtils.getValue(this.style, mxShapeIOS7Slider2.prototype.cst.BAR_POS, '40')) / 100;
