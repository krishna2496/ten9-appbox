...
mxShapeGmdlSwitch.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var state = mxUtils.getValue(
    this.style,
    mxShapeGmdlSwitch.prototype.cst.STATE,
    mxShapeGmdlSwitch.prototype.cst.STATE_ON,
  );
...
mxShapeGmdlMarginRect.prototype.background = function (c, x, y, w, h, state) {
  var margin = parseFloat(
    mxUtils.getValue(this.style, mxShapeGmdlMarginRect.prototype.cst.MARGIN, '0'),
  );
  var marginTop = parseFloat(
    mxUtils.getValue(this.style, mxShapeGmdlMarginRect.prototype.cst.MARGIN_TOP, '0'),
  );
  var marginLeft = parseFloat(
    mxUtils.getValue(this.style, mxShapeGmdlMarginRect.prototype.cst.MARGIN_LEFT, '0'),
  );
  var marginBottom = parseFloat(
    mxUtils.getValue(this.style, mxShapeGmdlMarginRect.prototype.cst.MARGIN_BOTTOM, '0'),
  );
  var marginRight = parseFloat(
    mxUtils.getValue(this.style, mxShapeGmdlMarginRect.prototype.cst.MARGIN_RIGHT, '0'),
  );
...
mxCellRenderer.registerShape(
  mxShapeGmdlMarginRect.prototype.cst.SHAPE_MARGIN_RECT,
...
mxShapeGmdlSliderNormal.prototype.background = function (c, x, y, w, h) {
  var hSize = parseFloat(
    mxUtils.getValue(this.style, mxShapeGmdlSliderNormal.prototype.cst.HANDLE_SIZE, '10'),
  );
...
mxCellRenderer.registerShape(
  mxShapeGmdlSliderNormal.prototype.cst.SHAPE_SLIDER_NORMAL,
...
mxShapeGmdlSlider2.prototype.background = function (c, x, y, w, h) {
  var hSize = parseFloat(
    mxUtils.getValue(this.style, mxShapeGmdlSlider2.prototype.cst.HANDLE_SIZE, '10'),
  );
  var barPos =
    parseFloat(mxUtils.getValue(this.style, mxShapeGmdlSlider2.prototype.cst.BAR_POS, '40')) / 100;
  ...
  var handles = [
    Graph.createHandle(
      ...
      function (bounds) {
        var barPos = Math.max(
          0,
          Math.min(bounds.width, parseFloat(mxUtils.getValue(this.state.style, 'barPos', 0.4))),
        );
      ...
      function (bounds, pt) {
        this.state.style['barPos'] =
          Math.round(100 * Math.max(0, Math.min(100, ((pt.x - bounds.x) * 100) / bounds.width))) /
          100;
      },
    ),
  ];
...
mxShapeGmdlSliderFocused.prototype.background = function (c, x, y, w, h) {
  var hSize = parseFloat(
    mxUtils.getValue(this.style, mxShapeGmdlSliderFocused.prototype.cst.HANDLE_SIZE, '10'),
  );
  var barPos =
    parseFloat(mxUtils.getValue(this.style, mxShapeGmdlSliderFocused.prototype.cst.BAR_POS, '40')) /
    100;
...
mxCellRenderer.registerShape(
  mxShapeGmdlSliderFocused.prototype.cst.SHAPE_SLIDER_FOCUSED,
  mxShapeGmdlSliderFocused,
);

mxShapeGmdlSliderFocused.prototype.constraints = null;

Graph.handleFactory[mxShapeGmdlSliderFocused.prototype.cst.SHAPE_SLIDER_FOCUSED] = function (
  state,
) {
  var handles = [
    Graph.createHandle(
...
mxShapeGmdlSliderDisabled.prototype.background = function (c, x, y, w, h) {
  var hSize = parseFloat(
    mxUtils.getValue(this.style, mxShapeGmdlSliderDisabled.prototype.cst.HANDLE_SIZE, '10'),
  );
  var hPos =
    parseFloat(
      mxUtils.getValue(this.style, mxShapeGmdlSliderDisabled.prototype.cst.HANDLE_POSITION, '50'),
    ) / 100;
...
mxCellRenderer.registerShape(
  mxShapeGmdlSliderDisabled.prototype.cst.SHAPE_SLIDER_DISABLED,
...
mxShapeGmdlSliderDisabled2.prototype.background = function (c, x, y, w, h) {
  var hSize = parseFloat(
    mxUtils.getValue(this.style, mxShapeGmdlSliderDisabled2.prototype.cst.HANDLE_SIZE, '10'),
  );
  var hPos =
    parseFloat(
      mxUtils.getValue(this.style, mxShapeGmdlSliderDisabled2.prototype.cst.HANDLE_POSITION, '50'),
    ) / 100;
...
mxCellRenderer.registerShape(
  mxShapeGmdlSliderDisabled2.prototype.cst.SHAPE_SLIDER_DISABLED,
  mxShapeGmdlSliderDisabled2,
);

mxShapeGmdlSlider2.prototype.constraints = null;

Graph.handleFactory[mxShapeGmdlSliderDisabled2.prototype.cst.SHAPE_SLIDER_DISABLED] = function (
  state,
) {
  var handles = [
    Graph.createHandle(
      ...
      function (bounds) {
        var hPos = Math.max(
          0,
          Math.min(bounds.width, parseFloat(mxUtils.getValue(this.state.style, 'hPos', 0.4))),
        );

        return new mxPoint(bounds.x + (hPos * bounds.width) / 100, bounds.y + bounds.height / 2);
      },
      function (bounds, pt) {
        this.state.style['hPos'] =
          Math.round(100 * Math.max(0, Math.min(100, ((pt.x - bounds.x) * 100) / bounds.width))) /
          100;
      },
    ),
...
mxShapeGmdlSliderDiscrete.prototype.background = function (c, x, y, w, h) {
  var hSize = parseFloat(
    mxUtils.getValue(this.style, mxShapeGmdlSliderDiscrete.prototype.cst.HANDLE_SIZE, '10'),
  );
  var barPos =
    parseFloat(
      mxUtils.getValue(this.style, mxShapeGmdlSliderDiscrete.prototype.cst.BAR_POS, '40'),
    ) / 100;
...
mxCellRenderer.registerShape(
  mxShapeGmdlSliderDiscrete.prototype.cst.SHAPE_DISCRETE,
...
mxShapeGmdlSliderDiscreteDots.prototype.background = function (c, x, y, w, h) {
  var hSize = parseFloat(
    mxUtils.getValue(this.style, mxShapeGmdlSliderDiscreteDots.prototype.cst.HANDLE_SIZE, '10'),
  );
  var barPos =
    parseFloat(
      mxUtils.getValue(this.style, mxShapeGmdlSliderDiscreteDots.prototype.cst.BAR_POS, '40'),
    ) / 100;
  var fontSize = parseFloat(mxUtils.getValue(this.style, mxConstants.STYLE_FONTSIZE, '12'));
  var fontColor = mxUtils.getValue(this.style, mxConstants.STYLE_FONTCOLOR, '#000000');
...
mxCellRenderer.registerShape(
  mxShapeGmdlSliderDiscreteDots.prototype.cst.SHAPE_DISCRETE_DOTS,
  mxShapeGmdlSliderDiscreteDots,
);

mxShapeGmdlSliderDiscreteDots.prototype.constraints = null;

Graph.handleFactory[mxShapeGmdlSliderDiscreteDots.prototype.cst.SHAPE_DISCRETE_DOTS] = function (
  state,
) {
  var handles = [
    Graph.createHandle(
      ...
      function (bounds, pt) {
        this.state.style['barPos'] =
          Math.round(0.05 * Math.max(0, Math.min(100, ((pt.x - bounds.x) * 100) / bounds.width))) /
          0.05;
      },
    ),
  ];
...
mxCellRenderer.registerShape(
  mxShapeGmdlProgressBar.prototype.cst.PROGRESS_BAR,
  mxShapeGmdlProgressBar,
);
...
Graph.handleFactory[mxShapeGmdlProgressBar.prototype.cst.PROGRESS_BAR] = function (state) {
  ...
  var handle2 = Graph.createHandle(
    ...
    function (bounds) {
      var dx2 = Math.max(
        0,
        Math.min(1, parseFloat(mxUtils.getValue(this.state.style, 'dx2', this.dx1))),
      );
