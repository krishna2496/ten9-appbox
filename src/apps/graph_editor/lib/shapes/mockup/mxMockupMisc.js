...
mxShapeMockupPlaybackControls.prototype.foreground = function (
  c,
  w,
  h,
  controlBarHeight,
  ...
  var fillColor2 = mxUtils.getValue(
    this.style,
    mxShapeMockupPlaybackControls.prototype.cst.FILL_COLOR2,
    '#99ddff',
  );
  var strokeColor2 = mxUtils.getValue(
    this.style,
    mxShapeMockupPlaybackControls.prototype.cst.STROKE_COLOR2,
    'none',
  );
  var fillColor3 = mxUtils.getValue(
    this.style,
    mxShapeMockupPlaybackControls.prototype.cst.FILL_COLOR3,
    '#ffffff',
  );
  var strokeColor3 = mxUtils.getValue(
    this.style,
    mxShapeMockupPlaybackControls.prototype.cst.STROKE_COLOR3,
    'none',
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupPlaybackControls.prototype.cst.SHAPE_PLAYBACK_CONTROLS,
...
mxShapeMockupProgressBar.prototype.foreground = function (c, w, h) {
  var fillColor2 = mxUtils.getValue(
    this.style,
    mxShapeMockupProgressBar.prototype.cst.FILL_COLOR2,
    '#ddeeff',
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupProgressBar.prototype.cst.SHAPE_PROGRESS_BAR,
  mxShapeMockupProgressBar,
);
  ...
  var handles = [
    Graph.createHandle(
      ...
      function (bounds) {
        ...
        return new mxPoint(
          bounds.x + (barPos * bounds.width) / 100,
...
mxCellRenderer.registerShape(
  mxShapeMockupShoppingCart.prototype.cst.SHAPE_SHOPPING_CART,
  mxShapeMockupShoppingCart,
);
...
mxShapeMockupRating.prototype.paintVertexShape = function (c, x, y, w, h) {
  var ratingStyle = mxUtils.getValue(
    this.style,
    mxShapeMockupRating.prototype.cst.RATING_STYLE,
    mxShapeMockupRating.prototype.cst.RATING_STAR,
  );
  var grade = mxUtils.getValue(this.style, mxShapeMockupRating.prototype.cst.GRADE, '5');
  var ratingScale = mxUtils.getValue(
    this.style,
    mxShapeMockupRating.prototype.cst.RATING_SCALE,
    '10',
  );
  ...
  var emptyFillColor = mxUtils.getValue(
    this.style,
    mxShapeMockupRating.prototype.cst.EMPTY_FILL_COLOR,
    '#ffffff',
  );
...
mxShapeMockupVolumeSlider.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var fillColor2 = mxUtils.getValue(
    this.style,
    mxShapeMockupVolumeSlider.prototype.cst.FILL_COLOR2,
    '#ddeeff',
  );
  ...
  c.arcTo(
    controlBarHeight * 0.2,
    controlBarHeight * 0.3,
    0,
    0,
    1,
    soundStartX + controlBarHeight * 0.4,
    soundStartY + controlBarHeight * 0.65,
  );
  c.moveTo(soundStartX + controlBarHeight * 0.425, soundStartY + controlBarHeight * 0.25);
  c.arcTo(
    controlBarHeight * 0.225,
    controlBarHeight * 0.35,
    0,
    0,
    1,
    soundStartX + controlBarHeight * 0.425,
    soundStartY + controlBarHeight * 0.75,
  );
  c.moveTo(soundStartX + controlBarHeight * 0.5, soundStartY + controlBarHeight * 0.2);
  c.arcTo(
    controlBarHeight * 0.25,
    controlBarHeight * 0.4,
    0,
    0,
    1,
    soundStartX + controlBarHeight * 0.5,
    soundStartY + controlBarHeight * 0.8,
  );
  c.fillAndStroke();
  ...
  c.roundrect(
    videoBarStartX,
    videoBarStartY + controlBarHeight * 0.35,
    videoBarEndX,
    controlBarHeight * 0.3,
    5,
    5,
  ...
  c.ellipse(
    barEnd - controlBarHeight * 0.25,
    videoBarStartY + controlBarHeight * 0.25,
    controlBarHeight * 0.5,
    controlBarHeight * 0.5,
  );
  c.fillAndStroke();
};
...
mxCellRenderer.registerShape(
  mxShapeMockupVolumeSlider.prototype.cst.SHAPE_VOLUME_SLIDER,
  mxShapeMockupVolumeSlider,
);

Graph.handleFactory[mxShapeMockupVolumeSlider.prototype.cst.SHAPE_VOLUME_SLIDER] = function (
  state,
) {
  var handles = [
    Graph.createHandle(
      ...
      function (bounds) {
        ...
        return new mxPoint(
          bounds.x + (barPos * (bounds.width - 32.5)) / 100,
          bounds.y + bounds.height * 0.5,
        );
      },
      function (bounds, pt) {
...
mxCellRenderer.registerShape(
  mxShapeMockupTrashcan.prototype.cst.SHAPE_TRASHCAN,
...
mxCellRenderer.registerShape(
  mxShapeMockupCopyright.prototype.cst.SHAPE_COPYRIGHT,
  mxShapeMockupCopyright,
);
...
mxCellRenderer.registerShape(
  mxShapeMockupRegistered.prototype.cst.SHAPE_REGISTERED,
  mxShapeMockupRegistered,
);
...
mxShapeMockupRuler.prototype.foreground = function (c, w, h) {
  var facing = mxUtils.getValue(
    this.style,
    mxShapeMockupRuler.prototype.cst.ORIENTATION,
    mxShapeMockupRuler.prototype.cst.FACE_DOWN,
  );
...
mxShapeMockupRuler2.prototype.foreground = function (c, x, y, w, h) {
  var facing = mxUtils.getValue(
    this.style,
    mxShapeMockupRuler2.prototype.cst.ORIENTATION,
    mxShapeMockupRuler2.prototype.cst.FACE_DOWN,
  );
...
Graph.handleFactory[mxShapeMockupRuler2.prototype.cst.SHAPE_RULER] = function (state) {
  var handles = [
    Graph.createHandle(
      ...
      function (bounds, pt) {
        this.state.style['dx'] =
          Math.round(1000 * Math.max(0, Math.min(bounds.width, pt.x - bounds.x))) / 1000;
        this.state.style['spacingLeft'] =
          Math.round(1000 * Math.max(0, Math.min(bounds.width, pt.x - bounds.x))) / 1000 - 4;
...
mxShapeMockupRevisionTable.prototype.foreground = function (c, w, h) {
  var mainText = mxUtils
    .getValue(this.style, mxShapeMockupRevisionTable.prototype.cst.MAIN_TEXT, '')
    .toString()
    .split(',');
  var textColor = mxUtils.getValue(
    this.style,
    mxShapeMockupRevisionTable.prototype.cst.TEXT_COLOR,
    '#999999',
  );
  var textSize = mxUtils.getValue(
    this.style,
    mxShapeMockupRevisionTable.prototype.cst.TEXT_SIZE,
    '17',
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupRevisionTable.prototype.cst.SHAPE_REVISION_TABLE,
  mxShapeMockupRevisionTable,
);
...
mxShapeMockupStatusBar.prototype.foreground = function (c, w, h) {
  var fillColor2 = mxUtils.getValue(
    this.style,
    mxShapeMockupStatusBar.prototype.cst.FILL_COLOR2,
    '#ddeeff',
  );
  var strokeColor2 = mxUtils.getValue(
    this.style,
    mxShapeMockupStatusBar.prototype.cst.STROKE_COLOR2,
    '#008cff',
  );
  var mainText = mxUtils
    .getValue(this.style, mxShapeMockupStatusBar.prototype.cst.MAIN_TEXT, '')
    .toString()
    .split(',');
  var textColor = mxUtils.getValue(
    this.style,
    mxShapeMockupStatusBar.prototype.cst.TEXT_COLOR,
    '#999999',
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupStatusBar.prototype.cst.SHAPE_STATUS_BAR,
  mxShapeMockupStatusBar,
);
...
mxShapeMockupPin.prototype.paintVertexShape = function (c, x, y, w, h) {
  var fillColor2 = mxUtils.getValue(
    this.style,
    mxShapeMockupPin.prototype.cst.FILL_COLOR2,
    '#000000',
  );
  var fillColor3 = mxUtils.getValue(
    this.style,
    mxShapeMockupPin.prototype.cst.FILL_COLOR3,
    '#000000',
  );
  var strokeColor = mxUtils.getValue(this.style, mxConstants.STYLE_STROKECOLOR, '#000000');
  c.setShadow(false);
...
mxShapeMockupMiscRRect.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var rSize = parseInt(
    mxUtils.getValue(this.style, mxShapeMockupMiscRRect.prototype.cst.R_SIZE, '10'),
  );
