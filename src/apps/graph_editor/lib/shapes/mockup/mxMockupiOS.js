...
mxShapeMockupiButtonBar.prototype.paintVertexShape = function (c, x, y, w, h) {
  var textStrings = mxUtils
    .getValue(this.style, mxMockupC.BUTTON_TEXT, '+Button 1, Button 2, Button 3')
    .toString()
    .split(',');
...
mxShapeMockupiButtonBar.prototype.background = function (
  c,
  w,
  h,
  rSize,
...
mxShapeMockupiButtonBar.prototype.foreground = function (
  c,
  w,
  h,
  rSize,
...
mxShapeMockupiButtonBar.prototype.buttonText = function (
  c,
  w,
  h,
  textString,
...
mxCellRenderer.registerShape(
  mxShapeMockupiTopBar2.prototype.cst.SHAPE_ITOP_BAR2,
...
mxShapeMockupiButtonForward.prototype.mainText = function (
  c,
  x,
  y,
  w,
...
mxShapeMockupiRadioGroup.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var optionText = mxUtils
    .getValue(this.style, mxMockupC.BUTTON_TEXT, 'Option 1')
    .toString()
    .split(',');
...
mxShapeMockupiAlertBox.prototype.foreground = function (c, x, y, w, h, rSize) {
  var mainText = mxUtils
    .getValue(this.style, mxMockupC.BUTTON_TEXT, 'Main Text')
    .toString()
    .split(',');
...
mxShapeMockupiKeybSymbols.prototype.foreground = function (c, x, y, w, h, strokeColor) {
  ...
  c.text(
    ...
    0,
    0,
    String.fromCharCode(parseInt('00A3', 16)),
    mxConstants.ALIGN_CENTER,
    mxConstants.ALIGN_MIDDLE,
    0,
    null,
  ...
  c.text(
    ...
    0,
    0,
    String.fromCharCode(parseInt('00A5', 16)),
    mxConstants.ALIGN_CENTER,
    mxConstants.ALIGN_MIDDLE,
    0,
    null,
  ...
  c.text(
    ...
    0,
    0,
    String.fromCharCode(parseInt('0095', 16)),
    mxConstants.ALIGN_CENTER,
    mxConstants.ALIGN_MIDDLE,
    0,
    null,
...
mxShapeMockupiHorButtonBar.prototype.background = function (
  c,
  w,
  h,
  rSize,
...
mxShapeMockupiHorButtonBar.prototype.buttonText = function (
  c,
  w,
  h,
  textString,
  ...
  var handles = [
    Graph.createHandle(
      ...
      function (bounds) {
        var barPos = Math.max(
          0,
          Math.min(bounds.width, parseFloat(mxUtils.getValue(this.state.style, 'barPos', 40))),
        );

        return new mxPoint(
          bounds.x + bounds.width * 0.1 + (barPos * bounds.width * 0.8) / 100,
          ...
          Math.round(
            100 *
              Math.max(
                ...
                Math.min(
                  100,
                  ((pt.x - bounds.width * 0.1 - bounds.x) * 100) / (bounds.width * 0.8),
                ),
              ),
          ) / 100;
      },
...
mxShapeIosTopButton.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var rSize = parseInt(
    mxUtils.getValue(this.style, mxShapeIosTopButton.prototype.cst.R_SIZE, '10'),
  );
...
mxShapeIosBottomButton.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var rSize = parseInt(
    mxUtils.getValue(this.style, mxShapeIosBottomButton.prototype.cst.R_SIZE, '10'),
  );
...
mxCellRenderer.registerShape(
  mxShapeIosBottomButton.prototype.cst.BOTTOM_BUTTON,
  mxShapeIosBottomButton,
);
...
mxShapeMockupFancyRRect.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var rSize = parseInt(
    mxUtils.getValue(this.style, mxShapeMockupFancyRRect.prototype.cst.R_SIZE, '10'),
  );
...
mxCellRenderer.registerShape(
  mxShapeMockupFancyRRect.prototype.cst.FANCY_RRECT,
  mxShapeMockupFancyRRect,
);
