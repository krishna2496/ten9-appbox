...
const { mxCellRenderer, mxMarker, mxShape, mxUtils } = require('../../jgraph/mxClient.js');
...
mxCellRenderer.registerShape(
  mxShapeMockupCurlyBrace.prototype.cst.SHAPE_CURLY_BRACE,
  mxShapeMockupCurlyBrace,
);
...
mxCellRenderer.registerShape(
  mxShapeMockupScratchOut.prototype.cst.SHAPE_SCRATCH_OUT,
